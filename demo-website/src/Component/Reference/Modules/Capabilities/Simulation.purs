module PSD3.Reference.Modules.Capabilities.Simulation where
...
-- | PSD3.Capabilities.Simulation module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Capabilities.Simulation" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Force simulation capabilities" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Capabilities/Simulation.purs"
