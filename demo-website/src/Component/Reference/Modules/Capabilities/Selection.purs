module PSD3.Reference.Modules.Capabilities.Selection where
...
-- | PSD3.Capabilities.Selection module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Capabilities.Selection" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Core selection and element manipulation operations" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Capabilities/Selection.purs"
