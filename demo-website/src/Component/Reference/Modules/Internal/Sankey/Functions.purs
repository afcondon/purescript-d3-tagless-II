module PSD3.Reference.Modules.Internal.Sankey.Functions where
...
-- | PSD3.Internal.Sankey.Functions module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Internal.Sankey.Functions" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Sankey diagram functions" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Internal/Sankey/Functions.purs"
