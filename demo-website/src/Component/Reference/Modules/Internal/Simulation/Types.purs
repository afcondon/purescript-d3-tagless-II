module PSD3.Reference.Modules.Internal.Simulation.Types where
...
-- | PSD3.Internal.Simulation.Types module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Internal.Simulation.Types" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Simulation type definitions" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Internal/Simulation/Types.purs"
