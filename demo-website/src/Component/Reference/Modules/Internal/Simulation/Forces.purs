module PSD3.Reference.Modules.Internal.Simulation.Forces where
...
-- | PSD3.Internal.Simulation.Forces module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Internal.Simulation.Forces" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Force definitions for simulations" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Internal/Simulation/Forces.purs"
