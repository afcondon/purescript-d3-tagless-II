module PSD3.Reference.Modules.Interpreter.String where
...
-- | PSD3.Interpreter.String module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Interpreter.String" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "String interpreter - generates code as text" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Interpreter/String.purs"
