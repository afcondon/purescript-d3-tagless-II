module PSD3.Reference.Modules.Interpreter.D3 where
...
-- | PSD3.Interpreter.D3 module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Interpreter.D3" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "D3.js interpreter - runs visualizations in the browser" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Interpreter/D3.purs"
