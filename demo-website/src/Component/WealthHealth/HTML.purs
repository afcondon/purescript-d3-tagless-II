module Component.WealthHealth.HTML where
...
import Component.WealthHealth.State (State, LabelMode(..))
import Component.WealthHealth.Types (Region(..), regionName, regionColor)
