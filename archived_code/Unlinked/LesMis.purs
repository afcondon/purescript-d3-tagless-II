...
import PSD3.Capabilities.Simulation (SimulationUpdate, init, start, update)
...
handleAction = case _ of
  ...
  ToggleForce name -> do
    ...
    state <- get
    runWithD3_Simulation do
      -- TODO: use update API to set activeForces and alpha
      start

  Freeze -> runWithD3_Simulation do
    -- TODO: use update API to set alpha to 0
    pure unit

  Reheat -> runWithD3_Simulation do
    -- TODO: use update API to set alpha to 0.7
    start
-- Snippet_End
