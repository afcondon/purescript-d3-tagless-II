...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a3) {
      return function(b10) {
        return apply1(map45($$const(identity2))(a3))(b10);
      };
    };
  };
  ...
  var eqTuple = function(dictEq) {
    ...
    return function(dictEq1) {
      ...
      return {
        eq: function(x5) {
          return function(y5) {
            return eq8(x5.value0)(y5.value0) && eq14(x5.value1)(y5.value1);
          };
        }
      };
    };
  ...
  var _insertAt = function(just, nothing, i2, a3, l) {
  ...
  var sortByImpl = /* @__PURE__ */ (function() {
    function mergeFromTo(compare3, fromOrdering, xs1, xs2, from3, to) {
      ...
      while (i2 < mid && j < to) {
        x5 = xs2[i2];
        y5 = xs2[j];
        c2 = fromOrdering(compare3(x5)(y5));
        if (c2 > 0) {
          xs1[k++] = y5;
          ++j;
        } else {
      ...
      eq: function(x5) {
        return function(y5) {
          ...
          if (x5 instanceof Just && y5 instanceof Just) {
            return eq8(x5.value0)(y5.value0);
          }
          ;
          return false;
        };
  ...
  function bisector(f) {
    ...
    function left(a3, x5, lo = 0, hi = a3.length) {
      if (lo < hi) {
        ...
        do {
          const mid = lo + hi >>> 1;
          if (compare22(a3[mid], x5) < 0) lo = mid + 1;
          else hi = mid;
        } while (lo < hi);
      }
      return lo;
  ...
  function rgba(r, g, b10, a3) {
    if (a3 <= 0) r = g = b10 = NaN;
    return new Rgb(r, g, b10, a3);
  }
  ...
  function hslConvert(o) {
    ...
    o = o.rgb();
    var r = o.r / 255, g = o.g / 255, b10 = o.b / 255, min8 = Math.min(r, g, b10), max9 = Math.max(r, g, b10), h = NaN, s = max9 - min8, l = (max9 + min8) / 2;
    if (s) {
  ...
  function exponential(a3, b10, y5) {
    return a3 = Math.pow(a3, y5), b10 = Math.pow(b10, y5) - a3, y5 = 1 / y5, function(t) {
      return Math.pow(a3 + t * b10, y5);
    };
  }
  function gamma(y5) {
    return (y5 = +y5) === 1 ? nogamma : function(a3, b10) {
      return b10 - a3 ? exponential(a3, b10, y5) : constant_default(isNaN(a3) ? b10 : a3);
    };
  }
  function nogamma(a3, b10) {
    var d3 = b10 - a3;
    return d3 ? linear(a3, d3) : constant_default(isNaN(a3) ? b10 : a3);
  }
  ...
  function numberArray_default(a3, b10) {
    ...
    return function(t) {
      for (i2 = 0; i2 < n; ++i2) c2[i2] = a3[i2] * (1 - t) + b10[i2] * t;
      return c2;
    };
  }
  ...
  function genericArray(a3, b10) {
    var nb = b10 ? b10.length : 0, na = a3 ? Math.min(nb, a3.length) : 0, x5 = new Array(na), c2 = new Array(nb), i2;
    for (i2 = 0; i2 < na; ++i2) x5[i2] = value_default(a3[i2], b10[i2]);
    for (; i2 < nb; ++i2) c2[i2] = b10[i2];
    return function(t) {
      for (i2 = 0; i2 < na; ++i2) c2[i2] = x5[i2](t);
      return c2;
    };
  }
  ...
  function date_default(a3, b10) {
    ...
    return a3 = +a3, b10 = +b10, function(t) {
      return d3.setTime(a3 * (1 - t) + b10 * t), d3;
    };
  }
  ...
  function decompose_default(a3, b10, c2, d3, e, f) {
    var scaleX, scaleY, skewX;
    if (scaleX = Math.sqrt(a3 * a3 + b10 * b10)) a3 /= scaleX, b10 /= scaleX;
    if (skewX = a3 * c2 + b10 * d3) c2 -= a3 * skewX, d3 -= b10 * skewX;
    if (scaleY = Math.sqrt(c2 * c2 + d3 * d3)) c2 /= scaleY, d3 /= scaleY, skewX /= scaleY;
    if (a3 * d3 < b10 * c2) a3 = -a3, b10 = -b10, skewX = -skewX, scaleX = -scaleX;
    return {
      translateX: e,
      translateY: f,
  ...
  function parseCss(value13) {
    const m2 = new (typeof DOMMatrix === "function" ? DOMMatrix : WebKitCSSMatrix)(value13 + "");
  ...
  function interpolateTransform(parse7, pxComma, pxParen, degParen) {
    ...
    function rotate(a3, b10, s, q2) {
      if (a3 !== b10) {
        if (a3 - b10 > 180) b10 += 360;
        else if (b10 - a3 > 180) a3 += 360;
        q2.push({ i: s.push(pop4(s) + "rotate(", null, degParen) - 2, x: number_default(a3, b10) });
      } else if (b10) {
        s.push(pop4(s) + "rotate(" + b10 + degParen);
      }
    }
    function skewX(a3, b10, s, q2) {
      if (a3 !== b10) {
        q2.push({ i: s.push(pop4(s) + "skewX(", null, degParen) - 2, x: number_default(a3, b10) });
      } else if (b10) {
    ...
    return function(a3, b10) {
      var s = [], q2 = [];
      a3 = parse7(a3), b10 = parse7(b10);
      translate(a3.translateX, a3.translateY, b10.translateX, b10.translateY, s, q2);
      rotate(a3.rotate, b10.rotate, s, q2);
      skewX(a3.skewX, b10.skewX, s, q2);
      scale(a3.scaleX, a3.scaleY, b10.scaleX, b10.scaleY, s, q2);
      a3 = b10 = null;
      return function(t) {
  ...
  function locale_default(locale2) {
    var group4 = locale2.grouping === void 0 || locale2.thousands === void 0 ? identity_default : formatGroup_default(map6.call(locale2.grouping, Number), locale2.thousands + ""), currencyPrefix = locale2.currency === void 0 ? "" : locale2.currency[0] + "", currencySuffix = locale2.currency === void 0 ? "" : locale2.currency[1] + "", decimal = locale2.decimal === void 0 ? "." : locale2.decimal + "", numerals = locale2.numerals === void 0 ? identity_default : formatNumerals_default(map6.call(locale2.numerals, String)), percent = locale2.percent === void 0 ? "%" : locale2.percent + "", minus = locale2.minus === void 0 ? "\u2212" : locale2.minus + "", nan2 = locale2.nan === void 0 ? "NaN" : locale2.nan + "";
      ...
      function format2(value13) {
        ...
        if (type === "c") {
          ...
          if (maybeSuffix) {
            ...
            while (++i2 < n) {
              if (c2 = value13.charCodeAt(i2), 48 > c2 || c2 > 57) {
                valueSuffix = (c2 === 46 ? decimal + value13.slice(i2 + 1) : value13.slice(i2)) + valueSuffix;
  ...
  function symlogish(transform4) {
    var c2 = 1, scale = transform4(transformSymlog(c2), transformSymexp(c2));
  ...
  var getPalette = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Data.ColorPalette (line 70, column 1 - line 70, column 43): " + [v.constructor.name]);
  };
  ...
  var abs = Math.abs;
  var atan2 = function(y5) {
    return function(x5) {
      return Math.atan2(y5, x5);
    };
  };
  var ceil = Math.ceil;
  var cos = Math.cos;
  ...
  var ModuleTreemap = /* @__PURE__ */ (function() {
    function ModuleTreemap2(value0) {
      this.value0 = value0;
    }
    ;
    ModuleTreemap2.create = function(value0) {
      return new ModuleTreemap2(value0);
    };
    return ModuleTreemap2;
  })();
  var PackageGrid = /* @__PURE__ */ (function() {
    function PackageGrid2(value0) {
      this.value0 = value0;
    }
    ;
    PackageGrid2.create = function(value0) {
      return new PackageGrid2(value0);
    };
    return PackageGrid2;
  })();
  var ModuleOrbit = /* @__PURE__ */ (function() {
    function ModuleOrbit2(value0) {
      this.value0 = value0;
    }
    ;
    ModuleOrbit2.create = function(value0) {
      return new ModuleOrbit2(value0);
    };
    return ModuleOrbit2;
  })();
  var DependencyTree = /* @__PURE__ */ (function() {
    function DependencyTree2(value0) {
      this.value0 = value0;
    }
    ;
    DependencyTree2.create = function(value0) {
      return new DependencyTree2(value0);
    };
  ...
  var showScope = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.ViewState (line 118, column 1 - line 118, column 35): " + [v.constructor.name]);
  };
  var scopeName = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.ViewState (line 114, column 1 - line 114, column 35): " + [v.constructor.name]);
  };
  var eqScopeFilter = {
    eq: function(x5) {
      return function(y5) {
  ...
  var eqViewState = {
    eq: function(x5) {
      return function(y5) {
        if (x5 instanceof ModuleTreemap && y5 instanceof ModuleTreemap) {
          return eq13(x5.value0)(y5.value0);
        }
        ;
        if (x5 instanceof PackageGrid && y5 instanceof PackageGrid) {
          return eq13(x5.value0)(y5.value0);
        }
        ;
        if (x5 instanceof ModuleOrbit && y5 instanceof ModuleOrbit) {
          return eq13(x5.value0)(y5.value0);
        }
        ;
        if (x5 instanceof DependencyTree && y5 instanceof DependencyTree) {
          return eq13(x5.value0)(y5.value0);
        }
        ;
  ...
  var describe = function(vs) {
    if (vs instanceof ModuleTreemap) {
      return {
        text: "[" + ("Grid" + ("] of [" + (scopeName(vs.value0) + "] modules, sized by lines of code"))),
        controls: [{
          id: "layout",
          current: "grid",
          options: ["grid", "orbit"]
    ...
    ;
    if (vs instanceof PackageGrid) {
      return {
        text: "[" + ("Grid" + ("] of [" + (scopeName(vs.value0) + "] packages"))),
        controls: [{
          id: "layout",
          current: "grid",
          options: ["grid", "orbit"]
    ...
    ;
    if (vs instanceof ModuleOrbit) {
      return {
        text: "[" + ("Orbit" + ("] of [" + (scopeName(vs.value0) + "] modules, grouped by package"))),
        controls: [{
          id: "layout",
          current: "orbit",
          options: ["grid", "orbit", "tree"]
        }, {
          id: "scope",
          current: showScope(vs.value0),
          options: ["project", "all"]
    ...
    ;
    if (vs instanceof DependencyTree) {
      return {
        text: "[" + ("Dependency tree" + ("] of [" + (scopeName(vs.value0) + "] module dependencies"))),
        controls: [{
          id: "layout",
          current: "tree",
          options: ["grid", "orbit", "tree"]
    ...
    ;
    throw new Error("Failed pattern match at Engine.ViewState (line 52, column 15 - line 101, column 6): " + [vs.constructor.name]);
  };
  ...
  var fromFoldable2 = function(dictOrd) {
    ...
    return function(dictFoldable) {
      return foldl(dictFoldable)(function(m2) {
        return function(v) {
          return insert15(v.value0)(v.value1)(m2);
        };
      })(empty2);
    };
  };
  ...
  var foldableWithIndexObject = {
    ...
    foldrWithIndex: function(f) {
      return function(z) {
        return function(m2) {
          return foldr3(uncurry(f))(z)(toArrayWithKey(Tuple.create)(m2));
        };
      };
    },
    foldMapWithIndex: function(dictMonoid) {
  ...
  var showViewState = function(v) {
    if (v instanceof ModuleTreemap) {
      return "ModuleTreemap";
    }
    ;
    if (v instanceof PackageGrid) {
      return "PackageGrid";
    }
    ;
    if (v instanceof ModuleOrbit) {
      return "ModuleOrbit";
    }
    ;
    if (v instanceof DependencyTree) {
    ...
    return function(_controls) {
      return function(seg) {
        ...
        if (seg instanceof ControlText) {
          var $72 = $$null(seg.value1.options);
          if ($72) {
          ...
          return span2([class_("tangle-control"), onClick(function(v) {
            ...
            var $73 = eq22(state3.dropdownOpen)(new Just(seg.value1.id));
            if ($73) {
  ...
  var handleQuery = function(dictMonadAff) {
    var log11 = log5(monadEffectHalogenM(dictMonadAff.MonadEffect0()));
    return function(v) {
      if (v instanceof SetViewState) {
        return discard2(log11("[NarrativePanel] SetViewState received: " + showViewState(v.value0)))(function() {
    ...
    return function(v) {
      if (v instanceof HandleInput) {
        return modify_3(function(v1) {
          ...
          ;
          $100.viewState = v.value0.viewState;
          $100.packagePalette = v.value0.packagePalette;
          $100.projectName = v.value0.projectName;
          $100.projectId = v.value0.projectId;
          $100.projects = v.value0.projects;
          return $100;
        });
      }
      ;
      if (v instanceof ClickControl) {
        return bind3(get2)(function(state3) {
          return modify_3(function(v1) {
            ...
            ;
            $105.dropdownOpen = (function() {
              var $104 = eq22(state3.dropdownOpen)(new Just(v.value0));
              if ($104) {
                return Nothing.value;
              }
              ;
      ...
      if (v instanceof SelectOption) {
        return discard2(modify_3(function(v1) {
          ...
          ;
          $109.dropdownOpen = Nothing.value;
          return $109;
        }))(function() {
      ...
      if (v instanceof CloseDropdown) {
        return modify_3(function(v1) {
          ...
          ;
          $114.dropdownOpen = Nothing.value;
          $114.projectDropdownOpen = false;
          return $114;
        });
      }
      ;
      ...
      if (v instanceof ToggleProjectDropdown) {
        return bind3(get2)(function(state3) {
          return modify_3(function(v1) {
            ...
            ;
            $117.projectDropdownOpen = !state3.projectDropdownOpen;
            return $117;
          });
        });
      }
    ...
    return function(controls2) {
      var findControlForText = function(inner) {
        return function(ctrls) {
          ...
          return find2(function(c2) {
            return toLower(c2.current) === lowerInner || any2(function(opt) {
    ...
    return {
      ...
      foldl: function(f) {
        var go2 = function(b10) {
          return function(fa) {
            return foldl13(go2)(f(b10)(head3(fa)))(tail(fa));
          };
        };
        return go2;
      },
  ...
  var decodeArray3 = /* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons1({
  ...
  var gDecodeJsonCons22 = /* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(decodeJsonString)));
  var nameIsSymbol = {
    reflectSymbol: function() {
      return "name";
    }
  ...
  var gDecodeJsonCons3 = /* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeForeignObject2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons22(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(decodeJsonBoolean))(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons1({
    reflectSymbol: function() {
      return "targetModule";
    }
  })()())({
  ...
  var decodeJson1 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons3(gDecodeJsonNil)(functionsIsSymbol)()())());
  var show3 = /* @__PURE__ */ show(showInt);
  var gDecodeJsonCons4 = /* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldMaybe(decodeJsonString));
  ...
  var decodeJson5 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons4(/* @__PURE__ */ gDecodeJsonCons5(/* @__PURE__ */ gDecodeJsonCons4(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons5(gDecodeJsonNil)({
    reflectSymbol: function() {
  ...
  var gDecodeJsonCons6 = /* @__PURE__ */ gDecodeJsonCons1({
    reflectSymbol: function() {
      return "path";
    }
  })()();
  ...
  var decodeJson6 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeForeignObject2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons22(/* @__PURE__ */ gDecodeJsonCons2(gDecodeJsonCons6)({
    reflectSymbol: function() {
      return "package";
    }
  })()())(dependsIsSymbol)()())()));
  var decodeJson7 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeForeignObject2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons22(gDecodeJsonNil)(dependsIsSymbol)()())()));
  var locIsSymbol = {
    reflectSymbol: function() {
      return "loc";
    }
  };
  var decodeJson8 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons5(gDecodeJsonCons6)(locIsSymbol)()())())))(gDecodeJsonNil)(locIsSymbol)()())());
    ...
    return function(reachableIds) {
      return function(node) {
        var withTreePos = (function() {
          ...
          ;
          throw new Error("Failed pattern match at Data.Loader (line 560, column 19 - line 573, column 22): " + [v.constructor.name]);
        })();
      ...
      return function(packageLocMap) {
        return function(idx) {
          return function(name16) {
            ...
            var r = max4(8)(sqrt3(toNumber(totalLoc)) * 0.5);
  ...
  var markLinkType = function(spanningTreeEdges) {
    return function(link3) {
      ...
      var $364 = member1(edge)(spanningTreeEdges);
      if ($364) {
        return {
          source: link3.source,
          target: link3.target,
  ...
  var mapLeft = function(v) {
    return function(v1) {
      ...
      ;
      throw new Error("Failed pattern match at Data.Loader (line 236, column 1 - line 236, column 62): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  ...
  var findRootModule = function(modules) {
    var v = find2(function(m2) {
      return m2.name === "PSD3.Main";
    })(modules);
    if (v instanceof Just) {
      return v.value0.id;
    }
    ;
    if (v instanceof Nothing) {
      var v1 = last(sortWith2(function(m2) {
        return length(m2.sources);
      })(modules));
      if (v1 instanceof Just) {
        return v1.value0.id;
      }
      ...
      ;
      throw new Error("Failed pattern match at Data.Loader (line 511, column 7 - line 513, column 21): " + [v1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Data.Loader (line 506, column 3 - line 513, column 21): " + [v.constructor.name]);
  };
  var fetchJson = function(url2) {
    return bind6(get4(json)(url2))(function(result) {
      return pure9((function() {
        ...
        ;
        throw new Error("Failed pattern match at Data.Loader (line 232, column 10 - line 234, column 42): " + [result.constructor.name]);
      })());
    });
  };
  var charCode = function(c2) {
    var v = indexOf(singleton3(c2))("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789._-");
    if (v instanceof Just) {
      return v.value0;
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Data.Loader (line 791, column 14 - line 793, column 15): " + [v.constructor.name]);
  };
  var stringHash = function(s) {
    var chars = toCharArray(s);
    return foldl12(function(acc) {
      return function(c2) {
        return mod3((acc * 31 | 0) + charCode(c2) | 0)(1e6);
      };
    })(0)(chars);
  };
                  ...
                  return function(packageNodes) {
                    return function(targetsMap) {
                      return function(sourcesMap) {
                        ...
                        var r = 4 + sqrt3(toNumber(loc)) * 0.8;
    ...
    return function(moduleIdMap) {
      var addTargets = function(acc) {
        return function(v) {
          ...
          ;
          throw new Error("Failed pattern match at Data.Loader (line 757, column 5 - line 763, column 42): " + [v1.constructor.name]);
        };
      };
  ...
  var buildLinks = function(modulesObj) {
    return function(moduleIdMap) {
      var mkLinks = function(v) {
        ...
        ;
        throw new Error("Failed pattern match at Data.Loader (line 738, column 5 - line 749, column 25): " + [v1.constructor.name]);
      };
              ...
              return bind12(packagesResult)(function(packagesJson) {
                return bind12(locResult)(function(locJson) {
                  return bind12(declarationsResult)(function(declarationsJson) {
                    return bind12(mapLeft(printJsonDecodeError)(decodeJson6(modulesJson)))(function(v) {
                      return bind12(mapLeft(printJsonDecodeError)(decodeJson7(packagesJson)))(function(v1) {
                        return bind12(mapLeft(printJsonDecodeError)(decodeJson8(locJson)))(function(v2) {
  ...
  var loadModelForProject = function(projectId) {
    ...
    return bind6(fetchJson(projectUrl + ("modules/" + show3(projectId))))(function(modulesResult) {
      return bind6(fetchJson(projectUrl + ("packages/" + show3(projectId))))(function(packagesResult) {
        return bind6(fetchJson(projectUrl + ("loc/" + show3(projectId))))(function(locResult) {
          return bind6(fetchJson(projectUrl + ("declarations-summary/" + show3(projectId))))(function(declarationsResult) {
            return pure9(bind12(modulesResult)(function(modulesJson) {
              return bind12(packagesResult)(function(packagesJson) {
                return bind12(locResult)(function(locJson) {
                  return bind12(declarationsResult)(function(declarationsJson) {
  ...
  function sort_default(compare3) {
    ...
    function compareNode(a3, b10) {
      return a3 && b10 ? compare3(a3.__data__, b10.__data__) : !a3 - !b10;
    }
  ...
  function link_default(links) {
    ...
    function initialize() {
      if (!nodes) return;
      var i2, n = nodes.length, m2 = links.length, nodeById = new Map(nodes.map((d3, i3) => [id5(d3, i3, nodes), d3])), link3;
  ...
  function simulation_default(nodes) {
    var simulation, alpha = 1, alphaMin = 1e-3, alphaDecay = 1 - Math.pow(alphaMin, 1 / 300), alphaTarget = 0, velocityDecay = 0.6, forces = /* @__PURE__ */ new Map(), stepper = timer(step4), event = dispatch_default2("tick", "end"), random2 = lcg_default();
    if (nodes == null) nodes = [];
    function step4() {
      tick2();
    ...
    function initializeNodes2() {
      for (var i2 = 0, n = nodes.length, node; i2 < n; ++i2) {
        node = nodes[i2], node.index = i2;
        if (node.fx != null) node.x = node.fx;
        if (node.fy != null) node.y = node.fy;
        if (isNaN(node.x) || isNaN(node.y)) {
          var radius3 = initialRadius * Math.sqrt(0.5 + i2), angle = i2 * initialAngle;
          node.x = radius3 * Math.cos(angle);
          node.y = radius3 * Math.sin(angle);
        }
    ...
    function initializeForce2(force2) {
    ...
    return simulation = {
      tick: tick2,
      restart: function() {
        return stepper.restart(step4), simulation;
      },
      stop: function() {
        return stepper.stop(), simulation;
      },
      nodes: function(_) {
        return arguments.length ? (nodes = _, initializeNodes2(), forces.forEach(initializeForce2), simulation) : nodes;
      },
      alpha: function(_) {
      ...
      randomSource: function(_) {
        return arguments.length ? (random2 = _, forces.forEach(initializeForce2), simulation) : random2;
      },
      force: function(name16, _) {
        return arguments.length > 1 ? (_ == null ? forces.delete(name16) : forces.set(name16, initializeForce2(_)), simulation) : forces.get(name16);
      },
      find: function(x5, y5, radius3) {
        var i2 = 0, n = nodes.length, dx, dy, d22, node, closest;
        if (radius3 == null) radius3 = Infinity;
        else radius3 *= radius3;
        for (i2 = 0; i2 < n; ++i2) {
          node = nodes[i2];
          dx = x5 - node.x;
          dy = y5 - node.y;
          d22 = dx * dx + dy * dy;
          if (d22 < radius3) closest = node, radius3 = d22;
        }
        return closest;
      },
      on: function(name16, _) {
        return arguments.length > 1 ? (event.on(name16, _), simulation) : event.on(name16);
      }
    };
  }
  ...
  function manyBody_default() {
    ...
    function accumulate(quad) {
      var strength2 = 0, q2, c2, weight = 0, x5, y5, i2;
      if (quad.length) {
        for (x5 = y5 = i2 = 0; i2 < 4; ++i2) {
          if ((q2 = quad[i2]) && (c2 = Math.abs(q2.value))) {
            strength2 += q2.value, weight += c2, x5 += c2 * q2.x, y5 += c2 * q2.y;
          }
        }
        quad.x = x5 / weight;
        quad.y = y5 / weight;
  ...
  function drag_default() {
    ...
    function touchstarted(event, d3) {
      ...
      var touches = event.changedTouches, c2 = container.call(this, event, d3), n = touches.length, i2, gesture;
      for (i2 = 0; i2 < n; ++i2) {
        if (gesture = beforestart(this, c2, event, d3, touches[i2].identifier, touches[i2])) {
          nopropagation(event);
  ...
  // output/Engine.AtomicView/foreign.js
  var moduleColorScale = ordinal(category10_default);
  var activeSimulation = null;
  var clearAtomicView_ = () => {
    if (activeSimulation) {
  ...
  var renderAtomicView_ = (declarationInfo) => () => {
    clearAtomicView_();
  ...
  `;
    ...
    const seenCallers = /* @__PURE__ */ new Set();
    calledBy.forEach((caller, i2) => {
    ...
    const width10 = 800;
    const height10 = 410;
    const svg = select_default2("#atomic-view-svg").append("svg").attr("width", "100%").attr("height", "100%").attr("viewBox", `0 0 ${width10} ${height10}`);
    const defs = svg.append("defs");
    defs.append("marker").attr("id", "arrow-outgoing").attr("viewBox", "0 -5 10 10").attr("refX", 20).attr("refY", 0).attr("markerWidth", 6).attr("markerHeight", 6).attr("orient", "auto").append("path").attr("fill", "#4ade80").attr("d", "M0,-5L10,0L0,5");
    defs.append("marker").attr("id", "arrow-incoming").attr("viewBox", "0 -5 10 10").attr("refX", 20).attr("refY", 0).attr("markerWidth", 6).attr("markerHeight", 6).attr("orient", "auto").append("path").attr("fill", "#f97316").attr("d", "M0,-5L10,0L0,5");
    const linkGroup = svg.append("g").attr("class", "links");
    const linkElements = linkGroup.selectAll("line").data(links).enter().append("line").attr("stroke", (d3) => d3.type === "outgoing" ? "#4ade80" : "#f97316").attr("stroke-width", 1.5).attr("stroke-opacity", 0.6).attr("marker-end", (d3) => d3.type === "outgoing" ? "url(#arrow-outgoing)" : "url(#arrow-incoming)");
    const nodeGroup = svg.append("g").attr("class", "nodes");
    const nodeElements = nodeGroup.selectAll("g").data(nodes).enter().append("g").attr("class", "node").style("cursor", "grab");
    nodeElements.append("circle").attr("r", (d3) => d3.type === "center" ? 20 : 12).attr("fill", (d3) => {
      if (d3.type === "center") return "#7dd3fc";
      return moduleColorScale(d3.module);
    }).attr("stroke", (d3) => d3.type === "center" ? "#fff" : "#333").attr("stroke-width", (d3) => d3.type === "center" ? 3 : 1);
    nodeElements.append("text").text((d3) => d3.label).attr("dy", (d3) => d3.type === "center" ? 35 : 25).attr("text-anchor", "middle").attr("fill", "#fff").attr("font-size", (d3) => d3.type === "center" ? "14px" : "11px").attr("font-weight", (d3) => d3.type === "center" ? "bold" : "normal");
    nodeElements.append("text").text((d3) => d3.module.split(".").pop()).attr("dy", (d3) => d3.type === "center" ? 50 : 38).attr("text-anchor", "middle").attr("fill", "#888").attr("font-size", "9px");
    const simulation = simulation_default(nodes).force("link", link_default(links).id((d3) => d3.id).distance(120).strength(0.5)).force("charge", manyBody_default().strength(-300)).force("x", x_default2().x((d3) => {
      if (d3.type === "center") return width10 / 2;
      if (d3.type === "incoming") return width10 * 0.2;
      return width10 * 0.8;
    }).strength(0.3)).force("y", y_default2(height10 / 2).strength(0.1)).force("collide", collide_default().radius(40));
    activeSimulation = simulation;
    const dragBehavior = drag_default().on("start", (event, d3) => {
    ...
    simulation.on("tick", () => {
      linkElements.attr("x1", (d3) => d3.source.x).attr("y1", (d3) => d3.source.y).attr("x2", (d3) => d3.target.x).attr("y2", (d3) => d3.target.y);
      nodeElements.attr("transform", (d3) => `translate(${d3.x},${d3.y})`);
    });
  };

  // output/Engine.AtomicView/index.js
  var renderAtomicView = function(fnInfo) {
    return renderAtomicView_({
      ...
      return function(c2) {
        ...
        if ($147) {
          ...
          if ($148) {
            ...
            var y5 = sqrt3(max5(0)(b22 / d22 - x5 * x5));
            return {
              x: b10.x - x5 * dx - y5 * dy,
              y: b10.y - x5 * dy + y5 * dx,
              r: c2.r
          ...
          var y5 = sqrt3(max5(0)(a22 / d22 - x5 * x5));
          return {
            x: a3.x + x5 * dx - y5 * dy,
            y: a3.y + x5 * dy + y5 * dx,
            r: c2.r
  ...
  var enclosesWeak = function(a3) {
    return function(b10) {
      var dy = b10.y - a3.y;
      var dx = b10.x - a3.x;
      var dr = a3.r - b10.r + max5(a3.r)(max5(b10.r)(1)) * epsilon;
      return dr > 0 && dr * dr > dx * dx + dy * dy;
    };
  };
  ...
  var encloseBasis3 = function(a3) {
    return function(b10) {
      return function(c2) {
        ...
        var xa = (b22 * d3 - b32 * d22) / (ab * 2) - a3.x;
        var xb = (b32 * c22 - b22 * c3) / ab;
        var ya = (a32 * d22 - a22 * d3) / (ab * 2) - a3.y;
        ...
        var r = (function() {
          ...
          if ($182) {
            return -(bigB + sqrt3(bigB * bigB - 4 * bigA * bigC)) / (2 * bigA);
          }
          ;
          return -bigC / bigB;
        })();
  ...
  var encloseBasis2 = function(a3) {
    return function(b10) {
      ...
      var x21 = b10.x - a3.x;
      var r21 = b10.r - a3.r;
      var l = sqrt3(x21 * x21 + y21 * y21);
      return {
        x: (a3.x + b10.x + x21 / l * r21) / 2,
        y: (a3.y + b10.y + y21 / l * r21) / 2,
        r: (l + a3.r + b10.r) / 2
      };
    };
  };
  ...
  var packSiblingsMap = function(inputCircles) {
    ...
    if (v2 instanceof Just && (v1 instanceof Just && v instanceof Just)) {
      ...
      var translated = map27(function(c2) {
        return {
          r: c2.r,
          x: c2.x - enclosing.x,
          y: c2.y - enclosing.y
          ...
          return function(node) {
            ...
            if ($42) {
              ...
              return function __do8() {
                (function() {
                  if (isReexport) {
                    return log6("[BubblePack] Re-export module: " + (node.name + (" (depends on " + (show4(length(node.targets)) + " modules)"))))();
                  }
                  ;
            ...
            ;
            return function __do8() {
              log6("[BubblePack] Rendering " + (node.name + (" with " + (show4(length(decls)) + " declarations"))))();
              var hierData = buildModuleHierarchy(node.name)(decls);
              var packRoot = hierarchy(hierData);
              var packSize = node.r * 3;
              var config = {
  ...
  var startAnimation = function(onFrame) {
    return function __do8() {
      ...
      return bind9(getCancelRef(cancelRef))(identity15);
    };
  };
  ...
  var log7 = /* @__PURE__ */ log5(monadEffectEffect);
    ...
    return function(stateRef) {
      return function(state3) {
        return function __do8() {
          ...
          log7("[Scene] Applied " + (show5(length(rules)) + " final rules"))();
  ...
  var mkGridConfig = function(packageCount) {
    ...
    var gridCols = ceil2(sqrt3(toNumber(packageCount) * aspect));
  ...
  var gridPosForIndex = function(cfg) {
    return function(idx) {
      ...
      var y5 = (toNumber(row) - cfg.gridRowsN / 2 + 0.5) * cfg.spacingY;
      var col2 = mod5(idx)(cfg.gridCols);
      var x5 = (toNumber(col2) - cfg.gridColsN / 2 + 0.5) * cfg.spacingX;
      return {
        x: x5,
        y: y5
      };
  ...
  var calculateGridPositions = function(nodes) {
    ...
    return fromFoldable14(map30(function(n) {
      return new Tuple(show6(n.id), gridPosForIndex(cfg)(nodeGridIndex(n)));
    })(nodes));
  };
  ...
  var treeRunLayout = function(nodes) {
    return fromFoldable15(map31(function(n) {
  ...
  var treeFormLayout = function(nodes) {
    ...
    return fromFoldable15(map31(getPosition)(nodes));
  };
  ...
  var orbitLayout = function(nodes) {
    ...
    var getPackageOrbitPos = function(pkg) {
      ...
      return new Tuple(show7(pkg.id), {
        x: px,
        y: py
      });
    };
    var packagePositions = fromFoldable15(map31(getPackageOrbitPos)(packages));
    var getNodeOrbitPos = function(pkgMap) {
      return function(node) {
        ...
        ;
        if (node.nodeType instanceof ModuleNode) {
          var v = lookup3(show7(node.cluster))(pkgMap);
          if (v instanceof Just) {
            return new Tuple(show7(node.id), v.value0);
          }
          ;
          if (v instanceof Nothing) {
            return new Tuple(show7(node.id), {
    ...
    return fromFoldable15(map31(getNodeOrbitPos(packagePositions))(nodes));
  };
  ...
  var orbitFormFinalRules = function(nodes) {
    ...
    var pkgOrbitMap = fromFoldable15(map31(getPackageOrbitPos)(packages));
    return [{
      ...
      select: isModule,
      apply: function(n) {
        var v = lookup3(show7(n.cluster))(pkgOrbitMap);
        if (v instanceof Just) {
          return {
            id: n.id,
            x: n.x,
  ...
  var elasticIn = (function custom4(a3, p2) {
    var s = Math.asin(1 / (a3 = Math.max(1, a3))) * (p2 /= tau);
    function elasticIn2(t) {
      return a3 * tpmt(- --t) * Math.sin((s - t) / p2);
    }
  ...
  var elasticOut = (function custom5(a3, p2) {
    ...
    function elasticOut2(t) {
      return 1 - a3 * tpmt(t = +t) * Math.sin((t + s) / p2);
    }
  ...
  var elasticInOut = (function custom6(a3, p2) {
    ...
    function elasticInOut2(t) {
      return ((t = t * 2 - 1) < 0 ? a3 * tpmt(-t) * Math.sin((s - t) / p2) : 2 - a3 * tpmt(t) * Math.sin((s + t) / p2)) / 2;
    }
  ...
  function zoom_default2() {
    ...
    function schedule(transition2, transform4, point3, event) {
      transition2.on("start.zoom", function() {
        ...
        var that = this, args = arguments, g = gesture(that, args).event(event), e = extent.apply(that, args), p2 = point3 == null ? centroid(e) : typeof point3 === "function" ? point3.apply(that, args) : point3, w = Math.max(e[1][0] - e[0][0], e[1][1] - e[0][1]), a3 = that.__zoom, b10 = typeof transform4 === "function" ? transform4.apply(that, args) : transform4, i2 = interpolate(a3.invert(p2).concat(w / a3.k), b10.invert(p2).concat(w / b10.k));
        return function(t) {
          if (t === 1) t = b10;
          else {
            var l = i2(t), k = w / l[2];
  ...
  var select5 = function(dictMonadEffect) {
    ...
    return function(selector) {
      return liftEffect12(function __do8() {
        var htmlDoc = bind10(windowImpl)(document2)();
              ...
              return function(v) {
                return liftEffect12((function() {
                  ...
                  return function __do8() {
                    ...
                    liftEffect3(log8("joinDataWithKey: found " + (show9(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                    liftEffect3(log8("joinDataWithKey: " + (show9(length(mapMaybe(function(v2) {
                      return v2.datum;
            ...
            return function(v) {
              return liftEffect12((function() {
                ...
                return function __do8() {
                  ...
                  liftEffect3(log8("joinData: found " + (show9(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                  liftEffect3(log8("joinData: " + (show9(length(mapMaybe(function(v2) {
                    return v2.datum;
                  })(oldBindings))) + " of those have data bound")))();
                  var validOldBindings = mapMaybe(function(v2) {
                    return mapFlipped1(v2.datum)(function(d3) {
  ...
  var renderTemplatesForPendingSelection = function(dictOrd) {
    return function(templateFn) {
      return function(pendingSel) {
        ...
        return traverseWithIndex3(function(idx) {
          return function(datum2) {
            var parentIdx = mod7(idx)(length(v.parentElements));
        ...
        if (v1 instanceof Join2) {
          return function __do8() {
            ...
            liftEffect3((function() {
              ...
              return log8("Tree API Join '" + (v1.value0.name + ("': enter=" + (show9(enterCount) + (", update=" + (show9(updateCount) + (", exit=" + show9(exitCount))))))));
            })())();
        ...
        if (v1 instanceof SceneJoin) {
          return function __do8() {
            ...
            liftEffect3((function() {
              ...
              return log8("Tree API SceneJoin '" + (v1.value0.name + ("': enter=" + (show9(enterCount) + (", update=" + (show9(updateCount) + (", exit=" + show9(exitCount))))))));
            })())();
            (function() {
        ...
        if (v1 instanceof SceneNestedJoin) {
          ...
          return function __do8() {
            ...
            liftEffect3((function() {
              ...
              return log8("Tree API SceneNestedJoin '" + (v1.value0.name + ("': enter=" + (show9(enterCount) + (", update=" + (show9(updateCount) + (", exit=" + show9(exitCount))))))));
            })())();
            (function() {
              if (v1.value0.exitBehavior instanceof Just) {
                if (v1.value0.exitBehavior.value0.transition instanceof Just) {
          ...
          return function(attrs) {
            return function(emptySelection) {
              return liftEffect12((function() {
                ...
                var dataArray = fromFoldable19(foldableData);
                ...
                return function(enterAttrs) {
                  return function(updateAttrs) {
                    return function(exitAttrs) {
                      return bind110(joinData4(foldableData)(selector)(emptySelection))(function(v) {
                        return bind110(bind110(append42(elemType)([])(v.value0.enter))(function(bound) {
                          ...
                          return bind110((function() {
                            ...
                            return discard26((function() {
                              ...
                              if (exitAttrs instanceof Just) {
                                return bind110(applyPerDatumAttrs1(exitAttrs.value0)(v.value0.exit))(function() {
                                  return remove22(v.value0.exit);
                                });
                              }
                              ;
  ...
  var discard1 = /* @__PURE__ */ discard4(bindD3v2M);
  var log9 = /* @__PURE__ */ log5(monadEffectD3v2M);
  ...
  var renderWatermarkSVG = function(packageNodes) {
    return bind11(select7("#treemap-watermark"))(function(watermarkGroup) {
      var translateY = -viewBoxHeight / 2;
      var translateX = -viewBoxWidth / 2;
      return bind11(appendChild5(Group.value)([transform3("translate(" + (show10(translateX) + ("," + (show10(translateY) + ")")))), id_2("watermark-inner")])(watermarkGroup))(function(innerGroup) {
        return bind11(appendData4(Rect.value)(packageNodes)([x4(function(v) {
          return v.x0;
        }), y4(function(v) {
          return v.y0;
        }), width9(function(n) {
          ...
          return discard1(log9("[Treemap] Rendering watermark labels for " + (show14(length(packageNodes)) + " packages")))(function() {
            return bind11(appendData4(Text2.value)(packageNodes)([x4(function(n) {
              return (n.x0 + n.x1) / 2;
            }), y4(function(n) {
              return n.y0 + 14;
  ...
  var buildTreemapData = function(nodes) {
    ...
    var packageIndexMap = fromFoldable16(mapWithIndex2(function(idx) {
      return function(pkg) {
    ...
    var groupByPackage = function(acc) {
      return function(mod8) {
        var existing = (function() {
          var v = lookup3(mod8["package"])(acc);
          if (v instanceof Just) {
            return v.value0;
          }
          ;
        ...
        return insert3(mod8["package"])(snoc(existing)(mod8))(acc);
      };
    };
  ...
  var computeTreemapPositions = function(nodes) {
    ...
    return fromFoldable16(map37(toPositionEntry)(packageNodes));
  };
  var recalculateTreemapPositions = function(nodes) {
    ...
    var clusterMap = fromFoldable16(map37(function(p2) {
      return new Tuple(show14(p2.id), p2.name);
    })(packages));
    var updateNode = function(node) {
      ...
      ;
      if (node.nodeType instanceof ModuleNode) {
        var v = lookup3(show14(node.cluster))(clusterMap);
        if (v instanceof Just) {
  ...
  var renderWatermark = function(nodes) {
    return function __do8() {
      ...
      log1("[Treemap] Watermark: " + (show14(length(packageNodes)) + " packages"))();
      ...
      return function(links) {
        return function(transform4) {
          var swizzle = function(nodeMap2) {
            return function(link3) {
              return bind13(intMapLookup(link3.source)(nodeMap2))(function(srcNode) {
                return bind13(intMapLookup(link3.target)(nodeMap2))(function(tgtNode) {
                  return pure16({
                    src: srcNode,
                    tgt: tgtNode,
                    link: link3
  ...
  var radialLinkPath = function(x13) {
    return function(y13) {
      return function(x24) {
        return function(y24) {
          var radius22 = sqrt3(x24 * x24 + y24 * y24);
          var radius1 = sqrt3(x13 * x13 + y13 * y13);
          ...
          return "M" + (show15(x13) + ("," + (show15(y13) + ("C" + (show15(cp1x) + ("," + (show15(cp1y) + (" " + (show15(cp2x) + ("," + (show15(cp2y) + (" " + (show15(x24) + ("," + show15(y24)))))))))))))));
        };
      };
    };
  };
  ...
  var log10 = /* @__PURE__ */ log5(monadEffectEffect);
  var show16 = /* @__PURE__ */ show(showBoolean);
  var insert11 = /* @__PURE__ */ insert(ordString);
  var bind22 = /* @__PURE__ */ bind(bindD3v2M);
  ...
  var fromFoldable18 = /* @__PURE__ */ fromFoldable5(foldableArray)(ordInt);
  ...
  var showViewState2 = function(v) {
    if (v instanceof ModuleTreemap && v.value0 instanceof ProjectOnly) {
      return "ModuleTreemap (project only)";
    }
    ;
    if (v instanceof ModuleTreemap && v.value0 instanceof ProjectAndLibraries) {
      return "ModuleTreemap (all)";
    }
    ;
    if (v instanceof PackageGrid && v.value0 instanceof ProjectOnly) {
      return "PackageGrid (project only)";
    }
    ;
    if (v instanceof PackageGrid && v.value0 instanceof ProjectAndLibraries) {
      return "PackageGrid (all)";
    }
    ;
    if (v instanceof ModuleOrbit && v.value0 instanceof ProjectOnly) {
      return "ModuleOrbit (project only)";
    }
    ;
    if (v instanceof ModuleOrbit && v.value0 instanceof ProjectAndLibraries) {
      return "ModuleOrbit (all)";
    }
    ;
    if (v instanceof DependencyTree && v.value0 instanceof ProjectOnly) {
      return "DependencyTree (project only)";
    }
    ;
    if (v instanceof DependencyTree && v.value0 instanceof ProjectAndLibraries) {
      return "DependencyTree (all)";
    }
    ;
    if (v instanceof Neighborhood) {
      return "Neighborhood (" + (v.value0 + ")");
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 827, column 1 - line 827, column 37): " + [v.constructor.name]);
  };
  var setTreeSceneClass = function(shouldAdd) {
    return function __do8() {
      ...
      if (mElement instanceof Just) {
        ...
        return log10("[Explorer] Set tree-scene class: " + show16(shouldAdd))();
      }
      ;
      if (mElement instanceof Nothing) {
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 737, column 3 - line 743, column 77): " + [mElement.constructor.name]);
    };
  };
  var setNeighborhoodForces = function(nodes) {
    return function(sim) {
      return function __do8() {
        ...
        var collideHandle = createCollideGrid(10)(0.7)(1);
        ...
        return log10("[Explorer] Neighborhood forces set (charge, collide, center)")();
      };
    };
  };
  var renderNeighborhoodLinksD3 = function(links) {
    ...
    return bind22(select8("#explorer-links"))(function(linksGroup) {
      return bind22(appendData5(Line.value)(links)([x12(getSourceX), y12(getSourceY), x23(getTargetX), y23(getTargetY), stroke3(function(v) {
        return "white";
      }), strokeWidth3(function(v) {
        return 1.5;
      }), opacity3(function(v) {
        return 0.6;
      }), class_4(function(v) {
  ...
  var renderForceLinks = function(nodes) {
    return function(links) {
      ...
      return function __do8() {
        log10("[Explorer] Rendering " + (show17(length(treeLinks)) + " force links"))();
  ...
  var randomizeModulePositions = function(nodes) {
    var getPackagePos = function(n) {
      if (n.nodeType instanceof PackageNode) {
        return new Just(new Tuple(show17(n.id), {
          x: n.gridX,
          y: n.gridY
        }));
      }
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 365, column 21 - line 367, column 26): " + [n.nodeType.constructor.name]);
    };
    var packagePositions = fromFoldable17(mapMaybe(getPackagePos)(nodes));
    var randomizeIfModule = function(n) {
      ...
      if (n.nodeType instanceof ModuleNode) {
        return function __do8() {
          ...
          var ry = random();
          var v = (function() {
            var v1 = lookup3(show17(n.cluster))(packagePositions);
            if (v1 instanceof Just) {
              return v1.value0;
            }
            ;
            ...
            ;
            throw new Error("Failed pattern match at Engine.Explorer (line 375, column 32 - line 377, column 40): " + [v1.constructor.name]);
          })();
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 369, column 25 - line 380, column 58): " + [n.nodeType.constructor.name]);
    };
  ...
  var nodeFill = function(n) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 576, column 14 - line 581, column 18): " + [n.nodeType.constructor.name]);
  };
  var nodeColor = function(v) {
  ...
  var nodeClass = function(n) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 588, column 15 - line 592, column 42): " + [n.nodeType.constructor.name]);
  };
  ...
  var renderTreeLinksD3 = function(nodeMap) {
    return function(links) {
      return bind22(select8("#explorer-links"))(function(linksGroup) {
        return bind22(appendData5(Path.value)(links)([d2(linkPathFn(nodeMap)), fill3(function(v) {
          return "none";
        }), stroke3(function(v) {
          return "white";
        }), strokeWidth3(function(v) {
  ...
  var globalViewStateRef = /* @__PURE__ */ (function() {
    return unsafePerformEffect($$new(new PackageGrid(ProjectAndLibraries.value)));
  })();
  ...
  var renderNeighborhoodLinks = function(nodes) {
    return function __do8() {
      ...
      var nodeIdSet = fromFoldable18(map39(function(v) {
        return v.id;
      })(nodes));
      var neighborhoodLinks = filter(function(link3) {
        return member5(link3.source)(nodeIdSet) && member5(link3.target)(nodeIdSet);
      })(allLinks);
      log10("[Explorer] Rendering " + (show17(length(neighborhoodLinks)) + " neighborhood links"))();
  ...
  var renderTreeLinks = function(nodes) {
    return function __do8() {
      ...
      var treeLinks = filter(isTreeLink)(links);
      log10("[Explorer] Rendering " + (show17(length(treeLinks)) + " tree links"))();
    ...
    return function(declarationName) {
      return function(kind2) {
        return function __do8() {
          ...
          if (v instanceof Nothing) {
            return log10("[Explorer] No function call data for: " + key)();
          }
          ;
          if (v instanceof Just) {
            log10("[Explorer] Found " + (show17(length(v.value0.calls)) + (" outgoing calls, " + (show17(length(v.value0.calledBy)) + " callers"))))();
            return renderAtomicView(v.value0)();
          }
          ;
          throw new Error("Failed pattern match at Engine.Explorer (line 1307, column 5 - line 1312, column 32): " + [v.constructor.name]);
        };
      };
    };
  };
  ...
  var formatNodeTooltip = function(node) {
    var nodeTypeLabel = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 498, column 3 - line 498, column 38): " + [v.constructor.name]);
    };
    ...
    return '<div class="tooltip-header">' + (node.name + ("</div>" + ('<div class="tooltip-package">' + (node["package"] + ("</div>" + ('<div class="tooltip-metrics">' + (metric("Type")(nodeTypeLabel(node.nodeType)) + (metric("Dependencies")(show17(length(node.targets))) + (metric("Dependents")(show17(length(node.sources))) + "</div>")))))))));
  };
  ...
  var fixPackagePosition = function(node) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 355, column 27 - line 357, column 21): " + [node.nodeType.constructor.name]);
  };
    ...
    return function(declarationName) {
      return function(_kind) {
        return function __do8() {
          ...
          ;
          throw new Error("Failed pattern match at Engine.Explorer (line 1321, column 3 - line 1328, column 64): " + [v.constructor.name]);
        };
      };
    };
  };
  var clearElement2 = function(element3) {
    var clearNode = function(node) {
      return function __do8() {
        ...
        ;
        throw new Error("Failed pattern match at Engine.Explorer (line 724, column 5 - line 728, column 27): " + [mChild.constructor.name]);
      };
    };
  ...
  var clearNodesGroup = function __do3() {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 1235, column 3 - line 1237, column 63): " + [mElement.constructor.name]);
  };
  var clearTreeLinks = function __do4() {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 709, column 3 - line 714, column 63): " + [mElement.constructor.name]);
  };
  ...
  var focusOnNeighborhood = function(nodes) {
    return function(sim) {
      return function __do8() {
        log10("[Explorer] Focusing on neighborhood with " + (show17(length(nodes)) + " nodes"))();
        hideTooltip();
        clearTreeLinks();
        clearNodesGroup();
        setNodes(nodes)(sim)();
        ...
        launchAff_((function() {
          ...
          return discard22(log12("[Explorer] Fetching batch data for " + (show17(length(moduleNames)) + " modules")))(function() {
            return bind32(fetchBatchDeclarations(moduleNames))(function(declResult) {
              return discard22((function() {
                ...
                ;
                throw new Error("Failed pattern match at Engine.Explorer (line 922, column 5 - line 924, column 27): " + [declResult.constructor.name]);
              })())(function() {
                var declarations = (function() {
                  ...
                  ;
                  throw new Error("Failed pattern match at Engine.Explorer (line 926, column 22 - line 928, column 31): " + [declResult.constructor.name]);
                })();
                return bind32(fetchBatchFunctionCalls(moduleNames))(function(fnCallResult) {
                  return discard22((function() {
                    ...
                    ;
                    throw new Error("Failed pattern match at Engine.Explorer (line 932, column 5 - line 934, column 27): " + [fnCallResult.constructor.name]);
                  })())(function() {
                    var functionCalls = (function() {
                      ...
                      ;
                      throw new Error("Failed pattern match at Engine.Explorer (line 936, column 23 - line 938, column 31): " + [fnCallResult.constructor.name]);
                    })();
                    return discard22(liftEffect4(write(functionCalls)(globalFunctionCallsRef)))(function() {
                      return discard22(liftEffect4(log10("[Explorer] Batch fetched: " + (show17(size(declarations)) + (" modules with declarations, " + (show17(size(functionCalls)) + " function entries"))))))(function() {
                        return liftEffect4(function __do9() {
                          ...
                          var packElements = runD3v2M(bind22(select8("#explorer-nodes"))(function(nodesContainer) {
  ...
  var addTreeForces = function(nodes) {
    return function(links) {
      return function(sim) {
        var treeLinks = filter(isTreeLink)(links);
        return function __do8() {
          log10("[Explorer] Setting up force-directed tree with " + (show17(length(treeLinks)) + " links"))();
          write(empty2)(sim.forces)();
  ...
  var goToScene = function(sceneName) {
    return function(stateRef) {
      ...
      if (mScene instanceof Just) {
        return function __do8() {
          when4(sceneName === "TreeForm")(function __do9() {
            var state3 = read(stateRef)();
            var nodes = getNodes(state3.simulation)();
            clearTreeLinks();
          ...
          when4(sceneName === "TreeRun")(function __do9() {
            var state3 = read(stateRef)();
            var nodes = getNodes(state3.simulation)();
            var links = read(globalLinksRef)();
            clearTreeLinks();
          ...
          when4(isGridOrOrbitScene(sceneName))(function __do9() {
            var state3 = read(stateRef)();
            var nodes = getNodes(state3.simulation)();
      ...
      if (mScene instanceof Nothing) {
        return log10("[Explorer] Unknown scene: " + sceneName);
      }
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 314, column 3 - line 345, column 63): " + [mScene.constructor.name]);
    };
  };
  var toggleFocus = function(clickedNode) {
    return function __do8() {
      ...
      if (mStateRef instanceof Just) {
        ...
        var neighborhoodIds = fromFoldable18(append18([clickedNode.id])(append18(clickedNode.targets)(clickedNode.sources)));
        var neighborhoodNodes = filter(function(n) {
          return member5(n.id)(neighborhoodIds);
        })(currentNodes);
        log10("[Explorer] Focusing on node " + (show17(clickedNode.id) + (" (neighborhood: " + (show17(length(neighborhoodNodes)) + " nodes)"))))();
        write({
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 846, column 3 - line 890, column 65): " + [mStateRef.constructor.name]);
    };
  };
  var restoreToView = function(targetView) {
    return function __do8() {
      ...
      if (mStateRef instanceof Just) {
        var state3 = read(mStateRef.value0)();
        if (targetView instanceof ModuleTreemap) {
          return write(targetView)(globalViewStateRef)();
        }
        ;
        if (targetView instanceof PackageGrid) {
          return restoreFullView(focus3.fullNodes)(targetView)(state3.simulation)();
        }
        ;
        if (targetView instanceof ModuleOrbit) {
          return restoreFullView(focus3.fullNodes)(targetView)(state3.simulation)();
        }
        ;
        if (targetView instanceof DependencyTree) {
          return restoreFullView(focus3.fullNodes)(targetView)(state3.simulation)();
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at Engine.Explorer (line 1151, column 7 - line 1164, column 50): " + [targetView.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 1146, column 3 - line 1164, column 50): " + [mStateRef.constructor.name]);
    };
  };
      ...
      return function(sim) {
        return function __do8() {
          ...
          (function() {
            ...
            ;
            throw new Error("Failed pattern match at Engine.Explorer (line 1186, column 3 - line 1190, column 25): " + [mStateRef.constructor.name]);
          })();
  ...
  var renderNodesOnly = function(nodes) {
    return bind22(select8("#explorer-nodes"))(function(nodesGroup) {
      return bind22(appendData5(Circle.value)(nodes)([cx2(function(v) {
        return v.x;
      }), cy2(function(v) {
        return v.y;
      }), radius2(function(v) {
          ...
          return bind22(on4(onMouseEnter(function(node) {
            return function __do8() {
              ...
              return classifyElements("#explorer-nodes")("circle")(function(n) {
                ...
                ;
                var $238 = member5(n.id)(targetSet);
                if ($238) {
                  return "highlighted-upstream";
                }
                ;
                var $239 = member5(n.id)(sourceSet);
                if ($239) {
  ...
  var $lazy_navigateBack = /* @__PURE__ */ $runtime_lazy9("navigateBack", "Engine.Explorer", function() {
    return function __do8() {
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 1128, column 3 - line 1138, column 16): " + [v.constructor.name]);
    };
  });
  var navigateBack = /* @__PURE__ */ $lazy_navigateBack(1125);
  var renderSVG = function(containerSelector) {
    return function(nodes) {
      return bind22(select8(containerSelector))(function(container) {
        return bind22(appendChild6(SVG.value)([viewBox2(show23(-viewBoxWidth / 2) + (" " + (show23(-viewBoxHeight / 2) + (" " + (show23(viewBoxWidth) + (" " + show23(viewBoxHeight))))))), id_3("explorer-svg"), class_1("ce-viz")])(container))(function(svg) {
          return bind22(appendChild6(Group.value)([id_3("explorer-zoom-group")])(svg))(function(zoomGroup) {
            return bind22(appendChild6(Group.value)([id_3("treemap-watermark"), class_1("watermark")])(zoomGroup))(function() {
              return bind22(appendChild6(Group.value)([id_3("explorer-links")])(zoomGroup))(function() {
                return bind22(appendChild6(Group.value)([id_3("explorer-nodes")])(zoomGroup))(function(nodesGroup) {
                  return bind22(appendData5(Circle.value)(nodes)([cx2(function(v) {
                    return v.x;
                  }), cy2(function(v) {
                    return v.y;
                    ...
                    return bind22(on4(new Zoom(defaultZoom(new ScaleExtent(0.1, 10))("#explorer-zoom-group")))(svg))(function() {
                      ...
                      return bind22(on4(onMouseEnter(function(node) {
                        return function __do8() {
                          ...
                          var sourceSet = fromFoldable18(node.sources);
                          return classifyElements("#explorer-nodes")("circle")(function(n) {
                            var $244 = n.id === node.id;
                            if ($244) {
                              return "highlighted-source";
                            }
                            ;
                            var $245 = member5(n.id)(targetSet);
                            if ($245) {
                              return "highlighted-upstream";
                            }
                            ;
                            var $246 = member5(n.id)(sourceSet);
                            if ($246) {
                              return "highlighted-downstream";
                            }
                            ;
  ...
  var initExplorer = function(containerSelector) {
    var initialView = new PackageGrid(ProjectAndLibraries.value);
    return function __do8() {
      write(initialView)(globalViewStateRef)();
      log10("[Explorer] ViewState initialized (Halogen NarrativePanel polls this)")();
      return launchAff_(discard22(log12("[Explorer] BUILD: 2025-12-03 - Immediate TangleJS init"))(function() {
        return discard22(log12("[Explorer] Loading data..."))(function() {
          return bind32(loadModel)(function(result) {
            if (result instanceof Left) {
              return liftEffect4(log10("[Explorer] Error: " + result.value0));
            }
            ;
            if (result instanceof Right) {
              return discard22(liftEffect4(log10("[Explorer] Loaded: " + (show17(result.value0.moduleCount) + (" modules, " + (show17(result.value0.packageCount) + " packages"))))))(function() {
                return discard22(liftEffect4(write(result.value0.links)(globalLinksRef)))(function() {
                  return discard22(liftEffect4(write(result.value0.declarations)(globalDeclarationsRef)))(function() {
                    return bind32(liftEffect4(initWithModel(result.value0)(containerSelector)))(function(stateRef) {
                      return discard22(liftEffect4(write(new Just(stateRef))(globalStateRef)))(function() {
                        return liftEffect4(log10("[Explorer] Ready (function calls loaded on-demand per neighborhood)"));
                      });
                    });
                  });
                });
            ...
            ;
            throw new Error("Failed pattern match at Engine.Explorer (line 150, column 5 - line 162, column 95): " + [result.constructor.name]);
          });
        });
      }))();
    };
  ...
  var reloadWithProject = function(projectId) {
    return function __do8() {
      log10("[Explorer] Reloading with project: " + show17(projectId))();
      ...
      clearNodesGroup();
      return launchAff_(discard22(log12("[Explorer] Loading data for project " + (show17(projectId) + "...")))(function() {
        return bind32(loadModelForProject(projectId))(function(result) {
          if (result instanceof Left) {
            return liftEffect4(log10("[Explorer] Error loading project: " + result.value0));
          }
          ;
          if (result instanceof Right) {
            return discard22(liftEffect4(log10("[Explorer] Loaded: " + (show17(result.value0.moduleCount) + (" modules, " + (show17(result.value0.packageCount) + " packages"))))))(function() {
              return discard22(liftEffect4(write(result.value0.links)(globalLinksRef)))(function() {
                return discard22(liftEffect4(write(result.value0.declarations)(globalDeclarationsRef)))(function() {
                  return bind32(liftEffect4(read(globalStateRef)))(function(mStateRef) {
                    return discard22((function() {
                      if (mStateRef instanceof Nothing) {
                        return bind32(liftEffect4(initWithModel(result.value0)("#viz")))(function(stateRef) {
                          return liftEffect4(write(new Just(stateRef))(globalStateRef));
                        });
                      }
                      ;
                      if (mStateRef instanceof Just) {
                        return liftEffect4(updateWithModel(result.value0)(mStateRef.value0));
                      }
                      ;
                      throw new Error("Failed pattern match at Engine.Explorer (line 251, column 9 - line 258, column 56): " + [mStateRef.constructor.name]);
                    })())(function() {
                      return liftEffect4(log10("[Explorer] Project switch complete"));
                    });
                  });
                });
              });
          ...
          ;
          throw new Error("Failed pattern match at Engine.Explorer (line 241, column 5 - line 260, column 62): " + [result.constructor.name]);
        });
      }))();
    };
  };
    ...
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        ...
        return function(slot3) {
          return function(label5) {
            return function(req) {
              return $$void8(query22(slot3)(label5)(req(unit)));
            };
          };
        };
      };
  ...
  var showViewState3 = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Component.SpagoGridApp (line 262, column 1 - line 262, column 37): " + [v.constructor.name]);
  };
    ...
    return function(v1) {
      return function(v2) {
        if (v === "layout") {
          ...
          if (v1 === "grid") {
            return new PackageGrid(scope2);
          }
          ;
          if (v1 === "orbit") {
            return new ModuleOrbit(scope2);
          }
          ;
          if (v1 === "tree") {
            return new DependencyTree(scope2);
          }
          ;
          return v2;
        }
        ...
        if (v === "scope") {
          ...
          if (v2 instanceof ModuleTreemap) {
            return new ModuleTreemap(scope2);
          }
          ;
          if (v2 instanceof PackageGrid) {
            return new PackageGrid(scope2);
          }
          ;
          if (v2 instanceof ModuleOrbit) {
            return new ModuleOrbit(scope2);
          }
          ;
          if (v2 instanceof DependencyTree) {
            return new DependencyTree(scope2);
          }
          ;
          return v2;
  ...
  var handleControlChangeFromPanel = function(controlId) {
    return function(newValue) {
      return function __do8() {
        ...
        var mStateRef = read(globalStateRef)();
        if (mStateRef instanceof Just) {
          if (controlId === "layout" && newView instanceof PackageGrid) {
            return goToScene("GridRun")(mStateRef.value0)();
          }
          ;
          if (controlId === "layout" && newView instanceof ModuleOrbit) {
            return goToScene("OrbitRun")(mStateRef.value0)();
          }
          ;
          if (controlId === "layout" && newView instanceof DependencyTree) {
            return goToScene("TreeRun")(mStateRef.value0)();
          }
          ;
          return unit;
        }
        ...
        ;
        throw new Error("Failed pattern match at Component.SpagoGridApp (line 214, column 3 - line 224, column 25): " + [mStateRef.constructor.name]);
      };
    };
  };
  ...
  var pollLoop = function(dictMonadAff) {
    ...
    var numMod = function(a3) {
      return function(b10) {
        return a3 - b10 * toNumber(floor2(a3 / b10));
      };
    };
    var mkColorEntry = function(idx) {
      return function(v) {
        ...
        return {
          name: "Package " + show18(idx + 1 | 0),
          color: turbo_default(t)
        };
      };
    };
    return bind14(liftEffect10(read(globalViewStateRef)))(function(viewState) {
      return bind14(liftEffect10(read(globalModelInfoRef)))(function(modelInfo) {
        return bind14(get7)(function(state3) {
          return discard23(when5(notEq3(state3.viewState)(viewState))(handleAction2(dictMonadAff)(new ViewStateChanged(viewState))))(function() {
            return discard23(when5($$null(state3.packagePalette) && modelInfo.packageCount > 0)((function() {
              var palette = mapWithIndex2(mkColorEntry)(replicate(modelInfo.packageCount)(unit));
              return handleAction2(dictMonadAff)(new PackagePaletteChanged(palette));
            })()))(function() {
              return discard23(liftAff2(delay(100)))(function() {
                return pollLoop(dictMonadAff);
              });
            });
          });
        });
  ...
  var handleAction2 = function(dictMonadAff) {
    ...
    var log11 = log5(monadEffectHalogenM2);
    var liftEffect10 = liftEffect(monadEffectHalogenM2);
    var liftAff2 = liftAff(monadAffHalogenM(dictMonadAff));
    return function(v) {
      if (v instanceof Initialize2) {
        return discard23(log11("[SpagoGridApp] Initializing..."))(function() {
          return discard23(liftEffect10(initExplorer("#viz")))(function() {
            return discard23(modify_4(function(v1) {
              ...
              return discard23($$void9(fork(bind14(liftAff2(fetchProjects))(function(projectsResult) {
                if (projectsResult instanceof Right) {
                  ...
                  return discard23(log11("[SpagoGridApp] Loaded " + (show18(length(projectsResult.value0)) + " projects")))(function() {
                ...
                ;
                throw new Error("Failed pattern match at Component.SpagoGridApp (line 111, column 7 - line 117, column 66): " + [projectsResult.constructor.name]);
              }))))(function() {
                return $$void9(fork(pollLoop(dictMonadAff)));
              });
            });
          });
        });
      ...
      if (v instanceof ViewStateChanged) {
        return bind14(get7)(function(state3) {
          return when5(notEq3(state3.viewState)(v.value0))(discard23(log11("[SpagoGridApp] ViewState changed to: " + showViewState3(v.value0)))(function() {
            return discard23(modify_4(function(v1) {
              var $114 = {};
              for (var $115 in v1) {
                if ({}.hasOwnProperty.call(v1, $115)) {
              ...
              ;
              $114.viewState = v.value0;
              return $114;
            }))(function() {
              return discard23(log11("[SpagoGridApp] Sending SetViewState to NarrativePanel"))(function() {
                return $$void9(tell3(_narrativePanel)(unit)(SetViewState.create(v.value0)));
              });
            });
          }));
        });
      ...
      if (v instanceof PackagePaletteChanged) {
        return bind14(get7)(function(state3) {
          return when5(notEq1(state3.packagePalette)(v.value0))(discard23(log11("[SpagoGridApp] Package palette changed (" + (show18(length(v.value0)) + " packages)")))(function() {
            return discard23(modify_4(function(v1) {
              var $118 = {};
              for (var $119 in v1) {
              ...
              ;
              $118.packagePalette = v.value0;
              return $118;
            }))(function() {
              return $$void9(tell3(_narrativePanel)(unit)(SetPackagePalette.create(v.value0)));
            });
          }));
        });
      }
      ...
      if (v instanceof SwitchProject) {
        return bind14(get7)(function(state3) {
          return when5(state3.projectId !== v.value0)(discard23(log11("[SpagoGridApp] Switching to project: " + (v.value1 + (" (id: " + (show18(v.value0) + ")")))))(function() {
            return discard23(modify_4(function(v1) {
              var $126 = {};
              for (var $127 in v1) {
              ...
              ;
              $126.projectId = v.value0;
              $126.projectName = v.value1;
              $126.packagePalette = [];
              return $126;
            }))(function() {
              var resetViewState = new PackageGrid(ProjectAndLibraries.value);
      ...
      if (v instanceof NarrativePanelOutput) {
        ...
        if (v.value0 instanceof ProjectSelected) {
          return discard23(log11("[SpagoGridApp] Project selected: " + show18(v.value0.value0)))(function() {
            return bind14(get7)(function(state3) {
              ...
              ;
              if (v1 instanceof Nothing) {
                return log11("[SpagoGridApp] Unknown project ID: " + show18(v.value0.value0));
              }
              ;
              throw new Error("Failed pattern match at Component.SpagoGridApp (line 171, column 9 - line 173, column 86): " + [v1.constructor.name]);
            });
          });
        }
        ;
        throw new Error("Failed pattern match at Component.SpagoGridApp (line 157, column 5 - line 173, column 86): " + [v.value0.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Component.SpagoGridApp (line 100, column 16 - line 173, column 86): " + [v.constructor.name]);
    };
  };
  var render3 = function(dictMonadAff) {
    ...
    return function(state3) {
      return div3([class_("explorer-app")])([slot2(_narrativePanel)(unit)(component1)({
        ...
        ;
        throw new Error("Failed pattern match at Component.SpagoGridApp (line 89, column 7 - line 93, column 30): " + [state3.error.constructor.name]);
      })(), div3([id2("viz")])([])]);
    };
  };
    ...
    return mkComponent({
      initialState: function(v) {
        return {
          initialized: false,
          error: Nothing.value,
          viewState: new PackageGrid(ProjectAndLibraries.value),
          packagePalette: [],
  ...
  var selectElement = function(query3) {
    return bind15(liftEffect5(bindFlipped5(composeKleisliFlipped4((function() {
              ...
              return bind16(fresh(ForkId)(ref2))(function(fid) {
                return bind16(liftEffect6(read(ref2)))(function(v2) {
                  return bind16(liftEffect6($$new(false)))(function(doneRef) {
                    return bind16(fork3($$finally(liftEffect6(function __do8() {
    ...
    return function(v1) {
      return function(v2) {
        ...
        if (v1 instanceof Nothing && v2 instanceof Just) {
          return $$void11(appendChild2(v)(v2.value0));
        }
        ;
        return pure24(unit);
      };
            ...
            return function(v1) {
              if (v1 instanceof Nothing) {
                return function __do8() {
                  ...
                  $$void11(appendChild2(node)(toNode2(container)))();
                  return {
                    machine,
                    node,
                    renderChildRef
  ...
  var runUI2 = function(component4) {
    return function(i2) {
      return function(element3) {
        return bind19(liftEffect8(map44(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
  ...
  var discard25 = /* @__PURE__ */ discard9(bindAff);
  ...
  var main2 = function __do7() {
    ...
    return runHalogenAff(bind20(selectElement("#app"))(function(mAppEl) {
      if (mAppEl instanceof Nothing) {
        return liftEffect9(log4("[Main] ERROR: Could not find #app element!"));
      }
      ;
      if (mAppEl instanceof Just) {
        return discard25(liftEffect9(log4("[Main] Found #app, mounting Halogen...")))(function() {
