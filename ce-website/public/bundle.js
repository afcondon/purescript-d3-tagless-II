...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a3) {
      return function(b10) {
        return apply1(map36($$const(identity2))(a3))(b10);
      };
    };
  };
            ...
            return function(array4) {
              function go2(bot, top3) {
                switch (top3 - bot) {
                  ...
                  case 2:
                    return apply4(map36(array2)(f(array4[bot])))(f(array4[bot + 1]));
                  case 3:
                    return apply4(apply4(map36(array3)(f(array4[bot])))(f(array4[bot + 1])))(f(array4[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                    return apply4(map36(concat2)(go2(bot, pivot)))(go2(pivot, top3));
                }
              }
              ...
              if (rm instanceof Left) {
                return bind19(v1)(function(rn) {
                  ...
                  if (rn instanceof Left) {
                    return pure24(new Left(append11(rm.value0)(rn.value0)));
                  }
                  ;
      ...
      return function(f) {
        return function(ms) {
          return fold2(function(acc) {
            return function(k) {
              return function(v) {
                return apply4(map36(flip(insert(k)))(acc))(f(k)(v));
              };
            };
          })(pure110(empty2))(ms);
        };
  ...
  var caseJsonString = function(d2) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d2), $$const(d2), $$const(d2), f, $$const(d2), $$const(d2), j);
      };
    };
  };
  var caseJsonObject = function(d2) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d2), $$const(d2), $$const(d2), $$const(d2), $$const(d2), f, j);
      };
    };
  };
  ...
  var caseJsonNumber = function(d2) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d2), $$const(d2), f, $$const(d2), $$const(d2), $$const(d2), j);
      };
    };
  };
  var caseJsonBoolean = function(d2) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d2), f, $$const(d2), $$const(d2), $$const(d2), $$const(d2), j);
      };
    };
  };
  var caseJsonArray = function(d2) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d2), $$const(d2), $$const(d2), $$const(d2), f, $$const(d2), j);
      };
    };
  };
  ...
  function encodeURIComponent_to_RFC3986(input2) {
    return input2.replace(/[!'()*]/g, function(c2) {
  ...
  var Aff = (function() {
    ...
    function runPar(util, supervisor, par, cb) {
      ...
      function cancel(error3, cb2) {
        ...
        kills = null;
        var newKills = kill2(error3, root2, cb2);
  ...
  var fromFoldable4 = function(dictOrd) {
    ...
    return function(dictFoldable) {
      return foldl(dictFoldable)(function(m2) {
        return function(v) {
          return insert13(v.value0)(v.value1)(m2);
        };
      })(empty5);
    };
  };
  ...
  var petrify = function(parentX) {
    return function(t) {
      ...
      var childrenWithCoords = map11(petrify(nodeX))(children3);
      return mkTree((function() {
        var $110 = {};
  ...
  var spliceContours = function(offsets) {
    return function(contours) {
      ...
      if (v.length === 1) {
        return new Contours({
          left: new Cons(0, map11(function(x3) {
            return x3 + v[0].value0;
          })(v[0].value1.value0.left)),
          right: new Cons(0, map11(function(x3) {
            return x3 + v[0].value0;
      ...
      var shiftedContours = map14(function(v1) {
        return new Contours({
          left: map11(function(x3) {
            return x3 + v1.value0;
          })(v1.value1.value0.left),
          right: map11(function(x3) {
            return x3 + v1.value0;
    ...
    return function(separationFn) {
      return function(inputTree) {
        ...
        var renderWithContours = function(t) {
          ...
          var childTrees = map11(function(v2) {
            return v2.value0;
          })(childResults);
          var childRootData = map11(getRootData)(childTrees);
          var childContours = map11(function(v2) {
            return v2.value1;
          })(childResults);
          ...
          return bind3(uncons(state3.openPaths))(function(x3) {
            return bind3(head(x3.head))(function(currentId) {
              ...
              return new Just({
                ...
                spanningTree: append6(state3.spanningTree)(map16(function(targetId) {
                  return new Tuple(currentId, targetId);
                })(newTargets.yes)),
                redundantEdges: append6(state3.redundantEdges)(prunedEdges)
              });
  ...
  var mapTree = function(f) {
    return function(t) {
      return mkTree(f(head3(t)))(map17(mapTree(f))(tail(t)));
    };
  };
  ...
  var charCode = function(c2) {
    var v = indexOf(singleton6(c2))("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789._-");
    if (v instanceof Just) {
      return v.value0;
    }
    ;
  ...
  var stringHash = function(s) {
    ...
    return foldl12(function(acc) {
      return function(c2) {
        return mod2((acc * 31 | 0) + charCode(c2) | 0)(1e6);
      };
    })(0)(chars);
  };
  ...
  var buildLocMap = function(entries) {
    return fromFoldable12(map18(function(e) {
    ...
    return function(packagesObj) {
      return function(locMap) {
        return function(declarations) {
          ...
          var nodes = map18(updateNodeWithTreeData(treePositionMap)(reachableNodeIds))(nodesBeforeTree);
          var spanningTreeEdges = fromFoldable32(reachability.spanningTree);
          var links = map18(markLinkType(spanningTreeEdges))(allModuleLinks);
          return {
            nodes,
            links,
            packages,
  ...
  var fetchFunctionCalls = /* @__PURE__ */ (function() {
    return bind4(fetchJson(apiBaseUrl + "/data/function-calls.json"))(function(result) {
      return pure5(bind12(result)(function(json2) {
      ...
      return bind4(fetchJson(apiBaseUrl + "/data/spago-data/packages.json"))(function(packagesResult) {
        return bind4(fetchJson(apiBaseUrl + "/data/spago-data/LOC.json"))(function(locResult) {
          return bind4(fetchJson(apiBaseUrl + "/data/spago-data/declarations-summary.json"))(function(declarationsResult) {
            return pure5(bind12(modulesResult)(function(modulesJson) {
  ...
  function insert_default(name16, before) {
    var create6 = typeof name16 === "function" ? name16 : creator_default(name16), select8 = before == null ? constantNull : typeof before === "function" ? before : selector_default(before);
    return this.select(function() {
      return this.insertBefore(create6.apply(this, arguments), select8.apply(this, arguments) || null);
    });
  }
  ...
  function add3(tree2, x3, y3, d2) {
    if (isNaN(x3) || isNaN(y3)) return tree2;
    var parent2, node = tree2._root, leaf = { data: d2 }, x0 = tree2._x0, y0 = tree2._y0, x13 = tree2._x1, y13 = tree2._y1, xm, ym, xp, yp, right, bottom3, i2, j;
  ...
  function addAll(data) {
    var d2, i2, n = data.length, x3, y3, xz = new Array(n), yz = new Array(n), x0 = Infinity, y0 = Infinity, x13 = -Infinity, y13 = -Infinity;
    for (i2 = 0; i2 < n; ++i2) {
  ...
  function link_default(links) {
    ...
    function force2(alpha) {
      for (var k = 0, n = links.length; k < iterations; ++k) {
        for (var i2 = 0, link3, source2, target5, x3, y3, l, b10; i2 < n; ++i2) {
          link3 = links[i2], source2 = link3.source, target5 = link3.target;
          x3 = target5.x + target5.vx - source2.x - source2.vx || jiggle_default(random2);
          y3 = target5.y + target5.vy - source2.y - source2.vy || jiggle_default(random2);
          l = Math.sqrt(x3 * x3 + y3 * y3);
          l = (l - distances[i2]) / l * alpha * strengths[i2];
          x3 *= l, y3 *= l;
          target5.vx -= x3 * (b10 = bias[i2]);
          target5.vy -= y3 * b10;
    ...
    function initialize() {
      if (!nodes) return;
      var i2, n = nodes.length, m2 = links.length, nodeById = new Map(nodes.map((d2, i3) => [id5(d2, i3, nodes), d2])), link3;
    ...
    return simulation = {
      ...
      find: function(x3, y3, radius3) {
        ...
        for (i2 = 0; i2 < n; ++i2) {
          ...
          dy = y3 - node.y;
          d2 = dx * dx + dy * dy;
          if (d2 < radius3) closest = node, radius3 = d2;
        }
        return closest;
      },
  ...
  function drag_default() {
    ...
    function mousedowned(event, d2) {
      if (touchending || !filter5.call(this, event, d2)) return;
    ...
    function touchstarted(event, d2) {
      if (!filter5.call(this, event, d2)) return;
      var touches = event.changedTouches, c2 = container.call(this, event, d2), n = touches.length, i2, gesture;
      for (i2 = 0; i2 < n; ++i2) {
    ...
    drag.filter = function(_) {
      return arguments.length ? (filter5 = typeof _ === "function" ? _ : constant_default3(!!_), drag) : filter5;
    };
    ...
    drag.on = function() {
      ...
      return value13 === listeners ? drag : value13;
    };
  ...
  function bisector(f) {
    ...
    if (f.length !== 2) {
      ...
      compare22 = (d2, x3) => ascending2(f(d2), x3);
      delta = (d2, x3) => f(d2) - x3;
    } else {
  ...
  function tickSpec(start4, stop, count) {
    const step4 = (stop - start4) / Math.max(0, count), power2 = Math.floor(Math.log10(step4)), error3 = step4 / Math.pow(10, power2), factor = error3 >= e10 ? 10 : error3 >= e5 ? 5 : error3 >= e2 ? 2 : 1;
    let i1, i2, inc;
    if (power2 < 0) {
  ...
  function ordinal() {
    ...
    function scale(d2) {
      let i2 = index5.get(d2);
      if (i2 === void 0) {
        if (unknown !== implicit) return unknown;
        index5.set(d2, i2 = domain2.push(d2) - 1);
      }
  ...
  function date_default(a3, b10) {
    ...
    return a3 = +a3, b10 = +b10, function(t) {
      return d2.setTime(a3 * (1 - t) + b10 * t), d2;
    };
  }
  ...
  function decompose_default(a3, b10, c2, d2, e, f) {
    var scaleX, scaleY, skewX;
    if (scaleX = Math.sqrt(a3 * a3 + b10 * b10)) a3 /= scaleX, b10 /= scaleX;
    if (skewX = a3 * c2 + b10 * d2) c2 -= a3 * skewX, d2 -= b10 * skewX;
    if (scaleY = Math.sqrt(c2 * c2 + d2 * d2)) c2 /= scaleY, d2 /= scaleY, skewX /= scaleY;
    if (a3 * d2 < b10 * c2) a3 = -a3, b10 = -b10, skewX = -skewX, scaleX = -scaleX;
    return {
      translateX: e,
      translateY: f,
  ...
  function parseCss(value13) {
    ...
    return m2.isIdentity ? identity11 : decompose_default(m2.a, m2.b, m2.c, m2.d, m2.e, m2.f);
  }
  ...
  function interpolateTransform(parse7, pxComma, pxParen, degParen) {
    ...
    function rotate(a3, b10, s, q2) {
      if (a3 !== b10) {
        ...
        q2.push({ i: s.push(pop3(s) + "rotate(", null, degParen) - 2, x: number_default(a3, b10) });
      } else if (b10) {
    ...
    function skewX(a3, b10, s, q2) {
      if (a3 !== b10) {
        q2.push({ i: s.push(pop3(s) + "skewX(", null, degParen) - 2, x: number_default(a3, b10) });
      } else if (b10) {
  ...
  function polymap(domain2, range5, interpolate) {
    var j = Math.min(domain2.length, range5.length) - 1, d2 = new Array(j), r = new Array(j), i2 = -1;
    ...
    return function(x3) {
      ...
      return r[i3](d2[i3](x3));
    };
  }
  function copy(source2, target5) {
    return target5.domain(source2.domain()).range(source2.range()).interpolate(source2.interpolate()).clamp(source2.clamp()).unknown(source2.unknown());
  }
  function transformer() {
    var domain2 = unit2, range5 = unit2, interpolate = value_default, transform2, untransform, unknown, clamp3 = identity12, piecewise, output2, input2;
    function rescale() {
      var n = Math.min(domain2.length, range5.length);
      if (clamp3 !== identity12) clamp3 = clamper(domain2[0], domain2[n - 1]);
    ...
    scale.invert = function(y3) {
      return clamp3(untransform((input2 || (input2 = piecewise(range5, domain2.map(transform2), number_default)))(y3)));
    };
    scale.domain = function(_) {
    ...
    scale.clamp = function(_) {
      return arguments.length ? (clamp3 = _ ? true : identity12, rescale()) : clamp3 !== identity12;
    };
  ...
  function formatGroup_default(grouping, thousands) {
    return function(value13, width8) {
      ...
      while (i2 > 0 && g > 0) {
        if (length8 + g + 1 > width8) g = Math.max(1, width8 - length8);
        t.push(value13.substring(i2 -= g, i2 + g));
        if ((length8 += g + 1) > width8) break;
  ...
  var map19 = Array.prototype.map;
  var prefixes = ["y", "z", "a", "f", "p", "n", "\xB5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
  function locale_default(locale2) {
    var group4 = locale2.grouping === void 0 || locale2.thousands === void 0 ? identity_default : formatGroup_default(map19.call(locale2.grouping, Number), locale2.thousands + ""), currencyPrefix = locale2.currency === void 0 ? "" : locale2.currency[0] + "", currencySuffix = locale2.currency === void 0 ? "" : locale2.currency[1] + "", decimal = locale2.decimal === void 0 ? "." : locale2.decimal + "", numerals = locale2.numerals === void 0 ? identity_default : formatNumerals_default(map19.call(locale2.numerals, String)), percent = locale2.percent === void 0 ? "%" : locale2.percent + "", minus = locale2.minus === void 0 ? "\u2212" : locale2.minus + "", nan2 = locale2.nan === void 0 ? "NaN" : locale2.nan + "";
    function newFormat(specifier) {
      ...
      function format2(value13) {
        ...
        var length8 = valuePrefix.length + value13.length + valueSuffix.length, padding2 = length8 < width8 ? new Array(width8 - length8 + 1).join(fill3) : "";
        ...
        switch (align2) {
          ...
          case "=":
            ...
            break;
          case "^":
            value13 = padding2.slice(0, length8 = padding2.length >> 1) + valuePrefix + value13 + valueSuffix + padding2.slice(length8);
            break;
          default:
  ...
  function log4() {
    ...
    scale.copy = () => copy(scale, log4()).base(scale.base());
    initRange.apply(scale, arguments);
    return scale;
  }
  ...
  function powish(transform2) {
    var scale = transform2(identity12, identity12), exponent2 = 1;
    function rescale() {
      return exponent2 === 1 ? transform2(identity12, identity12) : exponent2 === 0.5 ? transform2(transformSqrt, transformSquare) : transform2(transformPow(exponent2), transformPow(1 / exponent2));
    }
  ...
  `;
    panel2.appendChild(svgContainer);
    document.body.appendChild(panel2);
    const handleOutsideClick = (e) => {
      if (!panel2.contains(e.target)) {
        clearAtomicView_();
    ...
    const linkElements = linkGroup.selectAll("line").data(links).enter().append("line").attr("stroke", (d2) => d2.type === "outgoing" ? "#4ade80" : "#f97316").attr("stroke-width", 1.5).attr("stroke-opacity", 0.6).attr("marker-end", (d2) => d2.type === "outgoing" ? "url(#arrow-outgoing)" : "url(#arrow-incoming)");
    const nodeGroup = svg.append("g").attr("class", "nodes");
    const nodeElements = nodeGroup.selectAll("g").data(nodes).enter().append("g").attr("class", "node").style("cursor", "grab");
    nodeElements.append("circle").attr("r", (d2) => d2.type === "center" ? 20 : 12).attr("fill", (d2) => {
      if (d2.type === "center") return "#7dd3fc";
      return moduleColorScale(d2.module);
    }).attr("stroke", (d2) => d2.type === "center" ? "#fff" : "#333").attr("stroke-width", (d2) => d2.type === "center" ? 3 : 1);
    nodeElements.append("text").text((d2) => d2.label).attr("dy", (d2) => d2.type === "center" ? 35 : 25).attr("text-anchor", "middle").attr("fill", "#fff").attr("font-size", (d2) => d2.type === "center" ? "14px" : "11px").attr("font-weight", (d2) => d2.type === "center" ? "bold" : "normal");
    nodeElements.append("text").text((d2) => d2.module.split(".").pop()).attr("dy", (d2) => d2.type === "center" ? 50 : 38).attr("text-anchor", "middle").attr("fill", "#888").attr("font-size", "9px");
    const simulation = simulation_default(nodes).force("link", link_default(links).id((d2) => d2.id).distance(120).strength(0.5)).force("charge", manyBody_default().strength(-300)).force("x", x_default2().x((d2) => {
      if (d2.type === "center") return width8 / 2;
      if (d2.type === "incoming") return width8 * 0.2;
      return width8 * 0.8;
    }).strength(0.3)).force("y", y_default2(height8 / 2).strength(0.1)).force("collide", collide_default().radius(40));
    activeSimulation = simulation;
    const dragBehavior = drag_default().on("start", (event, d2) => {
  ...
  var renderBoundBubblePack_ = (containerSelector) => (node) => (packCircles) => (centerOffset) => (categoryColorFn) => (onDeclarationClick2) => (onDeclarationHover2) => (onDeclarationLeave2) => () => {
    ...
    group4.selectAll("circle").data(packCircles).enter().append("circle").attr("cx", (d2) => d2.x - centerOffset).attr("cy", (d2) => d2.y - centerOffset).attr("r", (d2) => d2.r).attr("fill", (d2) => categoryColorFn(d2)()).attr("fill-opacity", (d2) => {
      if (d2.depth === 0) return 0.3;
      if (d2.depth === 1) return 0.6;
      return 0.8;
    }).attr("stroke", "#fff").attr("stroke-width", 0.5).attr("class", (d2) => {
      if (d2.depth === 0) return "pack-module";
      if (d2.depth === 1) return "pack-category";
      return "pack-declaration";
    }).style("cursor", (d2) => d2.depth === 2 ? "pointer" : "default").on("click", function(event, d2) {
      if (d2.depth === 2) {
        event.stopPropagation();
        onDeclarationClick2(node.name)(d2.data_)(d2.category)();
      }
    }).on("mouseenter", function(event, d2) {
      if (d2.depth === 2) {
        select_default2(this).attr("stroke", "#000").attr("stroke-width", 2);
        if (d2.category === "value") {
          onDeclarationHover2(node.name)(d2.data_)(d2.category)();
        }
      }
    }).on("mouseleave", function(event, d2) {
      if (d2.depth === 2) {
  ...
  var reportOverlaps = function(overlaps) {
    return traverse_2(function(o) {
      return log("  Overlap: circles " + (show3(o.i) + (" and " + (show3(o.j) + (" overlap by " + (show13(o.overlap) + " pixels"))))));
    })(overlaps);
  };
    ...
    return function(a3) {
      return function(c2) {
        ...
        if ($170) {
          ...
          var $171 = a22 > b22;
          if ($171) {
            var x3 = (d2 + b22 - a22) / (2 * d2);
            var y3 = sqrt(max4(0)(b22 / d2 - x3 * x3));
            return {
              x: b10.x - x3 * dx - y3 * dy,
              y: b10.y - x3 * dy + y3 * dx,
              r: c2.r
          ...
          ;
          var x3 = (d2 + a22 - b22) / (2 * d2);
          var y3 = sqrt(max4(0)(a22 / d2 - x3 * x3));
          return {
            x: a3.x + x3 * dx - y3 * dy,
            y: a3.y + x3 * dy + y3 * dx,
            r: c2.r
  ...
  var initState = function(c0) {
    return function(c1) {
      return function(c2) {
        ...
        var v = unsafePerformEffect(log("   Initial positions: c0=(" + (show13(c0$prime.x) + ("," + (show13(c0$prime.y) + (") c1=(" + (show13(c1$prime.x) + ("," + (show13(c1$prime.y) + (") c2=(" + (show13(c2$prime.x) + ("," + (show13(c2$prime.y) + ")")))))))))))));
        return {
          circles,
          frontChain: [0, 2, 1],
          nextId: 3
  ...
  var enclosesWeak = function(a3) {
    return function(b10) {
      var dy = b10.y - a3.y;
      var dx = b10.x - a3.x;
      var dr = a3.r - b10.r + max4(a3.r)(max4(b10.r)(1)) * epsilon;
      return dr > 0 && dr * dr > dx * dx + dy * dy;
    };
  };
        ...
        return function($copy_bId) {
          return function($copy_state) {
            ...
            function $tco_loop(maxRetries, newCircle, aId, bId, state3) {
              if (maxRetries <= 0) {
                var v = unsafePerformEffect(log("\u274C RETRY LIMIT HIT! Failed to place circle r=" + show13(newCircle.r)));
                $tco_done = true;
              ...
              if (otherwise) {
                ...
                if (v1 instanceof Just && v instanceof Just) {
                  ...
                  var v2 = unsafePerformEffect(log("  Try r=" + (show13(newCircle.r) + (" at (" + (show3(aId) + ("," + (show3(bId) + ")")))))));
                  var collisionResult = bidirectionalCollisionSearch(aId)(bId)(positioned)(state3);
                  if (collisionResult instanceof NoCollision) {
                    var v3 = unsafePerformEffect(log("    \u2705 Placed at (" + (show13(positioned.x) + (", " + (show13(positioned.y) + ")")))));
                    $tco_done = true;
                    return insertBetween(aId)(bId)(positioned)(state3);
                  }
                  ;
                  if (collisionResult instanceof CollisionFromJ) {
                    var v3 = unsafePerformEffect(log("    \u26A0\uFE0F Collision at j=" + (show3(collisionResult.value0) + (" - b:=" + show3(collisionResult.value0)))));
                  ...
                  if (collisionResult instanceof CollisionFromK) {
                    var v3 = unsafePerformEffect(log("    \u26A0\uFE0F Collision at k=" + (show3(collisionResult.value0) + (" - a:=" + show3(collisionResult.value0)))));
  ...
  var addCircle = function(newCircle) {
    return function(state3) {
      var v = unsafePerformEffect(log("\n\u27A4 Adding circle r=" + (show13(newCircle.r) + (" (total circles so far: " + (show3(size2(state3.circles)) + ")")))));
      var v1 = unsafePerformEffect(log("  Current front chain: " + show22(state3.frontChain)));
      ...
      ;
      if (v2 instanceof Just) {
        var v3 = unsafePerformEffect(log("  Best pair: (" + (show3(v2.value0.value0) + ("," + (show3(v2.value0.value1) + ")")))));
  ...
  var packSiblingsMap = function(inputCircles) {
    ...
    var v = unsafePerformEffect(log("\u{1F4E6} packSiblingsMap called with " + (show3(n) + " circles")));
    var v1 = unsafePerformEffect(log("   Radii: " + show32(map20(function(v22) {
      return v22.r;
    })(inputCircles))));
    var $288 = n === 0;
    if ($288) {
    ...
    if (v4 instanceof Just && (v3 instanceof Just && v2 instanceof Just)) {
      ...
      var translated = map20(function(c2) {
        return {
          r: c2.r,
          x: c2.x - enclosing.x,
          y: c2.y - enclosing.y
      ...
      var v5 = (function() {
        ...
        if ($300) {
          return unsafePerformEffect(log("\u26A0\uFE0F OVERLAPS DETECTED: " + (show3(length(overlaps)) + " pairs")));
        }
        ;
        return unit;
      })();
  ...
  // output/Engine.NarrativePanel/foreign.js
  var panel = null;
  var heroText = null;
  var hintText = null;
  var colorKey = null;
  ...
  var currentPalette = [];
  var initNarrativePanel_ = (onBack) => () => {
    ...
    const title3 = document.createElement("div");
    title3.className = "panel-title";
    title3.textContent = "What Is Being Shown";
  ...
  var renderColorKey = () => {
    ...
    <div class="color-key-items">
      ${currentPalette.map(({ name: name16, color: color2 }) => `
        <div class="color-key-item">
          <span class="color-key-swatch" style="background-color: ${color2}"></span>
          <span class="color-key-label">${name16}</span>
        </div>
      `).join("")}
    </div>
  `;
  ...
  var setFullViewNarrative_ = (projectName) => (moduleCount) => (packageCount) => () => {
  ...
  var setNeighborhoodNarrative_ = (moduleName) => (dependsOnCount) => (dependedByCount) => () => {
    if (!heroText || !hintText || !backButton) return;
  ...
  var setDeclarationHoverNarrative_ = (moduleName) => (declName) => (callsCount) => (calledByCount) => () => {
    if (!hintText) return;
  ...
  var clearDeclarationHoverNarrative_ = () => {
    if (!hintText) return;
    hintText.innerHTML = `
    Each bubble shows the module's declarations.<br/>
    <em>Hover a function</em> to see call relationships.
  ...
  // output/Engine.NarrativePanel/index.js
  var setNeighborhoodNarrative = function(moduleName) {
    return function(dependsOnCount) {
      return function(dependedByCount) {
        return setNeighborhoodNarrative_(moduleName)(dependsOnCount)(dependedByCount);
      };
    };
  };
  var setFullViewNarrative = function(projectName) {
    return function(moduleCount) {
      return function(packageCount) {
        return setFullViewNarrative_(projectName)(moduleCount)(packageCount);
      };
    };
  };
  var setDeclarationHoverNarrative = function(moduleName) {
    return function(declName) {
      return function(callsCount) {
        return function(calledByCount) {
          return setDeclarationHoverNarrative_(moduleName)(declName)(callsCount)(calledByCount);
        };
      };
    };
  };
  var setColorPalette = setColorPalette_;
  var initNarrativePanel = function(onBack) {
    return initNarrativePanel_(onBack);
  };
  var clearDeclarationHoverNarrative = clearDeclarationHoverNarrative_;
  ...
  function createForceXGrid_(strength) {
    return x_default2().x((d2) => d2.gridX).strength(strength);
  }
  function createForceYGrid_(strength) {
    return y_default2().y((d2) => d2.gridY).strength(strength);
  }
  function createCollideGrid_(padding2) {
    return function(strength) {
      return function(iterations) {
        return collide_default().radius((d2) => d2.r + padding2).strength(strength).iterations(iterations);
      };
    };
  }
  ...
  function requestAnimationFrame_(callback) {
    return function() {
      ...
      if (USE_SETTIMEOUT) {
        id5 = setTimeout(handler2, FRAME_TIME);
        return function() {
          clearTimeout(id5);
        };
      } else {
        id5 = requestAnimationFrame(handler2);
        return function() {
  ...
  var updateCirclePositions_ = (selector) => () => {
    select_default2(selector).selectAll("circle").attr("cx", (d2) => d2.x).attr("cy", (d2) => d2.y);
  };
  var updateLinkPositions_ = (selector) => () => {
    select_default2(selector).selectAll("line").attr("x1", (d2) => d2.source.x).attr("y1", (d2) => d2.source.y).attr("x2", (d2) => d2.target.x).attr("y2", (d2) => d2.target.y);
  };
  var updateGroupPositions_ = (selector) => () => {
    select_default2(selector).selectAll("g.module-pack").attr("transform", (d2) => `translate(${d2.x},${d2.y})`);
  };
  ...
  var log6 = /* @__PURE__ */ log2(monadEffectEffect);
  ...
  var buildIntMap_ = (pairs) => {
    ...
    for (let i2 = 0; i2 < pairs.length; i2++) {
      map36.set(pairs[i2].key, pairs[i2].value);
    }
    return map36;
  };
  var intMapLookup_ = (key) => (map36) => map36.get(key);
  ...
  function select_default3(select8) {
  ...
  function selectAll_default2(select8) {
    ...
    for (var groups = this._groups, m2 = groups.length, subgroups = [], parents = [], j = 0; j < m2; ++j) {
      for (var group4 = groups[j], n = group4.length, node, i2 = 0; i2 < n; ++i2) {
        if (node = group4[i2]) {
          for (var children3 = select8.call(node, node.__data__, i2, group4), child, inherit2 = get5(node, id5), k = 0, l = children3.length; k < l; ++k) {
  ...
  function zoom_default2() {
    ...
    function mousedowned(event, ...args) {
      ...
      var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v = select_default2(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p2 = pointer_default(event, currentTarget), x0 = event.clientX, y0 = event.clientY;
      nodrag_default(event.view);
  ...
  function attachClickWithDatum_(element3) {
    return (handler2) => () => {
      const selection2 = select_default2(element3);
      selection2.on("click", function(event, d2) {
        handler2(d2)();
      });
      selection2.style("cursor", "pointer");
      return element3;
  ...
  function attachMouseEnter_(element3) {
    return (handler2) => () => {
      const selection2 = select_default2(element3);
      selection2.on("mouseenter", function(event, d2) {
        handler2(d2)();
      });
      return element3;
    };
  ...
  function attachMouseLeave_(element3) {
    return (handler2) => () => {
      const selection2 = select_default2(element3);
      selection2.on("mouseleave", function(event, d2) {
        handler2(d2)();
      });
      return element3;
    };
      ...
      var applyBehavior = function(v1) {
        return function(v2) {
          ...
          if (v1 instanceof MouseMoveWithInfo) {
            return $$void6(attachMouseMoveWithEvent_(v2)(function(d2, evt) {
              return v1.value0({
                datum: d2,
          ...
          if (v1 instanceof MouseEnterWithInfo) {
            return $$void6(attachMouseEnterWithEvent_(v2)(function(d2, evt) {
              return v1.value0({
                datum: d2,
                clientX: toNumber(clientX(evt)),
                clientY: toNumber(clientY(evt)),
          ...
          if (v1 instanceof MouseLeaveWithInfo) {
            return $$void6(attachMouseLeaveWithEvent_(v2)(function(d2, evt) {
              return v1.value0({
                datum: d2,
                clientX: toNumber(clientX(evt)),
                clientY: toNumber(clientY(evt)),
              ...
              return function(v) {
                return liftEffect12((function() {
                  ...
                  return function __do8() {
                    ...
                    liftEffect3(log8("joinDataWithKey: found " + (show8(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                    liftEffect3(log8("joinDataWithKey: " + (show8(length(mapMaybe(function(v2) {
                      return v2.datum;
                    })(oldBindings))) + " of those have data bound")))();
                    var validOldBindings = mapMaybe(function(v2) {
                      return mapFlipped1(v2.datum)(function(d2) {
                        return {
                          element: v2.element,
                          datum: d2
                        };
                    ...
                    var newDataArray = fromFoldable16(foldableData);
            ...
            return function(v) {
              return liftEffect12((function() {
                ...
                return function __do8() {
                  ...
                  liftEffect3(log8("joinData: found " + (show8(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                  liftEffect3(log8("joinData: " + (show8(length(mapMaybe(function(v2) {
                    return v2.datum;
                  })(oldBindings))) + " of those have data bound")))();
                  var validOldBindings = mapMaybe(function(v2) {
                    return mapFlipped1(v2.datum)(function(d2) {
  ...
  var getDocument = function(v) {
    if (v instanceof EmptySelection) {
      return pure11(v.value0.document);
    }
    ;
    if (v instanceof BoundSelection) {
      return pure11(v.value0.document);
      ...
      return function(v1) {
        if (v1 instanceof Node2) {
          return function __do8() {
            ...
            var combinedChildMap = foldl2(union4)(empty5)(map27(snd)(childMaps));
        ...
        if (v1 instanceof Join) {
          return function __do8() {
            ...
            liftEffect3((function() {
              ...
              return log8("Tree API Join '" + (v1.value0.name + ("': enter=" + (show8(enterCount) + (", update=" + (show8(updateCount) + (", exit=" + show8(exitCount))))))));
            })())();
        ...
        if (v1 instanceof SceneJoin) {
          return function __do8() {
            ...
            liftEffect3((function() {
              ...
              return log8("Tree API SceneJoin '" + (v1.value0.name + ("': enter=" + (show8(enterCount) + (", update=" + (show8(updateCount) + (", exit=" + show8(exitCount))))))));
            })())();
            (function() {
        ...
        if (v1 instanceof SceneNestedJoin) {
          ...
          return function __do8() {
            ...
            liftEffect3((function() {
              ...
              return log8("Tree API SceneNestedJoin '" + (v1.value0.name + ("': enter=" + (show8(enterCount) + (", update=" + (show8(updateCount) + (", exit=" + show8(exitCount))))))));
            })())();
            (function() {
              if (v1.value0.exitBehavior instanceof Just) {
                if (v1.value0.exitBehavior.value0.transition instanceof Just) {
          ...
          return function(attrs) {
            return function(emptySelection) {
              return liftEffect12((function() {
                ...
                var dataArray = fromFoldable16(foldableData);
  ...
  var fromFoldable15 = /* @__PURE__ */ fromFoldable5(foldableArray)(ordInt);
  ...
  var randomizeModulePositions = function(nodes) {
    var getPackagePos = function(n) {
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 270, column 21 - line 272, column 26): " + [n.nodeType.constructor.name]);
    };
    var packagePositions = fromFoldable14(mapMaybe(getPackagePos)(nodes));
    var randomizeIfModule = function(n) {
      ...
      if (n.nodeType instanceof ModuleNode) {
        return function __do8() {
          ...
          var ry = random();
          var v = (function() {
            var v1 = lookup(show15(n.cluster))(packagePositions);
            if (v1 instanceof Just) {
              return v1.value0;
            }
            ;
            ...
            ;
            throw new Error("Failed pattern match at Engine.Explorer (line 280, column 32 - line 282, column 40): " + [v1.constructor.name]);
          })();
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 274, column 25 - line 285, column 58): " + [n.nodeType.constructor.name]);
    };
    return traverse4(randomizeIfModule)(nodes);
  };
  var onDeclarationLeave = function __do() {
    clearCallGraphHighlight();
    return clearDeclarationHoverNarrative();
  };
  ...
  var nodeClass = function(n) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 462, column 15 - line 466, column 42): " + [n.nodeType.constructor.name]);
  };
  var mkPackageColorEntry = function(idx) {
    return function(pkg) {
      var t = numMod(toNumber(idx) * 0.618033988749895)(1);
      var color2 = turbo_default(t);
      return {
        name: pkg.name,
        color: color2
      };
  ...
  var renderNeighborhoodLinks = function(nodes) {
    return function __do8() {
      ...
      var nodeIdSet = fromFoldable15(map29(function(v) {
        return v.id;
      })(nodes));
    ...
    return function(declarationName) {
      return function(kind2) {
        return function __do8() {
          ...
          ;
          throw new Error("Failed pattern match at Engine.Explorer (line 1012, column 5 - line 1017, column 32): " + [v.constructor.name]);
        };
      };
    };
  };
  ...
  var formatNodeTooltip = function(node) {
    var nodeTypeLabel = function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 374, column 3 - line 374, column 38): " + [v.constructor.name]);
    };
  ...
  var fixPackagePosition = function(node) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 260, column 27 - line 262, column 21): " + [node.nodeType.constructor.name]);
  };
    ...
    return function(declarationName) {
      return function(_kind) {
        return function __do8() {
          ...
          ;
          if (v instanceof Just) {
            var calleeModules = nub4(map29(function(v1) {
            ...
            return setDeclarationHoverNarrative(moduleName)(declarationName)(length(v.value0.calls))(length(v.value0.calledBy))();
          }
          ;
          throw new Error("Failed pattern match at Engine.Explorer (line 1026, column 3 - line 1035, column 131): " + [v.constructor.name]);
        };
      };
    };
  };
  var clearElement = function(element3) {
    var clearNode = function(node) {
      return function __do8() {
        ...
        ;
        throw new Error("Failed pattern match at Engine.Explorer (line 598, column 5 - line 602, column 27): " + [mChild.constructor.name]);
      };
    };
  ...
  var clearNodesGroup = function __do2() {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 946, column 3 - line 948, column 63): " + [mElement.constructor.name]);
  };
  var clearTreeLinks = function __do3() {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 583, column 3 - line 588, column 63): " + [mElement.constructor.name]);
  };
  ...
  var toggleFocus = function(clickedNode) {
    return function __do8() {
      var focus2 = read(globalFocusRef)();
      ...
      if (mStateRef instanceof Just) {
        ...
        if (focus2.focusedNodeId instanceof Just && focus2.focusedNodeId.value0 === clickedNode.id) {
          log9("[Explorer] Unfocusing from node " + show15(clickedNode.id))();
          restoreFullView(focus2.fullNodes)(state3.simulation)();
          return write({
            focusedNodeId: Nothing.value,
            fullNodes: []
          })(globalFocusRef)();
        ...
        var nodesToStore = (function() {
          var $160 = $$null(focus2.fullNodes);
          if ($160) {
            return currentNodes;
          }
          ;
          return focus2.fullNodes;
        })();
        var neighborhoodIds = fromFoldable15(append16([clickedNode.id])(append16(clickedNode.targets)(clickedNode.sources)));
        ...
        setNeighborhoodNarrative(clickedNode.name)(length(clickedNode.targets))(length(clickedNode.sources))();
        return focusOnNeighborhood(neighborhoodNodes)(state3.simulation)();
      }
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 644, column 3 - line 683, column 65): " + [mStateRef.constructor.name]);
    };
  };
    ...
    return function(sim) {
      return function __do8() {
        ...
        (function() {
          ...
          ;
          throw new Error("Failed pattern match at Engine.Explorer (line 899, column 3 - line 903, column 25): " + [mStateRef.constructor.name]);
        })();
        var modelInfo = read(globalModelInfoRef)();
        setFullViewNarrative(modelInfo.projectName)(modelInfo.moduleCount)(modelInfo.packageCount)();
        reheat(sim)();
        return unit;
      };
    };
        ...
        return bind22(select6("#explorer-nodes circle"))(function(circlesSel) {
          ...
          return bind22(on4(onMouseEnter(function(node) {
            return function __do8() {
              ...
              var targetSet = fromFoldable15(node.targets);
              var sourceSet = fromFoldable15(node.sources);
              return classifyElements("#explorer-nodes")("circle")(function(n) {
                var $164 = n.id === node.id;
                if ($164) {
                  return "highlighted-source";
                }
                ;
                var $165 = member5(n.id)(targetSet);
                if ($165) {
                  return "highlighted-upstream";
                }
                ;
                var $166 = member5(n.id)(sourceSet);
                if ($166) {
  ...
  var handleBackButton = function __do5() {
    log9("[Explorer] Back button clicked")();
    var focus2 = read(globalFocusRef)();
    var mStateRef = read(globalStateRef)();
    if (mStateRef instanceof Just && focus2.focusedNodeId instanceof Just) {
      var state3 = read(mStateRef.value0)();
      restoreFullView(focus2.fullNodes)(state3.simulation)();
      return write({
        focusedNodeId: Nothing.value,
    ...
    ;
    return log9("[Explorer] No focused state to go back from")();
  };
                  ...
                  return bind22(on4(new Zoom(defaultZoom(new ScaleExtent(0.1, 10))("#explorer-zoom-group")))(svg))(function() {
                    ...
                    return bind22(on4(onMouseEnter(function(node) {
                      return function __do8() {
                        ...
                        var sourceSet = fromFoldable15(node.sources);
                        return classifyElements("#explorer-nodes")("circle")(function(n) {
                          var $171 = n.id === node.id;
                          if ($171) {
                            return "highlighted-source";
                          }
                          ;
                          var $172 = member5(n.id)(targetSet);
                          if ($172) {
                            return "highlighted-upstream";
                          }
                          ;
                          var $173 = member5(n.id)(sourceSet);
                          if ($173) {
                            return "highlighted-downstream";
                          }
                          ;
  ...
  var initWithModel = function(model) {
    return function(containerSelector) {
      return function __do8() {
        ...
        initNarrativePanel(handleBackButton)();
        var colorPalette = mapWithIndex2(mkPackageColorEntry)(model.packages);
        setColorPalette(colorPalette)();
        setFullViewNarrative("purescript-d3-dataviz")(model.moduleCount)(model.packageCount)();
        ...
        var nodesWithFix = map29(fixPackagePosition)(randomizedNodes);
  ...
  var initExplorer = function(containerSelector) {
    return launchAff_(discard22(log1("[Explorer] BUILD: 2025-12-03 - Deferred function calls loading"))(function() {
      return discard22(log1("[Explorer] Loading data..."))(function() {
        return bind32(loadModel)(function(result) {
                ...
                return discard22(liftEffect4(write(result.value0.declarations)(globalDeclarationsRef)))(function() {
                  return bind32(liftEffect4(initWithModel(result.value0)(containerSelector)))(function(stateRef) {
                    return discard22(liftEffect4(write(new Just(stateRef))(globalStateRef)))(function() {
                      return discard22(liftEffect4(log9("[Explorer] Ready - loading function calls in background...")))(function() {
                        return bind32(forkAff(bind32(fetchFunctionCalls)(function(fnCallsResult) {
                          if (fnCallsResult instanceof Left) {
                            return liftEffect4(log9("[Explorer] Warning: Could not load function calls: " + fnCallsResult.value0));
                          }
                          ;
                          if (fnCallsResult instanceof Right) {
                            return discard22(liftEffect4(write(fnCallsResult.value0)(globalFunctionCallsRef)))(function() {
                              return liftEffect4(log9("[Explorer] Function calls loaded: " + (show15(size(fnCallsResult.value0)) + " functions")));
                            });
                          }
                          ;
                          throw new Error("Failed pattern match at Engine.Explorer (line 142, column 9 - line 146, column 114): " + [fnCallsResult.constructor.name]);
                        })))(function() {
                          return pure32(unit);
                        });
                      });
          ...
          ;
          throw new Error("Failed pattern match at Engine.Explorer (line 125, column 3 - line 147, column 16): " + [result.constructor.name]);
        });
      });
    }));
  };
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v) {
    var go2 = function(v2) {
      ...
      if (v2 instanceof Elem) {
        return new Elem(v2.value0, v2.value1, v.value0(v2.value2), map30(go2)(v2.value3));
      }
      ;
      if (v2 instanceof Keyed) {
        return new Keyed(v2.value0, v2.value1, v.value0(v2.value2), map30(map111(go2))(v2.value3));
      }
      ;
    ...
    return function(v) {
      ...
      if (v instanceof Query) {
        return unCoyoneda(function(g) {
          var $45 = map31(maybe(v.value1(unit))(g));
          return function($46) {
  ...
  var defaultEval = /* @__PURE__ */ (function() {
    return {
      handleAction: $$const(pure14(unit)),
      handleQuery: $$const(pure14(Nothing.value)),
  ...
  var render2 = function(state3) {
    return div2([class_3("explorer-app")])([(function() {
      if (state3.error instanceof Just) {
        return div2([classes(["floating-panel", "floating-panel--bottom-right", "error-message"])])([text5(state3.error.value0)]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Component.SpagoGridApp (line 50, column 7 - line 54, column 30): " + [state3.error.constructor.name]);
    })(), div2([id4("viz")])([])]);
  };
  var handleAction = function(dictMonadAff) {
    var monadEffectHalogenM2 = monadEffectHalogenM(dictMonadAff.MonadEffect0());
    var log10 = log2(monadEffectHalogenM2);
    var liftEffect10 = liftEffect(monadEffectHalogenM2);
    return function(v) {
      return discard4(log10("[Explorer] Initializing with new Scene Engine..."))(function() {
  ...
  var map33 = /* @__PURE__ */ map(functorCoyoneda);
  ...
  var evalQ = function(render3) {
    return function(ref2) {
      return function(q2) {
        return bind14(liftEffect6(read(ref2)))(function(v) {
          return evalM(render3)(ref2)(v["component"]["eval"](new Query(map33(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
        ...
        var go2 = function(ref2) {
          return function(v1) {
            ...
            if (v1 instanceof Raise) {
              return bind14(liftEffect6(read(ref2)))(function(v2) {
                return bind14(liftEffect6(read(v2.handlerRef)))(function(handler2) {
              ...
              return bind14(fresh(ForkId)(ref2))(function(fid) {
                return bind14(liftEffect6(read(ref2)))(function(v2) {
                  return bind14(liftEffect6($$new(false)))(function(doneRef) {
                    return bind14(fork3($$finally(liftEffect6(function __do8() {
      ...
      return function(i2) {
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot) {
                  return function __do8() {
                    var childrenIn = map34(slot.pop)(read(childrenInRef))();
                    var $$var2 = (function() {
                        ...
                        unDriverStateX(function(st) {
                          return function __do9() {
                            flip(write)(st.handlerRef)((function() {
                              var $65 = maybe(pure19(unit))(handler2);
                              return function($66) {
                      ...
                      if (childrenIn instanceof Nothing) {
                        return runComponent(lchs)((function() {
                          var $67 = maybe(pure19(unit))(handler2);
                          return function($68) {
                    ...
                    var isDuplicate = map34(function($69) {
        ...
        var render3 = function(lchs) {
          return function($$var2) {
            return function __do8() {
              var v = read($$var2)();
              var shouldProcessHandlers = map34(isNothing)(read(v.pendingHandlers))();
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind17(liftEffect8(map35(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
  ...
  var main2 = function __do7() {
    ...
    return runHalogenAff(bind18(selectElement("#app"))(function(mAppEl) {
