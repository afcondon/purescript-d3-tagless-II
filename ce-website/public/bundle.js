...
(() => {
              ...
              function go2(bot, top2) {
                switch (top2 - bot) {
                  case 0:
                    return pure8([]);
                  case 1:
                    return map17(array1)(f(array4[bot]));
                  case 2:
                    return apply3(map17(array2)(f(array4[bot])))(f(array4[bot + 1]));
                  case 3:
                    return apply3(apply3(map17(array3)(f(array4[bot])))(f(array4[bot + 1])))(f(array4[bot + 2]));
                  default:
  ...
  var request = function(driver2) {
    return function(req) {
      ...
      var headers = function(reqContent) {
        return addHeader(map7(ContentType.create)(bindFlipped2(toMediaType)(reqContent)))(addHeader(map7(Accept.create)(toMediaType2(req.responseFormat)))(req.headers));
      };
  ...
  function namespace_default(name16) {
    var prefix = name16 += "", i = prefix.indexOf(":");
    if (i >= 0 && (prefix = name16.slice(0, i)) !== "xmlns") name16 = name16.slice(i + 1);
  ...
  function select_default(select7) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) {
        if ((node = group4[i]) && (subnode = select7.call(node, node.__data__, i, group4))) {
  ...
  function selectAll_default(select7) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, node, i = 0; i < n; ++i) {
        if (node = group4[i]) {
          subgroups.push(select7.call(node, node.__data__, i, group4));
          parents.push(node);
        }
      }
    }
  ...
  function filter_default(match) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, subgroup = subgroups[j] = [], node, i = 0; i < n; ++i) {
  ...
  function data_default(value13, key) {
    ...
    var bind8 = key ? bindKey : bindIndex, parents = this._parents, groups = this._groups;
    ...
    for (var m = groups.length, update2 = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
      ...
      bind8(parent2, group4, enterGroup, updateGroup, exitGroup, data, key);
  ...
  function sort_default(compare3) {
    ...
    for (var groups = this._groups, m = groups.length, sortgroups = new Array(m), j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, sortgroup = sortgroups[j] = new Array(n), node, i = 0; i < n; ++i) {
        if (node = group4[i]) {
          sortgroup[i] = node;
        }
      }
  ...
  ClassList.prototype = {
    add: function(name16) {
      var i = this._names.indexOf(name16);
      if (i < 0) {
  ...
  function insert_default(name16, before) {
    var create5 = typeof name16 === "function" ? name16 : creator_default(name16), select7 = before == null ? constantNull : typeof before === "function" ? before : selector_default(before);
    return this.select(function() {
      return this.insertBefore(create5.apply(this, arguments), select7.apply(this, arguments) || null);
    });
  }
  ...
  function parseTypenames(typenames) {
    return typenames.trim().split(/^|\s+/).map(function(t) {
      var name16 = "", i = t.indexOf(".");
      if (i >= 0) name16 = t.slice(i + 1), t = t.slice(0, i);
  ...
  function onRemove(typename) {
    return function() {
      var on5 = this.__on;
      if (!on5) return;
      for (var j = 0, i = -1, m = on5.length, o; j < m; ++j) {
  ...
  function on_default(typename, value13, options2) {
    ...
    for (i = 0; i < n; ++i) this.each(on5(typenames[i], value13, options2));
    return this;
  }
  ...
  // output/Viz.LesMis.GUPDemo/foreign.js
  var updateNodePositions = (_selection) => () => {
    select_default2("#lesmis-gup-nodes").selectAll("circle").attr("cx", (d) => d.x).attr("cy", (d) => d.y);
  };
  var updateLinkPositions = (_selection) => () => {
    select_default2("#lesmis-gup-links").selectAll("line").attr("x1", (d) => d.source.x).attr("y1", (d) => d.source.y).attr("x2", (d) => d.target.x).attr("y2", (d) => d.target.y);
  };
  ...
  function add2(tree, x3, y3, d) {
    ...
    var parent2, node = tree._root, leaf = { data: d }, x0 = tree._x0, y0 = tree._y0, x13 = tree._x1, y13 = tree._y1, xm, ym, xp, yp, right, bottom2, i, j;
    if (!node) return tree._root = leaf, tree;
    while (node.length) {
      if (right = x3 >= (xm = (x0 + x13) / 2)) x0 = xm;
      else x13 = xm;
      if (bottom2 = y3 >= (ym = (y0 + y13) / 2)) y0 = ym;
      else y13 = ym;
      if (parent2 = node, !(node = node[i = bottom2 << 1 | right])) return parent2[i] = leaf, tree;
    }
    ...
    } while ((i = bottom2 << 1 | right) === (j = (yp >= ym) << 1 | xp >= xm));
    return parent2[j] = node, parent2[i] = leaf, tree;
  }
  function addAll(data) {
    var d, i, n = data.length, x3, y3, xz = new Array(n), yz = new Array(n), x0 = Infinity, y0 = Infinity, x13 = -Infinity, y13 = -Infinity;
    for (i = 0; i < n; ++i) {
  ...
  function cover_default(x3, y3) {
    ...
    if (isNaN(x0)) {
      ...
      var z = x13 - x0 || 1, node = this._root, parent2, i;
  ...
  function find_default(x3, y3, radius3) {
    var data, x0 = this._x0, y0 = this._y0, x13, y13, x24, y24, x32 = this._x1, y32 = this._y1, quads = [], node = this._root, q, i;
    ...
    while (q = quads.pop()) {
      if (!(node = q.node) || (x13 = q.x0) > x32 || (y13 = q.y0) > y32 || (x24 = q.x1) < x0 || (y24 = q.y1) < y0) continue;
      if (node.length) {
  ...
  function remove_default2(d) {
    ...
    var parent2, node = this._root, retainer, previous, next, x0 = this._x0, y0 = this._y0, x13 = this._x1, y13 = this._y1, x3, y3, xm, ym, right, bottom2, i, j;
    if (!node) return this;
    if (node.length) while (true) {
      ...
      if (!(parent2 = node, node = node[i = bottom2 << 1 | right])) return this;
  ...
  function visit_default(callback) {
    var quads = [], q, node = this._root, child, x0, y0, x13, y13;
    if (node) quads.push(new quad_default(node, this._x0, this._y0, this._x1, this._y1));
    while (q = quads.pop()) {
      if (!callback(node = q.node, x0 = q.x0, y0 = q.y0, x13 = q.x1, y13 = q.y1) && node.length) {
  ...
  function visitAfter_default(callback) {
    ...
    while (q = quads.pop()) {
      var node = q.node;
      if (node.length) {
        var child, x0 = q.x0, y0 = q.y0, x13 = q.x1, y13 = q.y1, xm = (x0 + x13) / 2, ym = (y0 + y13) / 2;
        if (child = node[0]) quads.push(new quad_default(child, x0, y0, xm, ym));
        if (child = node[1]) quads.push(new quad_default(child, xm, y0, x13, ym));
        if (child = node[2]) quads.push(new quad_default(child, x0, ym, xm, y13));
        if (child = node[3]) quads.push(new quad_default(child, xm, ym, x13, y13));
  ...
  function collide_default(radius3) {
    ...
    function initialize() {
      ...
      radii = new Array(n);
      for (i = 0; i < n; ++i) node = nodes[i], radii[node.index] = +radius3(node, i, nodes);
    }
    ...
    force.radius = function(_) {
      return arguments.length ? (radius3 = typeof _ === "function" ? _ : constant_default2(+_), initialize(), force) : radius3;
    };
    return force;
  }
  ...
  function link_default(links) {
    var id4 = index3, strength = defaultStrength, strengths, distance = constant_default2(30), distances, nodes, count, bias, random2, iterations = 1;
    if (links == null) links = [];
    ...
    function force(alpha) {
      for (var k = 0, n = links.length; k < iterations; ++k) {
        for (var i = 0, link, source, target5, x3, y3, l, b; i < n; ++i) {
          link = links[i], source = link.source, target5 = link.target;
          x3 = target5.x + target5.vx - source.x - source.vx || jiggle_default(random2);
          y3 = target5.y + target5.vy - source.y - source.vy || jiggle_default(random2);
    ...
    function initialize() {
      if (!nodes) return;
      var i, n = nodes.length, m = links.length, nodeById = new Map(nodes.map((d, i2) => [id4(d, i2, nodes), d])), link;
  ...
  function manyBody_default() {
    ...
    function force(_) {
      ...
      for (alpha = _, i = 0; i < n; ++i) node = nodes[i], tree.visit(apply3);
    }
    function initialize() {
      if (!nodes) return;
  ...
  function radial_default(radius3, x3, y3) {
    var nodes, strength = constant_default2(0.1), strengths, radiuses;
    if (typeof radius3 !== "function") radius3 = constant_default2(+radius3);
    if (x3 == null) x3 = 0;
    if (y3 == null) y3 = 0;
    function force(alpha) {
  ...
  function createLink_(config) {
    const force = link_default().distance(config.distance).strength(config.strength).iterations(config.iterations);
    return force;
  }
  ...
  function requestAnimationFrame_(callback) {
    return function() {
      ...
      if (USE_SETTIMEOUT) {
        id4 = setTimeout(handler, FRAME_TIME);
        return function() {
          clearTimeout(id4);
        };
      } else {
        id4 = requestAnimationFrame(handler);
        return function() {
  ...
  var startAnimation = function(onFrame) {
    return function __do2() {
      ...
      return bind3(getCancelRef(cancelRef))(identity8);
    };
  };
  ...
  var setNodes = function(nodes) {
    return function(sim) {
      return function __do2() {
        ...
        var forces = read(sim.forces)();
        return for_3(toUnfoldable5(forces))(function(v) {
          return function __do3() {
  ...
  var addForce = function(spec) {
    return function(sim) {
      var forceName = function(v) {
        ...
        ;
        throw new Error("Failed pattern match at PSD3.ForceEngine.Simulation (line 179, column 15 - line 186, column 20): " + [v.constructor.name]);
      };
      return function __do2() {
        var nodes = read(sim.nodes)();
        ...
        var handle = (function() {
          ...
          ;
          throw new Error("Failed pattern match at PSD3.ForceEngine.Simulation (line 146, column 13 - line 173, column 35): " + [spec.constructor.name]);
        })();
        var name16 = forceName(spec);
        return modify_(insert4(name16)(handle))(sim.forces)();
      };
    };
  };
  ...
  var tickTransitions = function(delta) {
    return function(transitions) {
      var advanced = map9(function(t) {
        return {
          item: t.item,
          progress: min3(1)(t.progress + delta)
        };
      })(transitions);
      var completed = map9(function(v) {
        return v.item;
      })(filter(function(t) {
        return t.progress >= 1;
      })(advanced));
  ...
  var tickProgressMap = function(dictOrd) {
    var filter5 = filter3(dictOrd);
    return function(delta) {
      return function(progressMap) {
        var advanced = map12(function(p) {
          return min3(1)(p + delta);
        })(progressMap);
        var completed = toUnfoldable6(keys3(filter5(function(p) {
          return p >= 1;
        })(advanced)));
        var active = filter5(function(p) {
          return p < 1;
        })(advanced);
        return {
          active,
  ...
  var rgb_default = (function rgbGamma(y3) {
    ...
    function rgb2(start4, end) {
      var r = color2((start4 = rgb(start4)).r, (end = rgb(end)).r), g = color2(start4.g, end.g), b = color2(start4.b, end.b), opacity3 = nogamma(start4.opacity, end.opacity);
      return function(t) {
        start4.r = r(t);
        start4.g = g(t);
        start4.b = b(t);
  ...
  function parseSvg(value13) {
    if (value13 == null) return identity9;
    if (!svgNode) svgNode = document.createElementNS("http://www.w3.org/2000/svg", "g");
    svgNode.setAttribute("transform", value13);
    if (!(value13 = svgNode.transform.baseVal.consolidate())) return identity9;
  ...
  function interrupt_default(node, name16) {
    ...
    for (i in schedules) {
      if ((schedule = schedules[i]).name !== name16) {
        empty5 = false;
        continue;
      }
  ...
  function tweenFunction(id4, name16, value13) {
    var tween0, tween1;
    ...
    return function() {
      ...
      if (tween !== tween0) {
        ...
        for (var t = { name: name16, value: value13 }, i = 0, n = tween1.length; i < n; ++i) {
          if (tween1[i].name === name16) {
            tween1[i] = t;
            break;
          }
  ...
  function tween_default(name16, value13) {
    ...
    if (arguments.length < 2) {
      ...
      for (var i = 0, n = tween.length, t; i < n; ++i) {
        if ((t = tween[i]).name === name16) {
          return t.value;
        }
      }
      return null;
    }
    return this.each((value13 == null ? tweenRemove : tweenFunction)(id4, name16, value13));
  }
  ...
  function attr_default2(name16, value13) {
    var fullname = namespace_default(name16), i = fullname === "transform" ? interpolateTransformSvg : interpolate_default;
    return this.attrTween(name16, typeof value13 === "function" ? (fullname.local ? attrFunctionNS2 : attrFunction2)(fullname, i, tweenValue(this, "attr." + name16, value13)) : value13 == null ? (fullname.local ? attrRemoveNS2 : attrRemove2)(fullname) : (fullname.local ? attrConstantNS2 : attrConstant2)(fullname, i, value13));
  }

  // node_modules/d3-transition/src/transition/attrTween.js
  function attrInterpolate(name16, i) {
    return function(t) {
      this.setAttribute(name16, i.call(this, t));
    };
  }
  ...
  function attrTweenNS(fullname, value13) {
    var t0, i0;
    function tween() {
      var i = value13.apply(this, arguments);
  ...
  function attrTween(name16, value13) {
    ...
    function tween() {
      var i = value13.apply(this, arguments);
      if (i !== i0) t0 = (i0 = i) && attrInterpolate(name16, i);
      return t0;
    }
    tween._value = value13;
    return tween;
  ...
  function delayFunction(id4, value13) {
    return function() {
      init3(this, id4).delay = +value13.apply(this, arguments);
    };
  }
  function delayConstant(id4, value13) {
    return value13 = +value13, function() {
      init3(this, id4).delay = value13;
    };
  }
  function delay_default(value13) {
    var id4 = this._id;
    return arguments.length ? this.each((typeof value13 === "function" ? delayFunction : delayConstant)(id4, value13)) : get4(this.node(), id4).delay;
  }

  // node_modules/d3-transition/src/transition/duration.js
  function durationFunction(id4, value13) {
    return function() {
      set2(this, id4).duration = +value13.apply(this, arguments);
    };
  }
  function durationConstant(id4, value13) {
    return value13 = +value13, function() {
      set2(this, id4).duration = value13;
    };
  }
  function duration_default(value13) {
    var id4 = this._id;
    return arguments.length ? this.each((typeof value13 === "function" ? durationFunction : durationConstant)(id4, value13)) : get4(this.node(), id4).duration;
  }

  // node_modules/d3-transition/src/transition/ease.js
  function easeConstant(id4, value13) {
    if (typeof value13 !== "function") throw new Error();
    return function() {
      set2(this, id4).ease = value13;
    };
  }
  function ease_default(value13) {
    var id4 = this._id;
    return arguments.length ? this.each(easeConstant(id4, value13)) : get4(this.node(), id4).ease;
  }

  // node_modules/d3-transition/src/transition/easeVarying.js
  function easeVarying(id4, value13) {
    return function() {
      var v = value13.apply(this, arguments);
  ...
  function onFunction(id4, name16, listener) {
    ...
    return function() {
      var schedule = sit(this, id4), on5 = schedule.on;
    ...
    for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) {
        if ((node = group4[i]) && (subnode = select7.call(node, node.__data__, i, group4))) {
          if ("__data__" in node) subnode.__data__ = node.__data__;
          subgroup[i] = subnode;
          schedule_default(subgroup[i], name16, id4, i, subgroup, get4(node, id4));
        }
      }
    }
  ...
  function selectAll_default2(select7) {
    ...
    for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, node, i = 0; i < n; ++i) {
        if (node = group4[i]) {
          for (var children3 = select7.call(node, node.__data__, i, group4), child, inherit2 = get4(node, id4), k = 0, l = children3.length; k < l; ++k) {
            if (child = children3[k]) {
              schedule_default(child, name16, id4, k, children3, inherit2);
            }
          }
  ...
  function styleMaybeRemove(id4, name16) {
    ...
    return function() {
      var schedule = set2(this, id4), on5 = schedule.on, listener = schedule.value[key] == null ? remove5 || (remove5 = styleRemove2(name16)) : void 0;
  ...
  function style_default2(name16, value13, priority) {
    var i = (name16 += "") === "transform" ? interpolateTransformCss : interpolate_default;
    return value13 == null ? this.styleTween(name16, styleNull(name16, i)).on("end.style." + name16, styleRemove2(name16)) : typeof value13 === "function" ? this.styleTween(name16, styleFunction2(name16, i, tweenValue(this, "style." + name16, value13))).each(styleMaybeRemove(this._id, name16)) : this.styleTween(name16, styleConstant2(name16, i, value13), priority).on("end.style." + name16, null);
  }

  // node_modules/d3-transition/src/transition/styleTween.js
  function styleInterpolate(name16, i, priority) {
    return function(t) {
      this.style.setProperty(name16, i.call(this, t), priority);
    };
  }
  function styleTween(name16, value13, priority) {
    ...
    function tween() {
      var i = value13.apply(this, arguments);
      if (i !== i0) t = (i0 = i) && styleInterpolate(name16, i, priority);
      return t;
    }
    tween._value = value13;
    return tween;
    ...
    for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, node, i = 0; i < n; ++i) {
        if (node = group4[i]) {
          ...
          schedule_default(node, name16, id1, i, group4, {
  ...
  function end_default() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      that.each(function() {
        var schedule = set2(this, id4), on5 = schedule.on;
        if (on5 !== on0) {
          on1 = (on0 = on5).copy();
  ...
  var id2 = 0;
  function Transition(groups, parents, name16, id4) {
    this._groups = groups;
    this._parents = parents;
    this._name = name16;
    this._id = id4;
  ...
  function transition_default2(name16) {
    ...
    for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) {
      for (var group4 = groups[j], n = group4.length, node, i = 0; i < n; ++i) {
        if (node = group4[i]) {
          schedule_default(node, name16, id4, i, group4, timing || inherit(node, id4));
        }
      }
    }
    return new Transition(groups, this._parents, name16, id4);
  }
      ...
      var applyBehavior = function(v1) {
        return function(v2) {
          ...
          if (v1 instanceof Click) {
            return $$void4(attachClick_(v2)(v1.value0));
          }
          ;
          if (v1 instanceof ClickWithDatum) {
            return $$void4(attachClickWithDatum_(v2)(v1.value0));
          }
          ;
          if (v1 instanceof MouseEnter) {
            return $$void4(attachMouseEnter_(v2)(v1.value0));
          }
          ;
          if (v1 instanceof MouseLeave) {
            return $$void4(attachMouseLeave_(v2)(v1.value0));
          }
          ;
          if (v1 instanceof Highlight) {
            return $$void4(attachHighlight_(v2)(v1.value0.enter)(v1.value0.leave));
          }
          ;
          if (v1 instanceof MouseMoveWithInfo) {
            return $$void4(attachMouseMoveWithEvent_(v2)(function(d, evt) {
              return v1.value0({
                datum: d,
          ...
          if (v1 instanceof MouseEnterWithInfo) {
            return $$void4(attachMouseEnterWithEvent_(v2)(function(d, evt) {
              return v1.value0({
                datum: d,
                clientX: toNumber(clientX(evt)),
                clientY: toNumber(clientY(evt)),
          ...
          if (v1 instanceof MouseLeaveWithInfo) {
            return $$void4(attachMouseLeaveWithEvent_(v2)(function(d, evt) {
              return v1.value0({
                datum: d,
                clientX: toNumber(clientX(evt)),
                clientY: toNumber(clientY(evt)),
              ...
              return function(v) {
                return liftEffect1((function() {
                  ...
                  return function __do2() {
                    ...
                    liftEffect2(log4("joinDataWithKey: found " + (show4(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                    liftEffect2(log4("joinDataWithKey: " + (show4(length(mapMaybe(function(v2) {
                      return v2.datum;
            ...
            return function(v) {
              return liftEffect1((function() {
                ...
                return function __do2() {
                  ...
                  liftEffect2(log4("joinData: found " + (show4(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                  liftEffect2(log4("joinData: " + (show4(length(mapMaybe(function(v2) {
                    return v2.datum;
                  })(oldBindings))) + " of those have data bound")))();
                  var validOldBindings = mapMaybe(function(v2) {
                    return mapFlipped1(v2.datum)(function(d) {
  ...
  var getDocument = function(v) {
    if (v instanceof EmptySelection) {
      return pure5(v.value0.document);
    }
    ;
    if (v instanceof BoundSelection) {
      return pure5(v.value0.document);
            ...
            return function __do2() {
              ...
              return traverse_2(function(attr) {
                if (attr instanceof StaticAttr) {
                  return transitionSetAttribute_(attr.value0)(attributeValueToString(attr.value1))(transition2);
                }
                ;
                if (attr instanceof DataAttr) {
                  return transitionSetAttribute_(attr.value0)(attributeValueToString(attr.value1(v.value1)))(transition2);
                }
                ;
                if (attr instanceof IndexedAttr) {
                  return transitionSetAttribute_(attr.value0)(attributeValueToString(attr.value1(v.value1)(index5)))(transition2);
                }
                ;
                throw new Error("Failed pattern match at PSD3v2.Selection.Operations (line 1023, column 32 - line 1031, column 103): " + [attr.constructor.name]);
              })(attrs)();
            };
          };
        })(elementDatumPairs);
          ...
          return function(v) {
            return function __do2() {
              ...
              traverse_2(function(attr) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3v2.Selection.Operations (line 1051, column 32 - line 1059, column 103): " + [attr.constructor.name]);
              })(attrs)();
    ...
    return function(datum2) {
      return function(index5) {
        return function(attrs) {
          return traverse_2(function(attr) {
            if (attr instanceof StaticAttr) {
              var $380 = attr.value0 === "textContent";
              if ($380) {
            ...
            ;
            if (attr instanceof DataAttr) {
              var val = attributeValueToString(attr.value1(datum2));
              var $383 = attr.value0 === "textContent";
              if ($383) {
            ...
            ;
            if (attr instanceof IndexedAttr) {
              var val = attributeValueToString(attr.value1(datum2)(index5));
              var $386 = attr.value0 === "textContent";
              if ($386) {
                return setTextContent_(val)(element);
              }
              ;
            ...
            ;
            throw new Error("Failed pattern match at PSD3v2.Selection.Operations (line 938, column 30 - line 955, column 51): " + [attr.constructor.name]);
          })(attrs);
        };
      };
    };
          ...
          return function(doc) {
            return function __do2() {
              ...
              if (tree instanceof Node2) {
                return applyAttributes(element)(datum2)(index5)(tree.value0.attrs)();
              }
              ;
              return unit;
            };
              ...
              var childElements = traverseWithIndex3(function(idx) {
                return function(v2) {
                  return function __do3() {
                    ...
                    appendChild2(childNode)(parentNode2)();
                    return child;
                  };
                };
            ...
            return function __do2() {
              var elements = traverse3(function(parent2) {
                return function __do3() {
                  ...
                  appendChild2(elementNode)(parentNode2)();
                  return element;
                };
              })(v1.parentElements)();
              return new EmptySelection({
      ...
      return function(v1) {
        if (v1 instanceof Node2) {
          return function __do2() {
            ...
            var combinedChildMap = foldl2(union3)(empty3)(map13(snd)(childMaps));
        ...
        if (v1 instanceof Join) {
          return function __do2() {
            ...
            var allChildMaps = append12(enterChildMaps)(updateChildMaps);
              ...
              if (v1.value0.enterBehavior instanceof Just) {
                ...
                (function() {
                  if (v1.value0.enterBehavior.value0.transition instanceof Just) {
                    var enterElements2 = map13(fst)(rendered);
                    ...
                    return liftEffect2(traverse_2(function(v3) {
              ...
              if (v1.value0.updateBehavior instanceof Just) {
                (function() {
                  if (v1.value0.updateBehavior.value0.transition instanceof Just) {
                    ...
                    return liftEffect2(applyTransitionToElements(v1.value0.updateBehavior.value0.transition.value0)(pairs)(v1.value0.updateBehavior.value0.attrs))();
                  }
                  ;
        ...
        if (v1 instanceof SceneNestedJoin) {
          var innerData = join2(map13(v1.value0.decompose)(v1.value0.joinData));
          return function __do2() {
              ...
              if (v1.value0.enterBehavior instanceof Just) {
                ...
                (function() {
                  if (v1.value0.enterBehavior.value0.transition instanceof Just) {
                    ...
                    var pairs = zipWith(Tuple.create)(enterElements2)(pendingData);
                    return liftEffect2(traverse_2(function(v4) {
                      var finalAttrs = (function() {
              ...
              return function(outerDatum) {
                ...
                if (v1 instanceof Just) {
                  return function __do2() {
                    ...
                    appendChild2(wrapperNode)(parentNode2)();
                  ...
                  return function(updateAttrs) {
                    return function(exitAttrs) {
                      return bind1(joinData4(foldableData)(selector)(emptySelection))(function(v) {
                        return bind1(bind1(append42(elemType)([])(v.value0.enter))(function(bound) {
  ...
  // output/Viz.LesMis.GUPDemo/index.js
  ...
  var tickProgressMap2 = /* @__PURE__ */ tickProgressMap(ordString);
  var show14 = /* @__PURE__ */ show(showInt);
  var transitionDelta = 0.025;
  var swizzleLinksSimple = function(nodes) {
    return function(links) {
      var swizzle = function(link) {
        return bind5(index(nodes)(link.source))(function(src9) {
          return bind5(index(nodes)(link.target))(function(tgt) {
            return pure6({
              source: src9,
              target: tgt,
              value: link.value
      ...
      return mapMaybe(swizzle)(links);
    };
  };
  var svgWidth = 900;
  var svgHeight = 600;
  var renderInitial = function(containerSelector) {
    return function(nodes) {
      return function(links) {
        return bind22(select6(containerSelector))(function(container) {
          return bind22(appendChild5(SVG.value)([width9(svgWidth), height9(svgHeight), viewBox2(show5(-svgWidth / 2) + (" " + (show5(-svgHeight / 2) + (" " + (show5(svgWidth) + (" " + show5(svgHeight))))))), id_2("lesmis-gup-svg"), class_2("lesmis-gup")])(container))(function(svg) {
            return bind22(appendChild5(Group.value)([id_2("lesmis-gup-zoom-group"), class_2("zoom-group")])(svg))(function(zoomGroup) {
              return bind22(appendChild5(Group.value)([id_2("lesmis-gup-links"), class_2("links")])(zoomGroup))(function(linksGroup) {
                return bind22(appendChild5(Group.value)([id_2("lesmis-gup-nodes"), class_2("nodes")])(zoomGroup))(function(nodesGroup) {
                  return bind22(appendData4(Circle.value)(nodes)([cx2(function(v) {
                    return v.x;
                  }), cy2(function(v) {
                    return v.y;
                  }), radius2($$const(5)), fill2($$const("#7f7f7f")), stroke2("#fff"), strokeWidth2(1.5)])(nodesGroup))(function(nodeSel) {
                    return bind22(appendData4(Line.value)(links)([x12(function(v) {
                      return v.source.x;
                    }), y12(function(v) {
                      return v.source.y;
                    }), x23(function(v) {
                      ...
                      return v.target.y;
                    }), stroke2("#666"), strokeWidth2(1.5), opacity2(0.8)])(linksGroup))(function(linkSel) {
                      return bind22(on4(new Zoom(defaultZoom(new ScaleExtent(0.1, 10))("#lesmis-gup-zoom-group")))(svg))(function() {
                        return pure12({
                          nodeSel,
                          linkSel
                        });
  ...
  var onSimulationTick = function(stateRef) {
    return function __do2() {
      var state3 = read(stateRef)();
      var v = tickProgressMap2(transitionDelta)(state3.enteringProgress);
      var v1 = tickTransitions(transitionDelta)(state3.exitingNodes);
      write({
        containerSelector: state3.containerSelector,
        fullModel: state3.fullModel,
        linkSelection: state3.linkSelection,
        nodeSelection: state3.nodeSelection,
        simulation: state3.simulation,
        visibleNodeIds: state3.visibleNodeIds,
        enteringProgress: v.active,
        exitingNodes: v1.active
      })(stateRef)();
      updateNodePositions(state3.nodeSelection)();
      return updateLinkPositions(state3.linkSelection)();
    };
  };
  var initGUPDemo = function(model) {
    return function(containerSelector) {
      var allNodeIds = map15(function(v) {
        return v.id;
      })(model.nodes);
      var initialEntering = startProgress2(allNodeIds)(empty3);
      var swizzledLinks = swizzleLinksSimple(model.nodes)(model.links);
      return function __do2() {
        log2("[GUP] Nodes: " + (show14(length(model.nodes)) + (", Links: " + (show14(length(model.links)) + (", Swizzled: " + show14(length(swizzledLinks)))))))();
        ...
        var v = runD3v2M(renderInitial(containerSelector)(currentNodes)(swizzledLinks))();
        var stateRef = $$new({
          fullModel: model,
          ...
          simulation: sim,
          containerSelector,
          nodeSelection: v.nodeSel,
          linkSelection: v.linkSel
        })();
        onTick(onSimulationTick(stateRef))(sim)();
        start(sim)();
        return stateRef;
      };
    };
  ...
  // output/Viz.LesMis.Model/index.js
  ...
  var processRawModel = function(raw) {
    var convertLink = function(idMap) {
      return function(v) {
        return bind6(lookup3(v.source)(idMap))(function(srcIdx) {
          return bind6(lookup3(v.target)(idMap))(function(tgtIdx) {
            return pure7({
              source: srcIdx,
              target: tgtIdx,
              value: v.value
    ...
    var nodes = mapWithIndex2(function(i) {
      return function(n) {
        var v = mkNode(n);
        return {
          fx: v.fx,
    ...
    var idToIndex = fromFoldable6(mapWithIndex2(function(i) {
      return function(n) {
  ...
  var decodeJson2 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(decodeJsonNumber))(gDecodeJsonNil)({
  ...
  })()())())))(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(decodeJsonInt))(/* @__PURE__ */ gDecodeJsonCons2(gDecodeJsonNil)({
    reflectSymbol: function() {
      return "id";
    }
  })()())({
  ...
  var range3 = function(start4) {
    return function(end) {
        ...
        var go2 = function($copy_i) {
          return function($copy_acc) {
            ...
            function $tco_loop(i, acc) {
              ...
              if (otherwise) {
                $tco_var_i = i + 1 | 0;
                $copy_acc = append5(acc)([i]);
                return;
              }
              ;
              throw new Error("Failed pattern match at Main (line 100, column 3 - line 102, column 42): " + [i.constructor.name, acc.constructor.name]);
            }
            ;
            while (!$tco_done) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 95, column 1 - line 95, column 33): " + [start4.constructor.name, end.constructor.name]);
    };
  };
  var replicate2 = function(n) {
    return function(a) {
      return map16($$const(a))(range3(0)(n - 1 | 0));
    };
  };
  var offsetNode = function(copyIdx) {
    return function(baseCount) {
      return function(node) {
        var offsetY2 = toNumber(div2(copyIdx)(4)) * 200 - 300;
        var offsetX2 = toNumber(mod3(copyIdx)(4)) * 200 - 300;
        var newIndex = node.index + (copyIdx * baseCount | 0) | 0;
        var newId2 = node.id + ("_" + show6(copyIdx));
        return {
          group: node.group,
          id: newId2,
          index: newIndex,
  ...
  var offsetLink = function(copyIdx) {
    return function(baseCount) {
      return function(link) {
        return {
          value: link.value,
          source: link.source + (copyIdx * baseCount | 0) | 0,
          target: link.target + (copyIdx * baseCount | 0) | 0
        };
      };
    };
  };
  var scaleModel = function(n) {
    return function(model) {
      var baseNodeCount = length(model.nodes);
      var replicatedLinks = concat(mapWithIndex2(function(copyIdx) {
        return function(v) {
          return map16(offsetLink(copyIdx)(baseNodeCount))(model.links);
        };
      })(replicate2(n)(unit)));
      var replicatedNodes = concat(mapWithIndex2(function(copyIdx) {
        return function(v) {
          return map16(offsetNode(copyIdx)(baseNodeCount))(model.nodes);
        };
      })(replicate2(n)(unit)));
      return {
  ...
  var main = function __do() {
    log2("[LesMis Scale Test] Starting...")();
    log2("[LesMis Scale Test] Build: 2024-12-01 15:10 (scale=" + (show6(scaleFactor) + "x)"))();
    return launchAff_(bind7(get2(json)("/data/miserables.json"))(function(result) {
      if (result instanceof Left) {
        return liftEffect3(log2("[LesMis] Fetch error: " + printError(result.value0)));
      }
      ;
      if (result instanceof Right) {
        var v = decodeJson2(result.value0.body);
        if (v instanceof Left) {
          return liftEffect3(log2("[LesMis] Decode error: " + printJsonDecodeError(v.value0)));
        }
        ;
        if (v instanceof Right) {
          var baseModel = processRawModel(v.value0);
          var scaledModel = scaleModel(scaleFactor)(baseModel);
          return discard22(liftEffect3(log2("[LesMis] Base: " + (show6(length(baseModel.nodes)) + (" nodes, " + (show6(length(baseModel.links)) + " links"))))))(function() {
            return discard22(liftEffect3(log2("[LesMis] Scaled: " + (show6(length(scaledModel.nodes)) + (" nodes, " + (show6(length(scaledModel.links)) + " links"))))))(function() {
              return discard22(liftEffect3($$void5(initGUPDemo(scaledModel)("#app"))))(function() {
                return liftEffect3(log2("[LesMis] Demo initialized"));
              });
            });
          });
        }
        ;
        throw new Error("Failed pattern match at Main (line 32, column 9 - line 40, column 57): " + [v.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Main (line 29, column 5 - line 40, column 57): " + [result.constructor.name]);
    }))();
  };
