...
(() => {
  // output/Component.SpagoGridApp/foreign.js
  function showFlareContainer() {
    const container = document.getElementById("flare-tree-container");
    if (container) {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b10) {
        return apply1(map35($$const(identity2))(a2))(b10);
      };
    };
  };
  ...
  var eqTuple = function(dictEq) {
    ...
    return function(dictEq1) {
      ...
      return {
        eq: function(x3) {
          return function(y3) {
            return eq4(x3.value0)(y3.value0) && eq13(x3.value1)(y3.value1);
          };
        }
      };
    };
            ...
            return function(array4) {
              function go2(bot, top3) {
                switch (top3 - bot) {
                  ...
                  case 2:
                    return apply3(map35(array2)(f(array4[bot])))(f(array4[bot + 1]));
                  case 3:
                    return apply3(apply3(map35(array3)(f(array4[bot])))(f(array4[bot + 1])))(f(array4[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top3 - bot) / 4) * 2;
                    return apply3(map35(concat2)(go2(bot, pivot)))(go2(pivot, top3));
                }
              }
              ...
              if (rm instanceof Left) {
                return bind18(v1)(function(rn) {
                  ...
                  if (rn instanceof Left) {
                    return pure21(new Left(append10(rm.value0)(rn.value0)));
                  }
                  ;
      ...
      return function(f) {
        return function(ms) {
          return fold2(function(acc) {
            return function(k) {
              return function(v) {
                return apply3(map35(flip(insert(k)))(acc))(f(k)(v));
              };
            };
          })(pure110(empty2))(ms);
        };
  ...
  var caseJsonString = function(d4) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d4), $$const(d4), $$const(d4), f, $$const(d4), $$const(d4), j);
      };
    };
  };
  var caseJsonObject = function(d4) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d4), $$const(d4), $$const(d4), $$const(d4), $$const(d4), f, j);
      };
    };
  };
  var toObject = /* @__PURE__ */ toJsonType(caseJsonObject);
  var caseJsonNumber = function(d4) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d4), $$const(d4), f, $$const(d4), $$const(d4), $$const(d4), j);
      };
    };
  };
  var caseJsonArray = function(d4) {
    return function(f) {
      return function(j) {
        return _caseJson($$const(d4), $$const(d4), $$const(d4), $$const(d4), f, $$const(d4), j);
      };
    };
  };
  ...
  var foldableTree = {
    ...
    foldMap: function(dictMonoid) {
      ...
      return function(f) {
        return function(v) {
          return append16(f(v.value0))(foldMap12(foldMap(foldableTree)(dictMonoid)(f))(v.value1));
        };
      };
    }
  };
  ...
  var buildGraphModel = function(config) {
    return function(nodes) {
      return function(links) {
        ...
        var nodeIds = fromFoldable22(map13(config.getNodeId)(nodes));
        var nodeById = fromFoldable1(map13(function(n) {
    ...
    return function(reachableIds) {
      return function(node) {
        var withTreePos = (function() {
          ...
          if (v instanceof Just) {
            var radius4 = v.value0.y / 1e3 * 500;
            var angle = v.value0.x / 1e3 * 2 * pi - pi / 2;
            var cartX = radius4 * cos(angle);
            var cartY = radius4 * sin(angle);
            return {
  ...
  var getDependencyTree = /* @__PURE__ */ bind4(/* @__PURE__ */ fetchJson("/data/spago-data/modules.json"))(function(modulesResult) {
              ...
              return bind12(mapLeft(printJsonDecodeError)(decodeJson2(modulesJson)))(function(v) {
                return bind12(mapLeft(printJsonDecodeError)(decodeJson1(packagesJson)))(function(v1) {
                  return bind12(mapLeft(printJsonDecodeError)(decodeJson22(locJson)))(function(v2) {
                    ...
                    var packageNames = keys(v1);
                    var packageLocMap = buildPackageLocMap(v)(locMap);
                    ...
                    var moduleNames = keys(v);
                    var moduleIdMap = fromFoldable12(mapWithIndex2(function(i2) {
                      return function(n) {
                        return new Tuple(n, i2 + packageCount | 0);
                      };
                    })(moduleNames));
                    var targetsMap = buildTargetsMap(v)(moduleIdMap);
                    var sourcesMap = buildSourcesMap(targetsMap);
                    var moduleCount = length(moduleNames);
                    var moduleNodes = mapWithIndex2(function(i2) {
                      return function(name16) {
                        return mkModuleNode(name16)(i2)(v)(locMap)(packageIdMap)(moduleIdMap)(packageCount)(moduleCount)(packageNodes)(targetsMap)(sourcesMap);
                      };
                    })(moduleNames);
                    var nodesBeforeTree = append13(packageNodes)(moduleNodes);
                    var allModuleLinks = buildLinks(v)(moduleIdMap);
                    var rootId = findRootModule(moduleNodes);
                    var graphConfig = {
                      getNodeId: function(v3) {
                        return v3.id;
                      },
                      getLinkSource: function(v3) {
                        return v3.source;
                      },
                      getLinkTarget: function(v3) {
                        return v3.target;
                      }
                    };
                    ...
                    var idToName = fromFoldable24(mapWithIndex2(function(i2) {
                      return function(n) {
                        return new Tuple(i2 + packageCount | 0, n);
                      };
                    })(moduleNames));
                    var hierTree = mapTree(function(nodeId) {
                      var name16 = fromMaybe("node-" + show3(nodeId))(lookup4(nodeId)(idToName));
                      return {
                        name: name16,
                        value: 1,
                        x: 0,
        ...
        return function() {
          ...
          for (let i2 = 0; i2 < nodes.length; i2++) {
            ...
            if (predicate(original)) {
              ...
              const updated = transform4(original);
  ...
  function add_default(d4) {
    const x3 = +this._x.call(null, d4), y3 = +this._y.call(null, d4);
    return add3(this.cover(x3, y3), x3, y3, d4);
  }
  function add3(tree2, x3, y3, d4) {
    if (isNaN(x3) || isNaN(y3)) return tree2;
    var parent2, node = tree2._root, leaf = { data: d4 }, x0 = tree2._x0, y0 = tree2._y0, x13 = tree2._x1, y13 = tree2._y1, xm, ym, xp, yp, right, bottom3, i2, j;
  ...
  function addAll(data) {
    var d4, i2, n = data.length, x3, y3, xz = new Array(n), yz = new Array(n), x0 = Infinity, y0 = Infinity, x13 = -Infinity, y13 = -Infinity;
    for (i2 = 0; i2 < n; ++i2) {
      if (isNaN(x3 = +this._x.call(null, d4 = data[i2])) || isNaN(y3 = +this._y.call(null, d4))) continue;
      xz[i2] = x3;
      yz[i2] = y3;
      if (x3 < x0) x0 = x3;
      if (x3 > x13) x13 = x3;
  ...
  function find_default(x3, y3, radius4) {
    var data, x0 = this._x0, y0 = this._y0, x13, y13, x24, y24, x32 = this._x1, y32 = this._y1, quads = [], node = this._root, q2, i2;
    if (node) quads.push(new quad_default(node, x0, y0, x32, y32));
    if (radius4 == null) radius4 = Infinity;
    else {
      x0 = x3 - radius4, y0 = y3 - radius4;
      x32 = x3 + radius4, y32 = y3 + radius4;
      radius4 *= radius4;
    }
    while (q2 = quads.pop()) {
  ...
  function remove_default(d4) {
    if (isNaN(x3 = +this._x.call(null, d4)) || isNaN(y3 = +this._y.call(null, d4))) return this;
  ...
  function collide_default(radius4) {
    var nodes, radii, random2, strength = 1, iterations = 1;
    if (typeof radius4 !== "function") radius4 = constant_default(radius4 == null ? 1 : +radius4);
    function force2() {
    ...
    function initialize() {
      ...
      radii = new Array(n);
      for (i2 = 0; i2 < n; ++i2) node = nodes[i2], radii[node.index] = +radius4(node, i2, nodes);
    }
    ...
    force2.radius = function(_) {
      return arguments.length ? (radius4 = typeof _ === "function" ? _ : constant_default(+_), initialize(), force2) : radius4;
    };
    return force2;
  }
  ...
  function link_default(links) {
    ...
    function initialize() {
      if (!nodes) return;
      var i2, n = nodes.length, m = links.length, nodeById = new Map(nodes.map((d4, i3) => [id5(d4, i3, nodes), d4])), link3;
  ...
  function data_default2(value13, key) {
    ...
    for (var m = groups.length, update2 = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
      ...
      bind18(parent2, group4, enterGroup, updateGroup, exitGroup, data, key);
  ...
  function drag_default() {
    ...
    function mousedowned(event, d4) {
      if (touchending || !filter5.call(this, event, d4)) return;
    ...
    function touchstarted(event, d4) {
      if (!filter5.call(this, event, d4)) return;
      var touches = event.changedTouches, c = container.call(this, event, d4), n = touches.length, i2, gesture;
      for (i2 = 0; i2 < n; ++i2) {
        if (gesture = beforestart(this, c, event, d4, touches[i2].identifier, touches[i2])) {
          nopropagation(event);
  ...
  function createForceXGrid_(strength) {
    return x_default2().x((d4) => d4.gridX).strength(strength);
  }
  function createForceYGrid_(strength) {
    return y_default2().y((d4) => d4.gridY).strength(strength);
  }
  function createCollideGrid_(padding2) {
    return function(strength) {
      return function(iterations) {
        return collide_default().radius((d4) => d4.r + padding2).strength(strength).iterations(iterations);
      };
    };
  }
  ...
  var updateCirclePositions_ = (selector) => () => {
    select_default2(selector).selectAll("circle").attr("cx", (d4) => d4.x).attr("cy", (d4) => d4.y);
  };
  var updateLinkPositions_ = (selector) => () => {
    select_default2(selector).selectAll("line").attr("x1", (d4) => d4.source.x).attr("y1", (d4) => d4.source.y).attr("x2", (d4) => d4.target.x).attr("y2", (d4) => d4.target.y);
  };
  ...
  var capturePositions = function(nodes) {
    return fromFoldable11(map19(function(n) {
      return new Tuple(show4(n.id), {
        x: n.x,
        y: n.y
      });
    })(nodes));
    ...
    return function(stateRef) {
      return function(state3) {
        return function __do4() {
          ...
          log4("[Scene] Applied " + (show4(length(rules)) + " final rules"))();
  ...
  var recalculateGridPositions = function(nodes) {
    return function(packageCount) {
      ...
      var updateNode = function(node) {
        ...
        ;
        throw new Error("Failed pattern match at Viz.SpagoGridTest.GridLayout (line 54, column 23 - line 71, column 67): " + [node.nodeType.constructor.name]);
      };
      return map20(updateNode)(nodes);
    };
  };
  var calculateGridPositions = function(nodes) {
    return fromFoldable13(map20(function(n) {
  ...
  // output/Viz.SpagoGridTest.TreeLayout/index.js
  var show6 = /* @__PURE__ */ show(showInt);
  var fromFoldable14 = /* @__PURE__ */ fromFoldable2(foldableArray);
  var calculateTreePositions = function(nodes) {
    var getTreePosition = function(node) {
      if (node.nodeType instanceof ModuleNode) {
        return new Just(new Tuple(show6(node.id), {
          x: node.treeX,
          y: node.treeY
        }));
      }
      ...
      ;
      throw new Error("Failed pattern match at Viz.SpagoGridTest.TreeLayout (line 31, column 26 - line 37, column 14): " + [node.nodeType.constructor.name]);
    };
    return fromFoldable14(mapMaybe(getTreePosition)(nodes));
  };
  ...
  var tree4Layout = function(nodes) {
    ...
    return fromFoldable15(map21(getPosition)(nodes));
  };
  ...
  var tree5Scene = /* @__PURE__ */ (function() {
    return {
      name: "Tree5",
      initRules: [pinAllRule],
      layout: calculateTreePositions,
  ...
  var isTreeModule = function(n) {
    return eq3(n.nodeType)(ModuleNode.value) && n.isInTree;
  };
  var tree2Layout = function(nodes) {
    var getPosition = function(node) {
      var $27 = isTreeModule(node);
      if ($27) {
        return new Tuple(show7(node.id), {
          x: node.treeX,
          y: node.treeY
  ...
  var tree2Scene = /* @__PURE__ */ (function() {
    return {
      name: "Tree2",
      initRules: [pinAllRule],
      layout: tree2Layout,
  ...
  var tree4Scene = /* @__PURE__ */ (function() {
    return {
      name: "Tree4",
      initRules: [pinAllRule],
      layout: tree4Layout,
  ...
  var tree1Layout = function(nodes) {
    ...
    var packagePositions = fromFoldable15(map21(getPackageOrbitPos)(packages));
    var getNodeOrbitPos = function(pkgMap) {
      return function(node) {
        ...
        if (node.nodeType instanceof ModuleNode) {
          ...
          ;
          throw new Error("Failed pattern match at Engine.Scenes (line 173, column 9 - line 175, column 67): " + [v.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Engine.Scenes (line 167, column 35 - line 175, column 67): " + [node.nodeType.constructor.name]);
      };
    };
    var allPositions = map21(getNodeOrbitPos(packagePositions))(nodes);
    return fromFoldable15(allPositions);
  };
  var isModule = function(n) {
    return eq3(n.nodeType)(ModuleNode.value);
  };
  var tree1FinalRules = function(nodes) {
    var packages = filter(isPackage)(nodes);
    var getPackageOrbitPos = function(pkg) {
      var py = sin(pkg.orbitAngle) * orbitRadius;
      var px = cos(pkg.orbitAngle) * orbitRadius;
    ...
    var pkgOrbitMap = fromFoldable15(map21(getPackageOrbitPos)(packages));
    return [{
      ...
      apply: function(n) {
        ...
        ;
        throw new Error("Failed pattern match at Engine.Scenes (line 201, column 11 - line 208, column 35): " + [v.constructor.name]);
      }
    }];
  };
  var tree1Scene = /* @__PURE__ */ (function() {
    return {
      name: "Tree1",
      initRules: [pinAllRule],
      layout: tree1Layout,
  ...
  var tree3Scene = /* @__PURE__ */ (function() {
    return {
      name: "Tree3",
      initRules: [pinAllRule],
      layout: calculateTreePositions,
  ...
  var gridScene = /* @__PURE__ */ (function() {
    return {
      name: "Grid",
      initRules: [pinAllRule],
  ...
  function bisector(f) {
    ...
    if (f.length !== 2) {
      ...
      compare22 = (d4, x3) => ascending2(f(d4), x3);
      delta = (d4, x3) => f(d4) - x3;
    } else {
  ...
  function ordinal() {
    ...
    function scale(d4) {
      let i2 = index5.get(d4);
      if (i2 === void 0) {
        if (unknown !== implicit) return unknown;
        index5.set(d4, i2 = domain2.push(d4) - 1);
      }
  ...
  function nogamma(a2, b10) {
    var d4 = b10 - a2;
    return d4 ? linear(a2, d4) : constant_default4(isNaN(a2) ? b10 : a2);
  }
  ...
  function date_default(a2, b10) {
    ...
    return a2 = +a2, b10 = +b10, function(t) {
      return d4.setTime(a2 * (1 - t) + b10 * t), d4;
    };
  }
  ...
  function decompose_default(a2, b10, c, d4, e, f) {
    var scaleX, scaleY, skewX;
    if (scaleX = Math.sqrt(a2 * a2 + b10 * b10)) a2 /= scaleX, b10 /= scaleX;
    if (skewX = a2 * c + b10 * d4) c -= a2 * skewX, d4 -= b10 * skewX;
    if (scaleY = Math.sqrt(c * c + d4 * d4)) c /= scaleY, d4 /= scaleY, skewX /= scaleY;
    if (a2 * d4 < b10 * c) a2 = -a2, b10 = -b10, skewX = -skewX, scaleX = -scaleX;
    return {
      translateX: e,
      translateY: f,
  ...
  function transformer() {
    var domain2 = unit2, range5 = unit2, interpolate = value_default, transform4, untransform, unknown, clamp3 = identity13, piecewise, output2, input3;
    function rescale() {
    ...
    function scale(x3) {
      return x3 == null || isNaN(x3 = +x3) ? unknown : (output2 || (output2 = piecewise(domain2.map(transform4), range5, interpolate)))(transform4(clamp3(x3)));
    }
    scale.invert = function(y3) {
      return clamp3(untransform((input3 || (input3 = piecewise(range5, domain2.map(transform4), number_default)))(y3)));
    };
    scale.domain = function(_) {
  ...
  function formatPrefixAuto_default(x3, p2) {
    var d4 = formatDecimalParts(x3, p2);
    if (!d4) return x3 + "";
    var coefficient = d4[0], exponent2 = d4[1], i2 = exponent2 - (prefixExponent = Math.max(-8, Math.min(8, Math.floor(exponent2 / 3))) * 3) + 1, n = coefficient.length;
  ...
  var map22 = Array.prototype.map;
  var prefixes = ["y", "z", "a", "f", "p", "n", "\xB5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
  function locale_default(locale2) {
    var group4 = locale2.grouping === void 0 || locale2.thousands === void 0 ? identity_default : formatGroup_default(map22.call(locale2.grouping, Number), locale2.thousands + ""), currencyPrefix = locale2.currency === void 0 ? "" : locale2.currency[0] + "", currencySuffix = locale2.currency === void 0 ? "" : locale2.currency[1] + "", decimal = locale2.decimal === void 0 ? "." : locale2.decimal + "", numerals = locale2.numerals === void 0 ? identity_default : formatNumerals_default(map22.call(locale2.numerals, String)), percent = locale2.percent === void 0 ? "%" : locale2.percent + "", minus = locale2.minus === void 0 ? "\u2212" : locale2.minus + "", nan2 = locale2.nan === void 0 ? "NaN" : locale2.nan + "";
    function newFormat(specifier) {
      specifier = formatSpecifier(specifier);
      var fill4 = specifier.fill, align2 = specifier.align, sign2 = specifier.sign, symbol = specifier.symbol, zero4 = specifier.zero, width8 = specifier.width, comma = specifier.comma, precision = specifier.precision, trim2 = specifier.trim, type = specifier.type;
      ...
      function format2(value13) {
        ...
        var length9 = valuePrefix.length + value13.length + valueSuffix.length, padding2 = length9 < width8 ? new Array(width8 - length9 + 1).join(fill4) : "";
  ...
  function linearish(scale) {
    ...
    scale.ticks = function(count) {
      var d4 = domain2();
      return ticks(d4[0], d4[d4.length - 1], count == null ? 10 : count);
    };
    scale.tickFormat = function(count, specifier) {
      var d4 = domain2();
      return tickFormat(d4[0], d4[d4.length - 1], count == null ? 10 : count, specifier);
    };
  ...
  function loggish(transform4) {
    ...
    scale.tickFormat = (count, specifier) => {
      ...
      return (d4) => {
        let i2 = d4 / pows(Math.round(logs(d4)));
        if (i2 * base3 < base3 - 0.5) i2 *= base3;
        return i2 <= k ? specifier(d4) : "";
      };
    };
    scale.nice = () => {
  ...
  function powish(transform4) {
    var scale = transform4(identity13, identity13), exponent2 = 1;
    function rescale() {
      return exponent2 === 1 ? transform4(identity13, identity13) : exponent2 === 0.5 ? transform4(transformSqrt, transformSquare) : transform4(transformPow(exponent2), transformPow(1 / exponent2));
    }
  ...
  function zoom_default2() {
    ...
    function translate(transform4, p0, p1) {
      var x3 = p0[0] - p1[0] * transform4.k, y3 = p0[1] - p1[1] * transform4.k;
      return x3 === transform4.x && y3 === transform4.y ? transform4 : new Transform(transform4.k, x3, y3);
    }
  ...
  function attachClickWithDatum_(element3) {
    return (handler3) => () => {
      const selection2 = select_default2(element3);
      selection2.on("click", function(event, d4) {
        handler3(d4)();
      });
      selection2.style("cursor", "pointer");
      return element3;
  ...
  function attachMouseEnter_(element3) {
    return (handler3) => () => {
      const selection2 = select_default2(element3);
      selection2.on("mouseenter", function(event, d4) {
        handler3(d4)();
      });
      return element3;
    };
  ...
  function attachMouseLeave_(element3) {
    return (handler3) => () => {
      const selection2 = select_default2(element3);
      selection2.on("mouseleave", function(event, d4) {
        handler3(d4)();
      });
      return element3;
    };
      ...
      var applyBehavior = function(v1) {
        return function(v2) {
          ...
          if (v1 instanceof MouseMoveWithInfo) {
            return $$void5(attachMouseMoveWithEvent_(v2)(function(d4, evt) {
              return v1.value0({
                datum: d4,
          ...
          if (v1 instanceof MouseEnterWithInfo) {
            return $$void5(attachMouseEnterWithEvent_(v2)(function(d4, evt) {
              return v1.value0({
                datum: d4,
                clientX: toNumber(clientX(evt)),
                clientY: toNumber(clientY(evt)),
          ...
          if (v1 instanceof MouseLeaveWithInfo) {
            return $$void5(attachMouseLeaveWithEvent_(v2)(function(d4, evt) {
              return v1.value0({
                datum: d4,
                clientX: toNumber(clientX(evt)),
                clientY: toNumber(clientY(evt)),
  ...
  var joinDataWithKey = function(dictMonadEffect) {
    var liftEffect13 = liftEffect(dictMonadEffect);
    return function(dictFoldable) {
      var fromFoldable20 = fromFoldable(dictFoldable);
              ...
              return function(v) {
                return liftEffect13((function() {
                  ...
                  return function __do4() {
                    ...
                    liftEffect3(log7("joinDataWithKey: found " + (show10(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                    liftEffect3(log7("joinDataWithKey: " + (show10(length(mapMaybe(function(v2) {
                      return v2.datum;
                    })(oldBindings))) + " of those have data bound")))();
                    var validOldBindings = mapMaybe(function(v2) {
                      return mapFlipped1(v2.datum)(function(d4) {
                        return {
                          element: v2.element,
                          datum: d4
                        };
                    ...
                    var newDataArray = fromFoldable20(foldableData);
            ...
            return function(v) {
              return liftEffect13((function() {
                ...
                return function __do4() {
                  ...
                  liftEffect3(log7("joinData: found " + (show10(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                  liftEffect3(log7("joinData: " + (show10(length(mapMaybe(function(v2) {
                    return v2.datum;
                  })(oldBindings))) + " of those have data bound")))();
                  var validOldBindings = mapMaybe(function(v2) {
                    return mapFlipped1(v2.datum)(function(d4) {
      ...
      return function(v1) {
        if (v1 instanceof Node3) {
          return function __do4() {
            ...
            var combinedChildMap = foldl2(union4)(empty3)(map25(snd)(childMaps));
        ...
        if (v1 instanceof Join) {
          return function __do4() {
            ...
            liftEffect3((function() {
              ...
              return log7("Tree API Join '" + (v1.value0.name + ("': enter=" + (show10(enterCount) + (", update=" + (show10(updateCount) + (", exit=" + show10(exitCount))))))));
            })())();
        ...
        if (v1 instanceof NestedJoin) {
          return function __do4() {
            ...
            var elements = map25(fst)(elementsAndMaps);
            var childMaps = map25(snd)(elementsAndMaps);
        ...
        if (v1 instanceof SceneJoin) {
          return function __do4() {
            ...
            liftEffect3((function() {
              ...
              return log7("Tree API SceneJoin '" + (v1.value0.name + ("': enter=" + (show10(enterCount) + (", update=" + (show10(updateCount) + (", exit=" + show10(exitCount))))))));
            })())();
            (function() {
        ...
        if (v1 instanceof SceneNestedJoin) {
          ...
          return function __do4() {
            ...
            liftEffect3((function() {
              ...
              return log7("Tree API SceneNestedJoin '" + (v1.value0.name + ("': enter=" + (show10(enterCount) + (", update=" + (show10(updateCount) + (", exit=" + show10(exitCount))))))));
            })())();
            (function() {
              if (v1.value0.exitBehavior instanceof Just) {
                if (v1.value0.exitBehavior.value0.transition instanceof Just) {
          ...
          return function(attrs) {
            return function(emptySelection) {
              return liftEffect13((function() {
                ...
                var dataArray = fromFoldable20(foldableData);
                ...
                return function(enterAttrs) {
                  return function(updateAttrs) {
                    return function(exitAttrs) {
                      return bind18(joinData4(foldableData)(selector)(emptySelection))(function(v) {
                        return bind18(bind18(append42(elemType)([])(v.value0.enter))(function(bound) {
                          ...
                          return bind18((function() {
                            ...
                            return discard26((function() {
                              ...
                              if (exitAttrs instanceof Just) {
                                return bind18(applyPerDatumAttrs1(exitAttrs.value0)(v.value0.exit))(function() {
                                  return remove22(v.value0.exit);
                                });
                              }
                              ;
  ...
  var fromFoldable17 = /* @__PURE__ */ fromFoldable4(ordInt)(foldableArray);
  ...
  var setTreeSceneClass = function(shouldAdd) {
    return function __do4() {
      ...
      if (mElement instanceof Just) {
        ...
        return log8("[Explorer] Set tree-scene class: " + show14(shouldAdd))();
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 458, column 3 - line 465, column 77): " + [mElement.constructor.name]);
    };
  };
  ...
  var renderForceLinks = function(nodes) {
    return function(links) {
      ...
      return function __do4() {
        log8("[Explorer] Rendering " + (show15(length(treeLinks)) + " force links"))();
  ...
  var randomizeModulePositions = function(nodes) {
    var getPackagePos = function(n) {
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 202, column 21 - line 204, column 26): " + [n.nodeType.constructor.name]);
    };
    ...
    var randomizeIfModule = function(n) {
      ...
      if (n.nodeType instanceof ModuleNode) {
        return function __do4() {
          ...
          var v = (function() {
            ...
            ;
            throw new Error("Failed pattern match at Engine.Explorer (line 211, column 34 - line 213, column 42): " + [v1.constructor.name]);
          })();
      ...
      ;
      throw new Error("Failed pattern match at Engine.Explorer (line 206, column 25 - line 216, column 58): " + [n.nodeType.constructor.name]);
    };
  ...
  var nodeClass = function(n) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 321, column 15 - line 325, column 42): " + [n.nodeType.constructor.name]);
  };
  ...
  var renderTreeLinks = function(nodes) {
    return function __do4() {
      ...
      var treeLinks = filter(isTreeLink)(links);
      log8("[Explorer] Rendering " + (show15(length(treeLinks)) + " tree links"))();
      var nodeMap = fromFoldable17(map27(function(n) {
  ...
  var fixPackagePosition = function(node) {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 192, column 27 - line 194, column 21): " + [node.nodeType.constructor.name]);
  };
  var clearTreeLinks = function __do() {
    ...
    ;
    throw new Error("Failed pattern match at Engine.Explorer (line 441, column 3 - line 446, column 63): " + [mElement.constructor.name]);
  };
  var addTreeForces = function(nodes) {
    return function(links) {
      return function(sim) {
        var treeLinks = filter(isTreeLink)(links);
        return function __do4() {
          log8("[Explorer] Setting up force-directed tree with " + (show15(length(treeLinks)) + " links"))();
  ...
  var initWithModel = function(model) {
    return function(containerSelector) {
      return function __do4() {
        ...
        var nodesWithFix = map27(fixPackagePosition)(randomizedNodes);
        ...
        modify_2(function(v) {
          return {
            ...
            simulation: v.simulation,
            transition: v.transition,
            currentScene: new Just(gridScene)
          };
        })(stateRef)();
        return stateRef;
      };
    ...
    return launchAff_(discard22(log1("[Explorer] BUILD: 2025-12-02 15:00 - Tree4 with force links"))(function() {
      return discard22(log1("[Explorer] Loading data..."))(function() {
        return bind22(loadModel)(function(result) {
          ...
          ;
          if (result instanceof Right) {
            return discard22(liftEffect4(log8("[Explorer] Loaded: " + (show15(result.value0.moduleCount) + (" modules, " + (show15(result.value0.packageCount) + " packages"))))))(function() {
  ...
  var goToScene = function(sceneName) {
    return function(stateRef) {
      var mScene = (function() {
        if (sceneName === "Grid") {
          return new Just(gridScene);
        }
        ;
        if (sceneName === "Tree1") {
          return new Just(tree1Scene);
        }
        ;
        if (sceneName === "Tree2") {
          return new Just(tree2Scene);
        }
        ;
        if (sceneName === "Tree3") {
          return new Just(tree3Scene);
        }
        ;
        if (sceneName === "Tree4") {
          return new Just(tree4Scene);
        }
        ;
        if (sceneName === "Tree5") {
          return new Just(tree5Scene);
        }
        ;
        return Nothing.value;
      })();
      if (mScene instanceof Just) {
        return function __do4() {
          when3(sceneName === "Tree2")(function __do5() {
            var state3 = read(stateRef)();
            var nodes = getNodes(state3.simulation)();
            renderTreeLinks(nodes)();
            return setTreeSceneClass(true)();
          })();
          when3(sceneName === "Tree4")(function __do5() {
            var state3 = read(stateRef)();
            var nodes = getNodes(state3.simulation)();
            var links = read(globalLinksRef)();
            clearTreeLinks();
          ...
          when3(sceneName === "Grid" || sceneName === "Tree1")(function __do5() {
            var state3 = read(stateRef)();
            var nodes = getNodes(state3.simulation)();
    ...
    return function(v) {
      ...
      if (v instanceof Query) {
        return unCoyoneda(function(g) {
          var $45 = map29(maybe(v.value1(unit))(g));
          return function($46) {
  ...
  // output/Viz.FlareRadialTree/foreign.js
  ...
  // output/Viz.FlareRadialTree/index.js
  ...
  var fromFoldable19 = /* @__PURE__ */ fromFoldable(foldableTree);
  ...
  var d3 = /* @__PURE__ */ d(toAttrStringFunctionStrin);
  ...
  var cx3 = /* @__PURE__ */ cx(toAttrNumberFunctionNumbe);
  var cy3 = /* @__PURE__ */ cy(toAttrNumberFunctionNumbe);
  var radius3 = /* @__PURE__ */ radius(toAttrNumberFunctionNumbe);
  var discard23 = /* @__PURE__ */ discard4(bindAff);
  var log12 = /* @__PURE__ */ log2(monadEffectAff);
  ...
  var verticalLinkPathFn = function(link3) {
    return "M" + (show16(link3.source.x) + ("," + (show16(link3.source.y) + ("L" + (show16(link3.target.x) + ("," + show16(link3.target.y)))))));
  };
  ...
  var radialLinkPath2 = function(x13) {
    return function(y13) {
      return function(x24) {
        return function(y24) {
          var radius22 = sqrt(x24 * x24 + y24 * y24);
          ...
          var cp1x = midRadius * cos(angle1);
          var cp1y = midRadius * sin(angle1);
          return "M" + (show16(x13) + ("," + (show16(y13) + ("C" + (show16(cp1x) + ("," + (show16(cp1y) + (" " + (show16(cp2x) + ("," + (show16(cp2y) + (" " + (show16(x24) + ("," + show16(y24)))))))))))))));
        };
      };
    };
  };
  var projectRadial = function(w) {
    return function(h) {
      return function(v) {
        var projectedChildren = map30(projectRadial(w)(h))(v.value1);
  ...
  var makeLinks = function(tree$prime) {
    var makeLinksList = function(v) {
      var grandchildLinks = bind8(v.value1)(makeLinksList);
      var childLinks = bind8(v.value1)(function(v1) {
        return pure11({
          source: {
            x: v.value0.x,
            y: v.value0.y
      ...
      return append15(childLinks)(grandchildLinks);
    };
    return fromFoldable18(makeLinksList(tree$prime));
  };
  var renderVerticalTree = function(selector) {
    return function(inputTree) {
      return runD3v2M(bind14(select8(selector))(function(container) {
        var config = {
        ...
        var positioned = tree(config)(inputTree);
        var nodes = fromFoldable19(positioned);
        var links = makeLinks(positioned);
        return discard1(liftEffect5(log9("[FlareRadialTree] Vertical tree: " + (show17(length(nodes)) + (" nodes, " + (show17(length(links)) + " links"))))))(function() {
          return bind14(appendChild6(SVG.value)([viewBox3("0 0 " + (show16(2e3) + (" " + show16(800)))), class_4("vertical-tree")])(container))(function(svg) {
            return bind14(appendChild6(Group.value)([class_4("links")])(svg))(function(linksGroup) {
              return bind14(appendData5(Path.value)(links)([d3(verticalLinkPathFn), fill3($$const("none")), stroke3($$const("#999")), strokeWidth3($$const(1))])(linksGroup))(function() {
                return bind14(appendChild6(Group.value)([class_4("nodes")])(svg))(function(nodesGroup) {
                  return bind14(appendData5(Circle.value)(nodes)([cx3(function(v) {
                    return v.x;
                  }), cy3(function(v) {
                    return v.y;
                  }), radius3($$const(3)), fill3($$const("#69b3a2")), stroke3($$const("#fff")), strokeWidth3($$const(1.5))])(nodesGroup))(function() {
                    return liftEffect5(log9("[FlareRadialTree] Vertical tree render complete"));
                  });
                });
              });
            });
  ...
  var loadAndRenderDependencyTreeVertical = function(selector) {
    return launchAff_(discard23(log12("[FlareRadialTree] Loading dependency tree (vertical)..."))(function() {
      return bind23(getDependencyTree)(function(result) {
        if (result instanceof Left) {
          return liftEffect1(log9("[FlareRadialTree] Dependency tree error: " + result.value0));
        }
        ;
        if (result instanceof Right) {
          return liftEffect1(renderVerticalTree(selector)(result.value0));
        }
        ;
        throw new Error("Failed pattern match at Viz.FlareRadialTree (line 285, column 3 - line 287, column 70): " + [result.constructor.name]);
      });
    }));
  };
  var linkPathFn2 = function(link3) {
    return radialLinkPath2(link3.source.x)(link3.source.y)(link3.target.x)(link3.target.y);
  };
  var renderFlareRadialTree = function(selector) {
    return function(flareTree) {
      return runD3v2M(bind14(select8(selector))(function(container) {
        ...
        var radialTree = projectRadial(600)(600)(positioned);
        var nodes = fromFoldable19(radialTree);
        var links = makeLinks(radialTree);
        return discard1(liftEffect5(log9("[FlareRadialTree] Rendering: " + (show17(length(nodes)) + (" nodes, " + (show17(length(links)) + " links"))))))(function() {
          return bind14(appendChild6(SVG.value)([viewBox3("0 0 " + (show16(600) + (" " + show16(600)))), class_4("flare-radial-tree")])(container))(function(svg) {
            return bind14(appendChild6(Group.value)([transform3("translate(" + (show16(centerX) + ("," + (show16(centerY) + ")")))), class_4("chart-group")])(svg))(function(chartGroup) {
              return bind14(appendChild6(Group.value)([class_4("links")])(chartGroup))(function(linksGroup) {
                return bind14(appendData5(Path.value)(links)([d3(linkPathFn2), fill3(function(v) {
                  return "none";
                }), stroke3(function(v) {
                  return "#999";
                  ...
                  return bind14(appendChild6(Group.value)([class_4("nodes")])(chartGroup))(function(nodesGroup) {
                    return bind14(appendData5(Circle.value)(nodes)([cx3(function(v) {
                      return v.x;
                    }), cy3(function(v) {
                      return v.y;
                      ...
                      return liftEffect5(log9("[FlareRadialTree] Render complete"));
                    });
                  });
                });
              });
  ...
  var loadAndRenderDependencyTree = function(selector) {
    return launchAff_(discard23(log12("[FlareRadialTree] Loading dependency tree..."))(function() {
      return bind23(getDependencyTree)(function(result) {
        if (result instanceof Left) {
          return liftEffect1(log9("[FlareRadialTree] Dependency tree error: " + result.value0));
        }
        ;
        if (result instanceof Right) {
          return liftEffect1(renderFlareRadialTree(selector)(result.value0));
        }
        ;
        throw new Error("Failed pattern match at Viz.FlareRadialTree (line 220, column 3 - line 222, column 73): " + [result.constructor.name]);
      });
    }));
  };
  var getChildren = function($88) {
    return toMaybe(getChildren_($88));
  };
  var hierDataToTree = function(hierData) {
    var value13 = getValue(hierData);
    ...
    var childrenList = (function() {
      ...
      if (childrenMaybe instanceof Just) {
        return fromFoldable25(map111(hierDataToTree)(childrenMaybe.value0));
      }
      ;
      throw new Error("Failed pattern match at Viz.FlareRadialTree (line 58, column 20 - line 60, column 76): " + [childrenMaybe.constructor.name]);
    })();
    return new Node2({
      name: name16,
      value: value13,
  ...
  var loadFlareData = /* @__PURE__ */ discard23(/* @__PURE__ */ log12("[FlareRadialTree] Loading flare-2.json..."))(function() {
    return bind23(get2(string)("./data/flare-2.json"))(function(response) {
      if (response instanceof Left) {
        return pure13(new Left("Failed to load: " + printError(response.value0)));
      }
      ;
      if (response instanceof Right) {
        var hierData = parseFlareJson(response.value0.body);
        var tree$prime = hierDataToTree(hierData);
        return pure13(new Right(tree$prime));
      }
      ;
      throw new Error("Failed pattern match at Viz.FlareRadialTree (line 69, column 3 - line 74, column 25): " + [response.constructor.name]);
    });
  });
  var loadAndRenderFlareTree = function(selector) {
    return launchAff_(bind23(loadFlareData)(function(result) {
      if (result instanceof Left) {
        return liftEffect1(log9("[FlareRadialTree] Error: " + result.value0));
      }
      ;
      if (result instanceof Right) {
        return liftEffect1(renderFlareRadialTree(selector)(result.value0));
      ...
      ;
      throw new Error("Failed pattern match at Viz.FlareRadialTree (line 211, column 3 - line 213, column 77): " + [result.constructor.name]);
    }));
  };
  ...
  var GoToGrid = /* @__PURE__ */ (function() {
    function GoToGrid2() {
    }
    ;
    GoToGrid2.value = new GoToGrid2();
    return GoToGrid2;
  })();
  var GoToTree1 = /* @__PURE__ */ (function() {
    function GoToTree12() {
    }
    ;
    GoToTree12.value = new GoToTree12();
    return GoToTree12;
  })();
  var GoToTree2 = /* @__PURE__ */ (function() {
    function GoToTree22() {
    }
    ;
    GoToTree22.value = new GoToTree22();
    return GoToTree22;
  })();
  var GoToTree3 = /* @__PURE__ */ (function() {
    function GoToTree32() {
    }
    ;
    GoToTree32.value = new GoToTree32();
    return GoToTree32;
  })();
  var GoToTree4 = /* @__PURE__ */ (function() {
    function GoToTree42() {
    }
    ;
    GoToTree42.value = new GoToTree42();
    return GoToTree42;
  })();
  var ShowFlareTree = /* @__PURE__ */ (function() {
    function ShowFlareTree2() {
    }
    ;
    ShowFlareTree2.value = new ShowFlareTree2();
    return ShowFlareTree2;
  })();
  var ShowDependencyTree = /* @__PURE__ */ (function() {
    function ShowDependencyTree2() {
    }
    ;
    ShowDependencyTree2.value = new ShowDependencyTree2();
    return ShowDependencyTree2;
  })();
  var ShowVerticalTree = /* @__PURE__ */ (function() {
    function ShowVerticalTree2() {
    }
    ;
    ShowVerticalTree2.value = new ShowVerticalTree2();
    return ShowVerticalTree2;
  })();
  var render2 = function(v) {
    return div2([class_3("explorer-app"), style("width: 100%; height: 100%; position: relative;")])([div2([style("position: absolute; top: 10px; left: 10px; z-index: 100; display: flex; gap: 10px; align-items: center;")])([h1([style("margin: 0; font-size: 18px; color: #333;")])([text5("Code Explorer")]), button2([style("padding: 8px 16px; border: none; border-radius: 4px; background: #4a90d9; color: white; cursor: pointer; font-size: 14px;"), onClick(function(v1) {
      return GoToGrid.value;
    })])([text5("Grid")]), button2([style("padding: 8px 16px; border: none; border-radius: 4px; background: #4a90d9; color: white; cursor: pointer; font-size: 14px;"), onClick(function(v1) {
      return GoToTree1.value;
    })])([text5("Tree1")]), button2([style("padding: 8px 16px; border: none; border-radius: 4px; background: #4a90d9; color: white; cursor: pointer; font-size: 14px;"), onClick(function(v1) {
      return GoToTree2.value;
    })])([text5("Tree2")]), button2([style("padding: 8px 16px; border: none; border-radius: 4px; background: #4a90d9; color: white; cursor: pointer; font-size: 14px;"), onClick(function(v1) {
      return GoToTree3.value;
    })])([text5("Tree3")]), button2([style("padding: 8px 16px; border: none; border-radius: 4px; background: #9b4ad9; color: white; cursor: pointer; font-size: 14px;"), onClick(function(v1) {
      return GoToTree4.value;
    })])([text5("Tree4")]), button2([style("padding: 8px 16px; border: none; border-radius: 4px; background: #d94a90; color: white; cursor: pointer; font-size: 14px;"), onClick(function(v1) {
      return ShowFlareTree.value;
    })])([text5("Flare Test")]), button2([style("padding: 8px 16px; border: none; border-radius: 4px; background: #4ad990; color: white; cursor: pointer; font-size: 14px;"), onClick(function(v1) {
      return ShowDependencyTree.value;
    })])([text5("Dep Tree")]), button2([style("padding: 8px 16px; border: none; border-radius: 4px; background: #d9904a; color: white; cursor: pointer; font-size: 14px;"), onClick(function(v1) {
      return ShowVerticalTree.value;
    })])([text5("Vertical")])]), div2([id4("viz"), style("width: 100%; height: 100%;")])([]), div2([id4("flare-tree-container"), style("position: absolute; top: 60px; right: 10px; width: 620px; height: 620px; background: white; border: 2px solid #999; border-radius: 8px; display: none; z-index: 200;")])([])]);
  };
  var goToScene2 = function(dictMonadAff) {
    var monadEffectHalogenM2 = monadEffectHalogenM(dictMonadAff.MonadEffect0());
    var log13 = log2(monadEffectHalogenM2);
    var liftEffect11 = liftEffect(monadEffectHalogenM2);
    return function(sceneName) {
      return discard5(log13("[Explorer] " + (sceneName + " button clicked")))(function() {
        return liftEffect11(function __do4() {
          ...
          ;
          throw new Error("Failed pattern match at Component.SpagoGridApp (line 153, column 5 - line 155, column 51): " + [mRef.constructor.name]);
        });
      });
    };
  };
  var handleAction = function(dictMonadAff) {
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return discard5(log13("[Explorer] Initializing with new Scene Engine..."))(function() {
          return discard5(liftEffect11(initExplorer("#viz")))(function() {
      ...
      ;
      if (v instanceof GoToGrid) {
        return goToScene1("Grid");
      }
      ;
      if (v instanceof GoToTree1) {
        return goToScene1("Tree1");
      }
      ;
      if (v instanceof GoToTree2) {
        return goToScene1("Tree2");
      }
      ;
      if (v instanceof GoToTree3) {
        return goToScene1("Tree3");
      }
      ;
      if (v instanceof GoToTree4) {
        return goToScene1("Tree4");
      }
      ;
      if (v instanceof ShowFlareTree) {
        return discard5(log13("[Explorer] Showing Flare radial tree test..."))(function() {
          return discard5(liftEffect11(showFlareContainer))(function() {
            return liftEffect11(loadAndRenderFlareTree("#flare-tree-container"));
          });
        });
      }
      ;
      if (v instanceof ShowDependencyTree) {
        return discard5(log13("[Explorer] Showing dependency tree test..."))(function() {
          return discard5(liftEffect11(showFlareContainer))(function() {
            return liftEffect11(loadAndRenderDependencyTree("#flare-tree-container"));
          });
        });
      }
      ;
      if (v instanceof ShowVerticalTree) {
        return discard5(log13("[Explorer] Showing vertical tree for debugging..."))(function() {
          return discard5(liftEffect11(showFlareContainer))(function() {
            return liftEffect11(loadAndRenderDependencyTreeVertical("#flare-tree-container"));
          });
        });
      }
      ;
      throw new Error("Failed pattern match at Component.SpagoGridApp (line 121, column 16 - line 145, column 93): " + [v.constructor.name]);
    };
  };
  ...
  var queueOrRun = function(ref2) {
    return function(au) {
      return bind15(liftEffect7(read(ref2)))(function(v) {
        if (v instanceof Nothing) {
          return au;
        }
        ;
  ...
  var evalQ = function(render3) {
    return function(ref2) {
      return function(q2) {
        return bind15(liftEffect7(read(ref2)))(function(v) {
          return evalM(render3)(ref2)(v["component"]["eval"](new Query(map32(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
            ...
            if (v1 instanceof Subscribe) {
              return bind15(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind15(liftEffect7(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind15(liftEffect7(read(ref2)))(function(v2) {
                    return discard12(liftEffect7(modify_2(map210(insert10(sid)(finalize)))(v2.subscriptions)))(function() {
                ...
                return bind15(liftEffect7(read(ref2)))(function(v2) {
                  return bind15(liftEffect7($$new(false)))(function(doneRef) {
                    return bind15(fork3($$finally(liftEffect7(function __do4() {
                      ...
                      return discard12(liftEffect7(unlessM2(read(doneRef))(modify_2(insert12(fid)(fiber))(v2.forks))))(function() {
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind17(liftEffect9(map34(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
  ...
  var main2 = function __do3() {
    ...
    return runHalogenAff(bind11(selectElement("#app"))(function(mAppEl) {
      if (mAppEl instanceof Nothing) {
        return liftEffect10(log("[Main] ERROR: Could not find #app element!"));
      }
      ;
      if (mAppEl instanceof Just) {
        return discard25(liftEffect10(log("[Main] Found #app, mounting Halogen...")))(function() {
