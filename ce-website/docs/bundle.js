...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b10) {
        return apply1(map27($$const(identity2))(a2))(b10);
      };
    };
  };
              ...
              function go2(bot, top3) {
                switch (top3 - bot) {
                  case 0:
                    return pure18([]);
                  case 1:
                    return map27(array1)(f(array4[bot]));
                  case 2:
                    return apply3(map27(array2)(f(array4[bot])))(f(array4[bot + 1]));
                  case 3:
                    return apply3(apply3(map27(array3)(f(array4[bot])))(f(array4[bot + 1])))(f(array4[bot + 2]));
                  default:
      ...
      return function(f) {
        return function(ms) {
          return fold2(function(acc) {
            return function(k) {
              return function(v) {
                return apply3(map27(flip(insert2(k)))(acc))(f(k)(v));
              };
            };
          })(pure18(empty4))(ms);
        };
  ...
  function data_default2(value13, key) {
    ...
    for (var m = groups.length, update2 = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
      ...
      bind10(parent2, group4, enterGroup, updateGroup, exitGroup, data, key);
  ...
  var updateCirclePositions_ = (selector) => () => {
    select_default2(selector).selectAll("circle").attr("cx", (d) => d.x).attr("cy", (d) => d.y);
  };
  ...
  function pinNodesAtPositions_(positions) {
    return function(nodesRef) {
      return function() {
        const nodes = nodesRef.value;
        for (let i2 = 0; i2 < nodes.length; i2++) {
  ...
  var pinNodesAtPositions = function(positions) {
    return function(sim) {
      return pinNodesAtPositions_(positions)(sim.nodes);
    };
  };
              ...
              return function(v) {
                return liftEffect12((function() {
                  ...
                  return function __do3() {
                    ...
                    var newDataArray = fromFoldable11(foldableData);
          ...
          return function(attrs) {
            return function(emptySelection) {
              return liftEffect12((function() {
                ...
                var dataArray = fromFoldable11(foldableData);
  ...
  var calculateTreePositions = function(nodes) {
    ...
    var packagePositions = mapWithIndex3(function(i2) {
      return function(pkg) {
        ...
        return new Tuple(show6(pkg.id), {
          x: x2,
          y: y2
        });
      };
    })(packages);
    var packagePosMap = fromFoldable9(packagePositions);
    var modulePositions = mapMaybe(function(n) {
      var $9 = eq4(n.nodeType)(ModuleNode.value);
      if ($9) {
        var v = lookup2(show6(n.cluster))(packagePosMap);
        if (v instanceof Just) {
          var offsetDist = 50 + toNumber(mod5(n.id)(100)) * 0.5;
          ...
          return new Just(new Tuple(show6(n.id), {
            x: mx,
            y: my
          }));
        }
        ...
        ;
        throw new Error("Failed pattern match at Viz.SpagoGridTest.TreeLayout (line 45, column 14 - line 53, column 29): " + [v.constructor.name]);
      }
      ;
      return Nothing.value;
    })(nodes);
    return fromFoldable9(append8(packagePositions)(modulePositions));
  };
  ...
  var show14 = /* @__PURE__ */ show(showScene);
  ...
  var pure12 = /* @__PURE__ */ pure(applicativeD3v2M);
  ...
  var eqObject2 = /* @__PURE__ */ eqObject(/* @__PURE__ */ eqRec2(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons2({
    reflectSymbol: function() {
      return "y";
    }
  })(eqNumber))()({
  ...
  var randomizeModulePositions = function(nodes) {
    var getPackagePos = function(n) {
      if (n.nodeType instanceof PackageNode) {
        return new Just(new Tuple(show7(n.id), {
          x: n.gridX,
          y: n.gridY
        }));
      }
    ...
    var randomizeIfModule = function(n) {
      ...
      if (n.nodeType instanceof ModuleNode) {
        return function __do3() {
          ...
          var ry = random();
          var v = (function() {
            var v1 = lookup2(show7(n.cluster))(packagePositions);
            if (v1 instanceof Just) {
              return v1.value0;
            }
            ;
  ...
  var nodesGroupId = "#spago-test-nodes";
    ...
    return function __do3() {
      ...
      (function() {
        ...
        if (state3.transition instanceof Just) {
          ...
          var $97 = newProgress >= 1;
          if ($97) {
            log7("[Explorer] Transition complete: " + show14(state3.transition.value0.targetScene))();
            (function() {
              if (state3.transition.value0.targetScene instanceof Grid) {
                updatePositionsInPlace(state3.transition.value0.targetPositions)(state3.simulation)();
                return unpinNodesInPlace(state3.simulation)();
              }
              ;
              return pinNodesAtPositions(state3.transition.value0.targetPositions)(state3.simulation)();
            })();
            return write({
          ...
          interpolatePositionsInPlace(state3.transition.value0.startPositions)(state3.transition.value0.targetPositions)(easedProgress)(state3.simulation)();
          return write({
  ...
  var renderSVG = function(containerSelector) {
    return function(nodes) {
      return bind13(select7(containerSelector))(function(container) {
        return bind13(appendChild5(SVG.value)([viewBox2(show23(-viewBoxWidth / 2) + (" " + (show23(-viewBoxHeight / 2) + (" " + (show23(viewBoxWidth) + (" " + show23(viewBoxHeight))))))), id_2("spago-test-svg"), class_3("ce-viz")])(container))(function(svg) {
          return bind13(appendChild5(Group.value)([id_2("spago-test-zoom-group")])(svg))(function(zoomGroup) {
            return bind13(appendChild5(Group.value)([id_2("spago-test-links")])(zoomGroup))(function() {
              return bind13(appendChild5(Group.value)([id_2("spago-test-nodes")])(zoomGroup))(function(nodesGroup) {
                return bind13(appendData4(Circle.value)(nodes)([cx2(function(v) {
                  ...
                  return bind13(on4(new Zoom(defaultZoom(new ScaleExtent(0.1, 10))("#spago-test-zoom-group")))(svg))(function() {
                    return pure12({
                      nodeSel
                    });
                  });
  ...
  var initWithModel = function(model) {
    return function(containerSelector) {
      return function __do3() {
        log7("[Explorer] BUILD: Using library Sim.interpolatePositionsInPlace for fast transitions")();
        ...
        var nodesWithFix = map21(fixPackagePosition)(randomizedNodes);
        log7("[SpagoGridTest] Nodes prepared: " + show7(length(nodesWithFix)))();
  ...
  var initSpagoGridTest = function(containerSelector) {
    return launchAff_(discard22(log1("[Explorer] Loading spago data..."))(function() {
      return bind22(loadModel)(function(result) {
        ...
        ;
        if (result instanceof Right) {
          return discard22(liftEffect4(log7("[Explorer] Loaded: " + (show7(result.value0.moduleCount) + (" modules, " + (show7(result.value0.packageCount) + " packages"))))))(function() {
  ...
  var transitionToScene = function(targetScene) {
    return function(stateRef) {
      return function __do3() {
        var state3 = read(stateRef)();
        return when3(notEq2(state3.currentScene)(targetScene) && eq5(state3.transition)(Nothing.value))(function __do4() {
          log7("[Explorer] Starting transition: " + (show14(state3.currentScene) + (" \u2192 " + show14(targetScene))))();
          var nodes = getNodes(state3.simulation)();
          var startPositions = fromFoldable10(map21(function(n) {
          ...
          pinNodesInPlace(state3.simulation)();
          write({
            currentScene: state3.currentScene,
            simulation: state3.simulation,
            transition: new Just({
  ...
  var selectElement = function(query2) {
    return bind7(liftEffect5(bindFlipped5(composeKleisliFlipped4((function() {
            ...
            if (v1 instanceof Subscribe) {
              return bind14(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind14(liftEffect6(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind14(liftEffect6(read(ref2)))(function(v2) {
                    return discard1(liftEffect6(modify_2(map24(insert9(sid)(finalize)))(v2.subscriptions)))(function() {
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind16(liftEffect8(map26(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
  ...
  var main2 = function __do2() {
    ...
    return runHalogenAff(bind9(selectElement("#app"))(function(mAppEl) {
      ...
      if (mAppEl instanceof Just) {
        return discard24(liftEffect9(log("[Main] Found #app, mounting Halogen...")))(function() {
          return bind9(runUI2(component2)(unit)(mAppEl.value0))(function() {
            return pure17(unit);
          });
        });
      }
