...
render _ =
  HH.div
    ...
    [ renderHeader "Creating Axes and Scales"
    ...
    , HH.main_
        [ HH.section
            ...
            , HH.p_
                [ HH.text "How to set up scales and generate axes for charts." ]
            ]
        ...
        , HH.section
            ...
            , HH.ul_
                [ HH.li_ [ HH.text "Setting up linear, ordinal, and time scales" ]
                , HH.li_ [ HH.text "Generating axes with d3-axis" ]
                , HH.li_ [ HH.text "Formatting tick labels" ]
                , HH.li_ [ HH.text "Responsive axes that resize" ]
                , HH.li_ [ HH.text "Custom tick values" ]
                ]
            ]
        ]
    ]
