  ...
  HH.div
    ...
    , HH.main_
        [ HH.section
            ...
            , HH.p_
                [ HH.text "How to make visualizations interactive with click, hover, and other events." ]
            ]
        ...
        , HH.section
            ...
            , HH.ul_
                [ HH.li_ [ HH.text "Click handlers on elements" ]
                , HH.li_ [ HH.text "Hover effects and highlights" ]
                , HH.li_ [ HH.text "Mouse position for tooltips" ]
                , HH.li_ [ HH.text "Keyboard events" ]
                , HH.li_ [ HH.text "Event delegation with selections" ]
                ]
            ]
        ]
    ]
