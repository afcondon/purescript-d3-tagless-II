    ...
    , HH.main_
        [ HH.section
            ...
            [ HH.h1
                ...
                [ HH.text "Adding Tooltips" ]
            , HH.p_
                [ HH.text "How to add informative tooltips that appear on hover." ]
            ]
        ...
        , HH.section
            ...
            , HH.ul_
                [ HH.li_ [ HH.text "Basic tooltip div approach" ]
                , HH.li_ [ HH.text "Positioning relative to mouse/element" ]
                , HH.li_ [ HH.text "Showing/hiding on hover" ]
                , HH.li_ [ HH.text "Formatting data in tooltips" ]
                , HH.li_ [ HH.text "Styling and theming" ]
                ]
            ]
        ]
    ]
