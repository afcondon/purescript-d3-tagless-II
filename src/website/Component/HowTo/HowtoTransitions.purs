  ...
  HH.div
    ...
    , HH.main_
        [ HH.section
            ...
            , HH.p_
                [ HH.text "How to create smooth, animated transitions between visualization states." ]
            ]
        ...
        , HH.section
            ...
            , HH.ul_
                [ HH.li_ [ HH.text "Setting up TransitionConfig (duration, easing, delay)" ]
                , HH.li_ [ HH.text "Enter transitions for new elements" ]
                , HH.li_ [ HH.text "Update transitions for changing data" ]
                , HH.li_ [ HH.text "Exit transitions for removed elements" ]
                , HH.li_ [ HH.text "Staggering animations with index-based delays" ]
                , HH.li_ [ HH.text "Chaining transitions for multi-step animations" ]
                ]
            ]
        ]
    ]
