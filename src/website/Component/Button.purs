...
-- |
-- | Currently used button variants (others retained for potential future use):
-- | - buttonPrimaryLeft, buttonPrimaryCenter, buttonPrimaryRight
-- | - buttonLeft, buttonCenter, buttonRight
module PSD3.Component.Button where
...
import PSD3.Component.Properties ((<&>))
...
centerVerticalClasses :: Array HH.ClassName
centerVerticalClasses = HH.ClassName <$>
  [ "w-11/12"
  , "rounded"
  , "m-2"
  ]
...
buttonVertical
  ...
  -> HH.HTML p i
buttonVertical =
  buttonGroupBuilder $ buttonClasses <> centerVerticalClasses
