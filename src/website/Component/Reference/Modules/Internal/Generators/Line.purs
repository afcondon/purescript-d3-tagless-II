module PSD3.Reference.Modules.Internal.Generators.Line where
...
-- | PSD3.Internal.Generators.Line module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Internal.Generators.Line" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Line and area generators" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Internal/Generators/Line.purs"
