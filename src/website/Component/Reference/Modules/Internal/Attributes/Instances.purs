module PSD3.Reference.Modules.Internal.Attributes.Instances where
...
-- | PSD3.Internal.Attributes.Instances module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Internal.Attributes.Instances" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Type class instances for attributes" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Internal/Attributes/Instances.purs"
