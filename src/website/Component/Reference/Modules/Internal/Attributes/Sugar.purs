module PSD3.Reference.Modules.Internal.Attributes.Sugar where
...
-- | PSD3.Internal.Attributes.Sugar module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Internal.Attributes.Sugar" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Syntactic sugar for attributes" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Internal/Attributes/Sugar.purs"
