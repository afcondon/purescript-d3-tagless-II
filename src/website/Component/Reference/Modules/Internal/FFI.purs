module PSD3.Reference.Modules.Internal.FFI where
...
-- | PSD3.Internal.FFI module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Internal.FFI" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Foreign function interface to D3.js" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Internal/FFI.purs"
