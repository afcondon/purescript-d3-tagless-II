module PSD3.Reference.Modules.Internal.Simulation.Functions where
...
-- | PSD3.Internal.Simulation.Functions module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Internal.Simulation.Functions" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Simulation implementation functions" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Internal/Simulation/Functions.purs"
