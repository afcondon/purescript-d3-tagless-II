module PSD3.Reference.Modules.Interpreter.MetaTree where
...
-- | PSD3.Interpreter.MetaTree module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Interpreter.MetaTree" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "MetaTree interpreter - produces AST representation" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Interpreter/MetaTree.purs"
