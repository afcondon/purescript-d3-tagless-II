module PSD3.Reference.Modules.Capabilities.Sankey where
...
-- | PSD3.Capabilities.Sankey module viewer
    ...
    [ -- Module header
      HH.section
        ...
        [ HH.h1
            ...
            [ HH.text "PSD3.Capabilities.Sankey" ]
        , HH.p
            [ HP.classes [ HH.ClassName "module-page__description" ] ]
            [ HH.text "Sankey diagram layout capabilities" ]
        ]
...
handleAction = case _ of
  Initialize -> do
    -- Load source file
    result <- H.liftAff $ loadSourceFile "PSD3/Capabilities/Sankey.purs"
