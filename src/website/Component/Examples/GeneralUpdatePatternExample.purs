module PSD3.Examples.GeneralUpdatePattern where
...
handleAction = case _ of
  Initialize -> do
    log "GeneralUpdatePatternExample: Drawing"
    _ <- H.liftEffect $ eval_D3M $ GUP.exGeneralUpdatePattern "#general-update-pattern-viz"
    log "GeneralUpdatePatternExample: Complete"
    pure unit
...
render _ =
  HH.div
    ...
    [ HH.header
        ...
        , HH.p_ [ HH.text "Enter, update, exit pattern visualization demonstrating D3's data join." ]
        ]
    , HH.section
        [ HP.classes [ HH.ClassName "example-viz-section" ] ]
        [ HH.h2_ [ HH.text "Visualization" ]
        , HH.div
            [ HP.id "general-update-pattern-viz"
