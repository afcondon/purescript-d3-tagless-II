module PSD3.Examples.ThreeLittleCircles where
...
handleAction = case _ of
  Initialize -> do
    log "ThreeLittleCirclesExample: Initialize"
    _ <- H.liftEffect $ eval_D3M $ Circles.drawThreeCircles "#three-circles-viz"
    log "ThreeLittleCirclesExample: Complete"
    pure unit
  ...
  HH.div
    ...
    [ HH.header
        ...
        , HH.p
            ...
            [ HH.text "The simplest possible D3 example - three colored circles positioned using SVG coordinates. This demonstrates the fundamental building blocks of D3 visualizations." ]
        ]
    , HH.section
    ...
    , HH.section
        ...
        , HH.p_
            [ HH.text "Full source: "
            , HH.code_ [ HH.text "src/website/Viz/ThreeLittleCircles/ThreeLittleCircles.purs" ]
            ]
        ]
    ]
