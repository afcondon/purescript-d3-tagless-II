module PSD3.Examples.ChordDiagram where
...
handleAction = case _ of
  Initialize -> do
    log "ChordDiagramExample: Initialize"
    _ <- H.liftEffect $ eval_D3M $ Chord.draw Chord.exampleMatrix Chord.exampleLabels "#chord-diagram-viz"
    log "ChordDiagramExample: Complete"
    pure unit
...
render _ =
  HH.div
    ...
    [ HH.header
        ...
        , HH.h1_ [ HH.text "Chord Diagram" ]
        , HH.p_ [ HH.text "Circular flow diagram showing relationships between entities." ]
        ]
    , HH.section
        [ HP.classes [ HH.ClassName "example-viz-section" ] ]
        [ HH.h2_ [ HH.text "Visualization" ]
        , HH.div
            [ HP.id "chord-diagram-viz"
