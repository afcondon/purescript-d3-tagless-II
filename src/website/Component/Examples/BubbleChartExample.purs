module PSD3.Examples.BubbleChart where
...
render _ =
  HH.div
    ...
    [ HH.header
        ...
        , HH.h1_ [ HH.text "Bubble Chart" ]
        , HH.p_ [ HH.text "Scatter plot with sized bubbles representing a third dimension of data." ]
        ]
    , HH.section
        [ HP.classes [ HH.ClassName "example-viz-section" ] ]
        [ HH.h2_ [ HH.text "Visualization" ]
        , HH.div
            [ HP.id "bubble-chart-viz"
