...
component = H.mkComponent
  ...
  render state =  
      HH.div [ HP.id "d3story-overlay", HP.classes [ HH.ClassName "metatree" ] ]
      [ HH.div [ HP.id "meta" ] [] -- the div where the d3 script will appear

      , HH.div [ HP.id "blurb" ] 
        [ HH.h1_ [ HH.text $ "Meta Tree" ] -- : a tree generated by first interpreting one << D3 script>>, then drawn using another <<script>>
