...
foreign import data TreeJson_ :: Type -> Type
...
makeD3TreeJSONFromTreeID :: forall id. Tree id -> TreeJson_ id
...
foreign import idTreeLeaf_   :: forall d id. id -> TreeJson_ d
foreign import idTreeParent_ :: forall d id. id -> Array (TreeJson_ d) -> TreeJson_ d
