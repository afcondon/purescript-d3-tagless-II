...
(() => {
  ...
  var unsafeCompareImpl = function(lt) {
    return function(eq9) {
      return function(gt) {
        return function(x23) {
          return function(y20) {
            return x23 < y20 ? lt : x23 === y20 ? eq9 : gt;
          };
        };
      };
    };
  ...
  var intAdd = function(x23) {
    return function(y20) {
      return x23 + y20 | 0;
    };
  };
  var intMul = function(x23) {
    return function(y20) {
      return x23 * y20 | 0;
    };
  };
  ...
  var intDegree = function(x23) {
    return Math.min(Math.abs(x23), 2147483647);
  };
  var intDiv = function(x23) {
    return function(y20) {
      if (y20 === 0) return 0;
      return y20 > 0 ? Math.floor(x23 / y20) : -Math.floor(x23 / -y20);
    };
  };
  var intMod = function(x23) {
    return function(y20) {
      if (y20 === 0) return 0;
      var yy = Math.abs(y20);
      return (x23 % yy + yy) % yy;
  ...
  var eqTuple = function(dictEq) {
    ...
    return function(dictEq1) {
      ...
      return {
        eq: function(x23) {
          return function(y20) {
            return eq9(x23.value0)(y20.value0) && eq14(x23.value1)(y20.value1);
          };
        }
      };
    };
  ...
  var ordTuple = function(dictOrd) {
    ...
    return function(dictOrd1) {
      ...
      return {
        compare: function(x23) {
          return function(y20) {
            var v = compare3(x23.value0)(y20.value0);
            if (v instanceof LT) {
              return LT.value;
            }
            ;
            ...
            ;
            return compare12(x23.value1)(y20.value1);
          };
        },
        Eq0: function() {
          return eqTuple2;
  ...
  function _trace(x23, k) {
    if (util !== void 0) {
      console.log(util.inspect(x23, { depth: null, colors: true }));
    } else {
      console.log(x23);
    }
    return k({});
  }
  function _spy(tag, x23) {
    if (util !== void 0) {
      console.log(tag + ":", util.inspect(x23, { depth: null, colors: true }));
    } else {
      console.log(tag + ":", x23);
    }
    return x23;
              ...
              if (rm instanceof Left) {
                return bind32(v1)(function(rn) {
                  ...
                  if (rn instanceof Left) {
                    return pure39(new Left(append20(rm.value0)(rn.value0)));
                  }
                  ;
  ...
  var unsafeCoerce2 = function(x23) {
    return x23;
  };
  ...
  var foldMapDefaultR = function(dictFoldable) {
    ...
    return function(dictMonoid) {
      ...
      var mempty2 = mempty(dictMonoid);
      return function(f) {
        return foldr22(function(x23) {
          return function(acc) {
            return append20(f(x23))(acc);
          };
        })(mempty2);
      };
    };
            ...
            return function(array4) {
              function go2(bot, top5) {
                switch (top5 - bot) {
                  ...
                  case 2:
                    return apply6(map54(array2)(f(array4[bot])))(f(array4[bot + 1]));
                  case 3:
                    return apply6(apply6(map54(array3)(f(array4[bot])))(f(array4[bot + 1])))(f(array4[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top5 - bot) / 4) * 2;
                    return apply6(map54(concat2)(go2(bot, pivot)))(go2(pivot, top5));
                }
              }
  ...
  var monadTransStateT = {
    lift: function(dictMonad) {
      ...
      return function(m) {
        return function(s) {
          return bind32(m)(function(x23) {
            return pure39(new Tuple(x23, s));
          });
        };
      };
    }
  ...
  var fromElement = function(x23) {
    return _read(Nothing.value, Just.create, x23);
  };
  ...
  var foldableWithIndexArray = {
    foldrWithIndex: function(f) {
      return function(z) {
        var $291 = foldr8(function(v) {
          return function(y20) {
            return f(v.value0)(v.value1)(y20);
          };
        })(z);
    ...
    foldlWithIndex: function(f) {
      return function(z) {
        var $294 = foldl8(function(y20) {
          return function(v) {
            return f(v.value0)(y20)(v.value1);
          };
        })(z);
  ...
  var sortByImpl = /* @__PURE__ */ (function() {
    function mergeFromTo(compare3, fromOrdering, xs1, xs2, from2, to2) {
      ...
      if (to2 - mid > 1) mergeFromTo(compare3, fromOrdering, xs2, xs1, mid, to2);
      i2 = from2;
      j = mid;
      k = from2;
      while (i2 < mid && j < to2) {
        x23 = xs2[i2];
        y20 = xs2[j];
        c = fromOrdering(compare3(x23)(y20));
        if (c > 0) {
          xs1[k++] = y20;
          ++j;
        } else {
  ...
  var uncons = /* @__PURE__ */ (function() {
    return unconsImpl($$const(Nothing.value))(function(x23) {
      return function(xs) {
        return new Just({
          head: x23,
          tail: xs
      ...
      return (function __do4() {
        ...
        foreach(xs)(function(x23) {
          return function __do5() {
            ...
            return when2(e)($$void6(push(x23)(arr)))();
          };
        })();
  ...
  var nubBy = function(comp) {
    return function(xs) {
      var indexedAndSorted = sortBy(function(x23) {
        return function(y20) {
          return comp(snd(x23))(snd(y20));
        };
  ...
  var groupBy = function(op) {
    return function(xs) {
      return (function __do4() {
        ...
        iterate(iter)(function(x23) {
          return $$void6(function __do5() {
            var sub1 = newSTArray();
            push(x23)(sub1)();
            pushWhile(op(x23))(iter)(sub1)();
  ...
  var cons3 = function(x23) {
    return function(xs) {
      return append2([x23])(xs);
    };
  };
  ...
  var unsafeClamp = function(x23) {
    if (!isFiniteImpl(x23)) {
      return 0;
    }
    ;
    if (x23 >= toNumber(top3)) {
      return top3;
    }
    ;
    if (x23 <= toNumber(bottom3)) {
      return bottom3;
    }
    ;
    if (otherwise) {
      return fromMaybe(0)(fromNumber(x23));
    }
    ;
    throw new Error("Failed pattern match at Data.Int (line 72, column 1 - line 72, column 29): " + [x23.constructor.name]);
  };
  ...
  var cons4 = function(y20) {
    return function(v) {
      return new NonEmpty(y20, new Cons(v.value0, v.value1));
    };
  };
    ...
    return function(tag) {
      return function(value16) {
        if (tagOf(value16) === tag) {
          return pure113(unsafeFromForeign(value16));
        }
        ;
        if (otherwise) {
    ...
    return function(k) {
      var go2 = function(f) {
        ...
        if (v instanceof Return) {
          return map117(Done.create)(pure113(v.value0));
        }
        ;
  ...
  var SubscriptionId = function(x23) {
    return x23;
  };
  var ForkId = function(x23) {
    return x23;
  };
  ...
  var evalQ = function(render19) {
    return function(ref2) {
      return function(q2) {
        return bind12(liftEffect4(read(ref2)))(function(v) {
          return evalM(render19)(ref2)(v["component"]["eval"](new Query(map20(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
  var evalM = function(render19) {
                ...
                var evalChild = function(v3) {
                  return parallel2(bind12(liftEffect4(read(v3)))(function(dsx) {
                    return unDriverStateX(function(ds) {
                      return evalQ(render19)(ds.selfRef)(v2.value1);
                    })(dsx);
                  }));
                };
              ...
              return bind12(liftEffect4(read(ref2)))(function(v2) {
                ...
                if (otherwise) {
                  return discard1(liftEffect4(write({
                    ...
                    return discard1(handleLifecycle(v2.lifecycleHandlers)(render19(v2.lifecycleHandlers)(ref2)))(function() {
                      return pure8(v3.value0);
                    });
                  });
                }
            ...
            if (v1 instanceof Subscribe) {
              return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind12(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                  return handleAff(evalF(render19)(ref2)(new Action(act)));
                })))(function(finalize) {
                  return bind12(liftEffect4(read(ref2)))(function(v2) {
              ...
              return bind12(fresh(ForkId)(ref2))(function(fid) {
                return bind12(liftEffect4(read(ref2)))(function(v2) {
                  return bind12(liftEffect4($$new(false)))(function(doneRef) {
                    ...
                    }))(evalM(render19)(ref2)(v1.value0))))(function(fiber) {
    ...
    return function(ref2) {
      return function(v) {
        ...
        if (v instanceof Action) {
          return bind12(liftEffect4(read(ref2)))(function(v1) {
            return evalM(render19)(ref2)(v1["component"]["eval"](new Action2(v.value0, unit)));
          });
        }
        ;
      ...
      return function(i2) {
        var squashChildInitializers = function(lchs) {
          return function(preInits) {
            return unDriverStateX(function(st) {
              var parentInitializer = evalM(render19)(st.selfRef)(st["component"]["eval"](new Initialize(unit)));
                      ...
                      if (childrenIn instanceof Just) {
                        ...
                        unDriverStateX(function(st) {
                          return function __do5() {
                            ...
                            return handleAff(evalM(render19)(st.selfRef)(st["component"]["eval"](new Receive(slot.input, unit))))();
                          };
                        })(dsx)();
          ...
          return function($$var2) {
            return function __do4() {
              ...
              var handler3 = (function() {
                ...
                var $70 = evalF(render19)(v.selfRef);
                return function($71) {
        ...
        var finalize = function(lchs) {
          return unDriverStateX(function(st) {
            return function __do4() {
              ...
              var f = evalM(render19)(st.selfRef)(st["component"]["eval"](new Finalize(unit)));
  ...
  var renderSpec = function(document3) {
    return function(container) {
      var render19 = function(handler3) {
    ...
    return function(i2) {
      return function(element3) {
        return bind14(liftEffect6(map25(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
          return runUI(renderSpec(document3)(element3))(component18)(i2);
        });
      };
    };
  };
  ...
  function d3SortSelection_(selection2) {
    return (compare3) => selection2.sort(compare3);
  }
  ...
  function d3PreserveSimulationPositions_(selection2) {
    return (nodedata) => (keyFn) => {
      const oldNodeMap = new Map(selection2.data().map((d9) => [keyFn(d9), d9]));
      const newNodeMap = new Map(nodedata.map((d9) => [keyFn(d9), d9]));
      console.log(`FFI: d3PreserveSimulationPositions_ given ${nodedata.length} nodes, in selection ${selection2.data().length}`);
      let updatedNodeData = nodedata.map((d9) => {
        let id5 = keyFn(d9);
        ...
        return Object.assign(oldNodeMap.get(id5) || d9, shell);
      });
  ...
  function d3PreserveLinkReferences_(link4) {
    return (links) => {
      const old = new Map(link4.data().map((d9) => [getLinkID_(d9), d9]));
      let updatedLinkData = links.map((d9) => Object.assign(old.get(getLinkID_(d9)) || d9, {}));
  ...
  function treeSortForTree_Spago(root3) {
    return root3.sum(function(d9) {
      return d9.value;
    }).sort(function(a2, b2) {
  ...
  function packSetSize_(layout) {
    return (width23) => (height23) => {
      layout.size([width23, height23]);
      return layout;
    };
  }
  ...
  var eqTreeLayout = {
    eq: function(x23) {
      return function(y20) {
        if (x23 instanceof Radial && y20 instanceof Radial) {
          return true;
        }
        ;
        if (x23 instanceof Horizontal && y20 instanceof Horizontal) {
          return true;
        }
        ;
        if (x23 instanceof Vertical && y20 instanceof Vertical) {
          return true;
        }
        ;
        return false;
  ...
  function bisector(f) {
    ...
    if (f.length !== 2) {
      compare12 = ascending;
      compare22 = (d9, x23) => ascending(f(d9), x23);
      delta = (d9, x23) => f(d9) - x23;
    } else {
      compare12 = f === ascending || f === descending ? f : zero2;
      compare22 = f;
      delta = f;
    }
    function left4(a2, x23, lo = 0, hi = a2.length) {
      if (lo < hi) {
        if (compare12(x23, x23) !== 0) return hi;
        do {
          const mid = lo + hi >>> 1;
          if (compare22(a2[mid], x23) < 0) lo = mid + 1;
          else hi = mid;
        } while (lo < hi);
      }
      return lo;
    }
    function right4(a2, x23, lo = 0, hi = a2.length) {
      if (lo < hi) {
        if (compare12(x23, x23) !== 0) return hi;
        do {
          const mid = lo + hi >>> 1;
    ...
    function center3(a2, x23, lo = 0, hi = a2.length) {
      const i2 = left4(a2, x23, lo, hi - 1);
      return i2 > lo && delta(a2[i2 - 1], x23) > -delta(a2[i2], x23) ? i2 - 1 : i2;
    }
  ...
  var left = 4;
  var epsilon = 1e-6;
  function translateX(x23) {
    return "translate(" + x23 + ",0)";
  }
  function translateY(y20) {
    return "translate(0," + y20 + ")";
  }
  ...
  function axis(orient, scale) {
    var tickArguments = [], tickValues = null, tickFormat2 = null, tickSizeInner = 6, tickSizeOuter = 6, tickPadding = 3, offset = typeof window !== "undefined" && window.devicePixelRatio > 1 ? 0 : 0.5, k = orient === top4 || orient === left ? -1 : 1, x23 = orient === left || orient === right ? "x" : "y", transform3 = orient === top4 || orient === bottom4 ? translateX : translateY;
    function axis2(context) {
      ...
      line = line.merge(tickEnter.append("line").attr("stroke", "currentColor").attr(x23 + "2", k * tickSizeInner));
      text18 = text18.merge(tickEnter.append("text").attr("fill", "currentColor").attr(x23, k * spacing).attr("dy", orient === top4 ? "0em" : orient === bottom4 ? "0.71em" : "0.32em"));
      ...
      line.attr(x23 + "2", k * tickSizeInner);
      text18.attr(x23, k * spacing).text(format2);
  ...
  function array(x23) {
    return x23 == null ? [] : Array.isArray(x23) ? x23 : Array.from(x23);
  }
  ...
  function data_default(value16, key) {
    ...
    var bind32 = key ? bindKey : bindIndex, parents = this._parents, groups = this._groups;
    ...
    for (var m = groups.length, update3 = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
      ...
      bind32(parent2, group3, enterGroup, updateGroup, exitGroup, data, key);
  ...
  function sort_default(compare3) {
    ...
    function compareNode(a2, b2) {
      return a2 && b2 ? compare3(a2.__data__, b2.__data__) : !a2 - !b2;
    }
  ...
  function exponential(a2, b2, y20) {
    return a2 = Math.pow(a2, y20), b2 = Math.pow(b2, y20) - a2, y20 = 1 / y20, function(t) {
      return Math.pow(a2 + t * b2, y20);
    };
  }
  function gamma(y20) {
    return (y20 = +y20) === 1 ? nogamma : function(a2, b2) {
      return b2 - a2 ? exponential(a2, b2, y20) : constant_default2(isNaN(a2) ? b2 : a2);
    };
  }
  ...
  var rgb_default = (function rgbGamma(y20) {
    var color2 = gamma(y20);
  ...
  function isNumberArray(x23) {
    return ArrayBuffer.isView(x23) && !(x23 instanceof DataView);
  }

  // node_modules/d3-interpolate/src/array.js
  function genericArray(a2, b2) {
    var nb = b2 ? b2.length : 0, na = a2 ? Math.min(nb, a2.length) : 0, x23 = new Array(na), c = new Array(nb), i2;
    for (i2 = 0; i2 < na; ++i2) x23[i2] = value_default(a2[i2], b2[i2]);
    for (; i2 < nb; ++i2) c[i2] = b2[i2];
    return function(t) {
      for (i2 = 0; i2 < na; ++i2) c[i2] = x23[i2](t);
      return c;
    };
  }
  ...
  function decompose_default(a2, b2, c, d9, e, f) {
    ...
    if (scaleY = Math.sqrt(c * c + d9 * d9)) c /= scaleY, d9 /= scaleY, skewX /= scaleY;
    if (a2 * d9 < b2 * c) a2 = -a2, b2 = -b2, skewX = -skewX, scaleX = -scaleX;
    return {
      translateX: e,
      translateY: f,
  ...
  var X = {
    ...
    input: function(x23, e) {
      return x23 == null ? null : [[+x23[0], e[0][1]], [+x23[1], e[1][1]]];
    },
    output: function(xy) {
  ...
  var Y = {
    ...
    input: function(y20, e) {
      return y20 == null ? null : [[e[0][0], +y20[0]], [e[1][0], +y20[1]]];
    },
    output: function(xy) {
  ...
  Path2.prototype = path.prototype = {
    constructor: Path2,
    moveTo: function(x23, y20) {
      this._ += "M" + (this._x0 = this._x1 = +x23) + "," + (this._y0 = this._y1 = +y20);
    },
    closePath: function() {
      if (this._x1 !== null) {
    ...
    lineTo: function(x23, y20) {
      this._ += "L" + (this._x1 = +x23) + "," + (this._y1 = +y20);
    },
    quadraticCurveTo: function(x110, y110, x23, y20) {
      this._ += "Q" + +x110 + "," + +y110 + "," + (this._x1 = +x23) + "," + (this._y1 = +y20);
    },
    bezierCurveTo: function(x110, y110, x23, y23, x24, y20) {
      this._ += "C" + +x110 + "," + +y110 + "," + +x23 + "," + +y23 + "," + (this._x1 = +x24) + "," + (this._y1 = +y20);
    },
    arcTo: function(x110, y110, x23, y23, r) {
      x110 = +x110, y110 = +y110, x23 = +x23, y23 = +y23, r = +r;
      var x0 = this._x1, y0 = this._y1, x212 = x23 - x110, y21 = y23 - y110, x01 = x0 - x110, y01 = y0 - y110, l01_2 = x01 * x01 + y01 * y01;
      if (r < 0) throw new Error("negative radius: " + r);
      if (this._x1 === null) {
        this._ += "M" + (this._x1 = x110) + "," + (this._y1 = y110);
      } else if (!(l01_2 > epsilon2)) ;
      else if (!(Math.abs(y01 * x212 - y21 * x01) > epsilon2) || !r) {
        this._ += "L" + (this._x1 = x110) + "," + (this._y1 = y110);
      } else {
        var x202 = x23 - x0, y20 = y23 - y0, l21_2 = x212 * x212 + y21 * y21, l20_2 = x202 * x202 + y20 * y20, l21 = Math.sqrt(l21_2), l01 = Math.sqrt(l01_2), l = r * Math.tan((pi2 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01))) / 2), t01 = l / l01, t21 = l / l21;
        if (Math.abs(t01 - 1) > epsilon2) {
          this._ += "L" + (x110 + t01 * x01) + "," + (y110 + t01 * y01);
        }
        this._ += "A" + r + "," + r + ",0,0," + +(y01 * x202 > x01 * y20) + "," + (this._x1 = x110 + t21 * x212) + "," + (this._y1 = y110 + t21 * y21);
      }
    },
    arc: function(x23, y20, r, a0, a1, ccw) {
      x23 = +x23, y20 = +y20, r = +r, ccw = !!ccw;
      var dx = r * Math.cos(a0), dy4 = r * Math.sin(a0), x0 = x23 + dx, y0 = y20 + dy4, cw = 1 ^ ccw, da = ccw ? a0 - a1 : a1 - a0;
      if (r < 0) throw new Error("negative radius: " + r);
      if (this._x1 === null) {
        this._ += "M" + x0 + "," + y0;
      ...
      if (da > tauEpsilon) {
        this._ += "A" + r + "," + r + ",0,1," + cw + "," + (x23 - dx) + "," + (y20 - dy4) + "A" + r + "," + r + ",0,1," + cw + "," + (this._x1 = x0) + "," + (this._y1 = y0);
      } else if (da > epsilon2) {
        this._ += "A" + r + "," + r + ",0," + +(da >= pi2) + "," + cw + "," + (this._x1 = x23 + r * Math.cos(a1)) + "," + (this._y1 = y20 + r * Math.sin(a1));
      }
    },
    rect: function(x23, y20, w, h) {
      this._ += "M" + (this._x0 = this._x1 = +x23) + "," + (this._y0 = this._y1 = +y20) + "h" + +w + "v" + +h + "h" + -w + "Z";
    },
    toString: function() {
      return this._;
    }
  ...
  function formatDecimal_default(x23) {
    return Math.abs(x23 = Math.round(x23)) >= 1e21 ? x23.toLocaleString("en").replace(/,/g, "") : x23.toString(10);
  }
  function formatDecimalParts(x23, p2) {
    if ((i2 = (x23 = p2 ? x23.toExponential(p2 - 1) : x23.toExponential()).indexOf("e")) < 0) return null;
    var i2, coefficient = x23.slice(0, i2);
    return [
  ...
  function exponent_default(x23) {
    return x23 = formatDecimalParts(Math.abs(x23)), x23 ? x23[1] : NaN;
  }

  // node_modules/d3-format/src/formatGroup.js
  function formatGroup_default(grouping, thousands) {
    return function(value16, width23) {
      var i2 = value16.length, t = [], j = 0, g = grouping[0], length9 = 0;
      while (i2 > 0 && g > 0) {
        if (length9 + g + 1 > width23) g = Math.max(1, width23 - length9);
        t.push(value16.substring(i2 -= g, i2 + g));
        if ((length9 += g + 1) > width23) break;
  ...
  var prefixExponent;
  function formatPrefixAuto_default(x23, p2) {
    var d9 = formatDecimalParts(x23, p2);
    if (!d9) return x23 + "";
    ...
    return i2 === n ? coefficient : i2 > n ? coefficient + new Array(i2 - n + 1).join("0") : i2 > 0 ? coefficient.slice(0, i2) + "." + coefficient.slice(i2) : "0." + new Array(1 - i2).join("0") + formatDecimalParts(x23, Math.max(0, p2 + i2 - 1))[0];
  }

  // node_modules/d3-format/src/formatRounded.js
  function formatRounded_default(x23, p2) {
    var d9 = formatDecimalParts(x23, p2);
    if (!d9) return x23 + "";
  ...
  var formatTypes_default = {
    "%": (x23, p2) => (x23 * 100).toFixed(p2),
    "b": (x23) => Math.round(x23).toString(2),
    "c": (x23) => x23 + "",
    "d": formatDecimal_default,
    "e": (x23, p2) => x23.toExponential(p2),
    "f": (x23, p2) => x23.toFixed(p2),
    "g": (x23, p2) => x23.toPrecision(p2),
    "o": (x23) => Math.round(x23).toString(8),
    "p": (x23, p2) => formatRounded_default(x23 * 100, p2),
    "r": formatRounded_default,
    "s": formatPrefixAuto_default,
    "X": (x23) => Math.round(x23).toString(16).toUpperCase(),
    "x": (x23) => Math.round(x23).toString(16)
  };

  // node_modules/d3-format/src/identity.js
  function identity_default2(x23) {
    return x23;
  }
  ...
  function locale_default(locale2) {
    ...
    function newFormat(specifier) {
      ...
      var fill19 = specifier.fill, align = specifier.align, sign2 = specifier.sign, symbol = specifier.symbol, zero4 = specifier.zero, width23 = specifier.width, comma = specifier.comma, precision = specifier.precision, trim2 = specifier.trim, type2 = specifier.type;
      if (type2 === "n") comma = true, type2 = "g";
      else if (!formatTypes_default[type2]) precision === void 0 && (precision = 12), trim2 = true, type2 = "g";
      if (zero4 || fill19 === "0" && align === "=") zero4 = true, fill19 = "0", align = "=";
      ...
      function format2(value16) {
        ...
        var length9 = valuePrefix.length + value16.length + valueSuffix.length, padding = length9 < width23 ? new Array(width23 - length9 + 1).join(fill19) : "";
        if (comma && zero4) value16 = group3(padding + value16, padding.length ? width23 - valueSuffix.length : Infinity), padding = "";
        switch (align) {
          case "<":
  ...
  function number3(x23) {
    return +x23;
  }

  // node_modules/d3-scale/src/continuous.js
  var unit2 = [0, 1];
  function identity13(x23) {
    return x23;
  }
  function normalize2(a2, b2) {
    return (b2 -= a2 = +a2) ? function(x23) {
      return (x23 - a2) / b2;
  ...
  function clamper(a2, b2) {
    ...
    return function(x23) {
      return Math.max(a2, Math.min(b2, x23));
    };
  }
  ...
  function polymap(domain, range3, interpolate) {
    ...
    return function(x23) {
      var i3 = bisect_default(domain, x23, 1, j) - 1;
      return r[i3](d9[i3](x23));
    };
  }
  function copy(source2, target7) {
  ...
  function transformer() {
    var domain = unit2, range3 = unit2, interpolate = value_default, transform3, untransform, unknown, clamp2 = identity13, piecewise, output2, input3;
    function rescale() {
      var n = Math.min(domain.length, range3.length);
      if (clamp2 !== identity13) clamp2 = clamper(domain[0], domain[n - 1]);
      piecewise = n > 2 ? polymap : bimap3;
      output2 = input3 = null;
      return scale;
    }
    function scale(x23) {
      return x23 == null || isNaN(x23 = +x23) ? unknown : (output2 || (output2 = piecewise(domain.map(transform3), range3, interpolate)))(transform3(clamp2(x23)));
    }
    scale.invert = function(y20) {
      return clamp2(untransform((input3 || (input3 = piecewise(range3, domain.map(transform3), number_default)))(y20)));
    };
    scale.domain = function(_) {
    ...
    scale.clamp = function(_) {
      return arguments.length ? (clamp2 = _ ? true : identity13, rescale()) : clamp2 !== identity13;
    };
  ...
  function constant_default4(x23) {
  ...
  function array_default(x23) {
    return typeof x23 === "object" && "length" in x23 ? x23 : Array.from(x23);
  }
  ...
  Linear.prototype = {
    ...
    point: function(x23, y20) {
      x23 = +x23, y20 = +y20;
      switch (this._point) {
        case 0:
          this._point = 1;
          this._line ? this._context.lineTo(x23, y20) : this._context.moveTo(x23, y20);
          break;
        case 1:
          this._point = 2;
        // falls through
        default:
          this._context.lineTo(x23, y20);
          break;
      }
    }
  };
  ...
  function line_default(x23, y20) {
    var defined = constant_default4(true), context = null, curve = linear_default, output2 = null;
    x23 = typeof x23 === "function" ? x23 : x23 === void 0 ? x3 : constant_default4(x23);
    y20 = typeof y20 === "function" ? y20 : y20 === void 0 ? y3 : constant_default4(y20);
    function line(data) {
      ...
      for (i2 = 0; i2 <= n; ++i2) {
        ...
        if (defined0) output2.point(+x23(d9, i2, data), +y20(d9, i2, data));
      }
      if (buffer) return output2 = null, buffer + "" || null;
    }
    line.x = function(_) {
      return arguments.length ? (x23 = typeof _ === "function" ? _ : constant_default4(+_), line) : x23;
    };
    line.y = function(_) {
      return arguments.length ? (y20 = typeof _ === "function" ? _ : constant_default4(+_), line) : y20;
    };
  ...
  Transform.prototype = {
    ...
    translate: function(x23, y20) {
      return x23 === 0 & y20 === 0 ? this : new Transform(this.k, this.x + this.k * x23, this.y + this.k * y20);
    },
    apply: function(point) {
      return [point[0] * this.k + this.x, point[1] * this.k + this.y];
    },
    applyX: function(x23) {
      return x23 * this.k + this.x;
    },
    applyY: function(y20) {
      return y20 * this.k + this.y;
    },
    invert: function(location2) {
      return [(location2[0] - this.x) / this.k, (location2[1] - this.y) / this.k];
    },
    invertX: function(x23) {
      return (x23 - this.x) / this.k;
    },
    invertY: function(y20) {
      return (y20 - this.y) / this.k;
    },
    rescaleX: function(x23) {
      return x23.copy().domain(x23.range().map(this.invertX, this).map(x23.invert, x23));
    },
    rescaleY: function(y20) {
      return y20.copy().domain(y20.range().map(this.invertY, this).map(y20.invert, y20));
    },
    toString: function() {
  ...
  var drawQuartet = function(dictBind) {
    ...
    return function(dictMonadEffect) {
      var liftEffect20 = liftEffect(dictMonadEffect);
      var Applicative0 = dictMonadEffect.Monad0().Applicative0();
      var pure39 = pure(Applicative0);
      ...
      return function(dictSelectionM) {
        ...
        return function(quartet) {
          return function(selector) {
            ...
            var xDomain = [0, 20];
            var yDomain = [0, 14];
            return bind32(attach2(selector))(function(v) {
              return bind32(appendTo2(v)(Svg.value)([viewBox(0)(0)(900)(700), classed2("scatter-quartet"), width9(900), height9(700)]))(function(svg2) {
                var drawSubplot = function(title4) {
                  return function(dataPoints) {
                    return function(xOffset) {
                      return function(yOffset) {
                        return bind32(appendTo2(svg2)(Group.value)([classed2("subplot"), transform([function(v1) {
                          return "translate(" + (show6(xOffset + margin.left) + ("," + (show6(yOffset + margin.top) + ")")));
                        }])]))(function(subplotGroup) {
                          return bind32(appendTo2(svg2)(Text2.value)([x4(xOffset + plotWidth / 2), y4(yOffset + 15), text7(title4), textAnchor2("middle"), fontSize2(16), classed2("subplot-title")]))(function() {
                            return bind32(liftEffect20(createLinearScale({
                              domain: xDomain,
                              range: [0, iWidth]
                            })))(function(xScale) {
                              return bind32(liftEffect20(createLinearScale({
                                ...
                                return bind32(appendTo2(subplotGroup)(Group.value)([classed2("x-axis"), transform([function(v1) {
                                  return "translate(0," + (show6(iHeight) + ")");
                                }])]))(function(xAxisGroup) {
                                  return bind32(appendTo2(subplotGroup)(Group.value)([classed2("y-axis")]))(function(yAxisGroup) {
                                    return bind32(liftEffect20(callAxis(xAxisGroup)(axisBottom2(xScale))))(function() {
                                      return bind32(liftEffect20(callAxis(yAxisGroup)(axisLeft2(yScale))))(function() {
                                        var addPoint = function(point) {
                                          var xPos = applyScale(xScale)(point.x);
                                          var yPos = applyScale(yScale)(point.y);
                                          return bind32(appendTo2(subplotGroup)(Circle.value)([cx2(xPos), cy2(yPos), radius2(4), fill2("#e74c3c"), strokeColor2("#c0392b"), strokeWidth2(1.5), classed2("scatter-point")]))(function() {
                                            return pure39(unit);
                                          });
                                        };
                                        return bind32(traverse_7(addPoint)(dataPoints))(function() {
                                          return pure39(unit);
                                        });
                                      });
                                    });
                ...
                return bind32(drawSubplot("Dataset I")(quartet.dataset1)(60)(60))(function() {
                  return bind32(drawSubplot("Dataset II")(quartet.dataset2)(60 + plotWidth + 60)(60))(function() {
                    return bind32(drawSubplot("Dataset III")(quartet.dataset3)(60)(60 + plotHeight + 60))(function() {
                      return bind32(drawSubplot("Dataset IV")(quartet.dataset4)(60 + plotWidth + 60)(60 + plotHeight + 60))(function() {
                        return pure39(unit);
                      });
                    });
                  });
  ...
  var selectionUpdateJoin = function(dictSelectionM) {
    var pure39 = pure(dictSelectionM.Monad0().Applicative0());
  ...
  var selectionSelectUnder = function(dictSelectionM) {
    ...
    return function(selection2) {
      return function(selector) {
        return pure39(d3SelectionSelectAll_(selector)(selection2));
      };
    };
  };
  ...
  var selectionMergeSelections = function(dictSelectionM) {
    ...
    return function(selectionA) {
      return function(selectionB) {
        return pure39(d3MergeSelectionWith_(selectionA)(selectionB));
      };
    };
  };
  ...
  var selectionFilterSelection = function(dictSelectionM) {
    ...
    return function(selection_) {
      return function(selector) {
        return pure39(d3FilterSelection_(selection_)(selector));
      };
    };
  };
  var selectionAttach = function(dictSelectionM) {
    var pure39 = pure(dictSelectionM.Monad0().Applicative0());
    return function(selector) {
      return pure39(d3SelectAllInDOM_(selector));
    };
  };
  ...
  var SimpleCharts = /* @__PURE__ */ (function() {
    function SimpleCharts2() {
    }
    ;
    SimpleCharts2.value = new SimpleCharts2();
    return SimpleCharts2;
  })();
  var ChordDiagram = /* @__PURE__ */ (function() {
    function ChordDiagram2() {
    }
    ;
    ChordDiagram2.value = new ChordDiagram2();
  ...
  var BubbleChart = /* @__PURE__ */ (function() {
    ...
    ;
    BubbleChart2.value = new BubbleChart2();
    return BubbleChart2;
  })();
  var SankeyDiagram = /* @__PURE__ */ (function() {
    function SankeyDiagram2() {
    }
    ;
    SankeyDiagram2.value = new SankeyDiagram2();
  ...
  var eqRoute = {
    eq: function(x23) {
      return function(y20) {
        if (x23 instanceof Home && y20 instanceof Home) {
          return true;
        }
        ;
        if (x23 instanceof GettingStarted && y20 instanceof GettingStarted) {
          return true;
        }
        ;
        if (x23 instanceof HowtoIndex && y20 instanceof HowtoIndex) {
          return true;
        }
        ;
        if (x23 instanceof Reference && y20 instanceof Reference) {
          return true;
        }
        ;
        if (x23 instanceof About && y20 instanceof About) {
          return true;
        }
        ;
        if (x23 instanceof Tutorial && y20 instanceof Tutorial) {
          return true;
        }
        ;
        if (x23 instanceof SimpleCharts && y20 instanceof SimpleCharts) {
          return true;
        }
        ;
        if (x23 instanceof ChordDiagram && y20 instanceof ChordDiagram) {
          return true;
        }
        ;
        if (x23 instanceof BubbleChart && y20 instanceof BubbleChart) {
          return true;
        }
        ;
        if (x23 instanceof SankeyDiagram && y20 instanceof SankeyDiagram) {
          return true;
        }
        ;
        if (x23 instanceof Hierarchies && y20 instanceof Hierarchies) {
          return true;
        }
        ;
        if (x23 instanceof Interpreters && y20 instanceof Interpreters) {
          return true;
        }
        ;
        if (x23 instanceof CodeExplorer && y20 instanceof CodeExplorer) {
          return true;
        }
        ;
        if (x23 instanceof Explore && y20 instanceof Explore) {
          return x23.value0 === y20.value0;
        }
        ;
        if (x23 instanceof NotFound && y20 instanceof NotFound) {
          return true;
        }
        ;
        return false;
  ...
  var semiringFree = /* @__PURE__ */ (function() {
    return {
      ...
      mul: function(v) {
        return function(v1) {
          return bind6(v)(function(xs) {
            return bind6(v1)(function(ys) {
              return pure11(append13(xs)(ys));
            });
          });
        };
      },
  ...
  var pure13 = /* @__PURE__ */ pure(/* @__PURE__ */ applicativeV(semiringFree));
  ...
  var str = function(route) {
    if (route instanceof Cons && route.value0 instanceof Path3) {
      return pure13(new Tuple(route.value1, route.value0.value0));
    }
    ;
  ...
  var runMatch = function(v) {
    return function(route) {
      var foldErrors = function(errs) {
        return new Left(foldl4(function(b2) {
          return function(a2) {
            return a2 + ("\n" + b2);
          };
        })("")(bind7(map29(reverse)(unwrap4(errs)))(function(es) {
          return pure14(foldl4(function(b2) {
            return function(a2) {
              return a2 + (";" + b2);
            };
          })("")(map29(showMatchError)(es)));
        })));
      };
      ...
      return function(v) {
        return function(r) {
          return validation(invalid)(function(v1) {
            return pure13(new Tuple(v1.value0, fn(v1.value1)));
          })(v(r));
        };
      };
    }
      ...
      return function(v1) {
        var processFnRes = function(v2) {
          return validation(invalid)(function(v3) {
            return pure13(new Tuple(v3.value0, v2.value1(v3.value1)));
          })(v1(v2.value0));
        };
        var processFnErr = function(r) {
          return function(err) {
            return invalid(mul2(err)(validation(identity15)($$const(one3))(v1(r))));
          };
        };
        return function(r) {
  ...
  var lit = function(input3) {
    return function(route) {
      if (route instanceof Cons && (route.value0 instanceof Path3 && route.value0.value0 === input3)) {
        return pure13(new Tuple(route.value1, unit));
      }
      ;
      if (route instanceof Cons && route.value0 instanceof Path3) {
  ...
  var end = function(route) {
    if (route instanceof Nil) {
      return pure13(new Tuple(Nil.value, unit));
    }
    ;
  ...
  var simpleCharts = /* @__PURE__ */ (function() {
    return applyFirst2(voidRight2(SimpleCharts.value)(lit("simple-charts")))(end);
  })();
  var sankeyDiagram = /* @__PURE__ */ (function() {
    return applyFirst2(voidRight2(SankeyDiagram.value)(lit("sankey-diagram")))(end);
  })();
  var routeToPath = function(v) {
    ...
    ;
    if (v instanceof SimpleCharts) {
      return "/simple-charts";
    }
    ;
    if (v instanceof ChordDiagram) {
      return "/chord-diagram";
    }
    ;
    if (v instanceof BubbleChart) {
      return "/bubble-chart";
    }
    ;
    if (v instanceof SankeyDiagram) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.RoutingDSL (line 99, column 1 - line 99, column 31): " + [v.constructor.name]);
  };
  ...
  var explore = /* @__PURE__ */ (function() {
    return applyFirst2(map(matchFunctor)(Explore.create)(applySecond2(lit("explore"))(str)))(end);
  })();
  var codeExplorer = /* @__PURE__ */ (function() {
    return applyFirst2(voidRight2(CodeExplorer.value)(lit("code-explorer")))(end);
  })();
  var chordDiagram = /* @__PURE__ */ (function() {
    return applyFirst2(voidRight2(ChordDiagram.value)(lit("chord-diagram")))(end);
  })();
  var bubbleChart = /* @__PURE__ */ (function() {
    return applyFirst2(voidRight2(BubbleChart.value)(lit("bubble-chart")))(end);
  })();
  var about = /* @__PURE__ */ (function() {
    return applyFirst2(voidRight2(About.value)(lit("about")))(end);
  })();
  var routes = /* @__PURE__ */ alt7(gettingStarted)(/* @__PURE__ */ alt7(howtoIndex)(/* @__PURE__ */ alt7(reference)(/* @__PURE__ */ alt7(tutorial)(/* @__PURE__ */ alt7(simpleCharts)(/* @__PURE__ */ alt7(chordDiagram)(/* @__PURE__ */ alt7(bubbleChart)(/* @__PURE__ */ alt7(sankeyDiagram)(/* @__PURE__ */ alt7(hierarchies)(/* @__PURE__ */ alt7(interpreters)(/* @__PURE__ */ alt7(codeExplorer)(/* @__PURE__ */ alt7(explore)(/* @__PURE__ */ alt7(about)(/* @__PURE__ */ alt7(rootRedirect)(notFound))))))))))))));
  var routing = /* @__PURE__ */ applySecond2(root2)(routes);

  // output/PSD3.RHSNavigation/index.js
  ...
  var render = function(currentRoute) {
    return div2([classes(["explanation-page__nav-panel"])])([h3([classes(["explanation-page__nav-title"])])([text5("Explore")]), nav([classes(["explanation-page__nav-links"])])([navLink(About.value)("About")(currentRoute), navLink(Tutorial.value)("Tutorial")(currentRoute), navLink(SimpleCharts.value)("Simple Charts")(currentRoute), navLink(ChordDiagram.value)("Chord Diagram")(currentRoute), navLink(BubbleChart.value)("Bubble Chart")(currentRoute), navLink(SankeyDiagram.value)("Sankey Diagram")(currentRoute), navLink(Hierarchies.value)("Hierarchies")(currentRoute), navLink(Interpreters.value)("Interpreters")(currentRoute), navLink(CodeExplorer.value)("Code Explorer")(currentRoute), a([href4("https://github.com/afcondon/purescript-d3-tagless"), target5("_blank"), rel4("noopener noreferrer"), classes(["explanation-page__nav-link", "explanation-page__nav-link--external"])])([text5("GitHub \u2197")])])]);
  };
  ...
  var renderTOCItem = function(item) {
    var levelClass = (function() {
      ...
      ;
      return ["toc-nav__item--level-" + show8(item.level + 1 | 0)];
    })();
    var classes2 = append14(["toc-nav__item"])(levelClass);
    return a([href4("#" + item.anchor), classes(classes2)])([text5(item.label)]);
  };
  var renderTOC = function(config) {
    return div2([classes(["toc-panel"])])([img([src9(fromMaybe("bookmark.jpeg")(config.image)), alt5(""), classes(["toc-panel__bookmark-pin"])]), div2([classes(["toc-panel__main"])])([div2([classes(["floating-panel__header"])])([h3([classes(["floating-panel__title"])])([text5(config.title)]), button([classes(["floating-panel__toggle"]), type_18(ButtonButton.value)])([text5("\u2212")])]), div2([classes(["floating-panel__content", "toc-panel__content"])])([nav([classes(["toc-nav"])])(map30(renderTOCItem)(config.items))])])]);
  };
  ...
  var handleAction = function(v) {
    return bind8(liftEffect7(eval_D3M(drawQuartet2(anscombesQuartet)("div.quartet-viz"))))(function() {
      return pure15(unit);
    });
  };
  ...
  var render2 = function(v) {
    return div2([classes(["explanation-page"])])([renderTOC({
      ...
      items: [{
        ...
        anchor: "heading-4",
        label: "The Data Visualization Process",
        level: 1
      }, {
        anchor: "anscombe",
        label: "Why Visualize? Anscombe's Quartet",
        level: 2
      }, {
        anchor: "heading-5",
        label: "Design philosophy of D3*",
        level: 2
      }, {
        anchor: "heading-6",
        label: "Design philosophy of PS<$>D3",
        level: 2
      }, {
        anchor: "heading-7",
        label: "Project Goals (and non-Goals)",
        level: 1
      }, {
        anchor: "heading-9",
        label: "Goals: details",
  ...
  var string = /* @__PURE__ */ (function() {
    return new $$String(identity16);
  })();
  var json = /* @__PURE__ */ (function() {
    return new Json(identity16);
  })();
  var ignore = /* @__PURE__ */ (function() {
  ...
  var jsonEmptyObject = /* @__PURE__ */ id4(empty4);
  ...
  var encode2 = /* @__PURE__ */ (function() {
    var encodePart = function(v) {
      ...
      if (v.value1 instanceof Just) {
        return apply2(map31(function(key) {
          return function(val) {
            return key + ("=" + val);
          };
    ...
    return function(req2) {
      ...
      var fromResponse = (function() {
        ...
        if (req2.responseFormat instanceof Document) {
          return function(x23) {
            return alt8(unsafeReadTagged2("Document")(x23))(alt8(unsafeReadTagged2("XMLDocument")(x23))(unsafeReadTagged2("HTMLDocument")(x23)));
          };
        }
        ;
      ...
      var extractContent = function(v2) {
        ...
        if (v2 instanceof FormURLEncoded) {
          return note("Body contains values that cannot be encoded as application/x-www-form-urlencoded")(map32(unsafeToForeign)(encode2(v2.value0)));
        }
        ;
      ...
      var headers = function(reqContent) {
        return addHeader(map32(ContentType.create)(bindFlipped9(toMediaType2)(reqContent)))(addHeader(map32(Accept.create)(toMediaType(req2.responseFormat)))(req2.headers));
      };
      var ajaxRequest = function(v2) {
        return {
          ...
          timeout: fromMaybe(0)(map32(function(v1) {
            return v1;
          })(req2.timeout))
        };
      };
  ...
  var loadFlareData = /* @__PURE__ */ bind(bindAff)(/* @__PURE__ */ get5(json)("./data/flare-2.json"))(function(result) {
    ...
    if (result instanceof Right) {
      return pure18(result.value0.body);
    }
    ;
    throw new Error("Failed pattern match at D3.Viz.BubbleChart (line 25, column 3 - line 30, column 25): " + [result.constructor.name]);
  });
      ...
      return function(dictSelectionM) {
        ...
        return function(jsonData) {
          return function(selector) {
            ...
            return bind32(attach2(selector))(function(v) {
              return bind32(appendTo2(v)(Svg.value)([viewBox(0)(0)(dims.width)(dims.height), classed3("bubble-chart"), width10(dims.width), height10(dims.height)]))(function(svg2) {
                return bind32(appendTo2(svg2)(Group.value)([classed3("bubbles")]))(function(chartGroup) {
                  ...
                  var drawBubble = function(node) {
                    ...
                    return when6(r > 0)(bind32(appendTo2(chartGroup)(Circle.value)([cx3(xPos), cy3(yPos), radius3(r), fill3(depthColor(round2(depth))), fillOpacity2(0.7), strokeColor3("#ffffff"), strokeWidth3(1), classed3("bubble")]))(function() {
                      return discard111(when6(r > 20)(bind32(appendTo2(chartGroup)(Text2.value)([x5(xPos), y5(yPos), text8(name16), textAnchor3("middle"), fontSize3(min7(12)(r / 3)), fill3("#ffffff"), classed3("bubble-label")]))(function() {
                        return pure113(unit);
                      })))(function() {
                        return pure113(unit);
                      });
                  ...
                  return bind32(traverse_7(drawBubble)(nodes))(function() {
                    return pure113(unit);
                  });
                });
              });
  ...
  // output/PSD3.BubbleChart/index.js
  ...
  var handleAction2 = function(v) {
    return bind9(liftAff2(loadFlareData))(function(jsonData) {
      return bind9(liftEffect8(eval_D3M(draw2(jsonData)("div.bubble-viz"))))(function() {
        return pure19(unit);
      });
    });
  };
  var _rhsNav2 = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  var render3 = function(v) {
    return div2([classes(["explanation-page"])])([div2([classes(["toc-panel"])])([img([src9("bookmark.jpeg"), alt5(""), classes(["toc-panel__bookmark-pin"])]), div2([classes(["toc-panel__main"])])([div2([classes(["floating-panel__header"])])([h3([classes(["floating-panel__title"])])([text5("Contents")]), button([classes(["floating-panel__toggle"]), type_19(ButtonButton.value)])([text5("\u2212")])]), div2([classes(["floating-panel__content", "toc-panel__content"])])([nav([classes(["toc-nav"])])([a([href4("#section-1"), classes(["toc-nav__item"])])([text5("1. Hierarchical Data")])])])])]), slot_3(_rhsNav2)(unit)(component)(BubbleChart.value), section([classes(["tutorial-section", "tutorial-intro"])])([h1([classes(["tutorial-title"])])([text5("Bubble Chart: Circle Packing Layout")]), p_([text5("Circle packing displays hierarchical data as nested circles, where the size of each circle represents a quantitative value. It's an efficient way to visualize part-to-whole relationships in hierarchical structures.")]), p_([text5("This layout is particularly effective for showing relative sizes at multiple levels of hierarchy, making it easy to spot dominant elements and compare proportions across branches.")])]), section([id2("section-1"), classes(["tutorial-section"])])([h2([classes(["tutorial-section-title"])])([text5("1. Flare Visualization Library Structure")]), p_([text5("This bubble chart shows the structure of the Flare visualization library. Each circle represents a class or package, with the size proportional to the lines of code. Nested circles show the package hierarchy.")]), div2([classes(["tutorial-viz-container"])])([div2([classes(["bubble-viz"])])([])]), p_([text5("The circle packing algorithm automatically arranges circles to minimize wasted space while maintaining the hierarchical relationships. Colors indicate the depth level in the hierarchy.")])])]);
  };
        ...
        return function(matrix) {
          return function(v) {
            return function(selector) {
              ...
              return bind32(attach2(selector))(function(v1) {
                return bind32(appendTo2(v1)(Svg.value)([viewBox(0)(0)(dims.width)(dims.height), classed4("chord-diagram"), width11(dims.width), height11(dims.height)]))(function(svg2) {
                  return bind32(appendTo2(svg2)(Group.value)([transform([function(v2) {
                    return "translate(" + (show9(centerX) + ("," + (show9(centerY) + ")")));
                    ...
                    return bind32(appendTo2(centerGroup)(Group.value)([classed4("ribbons")]))(function(ribbonsGroup) {
                      var drawRibbon = function(chord) {
                        ...
                        return bind32(appendTo2(ribbonsGroup)(Path.value)([d4(pathData), fill4(color2), fillOpacity3(0.67), strokeColor4("#000000"), strokeWidth4(0.5), classed4("ribbon")]))(function() {
                          return pure39(unit);
                        });
                      };
                      return bind32(traverse_7(drawRibbon)(chords))(function() {
                        return bind32(appendTo2(centerGroup)(Group.value)([classed4("arcs")]))(function(arcsGroup) {
                          return bind32(simpleJoin2(arcsGroup)(Group.value)(groups)(keyIsID_))(function(groupsJoin) {
                            var drawArc = function(idx) {
                              return function(group3) {
                                ...
                                return bind32(appendTo2(groupsJoin)(Path.value)([d4(pathData), fill4(color2), strokeColor4("#ffffff"), strokeWidth4(2), classed4("arc")]))(function() {
                                  return pure39(unit);
                                });
                              };
                            };
                            return bind32(traverse_7(function(idx) {
  ...
  // output/PSD3.ChordDiagram/index.js
  ...
  var handleAction3 = function(v) {
    return bind10(liftEffect9(eval_D3M(draw4(exampleMatrix)(exampleLabels)("div.chord-viz"))))(function() {
      return pure20(unit);
    });
  };
  var _rhsNav3 = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  var render4 = function(v) {
    return div2([classes(["explanation-page"])])([div2([classes(["toc-panel"])])([img([src9("bookmark.jpeg"), alt5(""), classes(["toc-panel__bookmark-pin"])]), div2([classes(["toc-panel__main"])])([div2([classes(["floating-panel__header"])])([h3([classes(["floating-panel__title"])])([text5("Contents")]), button([classes(["floating-panel__toggle"]), type_20(ButtonButton.value)])([text5("\u2212")])]), div2([classes(["floating-panel__content", "toc-panel__content"])])([nav([classes(["toc-nav"])])([a([href4("#section-1"), classes(["toc-nav__item"])])([text5("1. Programming Concepts")])])])])]), slot_4(_rhsNav3)(unit)(component)(ChordDiagram.value), section([classes(["tutorial-section", "tutorial-intro"])])([h1([classes(["tutorial-title"])])([text5("Chord Diagram: Visualizing Relationships")]), p_([text5("Chord diagrams show relationships and flows between entities in a circular layout. They're particularly effective for displaying interconnected systems, dependencies, or flows between groups.")]), p_([text5("The thickness of each chord represents the strength of the relationship, while colors help distinguish between different entities or groups.")])]), section([id2("section-1"), classes(["tutorial-section"])])([h2([classes(["tutorial-section-title"])])([text5("1. Programming Concepts Dependencies")]), p_([text5("This chord diagram visualizes the dependencies between fundamental programming concepts. Each arc represents a concept, and the ribbons show how strongly they depend on each other.")]), div2([classes(["tutorial-viz-container"])])([div2([classes(["chord-viz"])])([])]), p_([text5("The circular layout makes it easy to see both direct dependencies (following a single chord) and the overall pattern of interconnections in the system. Thicker chords indicate stronger dependencies.")])])]);
  };
  ...
  var unsafeReadProp = function(dictMonad) {
    ...
    return function(k) {
      return function(value16) {
        return unsafeReadPropImpl(fail3(new TypeMismatch("object", typeOf(value16))), pure39, k, value16);
      };
    };
  };
  ...
  var handler$prime = function(et) {
    return function(f) {
      return handler(et)(function(ev) {
        return map33(Action.create)(f(ev));
      });
    };
  };
  ...
  var addForeignPropHandler = function(key) {
    return function(prop19) {
      return function(reader) {
        return function(f) {
          var go2 = function(a2) {
            return composeKleisliFlipped4(reader)(readProp2(prop19))(unsafeToForeign(a2));
          };
  ...
  function getAttributes(node) {
    ...
    for (var i2 = 0; i2 < node.attributes.length; i2++) {
      let { name: name16, value: value16 } = node.attributes.item(i2);
      entries.push([name16, value16]);
    }
    return entries;
  }
  ...
  var readSnippetFiles = function(name16) {
    return bind11(get5(string)("./code-examples/" + name16))(function(response) {
      if (response instanceof Left) {
        return spy3("couldn't read snippet, error: ")(pure21(printError(response.value0)));
      }
      ;
      if (response instanceof Right) {
        return spy3("read snippet: ")(pure21(response.value0.body));
      }
      ;
  ...
  // output/PSD3.CodeExplorationPage/index.js
  ...
  var handleAction4 = function(v) {
    if (v instanceof Initialize5) {
      return bind15(get6)(function(state3) {
        return bind15(liftAff3(readSnippetFiles(state3.snippetId + ".purs")))(function(code2) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.CodeExplorationPage (line 56, column 16 - line 68, column 13): " + [v.constructor.name]);
  };
  ...
  var render6 = function(state3) {
    return div2([classes(["howto-page", "exploration-page"])])([renderTOC({
      ...
      image: new Just("cogs.jpeg")
    }), slot_5(_rhsNav4)(unit)(component)(new Explore(state3.snippetId)), section([classes(["tutorial-section", "tutorial-intro", "exploration-intro"]), id2("overview")])([h1([classes(["tutorial-title", "exploration-title"])])([text5("Exploring: " + state3.snippetId)]), p_([text5("Welcome to the code exploration zone. Here we'll disassemble every aspect of this code snippet, explain the concepts behind it, and connect you to the library reference documentation.")]), p_([text5("This is your deep dive into PureScript D3 programming - understanding not just what the code does, but why it's written this way, what each function means, and where to learn more.")]), p_([text5("When you've finished exploring this code, "), a([classes(["exploration-back-link"]), onClick(function(v) {
      return GoBack.value;
        ...
        var intersect2 = function(acc) {
          var go2 = function(l) {
            return function(r) {
              var $122 = l < ll && r < rl;
              if ($122) {
                var v = compare3(unsafeIndex2(ls)(l))(unsafeIndex2(rs)(r));
                if (v instanceof EQ) {
                  return function __do4() {
              ...
              ;
              return pure23(new Done(acc));
            };
          };
          return tailRecM22(go2)(0)(0);
        };
        return fromFoldable32(bind16(bind16(newSTArray)(intersect2))(unsafeFreeze)());
      };
    };
  };
  ...
  var difference2 = function(dictOrd) {
    ...
    return function(s1) {
      return function(s2) {
        return foldl5(flip(delete1))(s1)(toList2(s2));
      };
    };
  };
  ...
  var use = function(dictMonadState) {
    var gets3 = gets(dictMonadState);
    return function(p2) {
      return gets3(function(v) {
        return viewOn(v)(p2);
      });
    };
  };
  ...
  var get7 = function(dictIsSymbol) {
    var reflectSymbol2 = reflectSymbol(dictIsSymbol);
    return function() {
      return function(l) {
        return function(r) {
  ...
  var eqForceStatus = {
    eq: function(x23) {
      return function(y20) {
        if (x23 instanceof ForceActive && y20 instanceof ForceActive) {
          return true;
        }
        ;
        if (x23 instanceof ForceDisabled && y20 instanceof ForceDisabled) {
          return true;
        }
        ;
        return false;
  ...
  var map35 = /* @__PURE__ */ map(functorNonEmptyArray);
  ...
  var chunk = function(tuples) {
    ...
    var contains3 = toArray2(map35(fst)(tuples));
  ...
  var eqLinkType = {
    eq: function(x23) {
      return function(y20) {
        if (x23 instanceof M2M_Tree && y20 instanceof M2M_Tree) {
          return true;
        }
        ;
        if (x23 instanceof M2M_Graph && y20 instanceof M2M_Graph) {
          return true;
        }
        ;
        if (x23 instanceof P2P && y20 instanceof P2P) {
          return true;
        }
        ;
        if (x23 instanceof M2P && y20 instanceof M2P) {
          return true;
        }
        ;
        return false;
  ...
  var getGraphJSONData = function(v) {
    var names = append6(map36(function(v1) {
      return v1.key;
    })(v.modules))(map36(function(v1) {
      return v1.key;
    })(v.packages));
    ...
    var foldDepends = function(b2) {
      return function(a2) {
        ...
        return append6(map36(makeTuple)(a2.depends))(b2);
      };
    };
    var moduleLinks = map36(makeLink(M2M_Graph.value))(foldl2(foldDepends)([])(v.modules));
    var packageLinks = map36(makeLink(P2P.value))(foldl2(foldDepends)([])(v.packages));
    var depsMap = fromFoldable7(mapFlipped4(v.lsDeps)(function(d9) {
    ...
    var makeNodeFromPackageJSONCL = function(p2) {
      ...
      return {
        ...
        loc: p2.loc,
        links: {
          targets: map36(getId)(p2.depends),
          sources: [],
          treeChildren: [],
          inPackage: [],
          outPackage: [],
          contains: map36(getId)(p2.contains)
        },
        connected: true,
        showChildren: true,
    ...
    var addPackageInfo = function(v1) {
      var packageName = (function() {
        ...
        return bind17(index2(pieces)(0))(function(root3) {
          return bind17(index2(pieces)(1))(function(packageString) {
            if (root3 === ".spago") {
    ...
    var modulesPL = map36(addPackageInfo)(v.modules);
    var mapNamesToModules = fromFoldable7(map36(function(m) {
      return new Tuple(m.key, m);
    })(modulesPL));
    var maybeModules = function(ms) {
      return catMaybes(map36(function(k) {
        return lookup7(k)(mapNamesToModules);
      })(ms));
    };
    var rollUpLOC = function(ms) {
      return sum2(map36(function(v1) {
        return v1.loc;
      })(maybeModules(ms)));
    };
    var moduleNodes = map36(makeNodeFromModuleJSONPL)(modulesPL);
    var modulePackageLinks = map36(makeModuleToPackageLink)(moduleNodes);
    ...
    var modulePackageTuples = map36(function(m) {
      return new Tuple(m.key, m["package"]);
    })(modulesPL);
    var packageContains = map36(chunk)(groupBy(equalSnd2)(sortBy(compareSnd2)(modulePackageTuples)));
    var packageContainsMap = fromFoldable7(packageContains);
    var packageLOC = map36(function(v1) {
      return new Tuple(v1.value0, rollUpLOC(v1.value1));
    })(packageContains);
    var packageLOCMap = fromFoldable7(packageLOC);
    ...
    var packagesCL = map36(function($86) {
      return addRollUpLOC(addContains($86));
    })(v.packages);
    var packageNodes = map36(makeNodeFromPackageJSONCL)(packagesCL);
    var nodes = append6(moduleNodes)(packageNodes);
    var id2Node = fromFoldable12(mapFlipped4(nodes)(function(node) {
      return new Tuple(node.id, node);
    }));
    var sourceLinksMap = fromFoldable12(map36(getSourceLinks)(nodes));
    return {
      links,
      nodes,
      moduleNodes,
  ...
  var show10 = /* @__PURE__ */ show(showLinkType);
  ...
  var show33 = /* @__PURE__ */ show(showNodeType);
  ...
  var makeGraph = function(nodes) {
    var addNode = function(acc) {
      return function(node) {
        var depends = fromFoldable9(node.links.targets);
  ...
  var link_ = {
    ...
    linkClass: function($200) {
      return show10((function(v) {
        return v.linktype;
      })(unboxD3SimLink($200)));
    },
    linkClass2: /* @__PURE__ */ (function() {
      var $201 = append15("updated ");
      return function($202) {
        return $201(show10((function(v) {
          return v.linktype;
        })(unboxD3SimLink($202))));
      };
    })(),
  ...
  var sourcePackageIs = function(name16) {
    return function(link4) {
      return link_.source(link4).name === name16;
    };
  };
  ...
  var treeNodesToTreeXY_R = function(nodes) {
    var setXYtoTreeXY = function(v) {
      ...
      var radialTranslate2 = function(p2) {
        var x23 = p2.x * cos(p2.y);
        var y20 = p2.x * sin(p2.y);
        return {
          x: x23,
          y: y20
        };
    ...
    return append7(partitioned.no)(map37(setXYtoTreeXY)(partitioned.yes));
  };
  ...
  var moduleNodesToContainerXY = function(nodes) {
    ...
    var modulesWithGrid = map37(setModuleGridXY)(partitioned.no);
  ...
  var fixNamedNodeTo = function(label5) {
    return function(point) {
      return function(nodes) {
        ...
        return map37(fixNamedNode$prime)(nodes);
      };
    };
  };
  var datum_ = {
    ...
    nameAndID: function(d9) {
      return unboxD3SimNode(d9).name + (" " + show13(unboxD3SimNode(d9).id));
    },
    indexAndID: function(d9) {
      return unboxD3SimNode(d9).name + (" " + (show13(getIndexFromDatum_(d9)) + (" " + show13(unboxD3SimNode(d9).id))));
    },
    namePos: function(d9) {
      return "(" + (show23(floor(datum_.x(d9))) + ("," + (show23(floor(datum_.y(d9))) + ")")));
    },
    gridPoint: function(d9) {
      return fromMaybe({
        x: datum_.x(d9),
        y: datum_.y(d9)
      })(toMaybe(datum_.gridXY(d9)));
    },
    ...
    positionLabel: function(d9) {
      var v = datum_.nodetype(d9);
      if (v instanceof IsModule) {
        return -datum_.radius(d9);
      }
      ;
      if (v instanceof IsPackage) {
        return 0;
    ...
    collideRadius: function(d9) {
      var $174 = datum_.id(d9) === datum_.containerID(d9);
      if ($174) {
        return 10;
      }
      ;
    ...
    collideRadiusBig: function(d9) {
      return datum_.radius(d9) + 10;
    },
    nodeClass: function(d9) {
      return show33(datum_.nodetype(d9)) + (" " + (datum_.containerName(d9) + (" " + (datum_.name(d9) + (function() {
        var $175 = datum_.connected(d9);
        if ($175) {
          return " connected";
        }
        ;
    ...
    "nodeClass'": function(d9) {
      return "updated" + (show33(datum_.nodetype(d9)) + (" " + (datum_.containerName(d9) + (" " + (datum_.name(d9) + (function() {
        var $176 = datum_.connected(d9);
        if ($176) {
          return " connected";
        }
        ;
    ...
    colorByGroup: function(d9) {
      return d3SchemeCategory10N_(toNumber(datum_.cluster(d9)));
    },
    colorByDepth: function(d9) {
      var v = toMaybe(datum_.treeDepth(d9));
      if (v instanceof Nothing) {
        return "none";
      }
      ;
    ...
    fillByUsage: function(d9) {
      var $179 = datum_.connected(d9);
      if ($179) {
        return datum_.colorByGroup(d9);
      }
      ;
      return "none";
    },
    strokeByUsage: function(d9) {
      var $180 = datum_.connected(d9);
      if ($180) {
        return "none";
      }
      ;
    ...
    treeChildren: function(d9) {
      return datum_.links(d9).treeChildren;
    },
    isTreeParent: function(d9) {
      return !$$null3(datum_.treeChildren(d9));
    }
  };
  ...
  var classed5 = /* @__PURE__ */ classed(toAttrStringFn);
  var radius4 = /* @__PURE__ */ radius(toAttrNumberFn);
  var fill5 = /* @__PURE__ */ fill(toAttrStringFn);
  ...
  var updateAttrs = /* @__PURE__ */ (function() {
    return [classed5(datum_.nodeClass), transform$prime(datum_.translateNode)];
  })();
  var treeSceneAttributes = /* @__PURE__ */ (function() {
    return {
      circles: [radius4(datum_.radius), fill5(datum_.colorByDepth), strokeColor5(datum_.colorByGroup), strokeWidth5(3)],
      labels: [classed1("label"), x6(4), y(toAttrNumber)(2), text9(datum_.name)]
    };
  })();
  ...
  var graphSceneAttributes = /* @__PURE__ */ (function() {
    return {
      circles: [radius4(datum_.radius), fill5(datum_.colorByGroup), opacity2(datum_.opacityByType)],
      labels: [classed1("label"), x6(0.2), y6(datum_.positionLabel), textAnchor4("middle"), text9(datum_.name)]
    };
  })();
  ...
  var clusterSceneAttributes = /* @__PURE__ */ (function() {
    return {
      circles: [radius4(datum_.radius), fill5(datum_.fillByUsage), strokeColor5(datum_.strokeByUsage), strokeWidth5(3), opacity2(datum_.opacityByType)],
      labels: [classed1("label"), x6(0.2), y6(datum_.positionLabel), textAnchor4("middle"), text9(datum_.name)]
    };
  })();
  ...
  var classed6 = /* @__PURE__ */ classed(toAttrStringFn);
  ...
  var updateSimulation = function(dictEq) {
    return function(dictBind) {
      ...
      return function(dictMonadEffect) {
        var pure39 = pure(dictMonadEffect.Monad0().Applicative0());
        return function(dictSelectionM) {
            ...
            return function(v) {
              return function(v1) {
                if (v.selections.nodes instanceof Just && v.selections.links instanceof Just) {
                  return bind32(openSelection2(v.selections.nodes.value0)(show11(Group.value)))(function(node) {
                    return bind32(openSelection2(v.selections.links.value0)(show11(Line.value)))(function(link4) {
                      return bind32(mergeNewDataWithSim2(node)(keyIsID_)(link4)(keyIsID_)(v.rawdata))(function(merged) {
                        return bind32(updateJoin2(node)(Group.value)(merged.nodes)(keyIsID_))(function(node$prime) {
                          return bind32(appendTo2(node$prime.enter)(Group.value)(enterAttrs))(function(nodeEnter) {
                            return bind32(appendTo2(nodeEnter)(Circle.value)(v1.circles))(function() {
                              return discard111($$void11(appendTo2(nodeEnter)(Text2.value)(v1.labels)))(function() {
                                return discard111(setAttributes2(node$prime.exit)([remove]))(function() {
                                  return discard111(setAttributes2(node$prime.update)(updateAttrs))(function() {
                                    return bind32(selectUnder2(node$prime.update)(show11(Circle.value)))(function(updateCirclesSelection) {
                                      return discard111(setAttributes2(updateCirclesSelection)(v1.circles))(function() {
                                        return bind32(selectUnder2(node$prime.update)(show11(Text2.value)))(function(updateLabelsSelection) {
                                          return discard111(setAttributes2(updateLabelsSelection)(v1.labels))(function() {
                                            return bind32(mergeSelections2(nodeEnter)(node$prime.update))(function(mergedNodeSelection) {
                                              return discard111($$void11(on3(mergedNodeSelection)(new Drag(new CustomDrag("spago", simdrag)))))(function() {
                                                return bind32(updateJoin2(link4)(Line.value)(merged.links)(keyIsID_))(function(link$prime) {
                                                  return bind32(appendTo2(link$prime.enter)(Line.value)([classed6(link_.linkClass), strokeColor6(link_.color)]))(function(linkEnter) {
                                                    return discard111(setAttributes2(linkEnter)([classed12("enter")]))(function() {
                                                      return discard111(setAttributes2(link$prime.exit)([remove]))(function() {
                                                        return discard111(setAttributes2(link$prime.update)([classed12("update")]))(function() {
                                                          return bind32(mergeSelections2(linkEnter)(link$prime.update))(function(mergedlinksShown) {
    ...
    return function(dictMonadEffect) {
      ...
      return function(dictSimulationM) {
        return function(dictSelectionM) {
          ...
          var appendTo2 = appendTo(dictSelectionM);
          var on3 = on2(dictSelectionM);
          return bind32(liftEffect20(getWindowWidthHeight))(function(v) {
            return bind32(attach2("div.svg-container"))(function(root3) {
              return bind32(appendTo2(root3)(Svg.value)(svgAttrs(v.value0)(v.value1)))(function(svg2) {
                return bind32(appendTo2(svg2)(Group.value)([]))(function(inner) {
                  return bind32(on3(inner)(new Drag(DefaultDrag.value)))(function() {
                    return bind32(on3(svg2)(new Zoom({
                      ...
                      return bind32(appendTo2(inner)(Group.value)([classed12("links")]))(function(linksGroup) {
                        return bind32(appendTo2(inner)(Group.value)([classed12("nodes")]))(function(nodesGroup) {
                          return pure39({
  ...
  var getVizEventFromClick = function(e) {
    return function(d9) {
      return function(t) {
        return new NodeClick(datum_.nodetype(d9), datum_.id(d9));
      };
    };
  };
  ...
  var show14 = /* @__PURE__ */ show(showRegularForceType);
  var _name2 = /* @__PURE__ */ _name(strongForget);
  var fromFoldable10 = /* @__PURE__ */ fromFoldable2(ordString);
  ...
  var initialize2 = function(dictFoldable) {
    var fromFoldable111 = fromFoldable10(dictFoldable);
  ...
  var disableForce = /* @__PURE__ */ (function() {
    return set3(_status2)(ForceDisabled.value);
  })();
  ...
  var map38 = /* @__PURE__ */ map(functorMap);
  ...
  var fromFoldable11 = /* @__PURE__ */ fromFoldable3(foldableSet);
  var difference4 = /* @__PURE__ */ difference2(ordString);
  var fromFoldable14 = /* @__PURE__ */ fromFoldable6(foldableSet)(ordString);
  ...
  var simulationStart = function(dictMonadState) {
    ...
    return bind(Bind1)(use(dictMonadState)(_handle2))(function(handle) {
      return discard111(modifying3(function($246) {
        return _d3Simulation2(_alpha2($246));
      })($$const(1)))(function() {
        return pure39(startSimulation_(handle));
      });
    });
  };
  var simulationSetVariable = function(dictMonadState) {
    var bind32 = bind(dictMonadState.Monad0().Bind1());
    var use2 = use(dictMonadState);
    var modifying3 = modifying(dictMonadState);
    return function(v) {
      return bind32(use2(_handle2))(function(handle) {
  ...
  var simulationSetNodesFromSelection = function(dictBind) {
    ...
    return function(dictMonadState) {
      var use2 = use(dictMonadState);
      var pure39 = pure(dictMonadState.Monad0().Applicative0());
  ...
  var simulationEnableForcesByLabel = function(dictMonadState) {
    ...
    return function(labels9) {
      return bind32(use2(_handle2))(function(handle) {
        return bind32(use2(_forceLibrary1))(function(forces) {
          return modifying3(_forceLibrary2)($$const(map38(enableByLabels(handle)(labels9))(forces)));
        });
      });
    };
  };
  var simulationDisableForcesByLabel = function(dictMonadState) {
    ...
    return function(labels9) {
      return bind32(use2(_handle2))(function(handle) {
        return bind32(use2(_forceLibrary1))(function(forces) {
          return modifying3(_forceLibrary2)($$const(map38(disableByLabels(handle)(labels9))(forces)));
        });
      });
    };
  };
  var simulationActualizeForces = function(dictMonadState) {
    ...
    return function(activeForces) {
      return bind32(use2(_handle2))(function(handle) {
        return bind32(use2(_forceLibrary1))(function(library) {
          var allLabels = keys3(library);
          var disableLabels = fromFoldable11(difference4(fromFoldable14(allLabels))(activeForces));
          var enableLabels = fromFoldable11(intersection3(activeForces)(fromFoldable14(allLabels)));
          var v = spy4("\u{1F527} actualizeForces - enabling")(enableLabels);
          var v1 = spy4("\u{1F527} actualizeForces - disabling")(disableLabels);
          return discard111(simulationEnableForcesByLabel1(enableLabels))(function() {
            return discard111(simulationDisableForcesByLabel1(disableLabels))(function() {
              return bind32(use2(_forceLibrary1))(function(updatedLibrary) {
                var v2 = map38(updateForceInSimulation(handle))(updatedLibrary);
                return pure39(unit);
              });
            });
          });
      ...
      return function(dictMonadEffect) {
        ...
        return function(state_T) {
          return bind113(get9)(function(state3) {
            return bind113(liftEffect20(exec_D3M_Simulation(state3)(state_T)))(function(state$prime) {
  ...
  var evalEffectSimulation = function(dictBind) {
    ...
    return function(dictMonadState) {
      ...
      return function(dictMonadEffect) {
        var liftEffect20 = liftEffect(dictMonadEffect);
        var pure113 = pure(dictMonadEffect.Monad0().Applicative0());
        return function(state_T) {
          return bind113(get9)(function(state3) {
            return bind113(liftEffect20(run_D3M_Simulation(state3)(state_T)))(function(v) {
  ...
  var bind18 = /* @__PURE__ */ bind(bindD3SimM);
  var applicativeD3SimM = /* @__PURE__ */ applicativeStateT(monadEffect);
  var pure24 = /* @__PURE__ */ pure(applicativeD3SimM);
    ...
    addTickFunction: function(v) {
      return function(v1) {
        ...
        if (v1 instanceof Step3) {
          return bind18(simulationHandle(simulationMD3Selection_D3))(function(handle) {
    ...
    return function(id5) {
      return function(graph) {
        var processNextOpenDepPath = function(searchRecord) {
          return bind19(uncons(searchRecord.openDepPaths))(function(x23) {
            return bind19(head2(x23.head))(function(firstID) {
              return bind19(lookup13(firstID)(graph))(function(firstNode) {
                var newDeps = partition(function(d9) {
                  return !elem6(d9)(searchRecord.nodes);
                })(firstNode.links.targets);
                var newOpenDepPaths = mapFlipped7(newDeps.yes)(function(d9) {
                  return cons3(d9)(x23.head);
                });
                var prunedLinks = mapFlipped7(newDeps.no)(function(d9) {
                ...
                if ($12) {
                  return new Just({
                    ...
                    openDepPaths: x23.tail,
                    closedDepPaths: cons3(x23.head)(searchRecord.closedDepPaths),
                ...
                return new Just({
                  ...
                  dependencyTree: searchRecord.dependencyTree,
                  openDepPaths: append8(x23.tail)(newOpenDepPaths),
  ...
  var fromFoldable23 = /* @__PURE__ */ fromFoldable6(foldableList)(/* @__PURE__ */ ordTuple(ordInt)(ordInt));
  ...
  var setNodeXY_ForHorizontalTree = function(nodes) {
    return function(treeDerivedDataMap) {
      ...
      return map39(updateXY)(nodes);
    };
  };
  var pathsAsLists = function(paths) {
    return fromFoldable15(map39(function($77) {
      return fromFoldable15(reverse2($77));
    })(paths));
  };
  ...
  var makeTreeLinkTuples = function(closedPaths) {
    ...
    return fromFoldable16(fromFoldable23(linkTuples));
  };
  ...
  var buildTree = function(rootID) {
    return function(treelinks) {
      ...
      var linksWhoseSourceIs = function(id5) {
        return fromFoldable15(map39(function(v) {
          return v.target;
        })(filter2(function(l) {
          return l.source === id5;
        })(map39(unwrap9)(treelinks))));
      };
  ...
  var treeReduction = function(rootID) {
    return function(model) {
      ...
      var prunedTreeLinks = map39(tupleToLink(M2M_Graph.value))(reachable.redundantLinks);
      ...
      var treelinks = map39(changeLinkType(M2M_Tree.value))(partitionedLinks.yes);
  ...
  var addTreeToModel = function(rootName) {
    return function(maybeModel) {
      return bind20(maybeModel)(function(model) {
        return bind20(lookup11(rootName)(model.maps.name2ID))(function(rootID) {
          return pure25(treeReduction(rootID)(model));
        });
      });
    };
  };
  var readModelData = /* @__PURE__ */ (function() {
    return bind110(get5(string)("./data/spago-data/modules.json"))(function(moduleJSON) {
      return bind110(get5(string)("./data/spago-data/packages.json"))(function(packageJSON) {
        return bind110(get5(string)("./data/spago-data/lsdeps.jsonlines"))(function(lsdepJSON) {
          return bind110(get5(string)("./data/spago-data/LOC.json"))(function(locJSON) {
            var model = hush(apply3(apply3(apply3(map40(convertFilesToGraphModel)(moduleJSON))(packageJSON))(lsdepJSON))(locJSON));
            return pure110(addTreeToModel("PSD3.Main")(model));
          });
        });
      });
    });
  ...
  var radius5 = function(dictToAttr) {
  ...
  var x8 = /* @__PURE__ */ x7(toAttrNumber);
  var y8 = /* @__PURE__ */ y7(toAttrNumber);
  var radius6 = /* @__PURE__ */ radius5(toAttrNumberFn);
  ...
  var x13 = /* @__PURE__ */ x7(toAttrNumberFn);
  var y13 = /* @__PURE__ */ y7(toAttrNumberFn);
  var radius1 = /* @__PURE__ */ radius5(toAttrNumber);
  var forceLibrary = /* @__PURE__ */ (function() {
    ...
    return initialize2(foldableArray)(functorArray)([createForce("center")(new RegularForce(ForceCenter.value))(allNodes)([strength2(0.5), x8(0), y8(0)]), createForce("x")(new RegularForce(ForceX.value))(allNodes)([strength2(0.05), x8(0)]), createForce("y")(new RegularForce(ForceY.value))(allNodes)([strength2(0.07), y8(0)]), createForce("collide1")(new RegularForce(ForceCollide.value))(allNodes)([strength2(1), radius6(datum_.collideRadius)]), createForce("collide2")(new RegularForce(ForceCollide.value))(allNodes)([strength2(0.7), radius6(datum_.collideRadiusBig)]), createForce("charge1")(new RegularForce(ForceManyBody.value))(allNodes)([strength2(-50), theta2(0.9), distanceMin2(1), distanceMax2(infinity)]), createForce("charge2")(new RegularForce(ForceManyBody.value))(allNodes)([strength2(-100), theta2(0.9), distanceMin2(1), distanceMax2(400)]), createForce("chargetree")(new RegularForce(ForceManyBody.value))(treeExceptLeaves)([strength2(-100), theta2(0.9), distanceMin2(1), distanceMax2(400)]), createForce("clusterx_M")(new RegularForce(ForceX.value))(modulesOnly)([strength2(0.2), x13(datum_.gridPointX)]), createForce("clustery_M")(new RegularForce(ForceY.value))(modulesOnly)([strength2(0.2), y13(datum_.gridPointY)]), createForce("clusterx_P")(new RegularForce(ForceX.value))(packagesOnly)([strength2(0.8), x13(datum_.gridPointX)]), createForce("clustery_P")(new RegularForce(ForceY.value))(packagesOnly)([strength2(0.8), y13(datum_.gridPointY)]), createForce("htreeNodesX")(new RegularForce(ForceX.value))(new Just(new ForceFilter("tree only", function(d9) {
      return datum_.connected(d9);
    })))([strength2(0.4), x13(datum_.treePointX)]), createForce("htreeNodesY")(new RegularForce(ForceY.value))(new Just(new ForceFilter("tree only", function(d9) {
      return datum_.connected(d9);
    })))([strength2(0.4), y13(datum_.treePointY)]), createForce("vtreeNodesX")(new RegularForce(ForceX.value))(new Just(new ForceFilter("tree only", function(d9) {
      return datum_.connected(d9);
    })))([strength2(0.4), x13(datum_.treePointY)]), createForce("vtreeNodesY")(new RegularForce(ForceY.value))(new Just(new ForceFilter("tree only", function(d9) {
      return datum_.connected(d9);
    })))([strength2(0.4), y13(datum_.treePointX)]), createForce("packageOrbit")(new RegularForce(ForceRadial.value))(packagesOnly)([strength2(0.7), x8(0), y8(0), radius1(500)]), createForce("unusedOrbit")(new RegularForce(ForceRadial.value))(unusedModulesOnly)([strength2(0.8), x8(0), y8(0), radius1(900)]), createForce("moduleOrbit")(new RegularForce(ForceRadial.value))(usedModulesOnly)([strength2(0.8), x8(0), y8(0), radius1(600)]), createLinkForce(Nothing.value)([strength2(0.5), distance(toAttrNumber)(0), numKey(function($19) {
  ...
  var appendIProps = function(ip) {
    return function(ip$prime) {
      ...
      var classNames = pure26(classes(map41(ClassName)(nubByEq(function(c) {
  ...
  var buttonMainClasses = /* @__PURE__ */ append10(buttonSharedClasses)(/* @__PURE__ */ map42(ClassName)(["rounded"]));
  ...
  var fromFoldable17 = /* @__PURE__ */ fromFoldable6(foldableSet)(ordString);
  ...
  var initialScene = function(forceLibrary2) {
    return {
      ...
      activeForces: fromFoldable17(keys3(forceLibrary2)),
      cssClass: "",
  ...
  var _cssClass = function(dictStrong) {
    ...
    var $141 = prop14($$Proxy.value)(dictStrong);
    return function($142) {
      return $140($141($142));
    };
  };
  ...
  var slider = function(config) {
    ...
    }), type_22(InputRange.value), id2(config.id), class_("range-slider scaling-slider"), min5(config.min), max6(config.max), step4(new Step(config.step)), value14(show15(config.value))];
  };
  var renderTableForces = function(state3) {
    var renderForceItem = function(v) {
      return div2([classes(["force-item", (function() {
        var $22 = eq5(v.status)(ForceActive.value);
        if ($22) {
          return "force-active";
        }
        ;
    ...
    var forceData = map44(snd)(toUnfoldable4(view(_forceLibrary3)(state3)));
    return div_([h3_([text5("Forces")]), div2([classes(["force-grid"])])(map44(renderForceItem)(forceData))]);
  };
  var renderSimState = function(state3) {
    return div2([classes(["spago-sim-state"])])([caption_2([text5("Simulation state")]), p_([text5("CSS Class: " + view(_cssClass2)(state3))]), p_([text5("Links: " + show16(length4(view(_stagingLinks2)(state3))))]), p_([text5("Nodes: " + show16(length4(view(_stagingNodes2)(state3))))])]);
  };
  ...
  var liftEffect11 = /* @__PURE__ */ liftEffect(monadEffectEffect);
  ...
  var fromFoldable18 = /* @__PURE__ */ fromFoldable6(foldableArray)(ordString);
  ...
  var stageDataFromModel = function(dictMonadState) {
    ...
    var bind113 = bind(Bind1);
    var use2 = use(dictMonadState);
    var discard32 = discard11(Bind1);
    var assign1 = assign2(dictMonadState);
    return bind113(get(dictMonadState))(function(state3) {
      return bind113(use2(_linksShown2))(function(linksShown) {
        return bind113(use2(_linksActive2))(function(linksActive) {
          return bind113(use2(_chooseNodes2))(function(chooseNodes) {
            return bind113(use2(_nodeInitializerFunctions2))(function(nodeInitializerFunctions) {
  ...
  var simulationEvent = function(l) {
    return onMouseEventEffectful(MouseClick.value)(function(e) {
      return function(d9) {
        return function(t) {
          return liftEffect11(notify(l)(new EventFromVizualization(getVizEventFromClick(e)(d9)(t))));
        };
      };
    });
  };
  var runSimulation = function(dictMonadEffect) {
    ...
    return function(dictMonadState) {
      ...
      return discard32(stageDataFromModel(dictMonadState))(function() {
        return bind113(use2(_staging2))(function(staging) {
          return bind113(use2(_eventListener2))(function(maybeListener) {
            return bind113(use2(_sceneAttributes2))(function(sceneAttributes) {
              return bind113(use2(_activeForces2))(function(activeForces) {
  ...
  var handleAction5 = function(dictMonadAff) {
    var liftAff7 = liftAff(monadAffHalogenM(dictMonadAff));
    ...
    var runWithD3_Simulation1 = runWithD3_Simulation2(monadEffectHalogenM3);
    return function(v) {
      if (v instanceof Initialize6) {
        return bind21(liftAff7(readModelData))(function(v1) {
          return discard23(modifying2(_model2)($$const(v1)))(function() {
            return bind21(evalEffectSimulation1(initialize3))(function(openSelections) {
              return discard23(modifying2(function($140) {
                ...
                return discard23(modifying2(function($141) {
                  ...
                  return bind21(liftEffect110(create3))(function(v2) {
        ...
        return discard23(assign3(_chooseNodes1)(isPackage))(function() {
          return discard23(assign3(_linksShown1)(isP2P_Link))(function() {
            return discard23(assign3(_linksActive1)(sourcePackageIs("my-project")))(function() {
              return discard23(assign3(_activeForces1)(fromFoldable18(["center", "collide2", "charge2", "packageOrbit", linksForceName])))(function() {
            ...
            return discard23(assign3(_linksActive1)($$const(true)))(function() {
              return discard23(assign3(_cssClass3)("tree"))(function() {
                return discard23(assign3(_sceneAttributes1)(treeSceneAttributes))(function() {
                  return discard23(assign3(_activeForces1)(fromFoldable18(["htreeNodesX", "collide1", "y", linksForceName])))(function() {
          ...
          return discard23(assign3(_linksShown1)(isM2M_Tree_Link))(function() {
            return discard23(assign3(_linksActive1)($$const(true)))(function() {
              return discard23(assign3(_cssClass3)("tree radial"))(function() {
                return discard23(assign3(_sceneAttributes1)(treeSceneAttributes))(function() {
                  return discard23(assign3(_activeForces1)(fromFoldable18(["center", "collide2", "chargetree", "charge2", linksForceName])))(function() {
  ...
  var render8 = function(dictMonadAff) {
    var component18 = component6(dictMonadAff);
    return function(v) {
      return div2([classes(["fullscreen-page-wrapper", "spago-page-wrapper"])])([slot_6(_spagoComponent)(unit)(component18)(unit)]);
    };
  };
  ...
  // output/PSD3.GettingStarted/index.js
  ...
  var _rhsNav5 = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  var render9 = function(v) {
    return div2([classes(["tutorial-page"])])([renderTOC({
      ...
      image: Nothing.value
    }), slot_7(_rhsNav5)(unit)(component)(GettingStarted.value), section([classes(["tutorial-section", "tutorial-intro"])])([h1([classes(["tutorial-title"])])([text5("Getting Started with PS<$>D3")]), p_([text5("Welcome! This guide will help you install PS<$>D3, set up your first project, and create your first data visualization. By the end, you'll have a working PureScript project with a simple D3 visualization.")])]), section([classes(["tutorial-section"]), id2("installation")])([h2([classes(["tutorial-section-title"])])([text5("Installation")]), p_([text5("Before we begin, ensure you have the following installed on your system:")]), h3([id2("prerequisites")])([text5("Prerequisites")]), ul_([li_([text5("Node.js (version 18 or higher)")]), li_([text5("npm or yarn package manager")]), li_([text5("PureScript compiler (purs)")]), li_([text5("Spago (PureScript package manager and build tool)")])]), p_([text5("If you don't have PureScript and Spago installed, you can install them globally:")]), pre_([code_([text5("npm install -g purescript spago")])])]), section([classes(["tutorial-section"]), id2("setup")])([h2([classes(["tutorial-section-title"])])([text5("Project Setup")]), p_([text5("Create a new PureScript project and add PS<$>D3 as a dependency:")]), pre_([code_([text5("# Create a new directory for your project\nmkdir my-d3-viz\ncd my-d3-viz\n\n# Initialize a new Spago project\nspago init\n\n# Add PS<$>D3 dependencies\n# Note: Replace with actual package names once published\nspago install purescript-d3-tagless")])]), p_([text5("You'll also need to include D3.js in your HTML file. Create an ")]), code_([text5("index.html")]), text5(" file:"), pre_([code_([text5('<!DOCTYPE html>\n<html>\n<head>\n    <title>My D3 Visualization</title>\n    <script src="https://d3js.org/d3.v7.min.js"><\/script>\n</head>\n<body>\n    <div id="viz"></div>\n    <script src="index.js"><\/script>\n</body>\n</html>')])])]), section([classes(["tutorial-section"]), id2("first-viz")])([h2([classes(["tutorial-section-title"])])([text5("Your First Visualization")]), p_([text5("Let's create a simple bar chart. Create a file ")]), code_([text5("src/Main.purs")]), text5(":"), pre_([code_([text5("module Main where\n\nimport Prelude\nimport Effect (Effect)\nimport D3Tagless.Instance.Selection (eval_D3M)\n\nmain :: Effect Unit\nmain = do\n  -- Your first D3 visualization code will go here\n  pure unit")])]), p_([text5("Build and bundle your project:")]), pre_([code_([text5("spago build\nspago bundle --to index.js")])]), p_([text5("Open ")]), code_([text5("index.html")]), text5(" in your browser to see your visualization!")]), section([classes(["tutorial-section"]), id2("next-steps")])([h2([classes(["tutorial-section-title"])])([text5("Next Steps")]), p_([text5("Now that you have PS<$>D3 installed and working, explore these resources:")]), ul_([li_([text5("Check out the "), a([href4("#/howto")])([text5("How-to Guides")]), text5(" for step-by-step instructions on building specific visualizations")]), li_([text5("Read the "), a([href4("#/about")])([text5("Explanation pages")]), text5(" to understand the concepts behind PS<$>D3")]), li_([text5("Browse the "), a([href4("#/reference")])([text5("API Reference")]), text5(" for detailed documentation of all functions and types")])])])]);
  };
  ...
  var getTreeViaAJAX = function(url) {
    return bind22(get5(string)(url))(function(result) {
      return pure29(rmap4(function(v) {
      ...
      return function(dictSelectionM) {
        ...
        return function(treeJson) {
          return function(selector) {
            ...
            return bind32(attach2(selector))(function(v) {
              return bind32(appendTo2(v)(Svg.value)([viewBox(0)(0)(dims.width)(dims.height), classed7("icicle"), width13(dims.width), height13(dims.height)]))(function(svg2) {
                return bind32(appendTo2(svg2)(Group.value)([classed7("partitions")]))(function(chartGroup) {
                  ...
                  var drawPartition = function(node) {
                    ...
                    var x110 = hNodeX1_(node);
                    var y110 = hNodeY1_(node);
                    var partWidth = x110 - x0;
                    var partHeight = y110 - y0;
                    var depth = hNodeDepth_(node);
                    var name16 = getName2(node);
                    return when6(partWidth > 0 && partHeight > 0)(bind32(appendTo2(chartGroup)(Rect.value)([x10(x0), y9(y0), width13(partWidth), height13(partHeight), fill6(depthColor2(round2(depth))), fillOpacity4(0.7), strokeColor7("#ffffff"), strokeWidth6(1), classed7("partition")]))(function() {
                      return discard111(when6(partWidth > 60 && partHeight > 15)(bind32(appendTo2(chartGroup)(Text2.value)([x10(x0 + 4), y9(y0 + partHeight / 2 + 4), text10(name16), textAnchor5("start"), fontSize4(10), fill6("#ffffff"), classed7("partition-label")]))(function() {
                        return pure39(unit);
                      })))(function() {
                        return pure39(unit);
                      });
                  ...
                  return bind32(traverse_7(drawPartition)(nodes))(function() {
                    return pure39(unit);
                  });
                });
              });
      ...
      return function(dictSelectionM) {
        ...
        return function(treeJson) {
          return function(selector) {
            ...
            return bind32(attach2(selector))(function(v) {
              return bind32(appendTo2(v)(Svg.value)([viewBox(0)(0)(dims.width)(dims.height), classed8("treemap"), width14(dims.width), height14(dims.height)]))(function(svg2) {
                return bind32(appendTo2(svg2)(Group.value)([classed8("tiles")]))(function(chartGroup) {
                  var hierarchy = hierarchyFromJSON_(treeJson);
                  ...
                  var drawTile = function(node) {
                    ...
                    var x110 = hNodeX1_(node);
                    var y110 = hNodeY1_(node);
                    var tileWidth = x110 - x0;
                    var tileHeight = y110 - y0;
                    var depth = hNodeDepth_(node);
                    var name16 = getName3(node);
                    return when6(tileWidth > 0 && tileHeight > 0)(bind32(appendTo2(chartGroup)(Rect.value)([x11(x0), y10(y0), width14(tileWidth), height14(tileHeight), fill7(depthColor3(round2(depth))), fillOpacity5(0.6), strokeColor8("#ffffff"), strokeWidth7(1), classed8("tile")]))(function() {
                      return discard111(when6(tileWidth > 30 && tileHeight > 20)(bind32(appendTo2(chartGroup)(Text2.value)([x11(x0 + 2), y10(y0 + 12), text11(name16), textAnchor6("start"), fontSize5(10), fill7("#ffffff"), classed8("tile-label")]))(function() {
                        return pure39(unit);
                      })))(function() {
                        return pure39(unit);
                      });
                  ...
                  return bind32(traverse_7(drawTile)(nodes))(function() {
                    return pure39(unit);
                  });
                });
              });
  ...
  var draw1 = /* @__PURE__ */ draw5(bindD3M)(monadEffD3M)(d3TaglessD3M);
  var draw22 = /* @__PURE__ */ draw(bindD3M)(monadEffD3M)(d3TaglessD3M);
  ...
  var drawIcicle = function(treeJson) {
    return function(selector) {
      return liftEffect12(function __do4() {
        var v = runD3M(draw1(treeJson)(selector))();
        return unit;
      });
    };
  };
  ...
  var treeDatum_ = {
    ...
    onRHS: function(l) {
      return function(d9) {
        var $47 = eq13(l)(Radial.value) && treeDatum_.x(d9) >= pi;
        if ($47) {
          return true;
        }
        ;
    ...
    return function(dictSelectionM) {
      ...
      return function(config) {
        return function(tree2) {
          return bind32(attach2(config.selector))(function(root3) {
            return bind32(appendTo2(root3)(Svg.value)(append11(config.viewbox)([classed9("tree"), width15(config.svg.width), height15(config.svg.height)])))(function(svg2) {
              return bind32(appendTo2(svg2)(Group.value)([fontFamily2("sans-serif"), fontSize6(10)]))(function(container) {
                return bind32(appendTo2(container)(Group.value)([classed9("links")]))(function(links) {
                  return bind32(appendTo2(container)(Group.value)([classed9("nodes")]))(function(nodes) {
                    return bind32(simpleJoin2(links)(Path.value)(links_(tree2))(keyIsID_))(function(theLinks_) {
                      return discard111(setAttributes2(theLinks_)([strokeWidth8(1.5), strokeColor9(config.color), strokeOpacity2(0.4), fill8("none"), config.linkPath]))(function() {
                        return bind32(simpleJoin2(nodes)(Group.value)(descendants_(tree2))(keyIsID_))(function(nodeJoin_) {
                          return discard111(setAttributes2(nodeJoin_)(config.nodeTransform))(function() {
                            return bind32(appendTo2(nodeJoin_)(Circle.value)([fill1(function(v) {
                              ...
                              ;
                              return "#555";
                            }), radius7(2.5), strokeColor9("white")]))(function(theNodes) {
                              return bind32(appendTo2(nodeJoin_)(Text2.value)([dy2(0.31), x14(treeDatum_.textX(config.layout)), textAnchor7(treeDatum_.textAnchor(config.layout)), text12(treeDatum_.name), fill8(config.color)]))(function(theLabels) {
                                return pure39(svg2);
                              });
                            });
                          });
  ...
  var show34 = /* @__PURE__ */ show(showElement);
  ...
  var discard16 = /* @__PURE__ */ discard(discardUnit)(bindD3PrinterM);
  ...
  var pure30 = /* @__PURE__ */ pure(applicativeD3PrinterM);
  var d3Tagless = {
    attach: function(selector) {
      var code2 = showSelectAllInDOM_(selector);
      return discard16(modify_4(function(s) {
        return s + code2;
      }))(function() {
        return pure30(code2);
      });
  ...
  var eq6 = /* @__PURE__ */ eq(eqTreeLayout);
  ...
  var radialTranslate = function(d9) {
    return "translate(" + (show19(treeDatum_.y(d9)) + ",0)");
  };
  var radialRotate = function(x23) {
    return show19(x23 * 180 / pi - 90);
  };
  var radialRotateCommon = function(d9) {
    return "rotate(" + (radialRotate(treeDatum_.x(d9)) + ")");
  };
  var positionXYreflected = function(d9) {
    return "translate(" + (show19(treeDatum_.y(d9)) + ("," + (show19(treeDatum_.x(d9)) + ")")));
  };
  var positionXY = function(d9) {
    return "translate(" + (show19(treeDatum_.x(d9)) + ("," + (show19(treeDatum_.y(d9)) + ")")));
  };
  var configureAndRunScript = function(dictBind) {
    var draw20 = draw8(dictBind);
    return function(dictSelectionM) {
      var draw110 = draw20(dictSelectionM);
      return function(v) {
        return function(model) {
          return function(selector) {
            var svg2 = {
            ...
            var layout = (function() {
              var $33 = eq6(model.treeLayout)(Radial.value);
              if ($33) {
  ...
  var showHierarchyLayout = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at PSD3.Hierarchies (line 45, column 1 - line 54, column 27): " + [v.constructor.name]);
    }
  };
  var show20 = /* @__PURE__ */ show(showHierarchyLayout);
  ...
  var layoutDescription = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.Hierarchies (line 57, column 21 - line 66, column 140): " + [v.constructor.name]);
  };
  var eqHierarchyLayout = {
    eq: function(x23) {
      return function(y20) {
        if (x23 instanceof HorizontalTidy && y20 instanceof HorizontalTidy) {
          return true;
        }
        ;
        if (x23 instanceof HorizontalDendrogram && y20 instanceof HorizontalDendrogram) {
          return true;
        }
        ;
        if (x23 instanceof VerticalTidy && y20 instanceof VerticalTidy) {
          return true;
        }
        ;
        if (x23 instanceof VerticalDendrogram && y20 instanceof VerticalDendrogram) {
          return true;
        }
        ;
        if (x23 instanceof RadialTidy && y20 instanceof RadialTidy) {
          return true;
        }
        ;
        if (x23 instanceof RadialDendrogram && y20 instanceof RadialDendrogram) {
          return true;
        }
        ;
        if (x23 instanceof Icicle && y20 instanceof Icicle) {
          return true;
        }
        ;
        if (x23 instanceof CirclePacking && y20 instanceof CirclePacking) {
          return true;
        }
        ;
        if (x23 instanceof Treemap && y20 instanceof Treemap) {
          return true;
        }
        ;
        return false;
  ...
  var eq7 = /* @__PURE__ */ eq(eqHierarchyLayout);
  var renderLayoutOption = function(layout) {
    return function(label5) {
      return function(currentLayout) {
        return button([classes(append17(["control-panel__option"])((function() {
          var $41 = eq7(layout)(currentLayout);
          if ($41) {
  ...
  var drawLayoutViz = function(layout) {
    return function(model) {
      ...
      ;
      throw new Error("Failed pattern match at PSD3.Hierarchies (line 274, column 6 - line 298, column 47): " + [layout.constructor.name]);
    };
  };
  var handleAction7 = function(v) {
    if (v instanceof Initialize8) {
      return bind23(liftEffect14(eval_D3M(removeExistingSVG2("div.hierarchies-viz"))))(function() {
        return bind23(liftAff4(getTreeViaAJAX("./data/flare-2.json")))(function(treeJSON) {
          if (treeJSON instanceof Left) {
            return pure31(unit);
          }
          ;
          if (treeJSON instanceof Right) {
            return bind23(liftAff4(makeModel2(TidyTree.value)(Horizontal.value)(treeJSON.value0)))(function(model) {
              return bind23(liftAff4(drawLayoutViz(HorizontalTidy.value)(model)))(function() {
                return discard17(modify_5(function(st) {
                  var $46 = {};
                  for (var $47 in st) {
          ...
          ;
          throw new Error("Failed pattern match at PSD3.Hierarchies (line 246, column 5 - line 252, column 18): " + [treeJSON.constructor.name]);
        });
      });
    }
    ;
    if (v instanceof SelectLayout) {
      return bind23(liftEffect14(eval_D3M(removeExistingSVG2("div.hierarchies-viz"))))(function() {
        return discard17(modify_5(function(v1) {
          var $50 = {};
          for (var $51 in v1) {
  ...
  var renderExampleCard = function(title4) {
    return function(description) {
      return function(path3) {
        return a([href4("#" + path3), classes(["home-example-card"])])([h3([classes(["home-example-card__title"])])([text5(title4)]), p([classes(["home-example-card__description"])])([text5(description)])]);
      };
    };
  };
  var renderDocBox = function(category) {
    return function(title4) {
      return function(description) {
        return function(path3) {
          return function(linkText) {
            return function(maybeImage) {
              return a([href4("#" + path3), classes(["home-doc-box", "home-doc-box--" + category])])([(function() {
                if (maybeImage instanceof Just) {
                  return img([src9(maybeImage.value0), alt5(""), classes(["home-doc-box__image"])]);
                }
                ;
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Home (line 129, column 7 - line 136, column 30): " + [maybeImage.constructor.name]);
              })(), div2([classes(["home-doc-box__content"])])([h3([classes(["home-doc-box__title"])])([text5(title4)]), p([classes(["home-doc-box__description"])])([text5(description)]), span3([classes(["home-doc-box__link"])])([text5(linkText)])])]);
            };
          };
        };
      };
  ...
  var render11 = function(v) {
    return div2([classes(["home-page"])])([section([classes(["home-hero"])])([h1([classes(["home-hero__title"])])([text5("PS<$>D3")]), p([classes(["home-hero__subtitle"])])([text5("Type-safe, composable data visualization with PureScript and D3")]), p([classes(["home-hero__description"])])([text5("Finally Tagless design, functional programming principles, and the power of D3.js combined into an elegant, type-safe visualization library.")])]), section([classes(["home-docs"])])([h2([classes(["home-docs__title"])])([text5("Documentation")]), div2([classes(["home-docs__grid"])])([renderDocBox("tutorial")("Getting Started")("Installation, setup, and your first visualization")(routeToPath(GettingStarted.value))("Start Here \u2192")(Nothing.value), renderDocBox("howto")("How-to Guides")("Step-by-step instructions for building specific visualizations")(routeToPath(HowtoIndex.value))("Browse Guides \u2192")(new Just("cogs.jpeg")), renderDocBox("reference")("API Reference")("Complete technical documentation with type signatures")(routeToPath(Reference.value))("View API \u2192")(Nothing.value), renderDocBox("explanation")("Understanding")("Concepts, patterns, and design philosophy")(routeToPath(About.value))("Learn More \u2192")(new Just("bookmark.jpeg"))])]), section([classes(["home-examples"])])([h2([classes(["home-examples__title"])])([text5("Example Visualizations")]), div2([classes(["home-examples__grid"])])([renderExampleCard("Basic Charts")("Bar charts, line charts, and scatter plots")(routeToPath(Tutorial.value)), renderExampleCard("Hierarchies")("Trees, dendrograms, circle packing, and treemaps")(routeToPath(Hierarchies.value)), renderExampleCard("Network Diagrams")("Chord diagrams, Sankey diagrams, and force layouts")(routeToPath(ChordDiagram.value)), renderExampleCard("Code Explorer")("Interactive exploration of visualization code")(routeToPath(CodeExplorer.value))])])]);
  };
  ...
  // output/PSD3.HowtoIndex/index.js
    ...
    return function(title4) {
      return function(description) {
        return function(difficulty) {
          return div2([classes(["howto-item"])])([div2([classes(["howto-item__header"])])([h3([classes(["howto-item__title"])])([a([href4("#" + routeToPath(new Explore(snippetId))), classes(["howto-item__link"])])([text5(title4)])]), span3([classes(["howto-item__difficulty", "howto-item__difficulty--" + toLower(difficulty)])])([text5(difficulty)])]), p([classes(["howto-item__description"])])([text5(description)])]);
        };
      };
    };
  };
  ...
  var _rhsNav7 = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  ...
  // output/PSD3.CodeExample/index.js
  ...
  // output/PSD3.InterpretersDemo/index.js
  ...
  var pure111 = /* @__PURE__ */ pure(applicativeD3PrinterM);
  var sampleData = [{
    x: 50,
    y: 100
  }, {
  ...
  var scatterPlotString = /* @__PURE__ */ bind111(/* @__PURE__ */ attach(d3Tagless)("div.scatterplot-viz"))(function(v) {
    return bind111(appendTo1(v)(Svg.value)([classed10("simple-scatterplot"), width16(400), height16(300), viewBox(0)(0)(400)(300)]))(function(svg2) {
      return bind111(appendTo1(svg2)(Group.value)([classed10("dots")]))(function(dotsGroup) {
        return bind111(traverse_14(function(pt) {
          return bind111(appendTo1(dotsGroup)(Circle.value)([cx4(pt.x), cy4(pt.y), radius8(4), fill9("steelblue"), fillOpacity6(0.7)]))(function() {
            return pure111(unit);
          });
        })(sampleData))(function() {
          return pure111(dotsGroup);
        });
      });
    });
  });
  ...
  var renderInterpreterContent = function(state3) {
    return function(v) {
      ...
      ;
      throw new Error("Failed pattern match at PSD3.Interpreters (line 210, column 34 - line 270, column 8): " + [v.constructor.name]);
    };
  };
  var interpreterTitle = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.Interpreters (line 187, column 20 - line 192, column 55): " + [v.constructor.name]);
  };
  var interpreterDescription = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.Interpreters (line 196, column 26 - line 206, column 205): " + [v.constructor.name]);
  };
  ...
  var handleAction10 = function(v) {
    if (v instanceof Initialize11) {
      return bind24(liftEffect15(generateD3Code))(function(d3Code) {
        return bind24(liftAff5(readSnippetFiles("TLCSimple.purs")))(function(exampleCode) {
          return bind24(liftAff5(readSnippetFiles("VegaLiteExample.purs")))(function(vegaCode) {
            return bind24(liftAff5(readSnippetFiles("MermaidExample.purs")))(function(mermaidCode) {
  ...
  // output/PSD3.Reference/index.js
  ...
  var _rhsNav9 = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  var render14 = function(v) {
    return div2([classes(["reference-page"])])([renderTOC({
      ...
      image: Nothing.value
    }), slot_11(_rhsNav9)(unit)(component)(Reference.value), section([classes(["tutorial-section", "tutorial-intro"])])([h1([classes(["tutorial-title"])])([text5("API Reference")]), p_([text5("Complete technical documentation for the PS<$>D3 library. This reference provides detailed information about every function, type, and type class in the library.")])]), section([classes(["tutorial-section"]), id2("core")])([h2([classes(["tutorial-section-title"])])([text5("Core Concepts")]), p_([text5("PS<$>D3 is built on the Finally Tagless pattern, which allows you to write visualization code once and interpret it in multiple ways. The core abstraction is the "), code_([text5("SelectionM")]), text5(" type class.")]), h3_([text5("The SelectionM Type Class")]), pre_([code_([text5("class Monad m <= SelectionM s m | m -> s where\n  attach :: Selector s -> m s\n  appendTo :: s -> Element -> Array (Attr s) -> m s\n  selectAll :: s -> Selector s -> m s\n  -- ... and many more operations")])]), p_([text5("This type class defines the operations you can perform on D3 selections. The "), code_([text5("s")]), text5(" type parameter represents a selection, and "), code_([text5("m")]), text5(" is the monad in which these operations run.")])]), section([classes(["tutorial-section"]), id2("selection")])([h2([classes(["tutorial-section-title"])])([text5("Selection Operations")]), p_([text5("These functions form the core of PS<$>D3's selection API, allowing you to create, modify, and manipulate DOM elements.")]), h3([id2("attach")])([text5("attach")]), pre_([code_([text5("attach :: forall s m. SelectionM s m => Selector s -> m s")])]), p_([text5("Attaches to an existing DOM element using a CSS selector. This is typically the first operation in any D3 visualization.")]), p_([strong_([text5("Parameters:")])]), ul_([li_([code_([text5("Selector s")]), text5(' - A CSS selector string (e.g., "div.chart", "#visualization")')])]), p_([strong_([text5("Returns:")])]), ul_([li_([text5("A selection containing the matched element")])]), p_([strong_([text5("Example:")])]), pre_([code_([text5('root <- attach "div.my-chart"')])]), h3([id2("appendTo")])([text5("appendTo")]), pre_([code_([text5("appendTo :: forall s m. SelectionM s m => s -> Element -> Array (Attr s) -> m s")])]), p_([text5("Appends a new element to an existing selection with specified attributes.")]), p_([strong_([text5("Parameters:")])]), ul_([li_([code_([text5("s")]), text5(" - The parent selection to append to")]), li_([code_([text5("Element")]), text5(" - The type of element to create (Svg, Rect, Circle, etc.)")]), li_([code_([text5("Array (Attr s)")]), text5(" - Array of attributes to apply to the new element")])]), p_([strong_([text5("Returns:")])]), ul_([li_([text5("A selection containing the newly created element")])]), p_([strong_([text5("Example:")])]), pre_([code_([text5("svg <- appendTo root Svg\n  [ Width 400.0\n  , Height 300.0\n  , ViewBox 0.0 0.0 400.0 300.0\n  ]")])]), h3([id2("selectAll")])([text5("selectAll")]), pre_([code_([text5("selectAll :: forall s m. SelectionM s m => s -> Selector s -> m s")])]), p_([text5("Selects all descendant elements matching the given selector within a selection.")]), p_([strong_([text5("Parameters:")])]), ul_([li_([code_([text5("s")]), text5(" - The parent selection to search within")]), li_([code_([text5("Selector s")]), text5(" - CSS selector for the elements to find")])]), p_([strong_([text5("Returns:")])]), ul_([li_([text5("A selection containing all matched elements")])]), p_([strong_([text5("Example:")])]), pre_([code_([text5('circles <- selectAll svg "circle"')])])]), section([classes(["tutorial-section"]), id2("data")])([h2([classes(["tutorial-section-title"])])([text5("Data Binding")]), p_([text5("Documentation for data binding functions coming soon...")])]), section([classes(["tutorial-section"]), id2("scales")])([h2([classes(["tutorial-section-title"])])([text5("Scales")]), p_([text5("Documentation for scale functions coming soon...")])]), section([classes(["tutorial-section"]), id2("axes")])([h2([classes(["tutorial-section-title"])])([text5("Axes")]), p_([text5("Documentation for axis functions coming soon...")])])]);
  };
  ...
  function computeLinkBreadths({ nodes }) {
    for (const node of nodes) {
      ...
      for (const link4 of node.targetLinks) {
        link4.y1 = y110 + link4.width / 2;
        y110 += link4.width;
      }
    }
  }
  function Sankey() {
    let x0 = 0, y0 = 0, x110 = 1, y110 = 1;
    let dx = 24;
    let dy4 = 8, py;
    let id5 = defaultId;
    let align = justify;
    ...
    sankey.size = function(_) {
      return arguments.length ? (x0 = y0 = 0, x110 = +_[0], y110 = +_[1], sankey) : [x110 - x0, y110 - y0];
    };
    sankey.extent = function(_) {
      return arguments.length ? (x0 = +_[0][0], x110 = +_[1][0], y0 = +_[0][1], y110 = +_[1][1], sankey) : [[x0, y0], [x110, y110]];
    };
    ...
    function computeNodeDepths({ nodes: nodes2 }) {
      ...
      while (current.size) {
        ...
        if (++x23 > n) throw new Error("circular link");
        current = next2;
    ...
    function computeNodeLayers({ nodes: nodes2 }) {
      const x23 = max8(nodes2, (d9) => d9.depth) + 1;
      const kx = (x110 - x0 - dx) / (x23 - 1);
      const columns = new Array(x23);
      for (const node of nodes2) {
        const i2 = Math.max(0, Math.min(x23 - 1, Math.floor(align.call(null, node, x23))));
        node.layer = i2;
        node.x0 = x0 + i2 * kx;
        node.x1 = node.x0 + dx;
    ...
    function initializeNodeBreadths(columns) {
      const ky = min8(columns, (c) => (y110 - y0 - (c.length - 1) * py) / sum3(c, value15));
      for (const nodes2 of columns) {
        let y20 = y0;
        for (const node of nodes2) {
          node.y0 = y20;
          node.y1 = y20 + node.value * ky;
          y20 = node.y1 + py;
          for (const link4 of node.sourceLinks) {
            link4.width = link4.value * ky;
          }
        }
        y20 = (y110 - y20 + py) / (nodes2.length + 1);
    ...
    function computeNodeBreadths(graph) {
      ...
      py = Math.min(dy4, (y110 - y0) / (max8(columns, (c) => c.length) - 1));
      ...
      for (let i2 = 1, n = columns.length; i2 < n; ++i2) {
        ...
        for (const target7 of column) {
          ...
          for (const { source: source2, value: value16 } of target7.targetLinks) {
            ...
            y20 += targetTop(source2, target7) * v;
            w += v;
          }
          if (!(w > 0)) continue;
          let dy5 = (y20 / w - target7.y0) * alpha;
          target7.y0 += dy5;
          target7.y1 += dy5;
      ...
      for (let n = columns.length, i2 = n - 2; i2 >= 0; --i2) {
        ...
        for (const source2 of column) {
          ...
          for (const { target: target7, value: value16 } of source2.sourceLinks) {
            let v = value16 * (target7.layer - source2.layer);
            y20 += sourceTop(source2, target7) * v;
            w += v;
          }
          if (!(w > 0)) continue;
          let dy5 = (y20 / w - source2.y0) * alpha;
          source2.y0 += dy5;
          source2.y1 += dy5;
    ...
    function resolveCollisions(nodes2, alpha) {
      ...
      resolveCollisionsBottomToTop(nodes2, y110, nodes2.length - 1, alpha);
      resolveCollisionsTopToBottom(nodes2, y0, 0, alpha);
    }
    function resolveCollisionsTopToBottom(nodes2, y20, i2, alpha) {
      for (; i2 < nodes2.length; ++i2) {
        const node = nodes2[i2];
        const dy5 = (y20 - node.y0) * alpha;
        if (dy5 > 1e-6) node.y0 += dy5, node.y1 += dy5;
        y20 = node.y1 + py;
      }
    }
    function resolveCollisionsBottomToTop(nodes2, y20, i2, alpha) {
      for (; i2 >= 0; --i2) {
        const node = nodes2[i2];
        const dy5 = (node.y1 - y20) * alpha;
        if (dy5 > 1e-6) node.y0 -= dy5, node.y1 -= dy5;
        y20 = node.y0 - py;
      }
    }
    ...
    function targetTop(source2, target7) {
      let y20 = source2.y0 - (source2.sourceLinks.length - 1) * py / 2;
      for (const { target: node, width: width23 } of source2.sourceLinks) {
        if (node === target7) break;
        y20 += width23 + py;
      }
      for (const { source: node, width: width23 } of target7.targetLinks) {
    ...
    function sourceTop(source2, target7) {
      let y20 = target7.y0 - (target7.targetLinks.length - 1) * py / 2;
      for (const { source: node, width: width23 } of target7.targetLinks) {
        if (node === source2) break;
        y20 += width23 + py;
      }
  ...
  Path4.prototype = path2.prototype = {
    ...
    arcTo: function(x110, y110, x23, y23, r) {
      ...
      else if (!(Math.abs(y01 * x212 - y21 * x01) > epsilon3) || !r) {
        this._ += "L" + (this._x1 = x110) + "," + (this._y1 = y110);
      } else {
        var x202 = x23 - x0, y20 = y23 - y0, l21_2 = x212 * x212 + y21 * y21, l20_2 = x202 * x202 + y20 * y20, l21 = Math.sqrt(l21_2), l01 = Math.sqrt(l01_2), l = r * Math.tan((pi3 - Math.acos((l21_2 + l01_2 - l20_2) / (2 * l21 * l01))) / 2), t01 = l / l01, t21 = l / l21;
    ...
    arc: function(x23, y20, r, a0, a1, ccw) {
      ...
      if (da > tauEpsilon2) {
        ...
        this._ += "A" + r + "," + r + ",0," + +(da >= pi3) + "," + cw + "," + (this._x1 = x23 + r * Math.cos(a1)) + "," + (this._y1 = y20 + r * Math.sin(a1));
      }
    },
    rect: function(x23, y20, w, h) {
      this._ += "M" + (this._x0 = this._x1 = +x23) + "," + (this._y0 = this._y1 = +y20) + "h" + +w + "v" + +h + "h" + -w + "Z";
  ...
  function constant_default6(x23) {
    return function constant2() {
      return x23;
    };
  }
  ...
  function link3(curve) {
    var source2 = linkSource, target7 = linkTarget, x23 = x15, y20 = y11, context = null;
    function link4() {
      ...
      curve(context, +x23.apply(this, (argv[0] = s, argv)), +y20.apply(this, argv), +x23.apply(this, (argv[0] = t, argv)), +y20.apply(this, argv));
    ...
    link4.x = function(_) {
      return arguments.length ? (x23 = typeof _ === "function" ? _ : constant_default6(+_), link4) : x23;
    };
    link4.y = function(_) {
      return arguments.length ? (y20 = typeof _ === "function" ? _ : constant_default6(+_), link4) : y20;
    };
  ...
  function curveHorizontal(context, x0, y0, x110, y110) {
    context.moveTo(x0, y0);
    context.bezierCurveTo(x0 = (x0 + x110) / 2, y0, x0, y110, x110, y110);
  }
  ...
  var sankeySetDataWithConfig_ = (data) => (width23) => (height23) => (config) => () => {
    const sankeyGenerator = Sankey().nodeWidth(config.nodeWidth).nodePadding(config.nodePadding).nodeAlign(getAlignmentFunction(config.alignment)).extent([[1, 1], [width23 - 1, height23 - 5]]);
    const dataCopy = {
  ...
  var sankeySetData_ = (data) => (width23) => (height23) => () => {
    return sankeySetDataWithConfig_(data)(width23)(height23)({
      alignment: "justify",
  ...
  var sankeySetDataWithConfig = function(dictMonadEffect) {
    ...
    return function(data_2) {
      return function(width23) {
        return function(height23) {
          return function(config) {
            return liftEffect20(sankeySetDataWithConfig_(data_2)(width23)(height23)(config));
          };
        };
      };
    };
  ...
  var sankeySetData = function(dictMonadEffect) {
    ...
    return function(data_2) {
      return function(width23) {
        return function(height23) {
          return liftEffect20(sankeySetData_(data_2)(width23)(height23));
        };
      };
    };
  };
  ...
  var y14 = /* @__PURE__ */ y(toAttrNumberFn);
  var width17 = /* @__PURE__ */ width8(toAttrNumberFn);
  var height17 = /* @__PURE__ */ height8(toAttrNumberFn);
        ...
        return function(dictSankeyM) {
          ...
          return function(sankeyData) {
            return function(selector) {
              return bind32(liftEffect20(getWindowWidthHeight))(function(v) {
                return bind32(attach2(selector))(function(v1) {
                  return bind32(appendTo2(v1)(Svg.value)([viewBox(0)(0)(v.value0)(v.value1), classed11("sankey")]))(function(svg2) {
                    return bind32(appendTo2(svg2)(Group.value)([classed11("links")]))(function(linksGroup) {
                      return bind32(appendTo2(svg2)(Group.value)([classed11("nodes")]))(function(nodesGroup) {
                        return bind32(appendTo2(svg2)(Group.value)([classed11("labels")]))(function(labelsGroup) {
                          return bind32(setSankeyData2(sankeyData)(v.value0)(v.value1))(function(layoutResult) {
                            return bind32(simpleJoin2(linksGroup)(Path.value)(layoutResult.links)(keyForLink))(function(linksSelection) {
                              return discard111(setAttributes2(linksSelection)([classed11("sankey-link"), fill10("none"), strokeWidth9(link_2.width), strokeOpacity3(0.5), d5(sankeyLinkPath_), strokeColor10(link_2.color)]))(function() {
                                return bind32(simpleJoin2(nodesGroup)(Rect.value)(layoutResult.nodes)(keyForNode))(function(nodesSelection) {
                                  return discard111(setAttributes2(nodesSelection)([classed11("sankey-node"), x16(node_.x0), y14(node_.y0), width17(function(n) {
                                    return node_.x1(n) - node_.x0(n);
                                  }), height17(function(n) {
                                    return node_.y1(n) - node_.y0(n);
                                  }), fill12(node_.color), fillOpacity7(0.8)]))(function() {
                                    return bind32(simpleJoin2(labelsGroup)(Text2.value)(layoutResult.nodes)(keyForNode))(function(labelsSelection) {
                                      return discard111(setAttributes2(labelsSelection)([classed11("sankey-label"), x16(function(n) {
  ...
  var sankeyMD3Selection_D3Sank = {
    setSankeyData: function(data_2) {
      return function(width23) {
        return function(height23) {
          return sankeySetData2(data_2)(width23)(height23);
        };
      };
    },
    setSankeyDataWithConfig: function(data_2) {
      return function(width23) {
        return function(height23) {
          return function(config) {
            return sankeySetDataWithConfig2(data_2)(width23)(height23)(config);
          };
        };
      };
    },
  ...
  var runWithD3_Sankey = function(dictBind) {
    ...
    return function(dictMonadState) {
      ...
      return function(dictMonadEffect) {
        var liftEffect20 = liftEffect(dictMonadEffect);
        return function(state_T) {
          return bind32(get9)(function(state3) {
            return bind32(liftEffect20(exec_D3M_Sankey(state3)(state_T)))(function(state$prime) {
              return modify_9(function(v) {
                return state$prime;
              });
            });
      ...
      return function(dictSelectionM) {
        ...
        return function(data$prime) {
          return function(selector) {
            ...
            var maxPop = fromMaybe(0)(maximum2(map46(function(v) {
              return v.population;
            })(data$prime)));
            ...
            var getStateX = function(state$prime) {
              return fromMaybe(0)(map115(function(i2) {
            ...
            var getAgeColor = function(age$prime) {
              return fromMaybe("#999999")(bind25(findIndex(function(a2) {
                return a2 === age$prime;
              })(ages))(function(i2) {
                return index2(ageColors)(i2);
              }));
            };
            return bind113(attach2(selector))(function(v) {
              return bind113(appendTo2(v)(Svg.value)([classed13("grouped-bar-chart"), width18(dims.width), height18(dims.height)]))(function(svg2) {
                return bind113(appendTo2(svg2)(Group.value)([transform([function(v1) {
                  return "translate(" + (show21(dims.marginLeft) + ("," + (show21(dims.marginTop) + ")")));
                }]), classed13("chart")]))(function(chartGroup) {
                  var drawBar = function(d9) {
                    ...
                    return bind113(appendTo2(chartGroup)(Rect.value)([x17(barX), y15(barY), width18(barWidth), height18(barHeight), fill11(getAgeColor(d9.age)), strokeColor11("white"), classed13("bar")]))(function() {
                      return pure39(unit);
                    });
                  };
                  return bind113(traverse_7(drawBar)(data$prime))(function() {
                    return bind113(appendTo2(chartGroup)(Group.value)([transform([function(v1) {
                      return "translate(0," + (show21(chartHeight) + ")");
                    }]), classed13("x-axis")]))(function(xAxis) {
                      var drawStateLabel = function(state$prime) {
                        var labelX = getStateX(state$prime) + stateWidth / 2;
                        return bind113(appendTo2(xAxis)(Text2.value)([x17(labelX), y15(20), text14(state$prime), textAnchor9("middle"), classed13("axis-label")]))(function() {
                          return pure39(unit);
                        });
                      };
                      return bind113(traverse_7(drawStateLabel)(states))(function() {
                        return bind113(appendTo2(chartGroup)(Group.value)([classed13("y-axis")]))(function(yAxis) {
                          var yTicks = [0, maxPop / 4, maxPop / 2, 3 * maxPop / 4, maxPop];
                          var drawYTick = function(value16) {
                            var tickY = chartHeight - value16 / maxPop * chartHeight;
                            return bind113(appendTo2(yAxis)(Text2.value)([x17(-10), y15(tickY + 4), text14(formatSI(value16)), textAnchor9("end"), classed13("axis-label")]))(function() {
                              return pure39(unit);
                            });
                          };
                          return bind113(traverse_7(drawYTick)(yTicks))(function() {
                            return pure39(unit);
                          });
                        });
                      });
  ...
  var groupBySeries = function(data$prime) {
    var series = nub4(map47(function(v) {
      return v.series;
    })(data$prime));
    ...
    return map47(getSeriesData)(series);
  };
  var getSeries = /* @__PURE__ */ (function() {
    var $53 = map47(function(v) {
      return v.series;
    });
    return function($54) {
      return nub4($53($54));
      ...
      return function(dictSelectionM) {
        ...
        return function(data$prime) {
          return function(selector) {
            ...
            var chartWidth = dims.width - dims.marginLeft - dims.marginRight;
            var chartHeight = dims.height - dims.marginTop - dims.marginBottom;
            var allValues = map47(function(v) {
              return v.value;
            })(data$prime);
            var maxValue = fromMaybe(0)(maximum3(allValues));
            var minValue = fromMaybe(0)(minimum2(allValues));
            ...
            var getSeriesColor = function(s) {
              return fromMaybe("#999999")(bind26(findIndex(function(x110) {
                return x110 === s;
            ...
            return bind113(attach2(selector))(function(v) {
              return bind113(appendTo2(v)(Svg.value)([classed14("multi-line-chart"), width19(dims.width), height19(dims.height)]))(function(svg2) {
                return bind113(appendTo2(svg2)(Group.value)([transform([function(v1) {
                  return "translate(" + (show25(dims.marginLeft) + ("," + (show25(dims.marginTop) + ")")));
                }]), classed14("chart")]))(function(chartGroup) {
                  var drawLine = function(points) {
                    ...
                    if (v1 instanceof Just) {
                      ...
                      return bind113(appendTo2(chartGroup)(Path.value)([d6(pathData), strokeColor12(color2), strokeWidth10(2), fill13("none"), classed14("line")]))(function() {
                        return pure39(unit);
                      });
                    }
                    ;
                  ...
                  return bind113(traverse_7(drawLine)(groupedData))(function() {
                    return bind113(appendTo2(chartGroup)(Group.value)([classed14("y-axis")]))(function(yAxis) {
                      var yTicks = [0, 5, 10, 15];
                      var yScale = function(v1) {
                        return chartHeight - (v1 - minValue) / (maxValue - minValue) * chartHeight;
                      };
                      var drawYTick = function(value16) {
                        var tickY = yScale(value16);
                        return bind113(appendTo2(yAxis)(Text2.value)([x18(-10), y16(tickY + 4), text15(toString(value16) + "%"), textAnchor10("end"), classed14("axis-label")]))(function() {
                          return pure39(unit);
                        });
                      };
                      return bind113(traverse_7(drawYTick)(yTicks))(function() {
                        return bind113(appendTo2(chartGroup)(Group.value)([transform([function(v1) {
                          return "translate(" + (show25(chartWidth + 20) + ", 0)");
                        }]), classed14("legend")]))(function(legend2) {
                          var drawLegendItem = function(idx) {
                            return function(series$prime) {
                              ...
                              return bind113(appendTo2(legend2)(Rect.value)([x18(0), y16(yPos), width19(15), height19(15), fill13(color2)]))(function() {
                                return bind113(appendTo2(legend2)(Text2.value)([x18(20), y16(yPos + 12), text15(series$prime), textAnchor10("start"), classed14("legend-label")]))(function() {
                                  return pure39(unit);
                                });
                              });
                            };
                          };
                          return bind113(traverse_7(function(t) {
    ...
    return function(outerRadius) {
      return function(startAngle) {
        return function(endAngle) {
          var y32 = innerRadius * sin(endAngle);
          var y23 = outerRadius * sin(endAngle);
          var y110 = outerRadius * sin(startAngle);
          var y0 = innerRadius * sin(startAngle);
          var x32 = innerRadius * cos(endAngle);
          var x23 = outerRadius * cos(endAngle);
          var x110 = outerRadius * cos(startAngle);
          ...
          return "M " + (toString(x0) + (" " + (toString(y0) + (" L " + (toString(x110) + (" " + (toString(y110) + (" A " + (toString(outerRadius) + (" " + (toString(outerRadius) + (" 0 " + (largeArc + (" 1 " + (toString(x23) + (" " + (toString(y23) + (" L " + (toString(x32) + (" " + (toString(y32) + (" A " + (toString(innerRadius) + (" " + (toString(innerRadius) + (" 0 " + (largeArc + (" 0 " + (toString(x0) + (" " + (toString(y0) + " Z")))))))))))))))))))))))))))))));
        };
      };
    };
  };
      ...
      return function(dictSelectionM) {
        ...
        return function(data$prime) {
          return function(selector) {
            ...
            var maxTotal = fromMaybe(0)(maximum4(map48(getStateTotal)(states)));
            var anglePerState = 2 * pi / stateCount;
            var anglepadding = 0.02 * anglePerState;
            var ageColors = ["#e41a1c", "#377eb8", "#4daf4a", "#984ea3", "#ff7f00", "#ffff33", "#a65628", "#f781bf", "#999999"];
            var getAgeColor = function(age$prime) {
              return fromMaybe("#999999")(bind27(findIndex(function(a2) {
                return a2 === age$prime;
              })(ages))(function(i2) {
                return index2(ageColors)(i2);
              }));
            ...
            return bind113(attach2(selector))(function(v) {
              return bind113(appendTo2(v)(Svg.value)([classed15("radial-stacked-bar"), width20(dims.width), height20(dims.height)]))(function(svg2) {
                return bind113(appendTo2(svg2)(Group.value)([transform([function(v1) {
                  return "translate(" + (show26(centerX) + ("," + (show26(centerY) + ")")));
                }]), classed15("chart")]))(function(chartGroup) {
                  var drawStateBar = function(stateIdx) {
                    return function(state$prime) {
                      var stateData = getStateData(state$prime)(data$prime);
                      var values2 = map48(function(v1) {
                      ...
                      var drawSegment = function(ageIdx) {
                        return function(seg) {
                          ...
                          if (v1 instanceof Just) {
                            ...
                            return bind113(appendTo2(chartGroup)(Path.value)([d7(pathData), fill14(color2), fillOpacity8(0.8), strokeColor13("#ffffff"), classed15("segment")]))(function() {
                              return pure39(unit);
                            });
                          }
                          ;
                  ...
                  return bind113(traverse_7(function(t) {
                    ...
                    var drawStateLabel = function(stateIdx) {
                      return function(state$prime) {
                        ...
                        return bind113(appendTo2(chartGroup)(Text2.value)([x19(labelX), y17(labelY), text16(state$prime), textAnchor11("middle"), transform([function(v1) {
                          return "rotate(" + (toString(rotation) + (" " + (toString(labelX) + (" " + (toString(labelY) + ")")))));
                        }]), classed15("state-label")]))(function() {
                          return pure39(unit);
                        });
                      };
                    };
  ...
  // output/PSD3.SimpleCharts/index.js
  var bind28 = /* @__PURE__ */ bind(bindHalogenM);
  var liftEffect16 = /* @__PURE__ */ liftEffect(/* @__PURE__ */ monadEffectHalogenM(monadEffectAff));
  var draw14 = /* @__PURE__ */ draw11(bindD3M)(monadEffD3M)(d3TaglessD3M);
  var draw15 = /* @__PURE__ */ draw12(bindD3M)(monadEffD3M)(d3TaglessD3M);
  var draw23 = /* @__PURE__ */ draw13(bindD3M)(monadEffD3M)(d3TaglessD3M);
  ...
  var handleAction13 = function(v) {
    return bind28(liftEffect16(eval_D3M(draw14(groupedBarData)("div.grouped-bar-viz"))))(function() {
      return bind28(liftEffect16(eval_D3M(draw15(multiLineData)("div.multi-line-viz"))))(function() {
        return bind28(liftEffect16(eval_D3M(draw23(groupedBarData)("div.radial-stacked-viz"))))(function() {
          return pure35(unit);
        });
      });
    });
  };
  var _rhsNav11 = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
      ...
      return function(dictSelectionM) {
        ...
        return function(dataPoints) {
          return function(selector) {
            ...
            var xValues = map49(function(v) {
              return v.x;
            })(dataPoints);
            var yValues = map49(function(v) {
              return v.y;
            })(dataPoints);
            ...
            return bind32(attach2(selector))(function(v) {
              return bind32(appendTo2(v)(Svg.value)([viewBox(0)(0)(defaultDimensions.width)(defaultDimensions.height), classed16("bar-chart"), width21(defaultDimensions.width), height21(defaultDimensions.height)]))(function(svg2) {
                ...
                return bind32(appendTo2(svg2)(Group.value)([transform([function(v1) {
                  return "translate(" + (show27(defaultDimensions.margin.left) + ("," + (show27(defaultDimensions.margin.top) + ")")));
                }])]))(function(chartGroup) {
                  return bind32(liftEffect20(createLinearScale({
                    domain: [minX, maxX],
                    range: [0, iWidth]
                    ...
                    return bind32(liftEffect20(createLinearScale({
                      ...
                      return bind32(appendTo2(chartGroup)(Group.value)([classed16("x-axis"), transform([function(v1) {
                        return "translate(0," + (show27(iHeight) + ")");
                      }])]))(function(xAxisGroup) {
                        return bind32(appendTo2(chartGroup)(Group.value)([classed16("y-axis"), transform([function(v1) {
                          return "translate(" + (show27(barWidth / 2 * -1 - 5) + ",0)");
                        }])]))(function(yAxisGroup) {
                          return bind32(liftEffect20(callAxis(xAxisGroup)(axisBottom2(xScale))))(function() {
                            return bind32(liftEffect20(callAxis(yAxisGroup)(axisLeft2(yScale))))(function() {
                              var addBar = function(point) {
                                ...
                                return bind32(appendTo2(chartGroup)(Rect.value)([x20(xPos), y18(yPos), width21(barWidth), height21(barHeight), fill15("#4a90e2"), strokeColor14("#357abd"), strokeWidth11(1), classed16("bar")]))(function() {
                                  return pure39(unit);
                                });
                              };
                              return bind32(traverse_7(addBar)(dataPoints))(function() {
                                return pure39(unit);
                              });
                            });
                          });
  ...
  var exGeneralUpdatePattern = function(dictSelectionM) {
    ...
    var openSelection2 = openSelection(dictSelectionM);
    var updateJoin2 = updateJoin(dictSelectionM);
    var discard111 = discard19(Bind1);
    var setAttributes2 = setAttributes(dictSelectionM);
    return function(selector) {
      ...
      var update3 = andThen2([classed17("update"), fill16("gray"), y19(200)])(to(transition2)([x21(xFromIndex2)]));
      var exit = andThen2([classed17("exit"), fill16("brown")])(to(transition2)([y19(400), remove]));
      var enter = andThen2([classed17("enter"), fill16("green"), x21(xFromIndex2), y19(0), text17(function($24) {
        return singleton7(datumIsChar($24));
      }), fontSize7(60)])(to(transition2)([y19(200)]));
      return bind32(attach2(selector))(function(root3) {
        return bind32(appendTo2(root3)(Svg.value)([viewBox(0)(100)(800)(350), classed17("d3svg gup")]))(function(svg2) {
          return bind32(appendTo2(svg2)(Group.value)([]))(function(letterGroup) {
            return pure39(function(letters) {
              return bind32(openSelection2(letterGroup)("text"))(function(enterSelection) {
                return bind32(updateJoin2(enterSelection)(Text2.value)(letters)(keyFunction))(function(updateSelections) {
                  return discard111(setAttributes2(updateSelections.exit)(exit))(function() {
                    return discard111(setAttributes2(updateSelections.update)(update3))(function() {
                      return bind32(appendTo2(updateSelections.enter)(Text2.value)([]))(function(newlyEntered) {
                        return discard111(setAttributes2(newlyEntered)(enter))(function() {
                          return pure39(newlyEntered);
                        });
                      });
                    });
                  });
      ...
      return function(dictSelectionM) {
        ...
        return function(dataPoints) {
          return function(selector) {
            ...
            var xValues = map50(function(v) {
              return v.x;
            })(dataPoints);
            var yValues = map50(function(v) {
              return v.y;
            })(dataPoints);
            var minX = fromMaybe(0)(minimum4(xValues));
            var maxX = fromMaybe(100)(maximum6(xValues));
            var minY = fromMaybe(0)(minimum4(yValues));
            var maxY = fromMaybe(100)(maximum6(yValues));
            return bind32(attach2(selector))(function(v) {
              return bind32(appendTo2(v)(Svg.value)([viewBox(0)(0)(defaultDimensions2.width)(defaultDimensions2.height), classed18("line-chart"), width22(defaultDimensions2.width), height22(defaultDimensions2.height)]))(function(svg2) {
                return bind32(appendTo2(svg2)(Group.value)([transform([function(v1) {
                  return "translate(" + (show28(defaultDimensions2.margin.left) + ("," + (show28(defaultDimensions2.margin.top) + ")")));
                }])]))(function(chartGroup) {
                  return bind32(liftEffect20(createLinearScale({
                    domain: [minX, maxX],
                    range: [0, iWidth]
                    ...
                    return bind32(liftEffect20(createLinearScale({
                      ...
                      return bind32(appendTo2(chartGroup)(Group.value)([classed18("x-axis"), transform([function(v1) {
                        return "translate(0," + (show28(iHeight) + ")");
                      }])]))(function(xAxisGroup) {
                        return bind32(appendTo2(chartGroup)(Group.value)([classed18("y-axis")]))(function(yAxisGroup) {
                          return bind32(liftEffect20(callAxis(xAxisGroup)(axisBottom2(xScale))))(function() {
                            return bind32(liftEffect20(callAxis(yAxisGroup)(axisLeft2(yScale))))(function() {
                              return bind32(liftEffect20(createLineGenerator({
                                xScale,
                                yScale
                              })))(function(lineGen) {
                                var pathData = generateLinePath(lineGen)(dataPoints);
                                return bind32(appendTo2(chartGroup)(Path.value)([d8(pathData), fill17("none"), strokeColor15("#4a90e2"), strokeWidth12(2), classed18("line")]))(function() {
                                  return pure39(unit);
                                });
                              });
                            });
  ...
  var drawThreeCircles = function(dictSelectionM) {
    ...
    var appendTo2 = appendTo(dictSelectionM);
    var simpleJoin2 = simpleJoin(dictSelectionM);
    var discard111 = discard20(Bind1);
    var setAttributes2 = setAttributes(dictSelectionM);
    var pure39 = pure(Monad0.Applicative0());
    return function(selector) {
      return bind32(attach2(selector))(function(root3) {
        return bind32(appendTo2(root3)(Svg.value)([viewBox(-10)(20)(120)(60), classed19("d3svg gup")]))(function(svg2) {
          return bind32(appendTo2(svg2)(Group.value)([]))(function(circleGroup) {
            return bind32(simpleJoin2(circleGroup)(Circle.value)([32, 57, 293])(keyIsID_))(function(circles) {
              return discard111(setAttributes2(circles)([fill18("green"), cx5(xFromIndex), cy5(50), radius9(10)]))(function() {
                return pure39(circles);
              });
            });
          });
        });
  ...
  var datum_2 = {
    ...
    y: function(d9) {
      return 100 - toNumber(d9) / 5;
    },
    color: function(d9) {
      return d3SchemePairedN_(toNumber(d9) / 100);
    }
  };
  var drawWithData = function(dictSelectionM) {
    ...
    return function(circleData) {
      return function(selector) {
        return bind32(attach2(selector))(function(root3) {
          return bind32(appendTo2(root3)(Svg.value)([viewBox(-10)(-100)(320)(160), classed19("d3svg gup")]))(function(svg2) {
            return bind32(appendTo2(svg2)(Group.value)([]))(function(circleGroup) {
              return bind32(simpleJoin2(circleGroup)(Circle.value)(circleData)(keyIsID_))(function(circles) {
                return discard111(setAttributes2(circles)([strokeColor16(datum_2.color), strokeWidth13(3), fill18("none"), cx5(datum_2.x), cy1(datum_2.y), radius9(10)]))(function() {
                  return pure39(circles);
                });
              });
            });
  ...
  var discard110 = /* @__PURE__ */ discard21(bindAff);
  ...
  var draw19 = /* @__PURE__ */ draw17(bindD3M)(monadEffD3M)(d3TaglessD3M);
  ...
  var runUpdate = function(update3) {
    var getLetters = (function() {
      ...
      return function __do4() {
        var choices = sequence2(map51(coinToss)(letters))();
        return catMaybes(choices);
      };
    })();
    return bind112(liftEffect17(getLetters))(function(letters) {
      return discard110(update3(letters))(function() {
        return delay(2300);
      });
    });
  };
  var runGeneralUpdatePattern = function(dictMonadEffect) {
    ...
    return discard21(Bind1)(log3(dictMonadEffect)("General Update Pattern example"))(function() {
      return bind32(liftEffect22(eval_D3M(exGeneralUpdatePattern2("div.gup-viz"))))(function(update3) {
        return pure210(function(letters) {
          return liftEffect17(applySecond3(runD3M(update3(letters)))(pure36(unit)));
        });
      });
    });
  };
  var runGeneralUpdatePattern1 = /* @__PURE__ */ runGeneralUpdatePattern(monadEffectHalogenM2);
  var lhsNav = /* @__PURE__ */ (function() {
    return renderTOC({
      title: "Contents",
      items: [{
        anchor: "section-1",
        label: "1. Three Little Circles",
        level: 0
      }, {
        anchor: "section-2",
        label: "2. General Update Pattern",
        level: 0
      }, {
        anchor: "section-3",
        label: "3. Data-Driven Positioning",
        level: 0
      }, {
        anchor: "section-4",
        label: "4. Bar Charts with Scales",
        level: 0
      }, {
        anchor: "section-5",
        label: "5. Line Charts and Paths",
        level: 0
      }, {
        anchor: "section-6",
        label: "6. Anscombe's Quartet",
        level: 0
      }, {
        anchor: "section-7",
        label: "7. Next Steps",
  ...
  var handleAction14 = function(v) {
    if (v instanceof Initialize15) {
      return bind29(liftAff6(readSnippetFiles("TLCSimple.purs")))(function(threeCircles) {
        return bind29(liftAff6(readSnippetFiles("GUP.purs")))(function(gup) {
          return bind29(liftAff6(readSnippetFiles("TLCParabola.purs")))(function(parabola) {
            return bind29(liftAff6(readSnippetFiles("BarChartDraw.purs")))(function(barChart) {
              return bind29(liftAff6(readSnippetFiles("LineChartDraw.purs")))(function(lineChart) {
                return bind29(liftAff6(readSnippetFiles("ScatterPlotQuartet.purs")))(function(quartet) {
                  return discard24(modify_7(function(v1) {
                    var $56 = {};
                    for (var $57 in v1) {
                    ...
                    ;
                    $56.threeCirclesSnippet = new Just(threeCircles);
                    $56.gupSnippet = new Just(gup);
                    $56.parabolaSnippet = new Just(parabola);
                    $56.barChartSnippet = new Just(barChart);
                    $56.lineChartSnippet = new Just(lineChart);
                    $56.quartetSnippet = new Just(quartet);
                    return $56;
                  }))(function() {
                    return bind29(liftEffect18(eval_D3M(drawThreeCircles2("div.three-circles-viz"))))(function() {
                      return bind29(runGeneralUpdatePattern1)(function(updateFn) {
                        return bind29(liftAff6(forkAff(forever2(runUpdate(updateFn)))))(function(fiber) {
                          return discard24(modify_7(function(state3) {
                            var $59 = {};
                            ...
                            ;
                            $59.gupFiber = new Just(fiber);
                            return $59;
                          }))(function() {
                            return bind29(liftEffect18(eval_D3M(drawWithData2([310, 474, 613, 726, 814, 877, 914, 926, 914, 877, 814, 726, 613, 474, 310])("div.parabola-viz"))))(function() {
                              return bind29(liftEffect18(eval_D3M(draw18(monthlySales)("div.barchart-viz"))))(function() {
                                return bind29(liftEffect18(eval_D3M(draw19(sineWaveData)("div.linechart-viz"))))(function() {
                                  return bind29(liftEffect18(eval_D3M(drawQuartet3(anscombesQuartet)("div.quartet-viz"))))(function() {
                                    return pure112(unit);
                                  });
                                });
                              });
    ...
    if (v instanceof Finalize3) {
      return bind29(gets2(function(v1) {
        return v1.gupFiber;
      }))(function(maybeFiber) {
  ...
  var discard25 = /* @__PURE__ */ discard(discardUnit)(bindMaybe);
  ...
  var parseQueryPart = function(decoder) {
    var part2tuple = function(input3) {
      var keyVal = map52(decoder)(split("=")(input3));
      return discard25(guard2(length4(keyVal) <= 2))(function() {
        return apply4(map116(Tuple.create)(head2(keyVal)))(index2(keyVal)(1));
      });
    };
    var $27 = map116(fromFoldable19);
  ...
  var parse7 = function(decoder) {
    return function(hash2) {
      var pathParts = function(str2) {
        var parts = fromFoldable110(map52(function($31) {
          return Path3.create(decoder($31));
        })(split("/")(str2)));
        var v2 = unsnoc(parts);
        if (v2 instanceof Just && (v2.value0.last instanceof Path3 && v2.value0.last.value0 === "")) {
          return v2.value0.init;
        }
        ;
        return parts;
      };
      var v = map116(flip(splitAt3)(hash2))(indexOf2("?")(hash2));
      if (v instanceof Just) {
        return append19(pathParts(v.value0.before))(map210(Query2.create)(fromFoldable24(parseQueryPart(decoder)(drop5(1)(v.value0.after)))));
      }
      ;
      if (v instanceof Nothing) {
  ...
  var setHash2 = function(h) {
    return bind30(bind30(windowImpl)(location))(setHash(h));
  };
  var getHash = /* @__PURE__ */ bind30(/* @__PURE__ */ bind30(windowImpl)(location))(/* @__PURE__ */ (function() {
    var $16 = map53((function() {
      var $18 = fromMaybe("");
      var $19 = stripPrefix("#");
      return function($20) {
        return $18($19($20));
  ...
  var foldHashes = function(cb) {
    return function(init4) {
      return function __do4() {
        var ref2 = bindFlipped10($$new)(bindFlipped10(init4)(getHash))();
        var win = map53(toEventTarget)(windowImpl)();
        var listener = eventListener(function(v) {
          return bindFlipped10(flip(write)(ref2))(join3(apply5(map53(cb)(read(ref2)))(getHash)));
        })();
  ...
  var matchesWith = function(dictFoldable) {
    ...
    return function(parser) {
      return function(cb) {
        var go2 = function(a2) {
          var $21 = maybe(pure37(a2))(function(b2) {
  ...
  var slot_22 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "gettingStarted";
    }
  })(ordUnit);
  var slot_32 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "howtoIndex";
    }
  })(ordUnit);
  var slot_42 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "reference";
    }
  })(ordUnit);
  var slot_52 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "about";
    }
  })(ordUnit);
  var slot_62 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "tutorial";
    }
  })(ordUnit);
  var slot_72 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "simpleCharts";
    }
  })(ordUnit);
  var slot_82 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "chordDiagram";
    }
  })(ordUnit);
  var slot_92 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "bubbleChart";
    }
  })(ordUnit);
  var slot_102 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "sankeyDiagram";
    }
  })(ordUnit);
  var slot_112 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "hierarchies";
    }
  })(ordUnit);
  var slot_122 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "interpreters";
    }
  })(ordUnit);
  var slot_132 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
      return "codeExplorer";
    }
  })(ordUnit);
  var component1 = /* @__PURE__ */ component7(monadAffAff);
  var slot_142 = /* @__PURE__ */ slot_15({
    reflectSymbol: function() {
  ...
  var handleAction15 = function(v) {
    if (v instanceof Initialize16) {
      return bind31(subscribe2(makeEmitter(function(push2) {
    ...
    if (v instanceof Navigate) {
      return liftEffect19(setHash2(routeToPath(v.value0)));
    }
    ;
    if (v instanceof RouteChanged) {
      if (v.value0 instanceof Just) {
        return discard26(modify_8(function(v1) {
          var $68 = {};
          for (var $69 in v1) {
          ...
          ;
          $68.currentRoute = v.value0.value0;
          return $68;
        }))(function() {
          return when5(eq8(v.value0.value0)(Home.value))(bind31(liftEffect19(function __do4() {
            var w = windowImpl();
            var loc = location(w)();
            return hash(loc)();
          }))(function(currentHash) {
            return when5(currentHash === "")(liftEffect19(setHash2("/")));
          }));
        });
      }
      ;
      if (v.value0 instanceof Nothing) {
        return modify_8(function(v1) {
          ...
          ;
          $72.currentRoute = NotFound.value;
          return $72;
        });
      }
      ;
      throw new Error("Failed pattern match at PSD3.Main (line 174, column 5 - line 185, column 57): " + [v.value0.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at PSD3.Main (line 158, column 16 - line 185, column 57): " + [v.constructor.name]);
  };
  var _tutorial = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  var _simpleCharts = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  var _sankeyDiagram = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  ...
  var _chordDiagram = /* @__PURE__ */ (function() {
    return $$Proxy.value;
  })();
  ...
  var renderPage = function(route) {
    ...
    if (v instanceof Home) {
      return slot_1(_home)(unit)(component10)(unit);
    }
    ;
    if (v instanceof GettingStarted) {
      return slot_22(_gettingStarted)(unit)(component8)(unit);
    }
    ;
    if (v instanceof HowtoIndex) {
      return slot_32(_howtoIndex)(unit)(component11)(unit);
    }
    ;
    if (v instanceof Reference) {
      return slot_42(_reference)(unit)(component13)(unit);
    }
    ;
    if (v instanceof About) {
      return slot_52(_about)(unit)(component2)(unit);
    }
    ;
    if (v instanceof Tutorial) {
      return slot_62(_tutorial)(unit)(component16)(unit);
    }
    ;
    if (v instanceof SimpleCharts) {
      return slot_72(_simpleCharts)(unit)(component15)(unit);
    }
    ;
    if (v instanceof ChordDiagram) {
      return slot_82(_chordDiagram)(unit)(component4)(unit);
    }
    ;
    if (v instanceof BubbleChart) {
      return slot_92(_bubbleChart)(unit)(component3)(unit);
    }
    ;
    if (v instanceof SankeyDiagram) {
      return slot_102(_sankeyDiagram)(unit)(component14)(unit);
    }
    ;
    if (v instanceof Hierarchies) {
      return slot_112(_hierarchies)(unit)(component9)(unit);
    }
    ;
    if (v instanceof Interpreters) {
      return slot_122(_interpreters)(unit)(component12)(unit);
    }
    ;
    if (v instanceof CodeExplorer) {
      return slot_132(_codeExplorer)(unit)(component1)(unit);
    }
    ;
    if (v instanceof Explore) {
      return slot_142(_codeExploration)(unit)(component5)(v.value0);
    }
    ;
    if (v instanceof NotFound) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.Main (line 104, column 20 - line 155, column 8): " + [v.constructor.name]);
  };
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return runUI2(component17)(unit)(body2);
  }));
