...
(() => {
  ...
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b10) {
        return apply1(map37($$const(identity2))(a2))(b10);
      };
    };
  };
            ...
            return function(array4) {
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  case 2:
                    return apply3(map37(array2)(f(array4[bot])))(f(array4[bot + 1]));
                  case 3:
                    return apply3(apply3(map37(array3)(f(array4[bot])))(f(array4[bot + 1])))(f(array4[bot + 2]));
                  default:
                    var pivot = bot + Math.floor((top2 - bot) / 4) * 2;
                    return apply3(map37(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
      ...
      return function(f) {
        return function(ms) {
          return fold2(function(acc) {
            return function(k) {
              return function(v) {
                return apply3(map37(flip(insert(k)))(acc))(f(k)(v));
              };
            };
          })(pure110(empty))(ms);
        };
        ...
        return function($copy_stack) {
          ...
          function $tco_loop(state3, stack) {
            ...
            if (v1 instanceof Just && v1.value0.value0 instanceof Visit) {
              if (member8(v1.value0.value0.value0)(state3.unvisited)) {
                var start4 = {
          ...
          if (v instanceof Just) {
            var layer = (function() {
              ...
              var depLayers = mapFlipped3(v.value0.depends)(function(depId) {
                return fromMaybe(0)(lookup10(depId)(accLayers));
              });
  ...
  var addLayers = function(dictOrd) {
    ...
    return function(tasks) {
      ...
      return mapFlipped3(tasks)(function(t) {
        return {
          id: t.id,
          layer: fromMaybe(0)(lookup10(t.id)(layers)),
          depends: t.depends
        };
      });
    };
  ...
  var unsafeArrayIndex = function(arr) {
    return function(i2) {
      ...
      ;
      if (v instanceof Nothing) {
        return unsafeCrashWith("swizzleLinks: Array index out of bounds: " + show4(i2));
      }
      ;
    ...
    function start4(elapsed) {
      ...
      timeout_default(function() {
        if (self.state === STARTED) {
          self.state = RUNNING;
          self.timer.restart(tick3, self.delay, self.time);
          tick3(elapsed);
        }
      });
      self.state = STARTING;
              ...
              return function(v) {
                return liftEffect12((function() {
                  ...
                  return function __do2() {
                    ...
                    liftEffect3(log4("joinDataWithKey: found " + (show5(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                    liftEffect3(log4("joinDataWithKey: " + (show5(length(mapMaybe(function(v2) {
                      return v2.datum;
            ...
            return function(v) {
              return liftEffect12((function() {
                ...
                return function __do2() {
                  ...
                  liftEffect3(log4("joinData: found " + (show5(length(existingElements)) + (" existing elements with selector '" + (selector + "'")))))();
                  liftEffect3(log4("joinData: " + (show5(length(mapMaybe(function(v2) {
                    return v2.datum;
                  })(oldBindings))) + " of those have data bound")))();
                  var validOldBindings = mapMaybe(function(v2) {
                    return mapFlipped12(v2.datum)(function(d) {
        ...
        if (v1 instanceof Join2) {
          return function __do2() {
            ...
            liftEffect3((function() {
              ...
              return log4("Tree API Join '" + (v1.value0.name + ("': enter=" + (show5(enterCount) + (", update=" + (show5(updateCount) + (", exit=" + show5(exitCount))))))));
            })())();
        ...
        if (v1 instanceof SceneJoin) {
          return function __do2() {
            ...
            liftEffect3((function() {
              ...
              return log4("Tree API SceneJoin '" + (v1.value0.name + ("': enter=" + (show5(enterCount) + (", update=" + (show5(updateCount) + (", exit=" + show5(exitCount))))))));
            })())();
            (function() {
        ...
        if (v1 instanceof SceneNestedJoin) {
          ...
          return function __do2() {
            ...
            liftEffect3((function() {
              ...
              return log4("Tree API SceneNestedJoin '" + (v1.value0.name + ("': enter=" + (show5(enterCount) + (", update=" + (show5(updateCount) + (", exit=" + show5(exitCount))))))));
            })())();
            (function() {
              if (v1.value0.exitBehavior instanceof Just) {
                if (v1.value0.exitBehavior.value0.transition instanceof Just) {
  ...
  var v3AttrFn = function(dictShow) {
    ...
    return function(name16) {
      return function(f) {
        return new DataAttr(name16, function(d) {
          return new StringValue(show10(f(d)));
        });
      };
    };
  };
  var v3Attr = function(dictShow) {
    ...
    return function(name16) {
      return function(expr) {
        return new DataAttr(name16, function(d) {
          return new StringValue(show10(runEvalD(expr)(d)(0)));
        });
      };
    };
  };
  ...
  var bind8 = /* @__PURE__ */ bind(bindD3v2M);
  ...
  var ordRecord1 = /* @__PURE__ */ ordRecord2(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons2({
    reflectSymbol: function() {
      return "y";
    }
  })(ordNumber))()({
  ...
  var nodeTemplate = function(_node) {
    return withBehaviors(elem3(Circle.value)([v3AttrFn2("cx")(function(v) {
      return v.x;
    }), v3AttrFn2("cy")(function(v) {
      return v.y;
    }), v3AttrFn2("r")(function(n) {
      return max7(5)(n.r * 0.5);
    }), v3AttrStr("fill")(str2("rgba(255, 255, 255, 0.5)")), v3AttrStr("stroke")(str2("rgba(255, 255, 255, 0.8)")), v3Attr2("stroke-width")(lit2(1.5)), v3AttrStr("class")(str2("force-node module-node"))]))([new Drag(new SimulationDrag(simulationId))]);
  };
  var linkTemplate = function(_link) {
    return elem3(Line.value)([v3AttrFn2("x1")(function(v) {
      return v.source.x;
    }), v3AttrFn2("y1")(function(v) {
      return v.source.y;
    }), v3AttrFn2("x2")(function(v) {
      return v.target.x;
    }), v3AttrFn2("y2")(function(v) {
      return v.target.y;
    }), v3AttrStr("stroke")(str2("rgba(255, 255, 255, 0.3)")), v3Attr2("stroke-width")(lit2(1)), v3AttrStr("class")(str2("force-link"))]);
  };
  var tick2 = function(stateRef) {
    return function(_config) {
      return runD3v2M(bind8(liftEffect4(read(stateRef)))(function(state3) {
        return bind8(select7("#force-zoom-group .force-links-group"))(function(linksGroup) {
          return bind8(select7("#force-zoom-group .force-nodes-group"))(function(nodesGroup) {
            var linksTree = joinData("force-links")("line")(state3.swizzled)(linkTemplate);
            return bind8(renderTree1(linksGroup)(linksTree))(function() {
              var nodesTree = joinData("force-nodes")("circle")(state3.nodes)(nodeTemplate);
              return bind8(renderTree22(nodesGroup)(nodesTree))(function() {
                return pure9(unit);
              });
            });
          });
  ...
  var isModuleLink = function(nodes) {
    return function(link3) {
      var tgtNode = find2(function(n) {
        return n.id === link3.target;
      })(nodes);
      var srcNode = find2(function(n) {
        return n.id === link3.source;
      })(nodes);
      if (srcNode instanceof Just && tgtNode instanceof Just) {
        return eq13(srcNode.value0.nodeType)(ModuleNode.value) && eq13(tgtNode.value0.nodeType)(ModuleNode.value);
      }
      ;
      return false;
    };
  ...
  var render2 = function(config) {
    return function(nodes) {
      return function(links) {
        return function __do2() {
          log5("[ForceGraph] Rendering " + (show6(length(nodes)) + " nodes"))();
          var moduleNodes = filter(function(n) {
            return eq13(n.nodeType)(ModuleNode.value);
          })(nodes);
          var moduleLinks = filter(function(l) {
            return isModuleLink(nodes)(l);
          })(links);
          log5("[ForceGraph] Modules: " + (show6(length(moduleNodes)) + (", Links: " + show6(length(moduleLinks)))))();
          var rawLinks = mapFlipped7(moduleLinks)(function(l) {
            return {
              source: l.source,
              target: l.target
            };
          });
          var swizzled = swizzleLinks(moduleNodes)(rawLinks)(function(src9) {
            return function(tgt) {
              return function(i2) {
                return function(v) {
                  return {
          ...
          setNodes(moduleNodes)(sim)();
          setLinks(rawLinks)(sim)();
          ...
          runD3v2M(bind8(select7(config.containerSelector))(function(container) {
            var containerTree = withChildren(withBehaviors(named2(SVG.value)("svg")([v3AttrStr("viewBox")(str2("-950 -570 1900 1140")), v3AttrStr("class")(str2("force-svg"))]))([new Zoom(defaultZoom(new ScaleExtent(0.5, 4))("#force-zoom-group"))]))([withChildren(named2(Group.value)("zoom-group")([v3AttrStr("id")(str2("force-zoom-group"))]))([named2(Group.value)("links-group")([v3AttrStr("class")(str2("force-links-group"))]), named2(Group.value)("nodes-group")([v3AttrStr("class")(str2("force-nodes-group"))])])]);
            return bind8(renderTree32(container)(containerTree))(function() {
              return pure9(unit);
            });
          }))();
          onTick(tick2(stateRef)(config))(sim)();
          start(sim)();
          log5("[ForceGraph] Simulation started")();
          return {
  ...
  var updatePositions = function(config) {
    return function(animState) {
      return function(layout) {
        ...
        var treeNodeMap = fromFoldable16(mapFlipped8(layout.treeNodes)(function(tn) {
  ...
  var buildTreeNodeMap = function(nodes) {
    return fromFoldable16(mapFlipped8(nodes)(function(n) {
      return new Tuple(n.id, n);
    }));
  };
  var buildLinksVizTree = function(linkPathFn) {
  ...
  var buildLinkElement = function(nodeMap) {
    return function(rootX) {
      return function(rootY) {
        return function(v) {
          return bind9(lookup7(v.value0)(nodeMap))(function(sourceNode) {
            return bind9(lookup7(v.value1)(nodeMap))(function(targetNode) {
              return pure10({
    ...
    return function(layout) {
      return function(rootX) {
        return function(rootY) {
          ...
          return function __do2() {
            log6("[TreeView] Adding " + (show7(length(linkElements)) + " tree links"))();
            removeElement(config.containerSelector + " g.tree-links-group")();
            runD3v2M(bind22(select8(config.containerSelector + " svg"))(function(svg) {
              return renderTree4(svg)(buildLinksVizTree(config.style.linkPath)(linkElements)(rootX)(rootY));
            }))();
            return unit;
          };
        };
  ...
  var renderAnimated = function(config) {
    return function(animState) {
      return function(nodes) {
        return function(links) {
          return function __do2() {
            log6("[TreeView] renderAnimated called, isFirstFrame=" + (show14(animState.isFirstFrame) + (", progress=" + show23(animState.progress))))();
            var layout = (function() {
              ...
              if (animState.treeLayout instanceof Nothing) {
                ...
                log6("[TreeView] Using root: " + show7(config.rootId))();
                var result = computeTreeLayout(config.style)(config.rootId)(nodes)(links);
                log6("[TreeView] Layout computed: root=" + (show7(result.rootId) + (" at (" + (show23(result.rootX) + (", " + (show23(result.rootY) + (")" + (", " + (show7(length(result.treeNodes)) + " nodes")))))))))();
                return result;
              }
              ;
            ...
            (function() {
              if (animState.isFirstFrame) {
                log6("[TreeView] First frame - root at (" + (show23(layout.rootX) + (", " + (show23(layout.rootY) + ")"))))();
                return addTreeLinks(config)(layout)(layout.rootX)(layout.rootY)();
              }
              ;
              return unit;
            })();
                          ...
                          return function($copy_remainingValue) {
                            return function($copy_acc) {
                              ...
                              function $tco_loop(i0, i1, x0, y0, x1, y1, remainingValue, acc) {
                                ...
                                var dy = y1 - y0;
                                var dx = x1 - x0;
                                var alpha = max8(dy / dx)(dx / dy) / (remainingValue * ratio);
                                      ...
                                      return function($copy_maxVal) {
                                        return function($copy_minRat) {
                                          ...
                                          function $tco_loop2(idx, sumVal, minVal, maxVal, minRat) {
                                            ...
                                            var newMax = max8(maxVal)(v12.value0.value);
                                            var newBeta = newSum * newSum * alpha;
                                            var newRatio = max8(newMax / newBeta)(newBeta / newMin);
                                ...
                                var isDice = dx < dy;
                                var initial = tryAdd(firstNode.i1)(firstNode.sumValue)(v1.value0.value)(v1.value0.value)(max8(v1.value0.value / beta0)(beta0 / v1.value0.value));
  ...
  })(ordNullable3))()(clusterIsSymbol)(ordInt)))))()(nameIsSymbol)(ordString))()({
    reflectSymbol: function() {
      return "isUsed";
    }
  })(ordBoolean))()({
  ...
  var highlightDependencies = function(containerSelector) {
    return function(node) {
      return function __do2() {
        ...
        log7("[Treemap]   targets (depends on): " + show8(node.targets))();
        log7("[Treemap]   sources (depended on by): " + show8(node.sources))();
        ...
        var classifier = function(rect) {
          ...
          if (rect.simNode instanceof Just) {
            ...
            ;
            var $215 = member7(rect.simNode.value0.id)(targetSet);
            if ($215) {
              return "is-target";
            }
            ;
            var $216 = member7(rect.simNode.value0.id)(sourceSet);
            if ($216) {
              return "is-source";
            }
            ;
  ...
  var render3 = function(config) {
    return function(callbacks) {
      return function(nodes) {
        return function __do2() {
          log7("[Treemap] Rendering " + (show15(length(nodes)) + " nodes"))();
          ...
          log7("[Treemap] Packages: " + (show15(length(packageNodes)) + (", Modules: " + show15(length(moduleNodes)))))();
          var positioned = computeTreemapLayout(config)(packageNodes)(moduleNodes);
          log7("[Treemap] Positioned: " + (show15(length(positioned.packages)) + (" packages, " + (show15(length(positioned.modules)) + " modules"))))();
          var vizTree = buildVizTree(config)(callbacks)(positioned);
          runD3v2M(bind13(select9(config.containerSelector))(function(container) {
  ...
  var showPhase = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Component.App (line 186, column 1 - line 186, column 32): " + [v.constructor.name]);
  };
  var makeTreemapCallbacks = function(mListener) {
    return {
      onNodeClick: function(node) {
        ...
        ;
        throw new Error("Failed pattern match at Component.App (line 420, column 27 - line 422, column 27): " + [mListener.constructor.name]);
      },
      onNodeHover: function(mNode) {
        ...
        ;
        throw new Error("Failed pattern match at Component.App (line 423, column 28 - line 425, column 27): " + [mListener.constructor.name]);
      }
    };
  };
    ...
    return function(state3) {
      return div3([class_("explorer-app")])([div3([class_("status-panel")])([h2_([text("Code Explorer v2")]), p_([text("Phase: " + showPhase(state3.phase))]), p_([text("View: " + viewDescription(state3.viewState))]), (function() {
        ...
        if (state3.modelData instanceof Just) {
          return p_([text("Loaded: " + (show9(state3.modelData.value0.moduleCount) + (" modules, " + (show9(state3.modelData.value0.packageCount) + " packages"))))]);
        }
        ;
        throw new Error("Failed pattern match at Component.App (line 155, column 11 - line 160, column 16): " + [state3.modelData.constructor.name]);
      })(), div3([class_("view-switcher")])([button([onClick(function(v) {
        return SwitchToTreemap.value;
      }), class_((function() {
        var $72 = isTreemapView(state3.viewState);
        if ($72) {
          return "active";
        }
        ;
        ...
        var $73 = isTreeView(state3.viewState);
        if ($73) {
          return "active";
        }
        ;
        ...
        var $74 = isForceView(state3.viewState);
        if ($74) {
          return "active";
        }
        ;
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return discard3(log9("[App] Initializing..."))(function() {
          return bind10(liftEffect10(create))(function(v1) {
            return discard3($$void6(subscribe2(v1.emitter)))(function() {
              return discard3(modify_3(function(v2) {
                ...
                ;
                $85.clickEmitter = new Just(v1.listener);
                return $85;
              }))(function() {
                return $$void6(fork(bind10(liftAff2(loadModel))(function(result) {
                  ...
                  ;
                  throw new Error("Failed pattern match at Component.App (line 220, column 7 - line 222, column 57): " + [result.constructor.name]);
                })));
              });
            });
          });
      ...
      if (v instanceof DataLoaded) {
        return discard3(log9("[App] Data loaded: " + (show9(v.value0.moduleCount) + " modules")))(function() {
          return bind10(get6)(function(state3) {
            return discard3(modify_3(function(v1) {
              ...
              ;
              $93.phase = Ready.value;
              $93.modelData = new Just(v.value0);
              $93.packageCount = v.value0.packageCount;
              return $93;
            }))(function() {
              var config = {
              ...
              return discard3(liftEffect10(render3(config)(callbacks)(v.value0.nodes)))(function() {
          ...
          return bind10(get6)(function(state3) {
            return discard3((function() {
              if (state3.forceHandle instanceof Just) {
                return liftEffect10(state3.forceHandle.value0.cleanup);
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at Component.App (line 256, column 5 - line 258, column 27): " + [state3.forceHandle.constructor.name]);
            })())(function() {
              if (state3.modelData instanceof Nothing) {
                return pure13(unit);
              }
              ...
              if (state3.modelData instanceof Just) {
                return discard3(modify_3(function(v1) {
                  ...
                  ;
                  $104.viewState = new Overview(TreemapView.value);
                  $104.treeAnimation = Nothing.value;
                  $104.treeRootId = Nothing.value;
                  $104.forceHandle = Nothing.value;
                  return $104;
                }))(function() {
                  var config = {
                    containerSelector: "#viz",
                  ...
                  var callbacks = makeTreemapCallbacks(state3.clickEmitter);
                  return discard3(liftEffect10(render3(config)(callbacks)(state3.modelData.value0.nodes)))(function() {
                    return log9("[App] Treemap rendered");
                  });
                });
              }
              ;
              throw new Error("Failed pattern match at Component.App (line 260, column 5 - line 276, column 37): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
        ...
        return discard3(log9("[App] SwitchToTree clicked"))(function() {
          return bind10(get6)(function(state3) {
            return discard3((function() {
              ...
              ;
              throw new Error("Failed pattern match at Component.App (line 282, column 5 - line 284, column 27): " + [state3.forceHandle.constructor.name]);
            })())(function() {
              if (state3.modelData instanceof Nothing) {
              ...
              if (state3.modelData instanceof Just) {
                return discard3(log9("[App] Initializing animation state"))(function() {
                  ...
                  return discard3(modify_3(function(v1) {
                    ...
                    ;
                    $111.viewState = new Overview(TreeView.value);
                    $111.treeAnimation = new Just(initAnimation);
                    $111.treeRootId = new Just(rootId);
                    $111.treeStyle = verticalTree;
                    $111.forceHandle = Nothing.value;
                    return $111;
                  }))(function() {
              ...
              ;
              throw new Error("Failed pattern match at Component.App (line 286, column 5 - line 301, column 27): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
        ...
        return discard3(log9("[App] SwitchToForce clicked"))(function() {
          return bind10(get6)(function(state3) {
            return discard3((function() {
              ...
              ;
              throw new Error("Failed pattern match at Component.App (line 307, column 5 - line 309, column 27): " + [state3.forceHandle.constructor.name]);
            })())(function() {
              if (state3.modelData instanceof Nothing) {
                return log9("[App] No model data, skipping");
              }
              ;
              if (state3.modelData instanceof Just) {
                return discard3(log9("[App] Starting force simulation"))(function() {
                  var config = {
                    containerSelector: "#viz",
                    packageCount: state3.modelData.value0.packageCount
                  };
                  return bind10(liftEffect10(render2(config)(state3.modelData.value0.nodes)(state3.modelData.value0.links)))(function(handle) {
                    return discard3(modify_3(function(v1) {
                      var $118 = {};
                      for (var $119 in v1) {
                      ...
                      ;
                      $118.viewState = new Overview(ForceView.value);
                      $118.treeAnimation = Nothing.value;
                      $118.treeRootId = Nothing.value;
                      $118.forceHandle = new Just(handle);
                      return $118;
                    }))(function() {
                      return log9("[App] Force simulation started");
                    });
                  });
                });
              }
              ;
              throw new Error("Failed pattern match at Component.App (line 311, column 5 - line 328, column 45): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
      ...
      if (v instanceof FocusSubtree) {
        return discard3(log9("[App] FocusSubtree on node " + show9(v.value0)))(function() {
          return bind10(get6)(function(state3) {
            if (state3.modelData instanceof Nothing) {
              return pure13(unit);
            }
            ;
            if (state3.modelData instanceof Just) {
              return discard3(liftEffect10(resetToTreemap("#viz")))(function() {
                return discard3(modify_3(function(v1) {
                  var $123 = {};
                  for (var $124 in v1) {
                  ...
                  ;
                  $123.viewState = new Overview(TreeView.value);
                  $123.treeAnimation = new Just(initAnimation);
                  $123.treeRootId = new Just(v.value0);
                  $123.treeStyle = horizontalTree;
                  return $123;
                }))(function() {
            ...
            ;
            throw new Error("Failed pattern match at Component.App (line 333, column 5 - line 348, column 27): " + [state3.modelData.constructor.name]);
          });
        });
      }
      ;
      if (v instanceof AnimationTick) {
        return bind10(get6)(function(state3) {
          if (state3.treeAnimation instanceof Just && (state3.modelData instanceof Just && (state3.treeRootId instanceof Just && isAnimating(state3.treeAnimation.value0)))) {
            ...
            return bind10(liftEffect10(renderAnimated(config)(state3.treeAnimation.value0)(state3.modelData.value0.nodes)(state3.modelData.value0.links)))(function(animWithLayout) {
              ...
              return discard3(modify_3(function(v1) {
                ...
                ;
                $131.treeAnimation = new Just(newAnim);
                return $131;
              }))(function() {
                return when4(isAnimating(newAnim))(startAnimationLoop(dictMonadAff));
              });
            });
          }
          ;
        ...
        return bind10(get6)(function(state3) {
          ...
          if (state3.viewState instanceof Overview && state3.viewState.value0 instanceof TreemapView) {
            if (v.value0 instanceof Just) {
              return discard3(modify_3(function(v1) {
                ...
                ;
                $141.highlightState = new HoverHighlight(v.value0.value0.id);
                return $141;
              }))(function() {
                return liftEffect10(highlightDependencies("#viz")(v.value0.value0));
              });
            }
            ;
            if (v.value0 instanceof Nothing) {
              return discard3(modify_3(function(v1) {
                ...
                ;
                $145.highlightState = NoHighlight.value;
                return $145;
              }))(function() {
                return liftEffect10(clearHighlight("#viz"));
              });
            }
            ;
            throw new Error("Failed pattern match at Component.App (line 386, column 9 - line 392, column 55): " + [v.value0.constructor.name]);
          }
          ;
          if (v.value0 instanceof Just) {
            return discard3(modify_3(function(v1) {
              ...
              ;
              $150.highlightState = new HoverHighlight(v.value0.value0.id);
              return $150;
            }))(function() {
              return liftEffect10(highlightDependencies("#viz")(v.value0.value0));
            });
          ...
          if (v.value0 instanceof Nothing) {
            return discard3(modify_3(function(v1) {
              ...
              ;
              $154.highlightState = NoHighlight.value;
              return $154;
            }))(function() {
              return liftEffect10(clearHighlight("#viz"));
            });
          ...
          ;
          throw new Error("Failed pattern match at Component.App (line 395, column 9 - line 401, column 55): " + [v.value0.constructor.name]);
        });
      }
      ;
      throw new Error("Failed pattern match at Component.App (line 208, column 16 - line 401, column 55): " + [v.constructor.name]);
    };
  };
  ...
  var selectElement = function(query2) {
    return bind11(liftEffect5(bindFlipped5(composeKleisliFlipped4((function() {
  ...
  var awaitLoad = /* @__PURE__ */ makeAff(function(callback) {
    return function __do2() {
      ...
      if (rs instanceof Loading) {
        var et = map32(toEventTarget)(windowImpl)();
  ...
  var evalQ = function(render5) {
    return function(ref2) {
      return function(q2) {
        return bind14(liftEffect6(read(ref2)))(function(v) {
          return evalM(render5)(ref2)(v["component"]["eval"](new Query(map34(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
    ...
    return function(component3) {
      return function(i2) {
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot) {
                  return function __do2() {
                    var childrenIn = map35(slot.pop)(read(childrenInRef))();
                    var $$var2 = (function() {
                      if (childrenIn instanceof Just) {
                        ...
                        unDriverStateX(function(st) {
                          return function __do3() {
                            ...
                            return handleAff(evalM(render5)(st.selfRef)(st["component"]["eval"](new Receive(slot.input, unit))))();
                          };
                        })(dsx)();
        ...
        var evalDriver = function(disposed) {
          return function(ref2) {
            return function(q2) {
              return bind16(liftEffect7(read(disposed)))(function(v) {
                if (v) {
        ...
        return bind16(liftEffect7(newLifecycleHandlers))(function(lchs) {
          return bind16(liftEffect7($$new(false)))(function(disposed) {
            return handleLifecycle(lchs)(function __do2() {
              var sio = create();
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind17(liftEffect8(map36(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind18(awaitBody)(function() {
    return bind18(selectElement("#app"))(function(mAppEl) {
      if (mAppEl instanceof Nothing) {
        return liftEffect9(log8("[Main] Error: #app element not found"));
      }
      ;
      if (mAppEl instanceof Just) {
        return bind18(runUI2(component2)(unit)(mAppEl.value0))(function() {
          return liftEffect9(log8("[Main] Code Explorer v2 started"));
        });
      }
      ;
