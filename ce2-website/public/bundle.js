...
(() => {
  ...
  var ordNodeType = {
    compare: function(x3) {
      return function(y3) {
        ...
        ;
        throw new Error("Failed pattern match at CE2.Types (line 0, column 0 - line 0, column 0): " + [x3.constructor.name, y3.constructor.name]);
      };
    },
    Eq0: function() {
      return eqNodeType;
  ...
  // output/CE2.Data.Loader/index.js
  ...
  var mapLeft = function(v) {
    return function(v1) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Data.Loader (line 244, column 1 - line 244, column 62): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  var fetchJson = function(url2) {
    return bind3(get3(json)(url2))(function(result) {
      return pure4((function() {
        ...
        ;
        throw new Error("Failed pattern match at CE2.Data.Loader (line 240, column 10 - line 242, column 42): " + [result.constructor.name]);
      })());
    });
  };
  var charCode = function(c) {
    ...
    ;
    throw new Error("Failed pattern match at CE2.Data.Loader (line 883, column 14 - line 885, column 15): " + [v.constructor.name]);
  };
    ...
    return function(moduleIdMap) {
      var addTargets = function(acc) {
        return function(v) {
          ...
          ;
          throw new Error("Failed pattern match at CE2.Data.Loader (line 849, column 5 - line 855, column 42): " + [v1.constructor.name]);
        };
      };
  ...
  var buildLinks = function(modulesObj) {
    return function(moduleIdMap) {
      var mkLinks = function(v) {
        ...
        ;
        throw new Error("Failed pattern match at CE2.Data.Loader (line 830, column 5 - line 841, column 25): " + [v1.constructor.name]);
      };
  ...
  // output/CE2.Data.TreeLayout/index.js
      ...
      return function(mPos) {
        ...
        if (mPos instanceof Just) {
          var v = (function() {
            ...
            ;
            throw new Error("Failed pattern match at CE2.Data.TreeLayout (line 261, column 28 - line 282, column 14): " + [orient.constructor.name]);
          })();
        ...
        ;
        throw new Error("Failed pattern match at CE2.Data.TreeLayout (line 244, column 3 - line 290, column 43): " + [mPos.constructor.name]);
      };
    };
  };
  ...
  var findRootModule = function(modules) {
    ...
    if (v instanceof Nothing) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Data.TreeLayout (line 177, column 7 - line 179, column 21): " + [v1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at CE2.Data.TreeLayout (line 173, column 3 - line 179, column 21): " + [v.constructor.name]);
  };
      ...
      return function(nodes) {
        return function(links) {
          ...
          var rootPos = (function() {
            ...
            ;
            throw new Error("Failed pattern match at CE2.Data.TreeLayout (line 152, column 15 - line 154, column 36): " + [v.constructor.name]);
          })();
          return {
            treeNodes,
  ...
  var neighborhoodViewLabel = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at CE2.ViewState (line 86, column 1 - line 86, column 56): " + [v.constructor.name]);
  };
  var viewDescription = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at CE2.ViewState (line 93, column 1 - line 93, column 39): " + [v.constructor.name]);
  };
    ...
    return function(newChildren) {
      if (parent2 instanceof Node2) {
        return new Node2({
          ...
          children: append8(parent2.value0.children)(newChildren)
        });
      }
      ;
    ...
    return function(child) {
      if (parent2 instanceof Node2) {
        return new Node2({
          ...
          attrs: parent2.value0.attrs,
          behaviors: parent2.value0.behaviors,
          children: append8(parent2.value0.children)([child])
        });
      }
      ;
      if (parent2 instanceof Join) {
    ...
    return function(newBehaviors) {
      if (tree2 instanceof Node2) {
        return new Node2({
          ...
          behaviors: append8(tree2.value0.behaviors)(newBehaviors)
        });
      }
      ;
  ...
  var fromFoldable11 = /* @__PURE__ */ fromFoldable4(foldableArray);
  var fromFoldable42 = /* @__PURE__ */ fromFoldable11(ordString);
  ...
  var applySetup = function(setupConfig) {
    return function(sim) {
      return function __do3() {
        ...
        var desiredNames = fromFoldable42(map22(function(v) {
          return v.name;
        })(setupConfig.forces));
        var currentNames = fromFoldable52(keys3(currentForces));
        var toRemove = difference1(currentNames)(desiredNames);
        for_3(toUnfoldable7(toRemove))(function(name16) {
          return modify_($$delete6(name16))(sim.forces);
        })();
        for_3(setupConfig.forces)(function(fc) {
          return function __do4() {
            ...
            return modify_(insert8(fc.name)(handle))(sim.forces)();
          };
        })();
  ...
  var tick = function(sim) {
    return function __do3() {
      ...
      var forceHandles = fromFoldable16(values2(forces));
        ...
        return function(v2) {
          if (v1 instanceof Node2) {
            return function __do3() {
              ...
              var combinedChildMap = foldl2(union5)(empty3)(map27(snd)(childMaps));
  ...
  var renderNodeHelper = function(dictOrd) {
    ...
    return function(v) {
      return function(v1) {
          ...
          return function __do3() {
            ...
            (function() {
              if (v1.value0.behaviors.exit instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1416, column 7 - line 1424, column 20): " + [v1.value0.behaviors.exit.value0.transition.constructor.name]);
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1414, column 3 - line 1428, column 16): " + [v1.value0.behaviors.exit.constructor.name]);
            })();
            var enterElementsAndMaps = (function() {
              if (v1.value0.behaviors.enter instanceof Just) {
                ...
                (function() {
                  if (v1.value0.behaviors.enter.value0.transition instanceof Just) {
                    var enterElements2 = map27(fst)(rendered);
                  ...
                  ;
                  throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1452, column 7 - line 1468, column 29): " + [v1.value0.behaviors.enter.value0.transition.constructor.name]);
                })();
                return rendered;
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1439, column 27 - line 1473, column 68): " + [v1.value0.behaviors.enter.constructor.name]);
            })();
            var enterElements = map27(fst)(enterElementsAndMaps);
            var enterChildMaps = map27(snd)(enterElementsAndMaps);
            var updateElements = (function() {
              if (v1.value0.behaviors.update instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1482, column 7 - line 1498, column 71): " + [v1.value0.behaviors.update.value0.transition.constructor.name]);
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1479, column 21 - line 1501, column 67): " + [v1.value0.behaviors.update.constructor.name]);
            })();
            var allElements = append14(enterElements)(updateElements);
            var combinedChildMap = foldl2(union5)(empty3)(enterChildMaps);
            var doc = (function() {
        ...
        ;
        if (v1 instanceof UpdateNestedJoin) {
          var innerData = join2(map27(v1.value0.decompose)(v1.value0.joinData));
          return function __do3() {
            ...
            (function() {
              if (v1.value0.behaviors.exit instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1593, column 7 - line 1601, column 20): " + [v1.value0.behaviors.exit.value0.transition.constructor.name]);
              }
              ;
              if (v1.value0.behaviors.exit instanceof Nothing) {
                remove1(v2.value0.exit)();
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1591, column 3 - line 1604, column 16): " + [v1.value0.behaviors.exit.constructor.name]);
            })();
            var enterElementsAndMaps = (function() {
              if (v1.value0.behaviors.enter instanceof Just) {
                var modifiedTemplate = function(datum2) {
                ...
                (function() {
                  ...
                  ;
                  throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1632, column 7 - line 1648, column 29): " + [v1.value0.behaviors.enter.value0.transition.constructor.name]);
                })();
                return rendered;
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1621, column 27 - line 1651, column 92): " + [v1.value0.behaviors.enter.constructor.name]);
            })();
            var updateElements = (function() {
              if (v1.value0.behaviors.update instanceof Just) {
                if (v1.value0.behaviors.update.value0.transition instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1657, column 7 - line 1670, column 86): " + [v1.value0.behaviors.update.value0.transition.constructor.name]);
              }
              ;
              if (v1.value0.behaviors.update instanceof Nothing) {
                return renderTemplatesForBoundSelection1(v1.value0.template)(v2.value0.update)();
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1654, column 21 - line 1671, column 91): " + [v1.value0.behaviors.update.constructor.name]);
            })();
            var enterElements = map27(fst)(enterElementsAndMaps);
            var allElements = append14(enterElements)(updateElements);
            var enterChildMaps = map27(snd)(enterElementsAndMaps);
  ...
  // output/CE2.Viz.ForceGraph/index.js
        ...
        return function __do3() {
          transformCircles(containerSelector)(function(rect) {
            if (rect.simNode instanceof Just) {
              var v = lookup6(rect.simNode.value0.id)(treeNodeMap);
            ...
            ;
            throw new Error("Failed pattern match at CE2.Viz.ForceGraph (line 304, column 5 - line 318, column 10): " + [rect.simNode.constructor.name]);
          })();
  ...
  var renderForcePhase = function(containerSelector) {
    return function(currentNodes) {
      ...
      return function __do3() {
        transformCircles(containerSelector)(function(rect) {
          if (rect.simNode instanceof Just) {
            var v = lookup6(rect.simNode.value0.id)(nodeMap);
            if (v instanceof Just) {
              return {
                cx: v.value0.x,
                cy: v.value0.y
            ...
            ;
            throw new Error("Failed pattern match at CE2.Viz.ForceGraph (line 381, column 9 - line 383, column 87): " + [v.constructor.name]);
          }
          ;
          if (rect.simNode instanceof Nothing) {
            return {
          ...
          ;
          throw new Error("Failed pattern match at CE2.Viz.ForceGraph (line 379, column 5 - line 384, column 83): " + [rect.simNode.constructor.name]);
        })();
        return transformPaths(containerSelector + " g.force-links-group")(function(el) {
          var tgtPos = (function() {
            var v = lookup6(el.targetId)(nodeMap);
            if (v instanceof Just) {
              return {
                x: v.value0.x,
                y: v.value0.y
            ...
            ;
            throw new Error("Failed pattern match at CE2.Viz.ForceGraph (line 394, column 16 - line 396, column 60): " + [v.constructor.name]);
          })();
          var srcPos = (function() {
            var v = lookup6(el.sourceId)(nodeMap);
            if (v instanceof Just) {
              return {
                x: v.value0.x,
                y: v.value0.y
            ...
            ;
            throw new Error("Failed pattern match at CE2.Viz.ForceGraph (line 391, column 16 - line 393, column 60): " + [v.constructor.name]);
          })();
        ...
        return function(links) {
          return function __do3() {
            ...
            var positionedNodes = mapMaybe(function(n) {
              var v = lookup6(n.id)(treeNodeMap);
              if (v instanceof Just && v.value0.isInTree) {
                return new Just({
                  id: n.id,
                  cluster: n.cluster,
  ...
  var buildLinkElement = function(nodeMap) {
    return function(rootX) {
      return function(rootY) {
        return function(v) {
          return bind22(lookup6(v.value0)(nodeMap))(function(sourceNode) {
            return bind22(lookup6(v.value1)(nodeMap))(function(targetNode) {
              return pure23({
                sourceId: v.value0,
                targetId: v.value1,
  ...
  var addTreeLinks = function(containerSelector) {
    return function(layout) {
      ...
      return function __do3() {
        ...
        runD3v2M(bind13(select6(containerSelector + " svg"))(function(svg) {
  ...
  // output/CE2.Viz.TreeView/index.js
      ...
      return function(layout) {
        ...
        return function __do3() {
          transformCircles(config.containerSelector)(function(rect) {
            ...
            ;
            throw new Error("Failed pattern match at CE2.Viz.TreeView (line 203, column 5 - line 221, column 10): " + [rect.simNode.constructor.name]);
          })();
  ...
  var buildLinkElement2 = function(nodeMap) {
    return function(rootX) {
      return function(rootY) {
        return function(v) {
          return bind7(lookup7(v.value0)(nodeMap))(function(sourceNode) {
            return bind7(lookup7(v.value1)(nodeMap))(function(targetNode) {
              return pure9({
      ...
      return function(rootX) {
        return function(rootY) {
          ...
          return function __do3() {
            ...
            runD3v2M(bind23(select7(config.containerSelector + " svg"))(function(svg) {
        ...
        return function(links) {
          return function __do3() {
            ...
            var layout = (function() {
              ...
              ;
              throw new Error("Failed pattern match at CE2.Viz.TreeView (line 125, column 13 - line 137, column 18): " + [animState.treeLayout.constructor.name]);
            })();
            (function() {
  ...
  var sum2 = function(v) {
    return function(valueAccessor) {
      ...
      var childrenValued = map29(function(child) {
  ...
  var hierarchy = function(rootData) {
    return function(childrenAccessor) {
      var computeHeights = function(v) {
        ...
        ;
        var childrenWithHeights = map29(computeHeights)(v.value0.children);
        var childHeights = map29(getHeight)(childrenWithHeights);
        ...
        return function(currentDepth) {
          return function(nodeData) {
            ...
            if (v instanceof Just) {
              ...
              var builtChildren = map29(buildNode(new Just(thisNode))(currentDepth + 1 | 0))(v.value0);
  ...
  var toTreemapNode = function(v) {
    return new TNode({
      ...
      children: map30(toTreemapNode)(v.value0.children),
      x0: 0,
      y0: 0,
      x1: 0,
      y1: 0
  ...
  var positionTree = function(config) {
    return function(v) {
      return function(paddingStack) {
        ...
        var finalChildren = map30(function(child) {
  ...
  // output/CE2.Viz.Treemap/index.js
  ...
  var select8 = /* @__PURE__ */ select(selectionMD3v2Selection_D);
  ...
  var packageLabelTemplate = function(_rect) {
    return elem3(Text.value)([fnAttr4("x")(function(r) {
      return r.x + 4;
  ...
  var moduleCircleTemplate = function(callbacks) {
    return function(_node) {
      return withBehaviors(elem3(Circle.value)([fnAttr4("cx")(function(r) {
        ...
        ;
        throw new Error("Failed pattern match at CE2.Viz.Treemap (line 380, column 31 - line 382, column 29): " + [r.simNode.constructor.name]);
      })]);
    };
  };
    ...
    return function(node) {
      return function __do3() {
        ...
        var classifier = function(rect) {
          ...
          ;
          throw new Error("Failed pattern match at CE2.Viz.Treemap (line 411, column 23 - line 417, column 16): " + [rect.simNode.constructor.name]);
        };
      ...
      return function(moduleNodes) {
        ...
        var modulesByPackage = (function() {
          var addModule = function(acc) {
            return function(mod5) {
              var existing = fromMaybe([])(lookup8(mod5["package"])(acc));
              return insert10(mod5["package"])(snoc(existing)(mod5))(acc);
            };
          };
        ...
        var getChildren2 = function(leaf) {
          ...
          if (leaf.nodeType instanceof PackageNode) {
            var mods = fromMaybe([])(lookup8(leaf.name)(modulesByPackage));
            var $220 = $$null(mods);
            if ($220) {
              return Nothing.value;
            }
          ...
          ;
          throw new Error("Failed pattern match at CE2.Viz.Treemap (line 174, column 9 - line 185, column 32): " + [leaf.nodeType.constructor.name]);
        };
          ...
          var processNode = function(acc) {
            return function(v1) {
              ...
              if (v1.value0.data_.simNode instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at CE2.Viz.Treemap (line 244, column 18 - line 264, column 70): " + [v1.value0.data_.nodeType.constructor.name]);
              }
              ;
              throw new Error("Failed pattern match at CE2.Viz.Treemap (line 233, column 14 - line 264, column 70): " + [v1.value0.data_.simNode.constructor.name]);
            };
          };
  ...
  var buildVizTree = function(_config) {
    return function(callbacks) {
      return function(positioned) {
        ...
        })]))(joinData("module-circles")("circle")(map31(toPackageRect)(positioned.modules))(moduleCircleTemplate(callbacks)))]);
      };
    };
  };
    ...
    return function(callbacks) {
      return function(nodes) {
        return function __do3() {
          ...
          runD3v2M(bind14(select8(config.containerSelector))(function(container) {
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v) {
    var go2 = function(v2) {
      ...
      if (v2 instanceof Elem) {
        return new Elem(v2.value0, v2.value1, v.value0(v2.value2), map32(go2)(v2.value3));
      }
      ;
      if (v2 instanceof Keyed) {
        return new Keyed(v2.value0, v2.value1, v.value0(v2.value2), map32(map111(go2))(v2.value3));
      }
      ;
  ...
  var defaultCallbacks = function __do2() {
    ...
    var startRef = $$new(pure12(unit))();
    var stopRef = $$new(pure12(unit))();
  ...
  // output/CE2.Component.App/index.js
  ...
  var showPhase = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at CE2.Component.App (line 239, column 1 - line 239, column 32): " + [v.constructor.name]);
  };
  var showForcePhase = {
    show: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 57, column 1 - line 60, column 35): " + [v.constructor.name]);
    }
  };
  ...
  var makeTreemapCallbacks = function(mListener) {
    return {
      onNodeClick: function(node) {
        ...
        ;
        throw new Error("Failed pattern match at CE2.Component.App (line 665, column 27 - line 667, column 27): " + [mListener.constructor.name]);
      },
      onNodeHover: function(mNode) {
        ...
        ;
        throw new Error("Failed pattern match at CE2.Component.App (line 668, column 28 - line 670, column 27): " + [mListener.constructor.name]);
      }
    };
  };
  ...
  var render3 = function(dictMonadAff) {
    return function(state3) {
      return div3([class_("explorer-app")])([div3([class_("status-panel")])([h2_([text5("Code Explorer v2")]), p_([text5("Phase: " + showPhase(state3.phase))]), p_([text5("View: " + viewDescription(state3.viewState))]), (function() {
        if (state3.forcePhase instanceof Just) {
          return p_([text5("Force phase: " + show25(state3.forcePhase.value0))]);
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at CE2.Component.App (line 189, column 11 - line 191, column 34): " + [state3.forcePhase.constructor.name]);
      })(), (function() {
        if (state3.modelData instanceof Nothing) {
          return p_([text5("No data loaded")]);
        }
        ;
        if (state3.modelData instanceof Just) {
          return p_([text5("Loaded: " + (show8(state3.modelData.value0.moduleCount) + (" modules, " + (show8(state3.modelData.value0.packageCount) + " packages"))))]);
        }
        ;
        throw new Error("Failed pattern match at CE2.Component.App (line 192, column 11 - line 197, column 16): " + [state3.modelData.constructor.name]);
      })(), div3([class_("view-switcher")])([button2([onClick(function(v) {
        ...
        ;
        return "";
      })())])([text5("Treemap")]), button2([onClick(function(v) {
        ...
        ;
        return "";
      })())])([text5("Tree")]), button2([onClick(function(v) {
        ...
        ;
        return "";
      })())])([text5("Force")])]), (function() {
        var $120 = isForceView(state3.viewState);
        if ($120) {
          return div3([class_("view-switcher")])([button2([onClick(function(v) {
            ...
            ;
            return "";
          })())])([text5("All")]), button2([onClick(function(v) {
            return ToggleForceProjectOnly.value;
          }), class_((function() {
  ...
  var findPackageOfNode = function(nodeId) {
    return function(nodes) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 676, column 3 - line 678, column 25): " + [v.constructor.name]);
    };
  };
  var cleanupForceSimulation = function(dictMonadAff) {
    ...
    return bind9(get6)(function(state3) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 629, column 3 - line 633, column 25): " + [state3.simulation.constructor.name]);
    });
  };
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return discard3(log9("[App] Initializing..."))(function() {
          return bind9(liftEffect9(create4))(function(v1) {
            return discard3($$void6(subscribe2(v1.emitter)))(function() {
              return discard3(modify_3(function(v2) {
                ...
                return $$void6(fork(bind9(liftAff2(loadModel))(function(result) {
                  ...
                  ;
                  throw new Error("Failed pattern match at CE2.Component.App (line 273, column 7 - line 275, column 57): " + [result.constructor.name]);
                })));
              });
            });
          });
        ...
        return discard3(log9("[App] Switching to Treemap view"))(function() {
          return bind9(get6)(function(state3) {
            return discard3(cleanupForceSimulation1)(function() {
              ...
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 311, column 5 - line 334, column 37): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
        ...
        return discard3(log9("[App] SwitchToTree clicked"))(function() {
          return bind9(get6)(function(state3) {
            return discard3(cleanupForceSimulation1)(function() {
              ...
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 342, column 5 - line 359, column 27): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
        ...
        return discard3(log9("[App] SwitchToForce clicked"))(function() {
          return bind9(get6)(function(state3) {
            return discard3(cleanupForceSimulation1)(function() {
              ...
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 367, column 5 - line 391, column 32): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
        ...
        return discard3(log9("[App] FocusSubtree on node " + show8(v.value0)))(function() {
          return bind9(get6)(function(state3) {
            return discard3(cleanupForceSimulation1)(function() {
              ...
              ;
              throw new Error("Failed pattern match at CE2.Component.App (line 401, column 5 - line 419, column 27): " + [state3.modelData.constructor.name]);
            });
          });
        });
      }
      ...
      if (v instanceof ForceAnimationTick) {
        return bind9(get6)(function(state3) {
          if (state3.forcePhase instanceof Just && (state3.forceLayout instanceof Just && state3.modelData instanceof Just)) {
            ...
            ;
            throw new Error("Failed pattern match at CE2.Component.App (line 452, column 9 - line 482, column 22): " + [state3.forcePhase.value0.constructor.name]);
          }
          ;
          return pure14(unit);
        });
      ...
      if (v instanceof HandleHover) {
        return bind9(get6)(function(state3) {
          ...
          if (state3.viewState instanceof Overview && state3.viewState.value0 instanceof TreemapView) {
            ...
            ;
            throw new Error("Failed pattern match at CE2.Component.App (line 568, column 9 - line 574, column 55): " + [v.value0.constructor.name]);
          }
          ;
          if (v.value0 instanceof Just) {
            return discard3(modify_3(function(v1) {
          ...
          ;
          throw new Error("Failed pattern match at CE2.Component.App (line 577, column 9 - line 583, column 55): " + [v.value0.constructor.name]);
        });
      }
      ;
      throw new Error("Failed pattern match at CE2.Component.App (line 261, column 16 - line 583, column 55): " + [v.constructor.name]);
    };
  };
            ...
            if (v1 instanceof Subscribe) {
              return bind15(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind15(liftEffect5(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind15(liftEffect5(read(ref2)))(function(v2) {
                    return discard1(liftEffect5(modify_(map210(insert13(sid)(finalize)))(v2.subscriptions)))(function() {
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind18(awaitBody)(function() {
    return bind18(selectElement("#app"))(function(mAppEl) {
      ...
      ;
      throw new Error("Failed pattern match at CE2.Main (line 20, column 3 - line 24, column 57): " + [mAppEl.constructor.name]);
    });
  }));
